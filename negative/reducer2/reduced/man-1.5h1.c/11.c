...
#line 174
    if (! ((unsigned int )*vs != (unsigned int )((void *)0))) {
#line 174
      goto while_break;
    }
    {
#line 175
    tmp___4 = strcmp((char const   *)*vs, (char const   *)name);
    }
#line 175
    if (tmp___4 == 0) {
      {
...
#line 314
    ...
    {
#line 314
    fp = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"r");
    }
#line 315
    if ((unsigned int )fp == (unsigned int )((void *)0)) {
#line 315
...
#line 317
          if (*extp) {
            {
#line 318
            strcat((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)extp));
#line 319
            fp = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"r");
            }
          }
...
#line 360
  if ((unsigned int )name != (unsigned int )(ultname)) {
    {
#line 361
    strcpy((char */* __restrict  */)(ultname), (char const   */* __restrict  */)((char const   *)name));
#line 362
    name = ultname;
    }
  }
...
#line 376
        ...
        {
#line 376
        strcpy((char */* __restrict  */)(cp + 1), (char const   */* __restrict  */)((char const   *)beg));
        }
      }
    } else {
      _L___1: 
...
#line 377
      if ((unsigned int )cp != (unsigned int )((void *)0)) {
        {
#line 378
        strcat((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)cp));
        }
      } else {
        {
#line 380
...
#line 381
        strcat((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)beg));
        }
      }
    }
  } else {
...
#line 392
        ...
        {
#line 393
        strcpy((char */* __restrict  */)buf___0, (char const   */* __restrict  */)((char const   *)d));
#line 394
        strcat((char */* __restrict  */)buf___0, (char const   */* __restrict  */)" ");
#line 395
        strcat((char */* __restrict  */)buf___0, (char const   */* __restrict  */)((char const   *)file));
        }
      } else {
        {
#line 397
...
#line 399
        strcat((char */* __restrict  */)buf___0, (char const   */* __restrict  */)" | ");
#line 400
        strcat((char */* __restrict  */)buf___0, (char const   */* __restrict  */)((char const   *)d));
        }
      }
    }
  }
...
#line 502
      tmp___1 = eos(bufh);
#line 502
      sprintf((char */* __restrict  */)tmp___1, (char const   */* __restrict  */)".pl %s",
              pl);
      }
    }
    {
...
#line 535
  ...
  {
#line 536
  strcpy((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)command));
  }
#line 538
...
#line 623
  command = (char *)((void *)0);
#line 629
  fp = fopen((char const   */* __restrict  */)((char const   *)cat_file), (char const   */* __restrict  */)"w");
  }
#line 629
  if ((unsigned int )fp == (unsigned int )((void *)0)) {
    {
...
#line 881
  if (tmp___5) {
    {
#line 886
    tmp = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"r");
#line 886
    fp = tmp;
    }
#line 888
...
#line 896
          strcat((char */* __restrict  */)(fullname), (char const   */* __restrict  */)((char const   *)name));
          }
        } else {
#line 898
          goto _L___0;
...
#line 897
      if ((unsigned long )(tmp___0 + 2U) < sizeof(fullname)) {
        {
#line 898
        strcpy((char */* __restrict  */)(fullname), (char const   */* __restrict  */)((char const   *)name));
        }
      } else {
        {
#line 900
...
#line 901
    ...
    {
#line 904
    strcpy((char */* __restrict  */)(fullpath), (char const   */* __restrict  */)((char const   *)(fullname)));
#line 905
...
#line 996
    i ++;
#line 996
    tmp_section_list[tmp] = my_strdup(p);
    }
#line 998
    if ((unsigned int )end == (unsigned int )((void *)0)) {
#line 999
...
#line 992
  ...
  while_break: 
#line 1002
  tmp_section_list[i] = (char *)((void *)0);
#line 1003
...
#line 1054
                if (tmp___2) {
                  {
#line 1057
                  strcpy((char */* __restrict  */)(path), (char const   */* __restrict  */)((char const   *)*gf));
#line 1058
...
{ 
  ...
  {
#line 100
  tmp = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& sb));
  }
#line 100
  if (tmp != 0) {
#line 101
...
#line 119
  memcpy((void */* __restrict  */)((void *)t), (void const   */* __restrict  */)((void const   *)p),
         (unsigned int )len);
#line 120
...
#line 191
    strcat((char */* __restrict  */)(cwd), (char const   */* __restrict  */)((char const   *)dir));
    }
#line 192
    if (*lang) {
      {
#line 193
      strcat((char */* __restrict  */)(cwd), (char const   */* __restrict  */)"/");
#line 194
      strcat((char */* __restrict  */)(cwd), (char const   */* __restrict  */)((char const   *)lang));
      }
    }
#line 196
    dir = cwd;
...
#line 199
    ...
    {
#line 200
    strcpy((char */* __restrict  */)(cwd), (char const   */* __restrict  */)((char const   *)dir));
#line 201
    strcat((char */* __restrict  */)(cwd), (char const   */* __restrict  */)"/");
#line 202
    strcat((char */* __restrict  */)(cwd), (char const   */* __restrict  */)((char const   *)lang));
...
#line 245
    if (tmp > 2U) {
      {
#line 248
      strncpy((char */* __restrict  */)(lang2), (char const   */* __restrict  */)((char const   *)lang),
              2U);
#line 249
      lang2[2] = (char)0;
#line 250
...
#line 204
  if (cf) {
    {
#line 206
    config = fopen((char const   */* __restrict  */)((char const   *)cf), (char const   */* __restrict  */)"r");
    }
#line 206
...
#line 93
      cat_name = tmp___5;
#line 94
      strcpy((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)(dlp->catdir)));
#line 95
      strcat((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)t2));
      }
#line 96
      goto gotit;
    }
...
#line 125
        strcat((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)name));
#line 126
        strcat((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)t3));
        }
#line 127
        goto gotit;
      }
...
#line 147
        strcat((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)(name + 4)));
#line 148
        strcat((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)t3));
        }
#line 149
...
#line 156
    cat_name = tmp___22;
#line 157
    strcpy((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)name));
    }
  } else {
#line 159
    cat_name = name;
...
#line 165
  if (ext) {
    {
#line 166
    strcat((char */* __restrict  */)cat_name, (char const   */* __restrict  */)((char const   *)ext));
    }
  }
#line 168
...
#line 154
      ...
      {
#line 156
      strncpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)name),
              (unsigned int )namesz);
#line 156
      path += namesz;
      }
#line 156
      ...
      {
#line 158
      strncpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)lang),
              (unsigned int )langsz);
#line 158
      path += langsz;
      }
#line 158
      ...
      {
#line 160
      strncpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)lang_l),
...
#line 160
      ...
      {
#line 162
      strncpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)lang_t),
...
#line 162
      ...
      {
#line 164
      strncpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)lang_c),
...
#line 84
  tmp = getmsg(n);
#line 84
  vfprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)tmp),
           p);
#line 85
  __builtin_va_end(p);
#line 86
...
#line 389
      memcpy((void */* __restrict  */)((void *)nextname), (void const   */* __restrict  */)((void const   *)(dp->d_name)),
             i);
#line 390
      count ++;
      }
...
#line 469
    ...
    {
#line 470
    strcpy((char */* __restrict  */)*(result + i), (char const   */* __restrict  */)((char const   *)dir));
    }
#line 471
    if (add_slash) {
#line 472
    ...
    {
#line 473
    strcpy((char */* __restrict  */)((*(result + i) + l) + add_slash), (char const   */* __restrict  */)((char const   *)*(array + i)));
#line 465
    i ++;
    }
  }
...
#line 525
    memcpy((void */* __restrict  */)((void *)directory_name), (void const   */* __restrict  */)((void const   *)pathname),
           directory_len);
#line 526
...
#line 601
      ...
      {
#line 607
      memcpy((void */* __restrict  */)((void *)*(result + 0)), (void const   */* __restrict  */)((void const   *)directory_name),
             directory_len + 1U);
#line 608
...
#line 65
  status = 0;
#line 67
  fa_stat = stat((char const   */* __restrict  */)((char const   *)fa), (struct stat */* __restrict  */)(& fa_sb));
  }
#line 68
  if (fa_stat != 0) {
#line 69
...
#line 69
  ...
  {
#line 71
  fb_stat = stat((char const   */* __restrict  */)((char const   *)fb), (struct stat */* __restrict  */)(& fb_sb));
  }
#line 72
  if (fb_stat != 0) {
#line 73
...
#line 294
      ...
      {
#line 283
      tmp___5 = __builtin_va_arg(p, char *);
#line 283
      tmp___3 = tmp___5;
#line 283
      tmp___0 = tmp___3;
...
#line 290
      len += 20;
#line 291
      tmp___6 = __builtin_va_arg(p, int );
#line 291
      tmp___4 = tmp___6;
#line 291
      tmp___2 = tmp___4;
...
#line 304
  __builtin_va_start(p, format);
#line 305
  vsprintf((char */* __restrict  */)s, (char const   */* __restrict  */)((char const   *)format),
           p);
#line 306
  __builtin_va_end(p);
  }

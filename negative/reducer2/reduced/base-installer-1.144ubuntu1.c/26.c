...
#line 45
  ...
  {
#line 46
  tmp___1 = strcpy((char */* __restrict  */)dst, (char const   */* __restrict  */)((char const   *)fld));
  }
#line 46
  return (tmp___1);
}
...
#line 80
  ...
  {
#line 82
  f = fopen((char const   */* __restrict  */)((char const   *)pkgsfile), (char const   */* __restrict  */)"r");
  }
#line 83
...
#line 101
        ...
        {
#line 102
        strcpy((char */* __restrict  */)(prev_pkg), (char const   */* __restrict  */)((char const   *)(cur_pkg)));
        }
      }
#line 104
...
#line 163
        if (output) {
          {
#line 164
          fputs((char const   */* __restrict  */)((char const   *)output), (FILE */* __restrict  */)stdout);
          }
        }
#line 165
        if (uniq) {
...
#line 240
      ...
      {
#line 242
      strcpy((char */* __restrict  */)(accum + accum_size), (char const   */* __restrict  */)((char const   *)(buf)));
#line 243
      accum_size += len;
      }
    }
...
#line 252
        if (tmp___4 == 0) {
          {
#line 253
          fputs((char const   */* __restrict  */)((char const   *)accum), (FILE */* __restrict  */)stdout);
          }
#line 254

...
#line 207
  tmp___0 = fread((void */* __restrict  */)((void *)id3tag), (size_t )128, (size_t )1,
                  (FILE */* __restrict  */)fin);
#line 207
  n = (int )tmp___0;
  }
...
#line 220
  fseek(fout, 0L, 2);
#line 222
  fwrite((void const   */* __restrict  */)((void const   *)id3tag), (size_t )128,
...
#line 252
    ...
    {
#line 253
    fptr = fopen((char const   */* __restrict  */)((char const   *)*(argv + ctr)),
...
#line 273
                    if ((int )mytag.songname[0] != 0) {
                      {
#line 274
                      strncpy((char */* __restrict  */)(strbuf), (char const   */* __restrict  */)((char const   *)(mytag.songname)),
                              (size_t )30);
#line 275
                      strbuf[30] = (char )'\000';
#line 276
...
#line 278
                    if ((int )mytag.artist[0] != 0) {
                      {
#line 279
                      strncpy((char */* __restrict  */)(strbuf), (char const   */* __restrict  */)((char const   *)(mytag.artist)),
                              (size_t )30);
#line 280
                      strbuf[30] = (char )'\000';
#line 281
...
#line 283
                    if ((int )mytag.album[0] != 0) {
                      {
#line 284
                      strncpy((char */* __restrict  */)(strbuf), (char const   */* __restrict  */)((char const   *)(mytag.album)),
                              (size_t )30);
#line 285
                      strbuf[30] = (char )'\000';
#line 286
...
#line 290
                      if ((int )mytag.note.v11.note[0] != 0) {
                        {
#line 291
                        strncpy((char */* __restrict  */)(strbuf), (char const   */* __restrict  */)((char const   *)(mytag.note.v11.note)),
                                (size_t )28);
#line 292
                        strbuf[28] = (char )'\000';
#line 293
...
#line 299
                    if ((int )mytag.note.v10.note[0] != 0) {
                      {
#line 300
                      strncpy((char */* __restrict  */)(strbuf), (char const   */* __restrict  */)((char const   *)(mytag.note.v10.note)),
                              (size_t )30);
#line 301
                      strbuf[30] = (char )'\000';
#line 302
...
#line 305
                    if ((int )mytag.year[0] != 0) {
                      {
#line 306
                      strncpy((char */* __restrict  */)(strbuf), (char const   */* __restrict  */)((char const   *)(mytag.year)),
                              (size_t )4);
#line 307
                      strbuf[4] = (char )'\000';
#line 308
...
#line 321
        strncpy((char */* __restrict  */)(mytag.songname), (char const   */* __restrict  */)((char const   *)newtitle),
                (size_t )30);
        }
      }
#line 323
...
#line 325
        strncpy((char */* __restrict  */)(mytag.artist), (char const   */* __restrict  */)((char const   *)newartist),
                (size_t )30);
        }
      }
#line 327
...
#line 329
        strncpy((char */* __restrict  */)(mytag.album), (char const   */* __restrict  */)((char const   *)newalbum),
                (size_t )30);
        }
      }
#line 331
...
#line 337
              strncpy((char */* __restrict  */)(mytag.note.v11.note), (char const   */* __restrict  */)((char const   *)newnote),
                      (size_t )28);
              }
            } else {
              {
...
#line 340
              strncpy((char */* __restrict  */)(mytag.note.v10.note), (char const   */* __restrict  */)((char const   *)newnote),
                      (size_t )30);
              }
            }
          } else {
...
#line 354
        strncpy((char */* __restrict  */)(mytag.year), (char const   */* __restrict  */)((char const   *)(strbuf)),
                (size_t )4);
        }
      }
#line 356

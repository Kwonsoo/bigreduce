...
#line 153
  print_len = snprintf((char */* __restrict  */)(buffer), (size_t )255, (char const   */* __restrict  */)((char const   *)(since_format)),
...
#line 184
  result = (off_t )0;
#line 186
  snprintf((char */* __restrict  */)(have), (size_t )256, (char const   */* __restrict  */)((char const   *)(since_format)),
           st->st_dev, st->st_ino, st->st_size);
#line 189
  match = 0;
#line 190
...
#line 191
  while (1) {
    ...
    {
#line 193
    tmp = fread((void */* __restrict  */)((void *)(got)), (size_t )sizeof(char ),
...
#line 236
      result = strtol((char const   */* __restrict  */)((char const   *)((got + line_offset) + 1)),
...
#line 268
          ...
          {
#line 274
          tmp___9 = fwrite((void const   */* __restrict  */)((void const   *)(have)),
                           (size_t )sizeof(char ), (size_t )line_length, (FILE */* __restrict  */)file);
          }
#line 274
...
#line 282
        ...
        {
#line 291
        tmp___13 = fwrite((void const   */* __restrict  */)((void const   *)(have)),
                          (size_t )sizeof(char ), (size_t )line_length, (FILE */* __restrict  */)file);
        }
#line 291
...
#line 329
      if (rl > 0) {
        {
#line 331
        tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)(buffer)),
                         (size_t )sizeof(char ), (size_t )rl, (FILE */* __restrict  */)stdout);
#line 331
        wl = (int )tmp___1;
        }
      }
...
#line 545
            if (verbose > 1) {
              {
#line 547
              printf((char const   */* __restrict  */)((char const   *)(since_format)),
                     st.st_dev, st.st_ino, seekdest);
#line 548

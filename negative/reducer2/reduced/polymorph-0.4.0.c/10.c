...
#line 46
    strcat((char */* __restrict  */)(where), (char const   */* __restrict  */)((char const   *)(init_file)));
    }
#line 47
    goto switch_break;
    case_2: 
...
#line 55
    tmp = getenv("HOME");
#line 55
    strcpy((char */* __restrict  */)(where), (char const   */* __restrict  */)((char const   *)tmp));
#line 56
    strcat((char */* __restrict  */)(where), (char const   */* __restrict  */)((char const   *)(hidn_file)));
    }
#line 57
    goto switch_break;
    switch_default: 
...
#line 61
    strcpy((char */* __restrict  */)(where), (char const   */* __restrict  */)((char const   *)tmp___0));
#line 62
    strcat((char */* __restrict  */)(where), (char const   */* __restrict  */)((char const   *)(init_file)));
    }
#line 63
...
#line 66
    rcfile = (FILE *)((void *)0);
#line 67
    rcfile = fopen((char const   */* __restrict  */)((char const   *)(where)), (char const   */* __restrict  */)"r");
#line 68
    found = 1;
    }
#line 69
...
#line 126
    strcpy((char */* __restrict  */)(target_dir), (char const   */* __restrict  */)((char const   *)(buf)));
#line 127
    strcpy((char */* __restrict  */)(after_dir), (char const   */* __restrict  */)((char const   *)colon));
#line 130
...
#line 192
  new_str[j] = (char )'\000';
#line 193
  strcpy((char */* __restrict  */)victim___0, (char const   */* __restrict  */)((char const   *)(new_str)));
  }
#line 195
  return;
}
...
#line 66
  ...
  {
#line 70
  strcpy((char */* __restrict  */)(tmp->dest), (char const   */* __restrict  */)((char const   *)victim___0));
#line 71
...
#line 102
  ...
  {
#line 105
  strcpy((char */* __restrict  */)(tmp->x3), (char const   */* __restrict  */)((char const   *)victim___0));
#line 106
...
#line 66
    if (track) {
      {
#line 68
      tmp___0 = stat((char const   */* __restrict  */)((char const   *)(victim->d_name)),
                     (struct stat */* __restrict  */)(& status));
      }
#line 68
      if (tmp___0 == -1) {
        {
...
#line 73
      if ((status.st_mode & 61440U) == 32768U) {
        {
#line 74
        strcpy((char */* __restrict  */)(filename), (char const   */* __restrict  */)((char const   *)(victim->d_name)));
#line 75
      ...
      {
#line 80
      tmp___1 = lstat((char const   */* __restrict  */)((char const   *)(victim->d_name)),
                      (struct stat */* __restrict  */)(& status));
      }
#line 80
      if (tmp___1 == -1) {
...
#line 116
    ...
    {
#line 118
    strcpy((char */* __restrict  */)(target), (char const   */* __restrict  */)((char const   *)optarg));
    }
#line 119
    goto switch_break;
    case_104: 
...
#line 198
    ...
    {
#line 200
    strcpy((char */* __restrict  */)(newname), (char const   */* __restrict  */)((char const   *)original));
#line 201
    error = -1;
    }
  }
...
#line 209
    if ((unsigned long )bslash != (unsigned long )((void *)0)) {
      {
#line 209
      strcpy((char */* __restrict  */)(newname), (char const   */* __restrict  */)((char const   *)(bslash + 1)));
      }
    }
  }
#line 212
...
#line 226
  ...
  {
#line 229
  strcpy((char */* __restrict  */)original, (char const   */* __restrict  */)((char const   *)(newname)));
  }
#line 231
  return;
}

...
{ 
  ...
  {
#line 39
  fread((void */* __restrict  */)((void *)(& x)), (size_t )4, (size_t )1, (FILE */* __restrict  */)fp);
  }
#line 40
  return (x);
}
...
{ 
  ...
  {
#line 47
  fread((void */* __restrict  */)((void *)(& x)), (size_t )2, (size_t )1, (FILE */* __restrict  */)fp);
  }
#line 48
  return (x);
}
...
#line 184
  if ((int )fmt == 0) {
    {
#line 185
    memcpy((void */* __restrict  */)((void *)dest), (void const   */* __restrict  */)((void const   *)src_v),
           (size_t )n);
    }
  } else
#line 186
...
#line 521
  ...
  {
#line 524
  tmp___0 = fread((void */* __restrict  */)((void *)buffer), (size_t )wf->block_align,
                  (size_t )num_samples, (FILE */* __restrict  */)wf->fp);
#line 524
  nr = (int )tmp___0;
#line 525
...
#line 130
  memcpy((void */* __restrict  */)((void *)(comment + 4)), (void const   */* __restrict  */)((void const   *)(vlen_le)),
         (size_t )4);
#line 132
  memcpy((void */* __restrict  */)((void *)(comment + 8)), (void const   */* __restrict  */)((void const   *)vendor_string),
         (size_t )vendor_len);
#line 134
...
#line 190
    if (size < free___0) {
      {
#line 191
      memcpy((void */* __restrict  */)((void *)(& ctx->buffer[used])), (void const   */* __restrict  */)data,
             size);
      }
#line 192
      return;
...
#line 203
  ...
  {
#line 206
  memcpy((void */* __restrict  */)((void *)(ctx->buffer)), (void const   */* __restrict  */)data,
         size);
  }
#line 207
  return;
...
{ 
  ...
  {
#line 31
  memcpy((void */* __restrict  */)((void *)res), (void const   */* __restrict  */)((void const   *)smp),
         (size_t )((unsigned long )n * sizeof(int32_t )));
  }
#line 32
  return;
...
#line 69
    airac_observe(table, (int )v2);
#line 69
    crc = (uint16_t )((int )v1 ^ (int )*(table + (int )v2));
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 238
            strncpy((char */* __restrict  */)(opts->filelist + 0)->outfile, (char const   */* __restrict  */)((char const   *)*(argv + i)),
                    (size_t )olen);
#line 239
            opts->found_output = 1;
            }
...
#line 298
      strncpy((char */* __restrict  */)(opts->filelist + i)->outfile, (char const   */* __restrict  */)((char const   *)(opts->filelist + i)->infile),
              (size_t )(ext + 1));
#line 299
...
#line 423
  ...
  {
#line 425
  fwrite((void const   */* __restrict  */)((void const   *)s.header), (size_t )1,
         (size_t )header_size, (FILE */* __restrict  */)files->ofp);
  }
#line 428
  if (first_file) {
#line 428
...
#line 487
    if (fs > 0U) {
      {
#line 488
      fwrite((void const   */* __restrict  */)((void const   *)frame), (size_t )1,
             fs, (FILE */* __restrict  */)files->ofp);
#line 489
...
#line 519
    sc = tmp___6;
#line 520
    fwrite((void const   */* __restrict  */)((void const   *)(& sc)), (size_t )4,
           (size_t )1, (FILE */* __restrict  */)files->ofp);
#line 521
    fwrite((void const   */* __restrict  */)((void const   *)(s.md5digest)), (size_t )1,
           (size_t )16, (FILE */* __restrict  */)files->ofp);
    }
  }
  {
#line 524
...
#line 533
  if (tmp) {
    {
#line 539
    files->ifp = fopen((char const   */* __restrict  */)((char const   *)files->infile),
...
#line 545
  if (tmp___0) {
    {
#line 551
    files->ofp = fopen((char const   */* __restrict  */)((char const   *)files->outfile),

...
{ 
  ...
  {
#line 309
  memcpy((void */* __restrict  */)((void *)(& output)), (void const   */* __restrict  */)((void const   *)buf),
         (size_t )8);
  }
#line 310
  return (output);
...
#line 194
  *t = (char )'\000';
#line 197
  dbffile = fopen((char const   */* __restrict  */)((char const   *)dbffilename),
...
#line 199
  ...
  {
#line 201
  tmp___5 = setvbuf((FILE */* __restrict  */)dbffile, (char */* __restrict  */)((char *)((void *)0)),
                    0, (size_t )131072);
  }
#line 201
  if (tmp___5) {
...
#line 202
  ...
  {
#line 204
  tmp___6 = fread((void */* __restrict  */)((void *)(& dbfheader)), (size_t )sizeof(dbfheader),
...
#line 235
  ...
  {
#line 237
  tmp___9 = fread((void */* __restrict  */)((void *)fields), dbffieldsize, fieldcount,
...
#line 246
  ...
  {
#line 251
  tmp___11 = fread((void */* __restrict  */)((void *)(& terminator)), (size_t )1,
                   (size_t )1, (FILE */* __restrict  */)dbffile);
  }
#line 251
  if (tmp___11 != 1U) {
...
#line 427
    blocksread = fread((void */* __restrict  */)((void *)inputbuffer), (size_t )tmp___26,
                       dbfbatchsize, (FILE */* __restrict  */)dbffile);
    }
#line 428
...
#line 449
        printf((char const   */* __restrict  */)((char const   *)(pgfields + fieldnum)->formatstring),
               tmp___29);
        }
#line 450
        goto switch_break___1;
...
#line 523
        ...
        {
#line 527
        strncpy((char */* __restrict  */)outputbuffer, (char const   */* __restrict  */)((char const   *)bufoffset),
                (size_t )(fields + fieldnum)->length);
#line 528
        *(outputbuffer + (int )(fields + fieldnum)->length) = (char )'\000';
#line 530
        s = outputbuffer;
        }
        {

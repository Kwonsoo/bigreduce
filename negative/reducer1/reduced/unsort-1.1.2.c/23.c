...
#line 88
      if (tlb) {
#line 88
        tmp___2 = (uint32_t )*(tlb + count);
      } else {
#line 88
        tmp___2 = (uint32_t )((uint32_t const   )count);
      }
#line 88
...
#line 130
        *tmp___1 = 0;
#line 131
        tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)optarg),
...
#line 88
      memcpy((void */* __restrict  */)((void *)dst), (void const   */* __restrict  */)((void const   *)src),
             (size_t )((unsigned long )count * sizeof(*src)));
      }
    }
  } else {
    {

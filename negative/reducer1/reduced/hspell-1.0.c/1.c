...
#line 334
    snprintf((char */* __restrict  */)(s), (size_t )sizeof(s), (char const   */* __restrict  */)"%s.sizes",
             dir);
#line 335
    tmp = fopen((char const   */* __restrict  */)((char const   *)(s)), (char const   */* __restrict  */)"r");
#line 335
    fp = (void *)tmp;
    }
#line 335
...
#line 337
    ...
    {
#line 339
    tmp___0 = fscanf((FILE */* __restrict  */)((FILE *)fp), (char const   */* __restrict  */)"%d %d %d",
                     & small, & medium, & full);
    }
#line 339
    if (tmp___0 != 3) {
...
{ 
  ...
  {
#line 634
  current = (struct node_index )dict->head;
  {
#line 635
  while (1) {
    while_continue: /* CIL Label */ ;
...
#line 647
    if (*word) {
#line 648
      n = (struct node_small *)(dict->nodes_small + (current.val_or_index & ~ ((1U << 31) | (1U << 30))));
#line 652
...
#line 668
    if (*word) {
#line 669
      n___0 = (struct node_medium *)(dict->nodes_medium + (current.val_or_index & ~ ((1U << 31) | (1U << 30))));
#line 673
      c = (char )*word;
#line 673
      cs = n___0->chars;
...
#line 164
      s[0] = (char )' ';
#line 166
      strcpy((char */* __restrict  */)(flathints + len), (char const   */* __restrict  */)((char const   *)(s)));
#line 167
      len += l;
      }
    } else

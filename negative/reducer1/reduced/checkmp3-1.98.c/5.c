...
#line 220
  ...
  {
#line 229
  strcpy((char */* __restrict  */)(FI->BIN_STRING), (char const   */* __restrict  */)((char const   *)(bin_string)));
#line 230
...
#line 535
  ...
  {
#line 538
  memcpy((void */* __restrict  */)((void *)byte_list), (void const   */* __restrict  */)((void const   *)(trans_list)),
         (size_t )128);
  }
#line 540
  return (1);
...
#line 581
  strncpy((char */* __restrict  */)(title), (char const   */* __restrict  */)((char const   *)(id3_tag->TITLE)),
          (size_t )tmp);
#line 582
  tmp___0 = get_last_char_offset(id3_tag->ARTIST);
#line 582
  strncpy((char */* __restrict  */)(artist), (char const   */* __restrict  */)((char const   *)(id3_tag->ARTIST)),
          (size_t )tmp___0);
#line 583
  tmp___1 = get_last_char_offset(id3_tag->ALBUM);
#line 583
  strncpy((char */* __restrict  */)(album), (char const   */* __restrict  */)((char const   *)(id3_tag->ALBUM)),
          (size_t )tmp___1);
#line 584
  tmp___2 = get_last_char_offset(id3_tag->YEAR);
#line 584
  strncpy((char */* __restrict  */)(year), (char const   */* __restrict  */)((char const   *)(id3_tag->YEAR)),
          (size_t )tmp___2);
#line 585
  tmp___3 = get_last_char_offset(id3_tag->COMMENT);
#line 585
  strncpy((char */* __restrict  */)(comment), (char const   */* __restrict  */)((char const   *)(id3_tag->COMMENT)),
          (size_t )tmp___3);
#line 596
...
#line 712
        if (mp3_i->PROT_BIT) {
          {
#line 713
          tmp___2 = fread((void */* __restrict  */)((void *)data_frame), (size_t )sizeof(char ),

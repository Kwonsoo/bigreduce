...
#line 158
  ...
  {
#line 161
  tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)long_int), (char const   */* __restrict  */)"%lli",
                   & l);
  }
#line 161
  if (tmp___2 != 1) {
...
#line 237
        num[j] = (char)0;
#line 238
        tmp___11 = sscanf((char const   */* __restrict  */)((char const   *)(num)),
                          (char const   */* __restrict  */)"%i", & k);
        }
#line 238
        if (tmp___11 != 1) {
          {
...
#line 261
    memcpy((void */* __restrict  */)((void *)ret), (void const   */* __restrict  */)((void const   *)(buf)),
           (size_t )i);
    }
  } else {
#line 264
...
#line 414
    i ++;
#line 414
    token[tmp___0] = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" \t\n");
    }
  }
  while_break___9: /* CIL Label */ ;
  }
...
#line 506
  strcpy((char */* __restrict  */)((char *)new->s1), (char const   */* __restrict  */)((char const   *)token[1]));
#line 507
  strcat((char */* __restrict  */)((char *)new->s1), (char const   */* __restrict  */)((char const   *)token[2]));
#line 508
  j = 0;
  }
  {
...
#line 665
  info = (char *)tmp___1;
#line 667
  fp = fopen((char const   */* __restrict  */)((char const   *)file___1), (char const   */* __restrict  */)"r");
  }
#line 668
...
#line 421
    while (1) {
      ...
      {
#line 423
      tmp___6 = fread((void */* __restrict  */)((void *)(ioblock)), (size_t )1, (size_t )8192,
...
#line 461
    if ((int )c->letter == 119) {
      {
#line 463
      tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)buf), (size_t )1,
                       length, (FILE */* __restrict  */)c->fd);
      }
#line 463
      if (tmp___1 != length) {
        {
...
#line 513
    format[0] = (char)0;
#line 514
    strncat((char */* __restrict  */)file___1, (char const   */* __restrict  */)((char const   *)f),
            (size_t )(bstart - f));
#line 515
    strncpy((char */* __restrict  */)(format), (char const   */* __restrict  */)((char const   *)bstart),
            (size_t )(blen - 1));
#line 516
...
#line 518
    sprintf((char */* __restrict  */)(num), (char const   */* __restrict  */)((char const   *)(format)),
            block_number);
#line 519
...
#line 519
    ...
    {
#line 520
    strcat((char */* __restrict  */)file___1, (char const   */* __restrict  */)((char const   *)(num)));
#line 521
    f = bstart + blen;
    }
  }
  ...
  {
#line 523
  strcat((char */* __restrict  */)file___1, (char const   */* __restrict  */)((char const   *)f));
  }
#line 524
  return;
}
...
#line 550
        c->fd = fopen((char const   */* __restrict  */)((char const   *)(file)), (char const   */* __restrict  */)"w");
        }
#line 551
        if ((unsigned long )c->fd == (unsigned long )((void *)0)) {
          {
...
#line 581
      ...
      {
#line 584
      c->fd = fopen((char const   */* __restrict  */)((char const   *)c->s1), (char const   */* __restrict  */)"w");
      }
#line 585
      if ((unsigned long )c->fd == (unsigned long )((void *)0)) {
        {
...
#line 599
    ...
    {
#line 602
    c->fd = fopen((char const   */* __restrict  */)((char const   *)c->s1), (char const   */* __restrict  */)"r");
    }
#line 603
    if ((unsigned long )c->fd == (unsigned long )((void *)0)) {
      {
...
#line 164
    ...
    {
#line 165
    memcpy((void */* __restrict  */)((void *)in_buffer.buffer), (void const   */* __restrict  */)((void const   *)in_buffer.read_pos),
           (size_t )to_be_saved);
#line 166
...
#line 482
  ...
  {
#line 484
  memcpy((void */* __restrict  */)((void *)out_buffer.write_pos), (void const   */* __restrict  */)((void const   *)buf),
         (size_t )length);
#line 485

...
#line 40
  out = fopen((char const   */* __restrict  */)((char const   *)outfile), (char const   */* __restrict  */)"w");
  }
#line 40
...
#line 30
  in = (FILE *)((void *)0);
#line 38
  in = fopen((char const   */* __restrict  */)((char const   *)(net___0->inputfile)),
...
#line 42
  tmp = sscanf((char const   */* __restrict  */)((char const   *)(instring)), (char const   */* __restrict  */)"%ld %ld",
               & t, & h);
  }
#line 42
  if (tmp != 2) {
...
#line 94
    fgets((char */* __restrict  */)(instring), 200, (FILE */* __restrict  */)in);
#line 96
    tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(instring)),
                     (char const   */* __restrict  */)"%ld %ld", & t, & h);
    }
#line 96
    if (tmp___3 != 2) {
#line 97
...
#line 143
    fgets((char */* __restrict  */)(instring), 200, (FILE */* __restrict  */)in);
#line 145
    tmp___8 = sscanf((char const   */* __restrict  */)((char const   *)(instring)),
                     (char const   */* __restrict  */)"%ld %ld %ld", & t, & h, & c);
    }
#line 145
    if (tmp___8 != 3) {
#line 146
...
#line 106
  net.bigM = (long )1.0e7;
#line 108
  strcpy((char */* __restrict  */)(net.inputfile), (char const   */* __restrict  */)((char const   *)*(argv + 1)));
#line 110
  tmp = read_min(& net);
  }
#line 110

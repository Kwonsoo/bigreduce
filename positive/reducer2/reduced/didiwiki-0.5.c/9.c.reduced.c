...
#line 111
    strncpy((char */* __restrict  */)url, (char const   */* __restrict  */)((char const   *)start),
            (size_t )(p - start));
#line 112
    *start = (char )'\000';
    }
...
{ 
  ...
  {
#line 162
  tmp = stat((char const   */* __restrict  */)((char const   *)filename), (struct stat */* __restrict  */)(& st));
  }
#line 162
  if (tmp) {
#line 163
  ...
  {
#line 165
  fp = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rb");
  }
#line 165
  if (! fp) {
#line 166
...
#line 168
  str = (char *)tmp___0;
#line 169
  tmp___1 = fread((void */* __restrict  */)((void *)str), (size_t )1, (size_t )st.st_size,
                  (FILE */* __restrict  */)fp);
#line 169
  len = (int )tmp___1;
  }
...
#line 183
  len = (int )(tmp + 1UL);
#line 185
  fp = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"wb");
  }
#line 185
  if (! fp) {
#line 186
...
#line 188
    ...
    {
#line 190
    tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)data), sizeof(char ),
                     (size_t )len, (FILE */* __restrict  */)fp);
#line 190
...
{ 
  ...
  {
#line 631
  stat((char const   */* __restrict  */)((char const   *)((*d1)->d_name)), (struct stat */* __restrict  */)(& st1));
#line 633
  stat((char const   */* __restrict  */)((char const   *)((*d2)->d_name)), (struct stat */* __restrict  */)(& st2));
  }
#line 635
...
#line 667
    ...
    {
#line 671
    stat((char const   */* __restrict  */)((char const   *)((*(namelist + n))->d_name)),
...
#line 712
    strftime((char */* __restrict  */)(datebuf), sizeof(datebuf), (char const   */* __restrict  */)"%Y-%m-%d %H:%M",
             (struct tm  const  */* __restrict  */)((struct tm  const  *)pTm));
#line 713
...
#line 1090
  ...
  {
#line 1095
  tmp___5 = stat((char const   */* __restrict  */)((char const   *)(datadir)), (struct stat */* __restrict  */)(& st));
  }
#line 1095
  if (tmp___5 != 0) {
    {
...
#line 303
      tmp___39 = fread((void */* __restrict  */)((void *)post_data), (size_t )1, (size_t )len,
                       (FILE */* __restrict  */)stdin);
#line 303
      len = (int )tmp___39;
#line 304
...
#line 344
    strcat((char */* __restrict  */)res->extra_headers, (char const   */* __restrict  */)((char const   *)header));
    }
  } else {
    {
#line 348
...
#line 374
      memcpy((void */* __restrict  */)((void *)((res->data + res->data_len) - 1)),
             (void const   */* __restrict  */)((void const   *)tmp), tmp___0 + 1UL);
      }
    } else {
      {
#line 376
...
#line 376
      memcpy((void */* __restrict  */)((void *)res->data), (void const   */* __restrict  */)((void const   *)tmp),
             tmp___1 + 1UL);
      }
    }
  } else
...
#line 387
    memcpy((void */* __restrict  */)((void *)((res->data + res->data_len) - 1)), (void const   */* __restrict  */)((void const   *)tmp),
           tmp___8 + 1UL);
#line 388
...
#line 440
  if (res->data) {
    {
#line 441
    fwrite((void const   */* __restrict  */)((void const   *)res->data), (size_t )1,
           (size_t )res->data_len, (FILE */* __restrict  */)stdout);
    }
  }
#line 442
  return;
...
#line 526
  inaddr.sin_port = htons((uint16_t )iPort);
#line 528
  tmp___0 = bind(listener, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& inaddr))),
...
#line 559
    tmp___3 = select(listener + 1, (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)0),
                     (fd_set */* __restrict  */)((fd_set *)0), (struct timeval */* __restrict  */)(& delay));
    }
#line 559
    if (tmp___3) {
      {

...
#line 152
    ...
    {
#line 154
    ret = stat((char const   */* __restrict  */)((char const   *)newpath), (struct stat */* __restrict  */)(& s));
    }
#line 155
    if (ret) {
#line 156
...
#line 507
  ...
  {
#line 512
  tmp___4 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)reg),
                    (char const   */* __restrict  */)((char const   *)(match)), (size_t )1,
                    (regmatch_t */* __restrict  */)(m), 0);
  }
#line 512
  if (tmp___4) {
#line 513
...
#line 41
  ...
  {
#line 43
  file = fopen((char const   */* __restrict  */)((char const   *)rpath), (char const   */* __restrict  */)"r");
  }
#line 44
  if (! file) {
#line 45
...
#line 77
  ...
  {
#line 79
  file = fopen((char const   */* __restrict  */)((char const   *)rpath), (char const   */* __restrict  */)"w");
  }
#line 80
  if (! file) {
#line 81
...
#line 127
      ...
      {
#line 129
      strcpy((char */* __restrict  */)((sensor->temperatures + nrtemps)->name), (char const   */* __restrict  */)((char const   *)(direntp->d_name)));
#line 131
...
#line 146
      ...
      {
#line 148
      strcpy((char */* __restrict  */)((sensor->fans + nrfans)->name), (char const   */* __restrict  */)((char const   *)(direntp->d_name)));
#line 150
...
#line 434
      clock_fw = 1;
#line 435
      strcpy((char */* __restrict  */)(clk_dir_path[2]), (char const   */* __restrict  */)((char const   *)(clk_dir_path[1])));
      }
    }
  } else {
    {
#line 430
    clock_fw = 0;
#line 431
    strcpy((char */* __restrict  */)(clk_dir_path[2]), (char const   */* __restrict  */)((char const   *)(clk_dir_path[0])));
    }
  }
  {
#line 440

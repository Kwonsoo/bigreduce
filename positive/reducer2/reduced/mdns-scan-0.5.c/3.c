...
#line 154
    ...
    {
#line 154
    r = select(fd + 1, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)(& fds),
               (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)tmp___4);
    }
#line 154
    if (r < 0) {
      {
...
#line 193
    ...
    {
#line 193
    r = select(fd + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
               (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)tmp___4);
    }
#line 193
    if (r < 0) {
...
#line 72
    *(d + 0) = (uint8_t )n;
#line 73
    memcpy((void */* __restrict  */)((void *)(d + 1)), (void const   */* __restrict  */)((void const   *)name),
           n);
#line 75
    name += n;
    }
...
#line 207
      ...
      {
#line 209
      memcpy((void */* __restrict  */)((void *)ret_name), (void const   */* __restrict  */)((void const   *)(p->data + index___0)),
             (size_t )n);
#line 210
      index___0 += (size_t )n;
#line 211
...
#line 271
  ...
  {
#line 273
  memcpy((void */* __restrict  */)ret_data, (void const   */* __restrict  */)((void const   *)(p->data + p->rindex)),
         l);
#line 274
  p->rindex += l;
  }

...
#line 52
    fwrite((void const   */* __restrict  */)((void const   *)(buf)), (size_t )1, (size_t )1,
           (FILE */* __restrict  */)fp___1);
#line 53
...
#line 67
      fwrite((void const   */* __restrict  */)((void const   *)(buf)), (size_t )1,
             (size_t )8, (FILE */* __restrict  */)fp___1);
      }
#line 69
      if (cnt == 1U) {
        {
...
#line 71
        fwrite((void const   */* __restrict  */)((void const   *)(buf)), (size_t )1,
               (size_t )1, (FILE */* __restrict  */)fp___1);
#line 72
...
#line 78
      fwrite((void const   */* __restrict  */)((void const   *)(buf)), (size_t )1,
             (size_t )2, (FILE */* __restrict  */)fp___1);
#line 80
...
#line 114
    fp___1 = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"wb");
    }
#line 115
...
#line 133
    if (par_dvdsub) {
      {
#line 134
      fwrite((void const   */* __restrict  */)((void const   *)"SPU "), (size_t )1,
             (size_t )4, (FILE */* __restrict  */)fp___1);
      }
    }
  }
#line 137
...
#line 110
  if (buf->cnt > 0U) {
    {
#line 111
    tmp = fwrite((void const   */* __restrict  */)((void const   *)buf->buf), (size_t )1,
                 buf->cnt, (FILE */* __restrict  */)fp___1);
    }
#line 111
    if (tmp != buf->cnt) {
#line 112
...
#line 126
  if (n > 0U) {
    {
#line 127
    r = fread((void */* __restrict  */)((void *)(mpeg->buf + mpeg->buf_n)), (size_t )1,
              n, (FILE */* __restrict  */)mpeg->fp);
    }
#line 128
    if (r < 0U) {
#line 129
...
#line 219
    if (n <= 4096U) {
      {
#line 220
      r = fread((void */* __restrict  */)((void *)(mpeg->buf)), (size_t )1, n, (FILE */* __restrict  */)mpeg->fp);
      }
    } else {
      {
#line 223
      r = fread((void */* __restrict  */)((void *)(mpeg->buf)), (size_t )1, (size_t )4096,
...
#line 248
  if (i > 0U) {
    {
#line 249
    memcpy((void */* __restrict  */)((void *)tmp), (void const   */* __restrict  */)((void const   *)(& mpeg->buf[mpeg->buf_i])),
           i);
#line 251
    tmp += i;
#line 252
...
#line 257
  if (n > 0U) {
    {
#line 258
    tmp___0 = fread((void */* __restrict  */)((void *)tmp), (size_t )1, n, (FILE */* __restrict  */)mpeg->fp);
#line 258
    ret += tmp___0;
    }
  }
...
#line 64
  sequence ++;
#line 66
  fp___1 = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"wb");
#line 68
  free((void *)fname);
  }
#line 70
...
#line 241
    fwrite((void const   */* __restrict  */)((void const   *)(buf)), (size_t )1, (size_t )4,
...
#line 52 "/home/wslee/benchmarks/sound/mpegdemux-0.1.3/src/mpegdemux.h"
int par_scan ;
...
#line 403
              ...
              {
#line 406
              tmp___1 = str_get_streams((char const   *)*(argv + argi), par_stream,
                                        1U);
              }
#line 406
              if (tmp___1) {
...
#line 415
                ...
                {
#line 418
                tmp___2 = str_get_streams((char const   *)*(argv + argi), par_substream,
                                          1U);
                }
#line 418
                if (tmp___2) {
...
#line 431
                    ...
                    {
#line 441
                    tmp___3 = str_get_streams((char const   *)*(argv + argi), par_stream,
                                              2U);
                    }
#line 441
                    if (tmp___3) {
...
#line 464
                      ...
                      {
#line 467
                      tmp___5 = strtoul((char const   */* __restrict  */)((char const   *)*(argv + argi)),
...
#line 474
                        ...
                        {
#line 477
                        tmp___6 = strtoul((char const   */* __restrict  */)((char const   *)*(argv + (argi + 1))),
                                          (char **/* __restrict  */)((char **)((void *)0)),
                                          0);
#line 477
                        id1 = (unsigned int )tmp___6;
#line 478
                        tmp___7 = strtoul((char const   */* __restrict  */)((char const   *)*(argv + (argi + 2))),
                                          (char **/* __restrict  */)((char **)((void *)0)),
                                          0);
#line 478
...
#line 489
                          ...
                          {
#line 492
                          tmp___8 = strtoul((char const   */* __restrict  */)((char const   *)*(argv + (argi + 1))),
                                            (char **/* __restrict  */)((char **)((void *)0)),
                                            0);
#line 492
                          id1___0 = (unsigned int )tmp___8;
#line 493
                          tmp___9 = strtoul((char const   */* __restrict  */)((char const   *)*(argv + (argi + 2))),
                                            (char **/* __restrict  */)((char **)((void *)0)),
                                            0);
#line 493
...
#line 535
                                                    ...
                                                    {
#line 538
                                                    par_inp = fopen((char const   */* __restrict  */)((char const   *)*(argv + argi)),
...
#line 547
                                                    ...
                                                    {
#line 550
                                                    par_out = fopen((char const   */* __restrict  */)((char const   *)*(argv + argi)),

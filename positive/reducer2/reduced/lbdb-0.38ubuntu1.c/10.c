...
#line 507
    *pc = (char)0;
#line 508
    strncpy((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)(tmp)),
            buflen);
#line 508
    *((buf + buflen) - 1) = (char)0;
    }
...
#line 576
      ...
      {
#line 577
      strncpy((char */* __restrict  */)pbuf, (char const   */* __restrict  */)((char const   *)addr->personal),
              buflen);
#line 577
...
#line 600
    ...
    {
#line 601
    strncpy((char */* __restrict  */)pbuf, (char const   */* __restrict  */)((char const   *)addr->mailbox),
            buflen);
#line 601
    *((pbuf + buflen) - 1) = (char)0;
#line 602
...
#line 155
        strncpy((char */* __restrict  */)hdr[i].tag, (char const   */* __restrict  */)((char const   *)fieldname),
...
#line 186
        strcpy((char */* __restrict  */)(cur_hdr->value + cur_hdr->len), (char const   */* __restrict  */)((char const   *)(buff)));
#line 187
        cur_hdr->len = nl;
#line 188
        chop(cur_hdr);
...
#line 118
  p = (char *)tmp___0;
#line 119
  memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)s),
         l);
  }
#line 120
  return (p);

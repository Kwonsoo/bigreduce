...
#line 115
  ...
  {
#line 118
  strncpy((char */* __restrict  */)(searchkey), (char const   */* __restrict  */)((char const   *)*(argv + 1)),
          (size_t )256);
  }
#line 119
  if (matchlimit == -2) {
...
#line 161
  fullpath[i] = (char )'\000';
#line 163
  tmp___0 = stat((char const   */* __restrict  */)((char const   *)(fullpath)), (struct stat */* __restrict  */)(& stbuf___1));
  }
#line 163
  if (tmp___0 != 0) {
#line 163
...
#line 220
  cspath = (char *)tmp___2;
#line 221
  strcpy((char */* __restrict  */)cspath, (char const   */* __restrict  */)((char const   *)spath));
#line 222
  start = cspath;
  }
  {
...
#line 67
  tmp___2 = stat((char const   */* __restrict  */)((char const   *)(fullpath___0)),
...
{ 
  ...
  {
#line 146
  tmp___0 = lstat((char const   */* __restrict  */)((char const   *)fullpath___2),
                  (struct stat */* __restrict  */)(& buffer));
  }
#line 146
  if (tmp___0 < 0) {
#line 147
...
#line 170
    if ((buffer.st_mode & 61440U) == 40960U) {
      {
#line 171
      tmp___3 = stat((char const   */* __restrict  */)((char const   *)fullpath___2),
                     (struct stat */* __restrict  */)(& buffer));
      }
#line 171
      if (tmp___3 < 0) {
...
#line 201
        if (tmp___5) {
          {
#line 205
          strcpy((char */* __restrict  */)ptr, (char const   */* __restrict  */)((char const   *)(dirp->d_name)));
#line 206

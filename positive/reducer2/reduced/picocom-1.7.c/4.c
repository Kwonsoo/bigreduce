...
#line 227
      ...
      {
#line 227
      tmp___0 = strtol((char const   */* __restrict  */)((char const   *)(buf)), (char **/* __restrict  */)((char **)((void *)0)),
                       10);
#line 227
      pid = (int )tmp___0;
      }
...
#line 562
  sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& empty_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 563
  sigaction(15, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& empty_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 564
  return;
...
#line 574
  sigaddset(& sigm, 15);
#line 575
  sigprocmask(0, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& sigm)),
              (sigset_t */* __restrict  */)(& sigm_old));
#line 577
  pid = fork();
  }
#line 578
  if (pid < 0) {
    {
#line 579
    sigprocmask(2, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& sigm_old)),
...
#line 632
    while (1) {
      ...
      {
#line 632
      tmp___5 = __builtin_va_arg(vls, char const   *);
#line 632
      tmp___4 = tmp___5;
#line 632
      s = tmp___4;
...
#line 880
      ...
      {
#line 881
      memcpy((void */* __restrict  */)((void *)(tty_q.buff)), (void const   */* __restrict  */)((void const   *)(tty_q.buff + n)),
             (size_t )(tty_q.len - n));
#line 882
      tty_q.len -= n;
      }
...
#line 915
  sigaction(15, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& exit_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 917
  sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 918
  sigaction(1, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 919
  sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 920
  sigaction(10, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 921
  sigaction(12, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 922
  sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& ign_action)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 923
  return;
...
#line 1116
    ...
    {
#line 1007
    strncpy((char */* __restrict  */)(opts.send_cmd), (char const   */* __restrict  */)((char const   *)optarg),
...
#line 1009
    ...
    {
#line 1011
    strncpy((char */* __restrict  */)(opts.receive_cmd), (char const   */* __restrict  */)((char const   *)optarg),
...
#line 1125
  ...
  {
#line 1127
  strncpy((char */* __restrict  */)(opts.port), (char const   */* __restrict  */)((char const   *)*(argv + optind)),
...
extern  __attribute__((__nothrow__)) int ( __attribute__((__leaf__)) ioctl)(int __fd ,
                                                                            ...
                                                                            , ...) ;
#line 205 "/home/wheatley/newnew/temp/picocom-1.7/term.h"

...
#line 54
  token = (char *)((void *)0);
#line 58
  fd = fopen((char const   */* __restrict  */)((char const   *)*file), (char const   */* __restrict  */)"r");
  }
#line 59
...
#line 90
  fd = fopen((char const   */* __restrict  */)((char const   *)(buff)), (char const   */* __restrict  */)"r");
  }
#line 90
  if ((unsigned long )fd == (unsigned long )((void *)0)) {
    {
...
#line 177
    ...
    {
#line 177
    fd = fopen((char const   */* __restrict  */)((char const   *)*file), (char const   */* __restrict  */)"rt");
    }
#line 177
    if ((unsigned long )fd == (unsigned long )((void *)0)) {
      _L: 
...
#line 177
  if (address.s_addr == 4294967295U) {
    {
#line 180
    tmp___4 = inet_pton(10, (char const   */* __restrict  */)((char const   *)*src_addr),
                        (void */* __restrict  */)((void *)(& address6.__in6_u.__u6_addr8)));
    }
#line 180
    if (tmp___4) {
#line 189
...
#line 284
      ...
      {
#line 287
      tmp___3 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& curr->cpattern)),
                        (char const   */* __restrict  */)((char const   *)url), (size_t )0,
                        (regmatch_t */* __restrict  */)((regmatch_t *)0), 0);
      }
#line 287
      if (tmp___3 == 0) {
        {
#line 288
        strcpy((char */* __restrict  */)newurl, (char const   */* __restrict  */)((char const   *)curr->replacement));
        }
#line 289
        return (pattern_no);
      }
...
{ 
  ...
  {
#line 312
  tmp = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& curr->cpattern)),
                (char const   */* __restrict  */)((char const   *)url), (size_t )10,
                (regmatch_t */* __restrict  */)(& match_data[0]), 0);
  }
#line 312
  if (tmp != 0) {
#line 313
...
{ 
  ...
  {
#line 58
  fd = fopen((char const   */* __restrict  */)((char const   *)file), (char const   */* __restrict  */)"a+");
  }
#line 58
  if ((unsigned long )fd == (unsigned long )((void *)0)) {
    {
...
#line 75
  tmp = vsnprintf((char */* __restrict  */)(msg), (size_t )4096, (char const   */* __restrict  */)((char const   *)format),
                  args);
  }
#line 75
  if (tmp > 4095) {
...
#line 83
  stored = sscanf((char const   */* __restrict  */)((char const   *)pattern), (char const   */* __restrict  */)"%s %s %s %s %s",
...
#line 163
  ...
  {
#line 166
  tmp___7 = regcomp((regex_t */* __restrict  */)(& compiled), (char const   */* __restrict  */)((char const   *)rgxurl),
                    regex_flags);
  }
#line 166
  if (tmp___7) {
...
#line 176
  ...
  {
#line 178
  strcpy((char */* __restrict  */)rpattern.pattern, (char const   */* __restrict  */)((char const   *)rgxurl));
#line 179
...
#line 183
  ...
  {
#line 185
  strcpy((char */* __restrict  */)rpattern.replacement, (char const   */* __restrict  */)((char const   *)repurl));
  }
#line 205
  if (urlgroup) {
    {
...
#line 210
    ...
    {
#line 212
    strcpy((char */* __restrict  */)rpattern.urlgroup, (char const   */* __restrict  */)((char const   *)urlgroup));
    }
  } else {
#line 215

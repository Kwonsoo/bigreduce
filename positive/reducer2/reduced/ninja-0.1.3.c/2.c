...
#line 241
    ...
    {
#line 243
    tmp = strtol((char const   */* __restrict  */)((char const   *)(d->d_name)), (char **/* __restrict  */)((char **)((void *)0)),
                 0);
#line 243
    pidnr = (int )tmp;
    }
...
#line 69
  snprintf((char */* __restrict  */)(mfile), sizeof(mfile), (char const   */* __restrict  */)"/proc/%d/maps",
           pid);
#line 71
  fd = fopen((char const   */* __restrict  */)((char const   *)(mfile)), (char const   */* __restrict  */)"r");
  }
#line 71
...
#line 80
    ...
    {
#line 82
    sscanf((char const   */* __restrict  */)((char const   *)(mbuf)), (char const   */* __restrict  */)"%24s %24s %24s %24s %24s %s",
...
#line 118
  snprintf((char */* __restrict  */)(link_path), sizeof(link_path), (char const   */* __restrict  */)"/proc/%d/exe",
           pid);
#line 119
  tmp = readlink((char const   */* __restrict  */)((char const   *)(link_path)), (char */* __restrict  */)(map_name___0),
...
#line 141
      sscanf((char const   */* __restrict  */)((char const   *)(wlist_entry)), (char const   */* __restrict  */)"%511s %511s %511s",
...
#line 28
    ...
    {
#line 31
    sscanf((char const   */* __restrict  */)((char const   *)(rbuf)), (char const   */* __restrict  */)"%32s %32s %32s %32s %32s",
...
#line 23
    fprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)"%s",
            "log: ");
#line 25
    vfprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)((char const   *)fmt),
             args);
#line 26
    puts("");
#line 27
...
#line 31
      __builtin_va_start(args, fmt);
#line 32
      fd = fopen((char const   */* __restrict  */)((char const   *)(global_opts.logfile)),
...
#line 34
        fprintf((FILE */* __restrict  */)fd, (char const   */* __restrict  */)"[%s ",
                tmp___0);
#line 35
        vfprintf((FILE */* __restrict  */)fd, (char const   */* __restrict  */)((char const   *)fmt),
                 args);
#line 36
...
{ 
  ...
  {
#line 13
  tmp = lstat((char const   */* __restrict  */)((char const   *)fpath), (struct stat */* __restrict  */)(& st));
  }
#line 13
  if (tmp == 0) {
#line 15
...
{ 
  ...
  {
#line 33
  fp = fopen((char const   */* __restrict  */)((char const   *)fpath), (char const   */* __restrict  */)"r");
  }
#line 33
  if ((unsigned long )fp == (unsigned long )((void *)0)) {
#line 34
...
#line 48
    cf_value[0] = (char)0;
#line 50
    sscanf((char const   */* __restrict  */)((char const   *)(buf___0)), (char const   */* __restrict  */)"%64s %c %160s\n",

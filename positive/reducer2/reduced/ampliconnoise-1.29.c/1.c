...
#line 73
  ofp = fopen((char const   */* __restrict  */)((char const   *)szTreeFile), (char const   */* __restrict  */)"w");
  }
#line 75
  if (ofp) {
    {
...
#line 110
    line = usage[i];
#line 111
    fputs((char const   */* __restrict  */)((char const   *)line), (FILE */* __restrict  */)ofp);
#line 109
    i ++;
    }
  }
...
#line 182
  if ((unsigned long )szTemp != (unsigned long )((void *)0)) {
    {
#line 183
    ptParams->dRes = strtod((char const   */* __restrict  */)((char const   *)szTemp),
                            (char **/* __restrict  */)(& pcError));
    }
#line 184
    if ((int )*pcError != 0) {
#line 185
...
#line 329
  if ((unsigned long )szBreak != (unsigned long )((void *)0)) {
    {
#line 330
    dWeight = strtod((char const   */* __restrict  */)((char const   *)(szBreak + 1)),
                     (char **/* __restrict  */)(& pcError));
    }
#line 331
    if ((int )*pcError != 0) {
...
#line 351
  afW = (float *)((void *)0);
#line 353
  ifp = fopen((char const   */* __restrict  */)((char const   *)szDistFile), (char const   */* __restrict  */)"r");
  }
#line 355
  if (ifp) {
    {
...
#line 360
    *szBrk = (char )'\000';
#line 362
    tmp = strtol((char const   */* __restrict  */)((char const   *)(szLine)), (char **/* __restrict  */)(& pcError),
                 10);
#line 362
    nN = (int )tmp;
    }
...
#line 392
        *szBrk = (char )'\000';
#line 394
        strcpy((char */* __restrict  */)*(aszID + i), (char const   */* __restrict  */)((char const   *)(szLine)));
#line 389
        i ++;
        }
      }
...
#line 423
        *szBrk = (char )'\000';
#line 425
        tmp___6 = strtod((char const   */* __restrict  */)((char const   *)(szLine)),
                         (char **/* __restrict  */)(& pcError));
#line 425
...
#line 772
  ...
  {
#line 782
  ofp = fopen((char const   */* __restrict  */)((char const   *)szOtuFile), (char const   */* __restrict  */)"w");
#line 783
  lfp = fopen((char const   */* __restrict  */)((char const   *)szListFile), (char const   */* __restrict  */)"w");
#line 785
...
#line 27
  ptData->nMaxLen = 0;
#line 29
  ifp = fopen((char const   */* __restrict  */)((char const   *)ptParams->szInputFile),

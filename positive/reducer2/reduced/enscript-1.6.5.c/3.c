...
#line 134
  tmp = (char *)tmp___1;
#line 135
  strcpy((char */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)str));
  }
#line 137
  return (tmp);
}
...
#line 3082
    if (translate) {
#line 3082
      tmp___1 = (unsigned int )*(translate + (int )((unsigned char )this_char));
    } else {
#line 3082
      tmp___1 = this_char;
    }
...
#line 3326
          memcpy((void */* __restrict  */)((void *)destination), (void const   */* __restrict  */)((void const   *)fail_stack.stack),
...
#line 4528
      if ((unsigned long )d == (unsigned long )end1) {
#line 4528
        tmp___58 = (int )((int const   )*string2);
      } else {
#line 4528
        tmp___58 = (int )((int const   )*d);
      }
#line 4528
      if (tmp___58 == 10) {
#line 4528
...
#line 4578
          memcpy((void */* __restrict  */)((void *)destination___0), (void const   */* __restrict  */)((void const   *)fail_stack.stack),
                 (size_t )((unsigned long )fail_stack.size * sizeof(fail_stack_elt_t )));
#line 4578
...
#line 4635
          memcpy((void */* __restrict  */)((void *)destination___1), (void const   */* __restrict  */)((void const   *)fail_stack.stack),
                 (size_t )((unsigned long )fail_stack.size * sizeof(fail_stack_elt_t )));
#line 4635
...
#line 4855
          memcpy((void */* __restrict  */)((void *)destination___2), (void const   */* __restrict  */)((void const   *)fail_stack.stack),
                 (size_t )((unsigned long )fail_stack.size * sizeof(fail_stack_elt_t )));
#line 4855
...
#line 4868
          memcpy((void */* __restrict  */)((void *)destination___3), (void const   */* __restrict  */)((void const   *)fail_stack.stack),
                 (size_t )((unsigned long )fail_stack.size * sizeof(fail_stack_elt_t )));
#line 4868
...
#line 4966
      tmp___103 = (int )((int const   )*string2);
    } else {
#line 4966
      if ((unsigned long )(d - 1) == (unsigned long )(string2 - 1)) {
#line 4966
        tmp___102 = (int )((int const   )*(end1 - 1));
      } else {
#line 4966
        tmp___102 = (int )((int const   )*(d - 1));
      }
#line 4966
      tmp___103 = tmp___102;
    }
...
#line 4967
    if ((unsigned long )d == (unsigned long )end1) {
#line 4967
      tmp___105 = (int )((int const   )*string2);
    } else {
#line 4967
      if ((unsigned long )d == (unsigned long )(string2 - 1)) {
#line 4967
        tmp___104 = (int )((int const   )*(end1 - 1));
      } else {
#line 4967
        tmp___104 = (int )((int const   )*d);
      }
#line 4967
      tmp___105 = tmp___104;
    }
...
#line 4991
    if ((unsigned long )d == (unsigned long )end1) {
#line 4991
      tmp___112 = (int )((int const   )*string2);
    } else {
#line 4991
      if ((unsigned long )d == (unsigned long )(string2 - 1)) {
#line 4991
        tmp___111 = (int )((int const   )*(end1 - 1));
      } else {
#line 4991
        tmp___111 = (int )((int const   )*d);
      }
#line 4991
      tmp___112 = tmp___111;
    }
...
#line 4997
        if ((unsigned long )(d - 1) == (unsigned long )end1) {
#line 4997
          tmp___118 = (int )((int const   )*string2);
        } else {
#line 4997
          if ((unsigned long )(d - 1) == (unsigned long )(string2 - 1)) {
#line 4997
            tmp___117 = (int )((int const   )*(end1 - 1));
          } else {
#line 4997
            tmp___117 = (int )((int const   )*(d - 1));
          }
#line 4997
          tmp___118 = tmp___117;
        }
...
#line 5059
    if ((unsigned long )d == (unsigned long )end1) {
#line 5059
      tmp___122 = (int )((int const   )*string2);
    } else {
#line 5059
      if ((unsigned long )d == (unsigned long )(string2 - 1)) {
#line 5059
        tmp___121 = (int )((int const   )*(end1 - 1));
      } else {
#line 5059
        tmp___121 = (int )((int const   )*d);
      }
#line 5059
      tmp___122 = tmp___121;
    }
...
#line 358
    ...
    {
#line 359
    strcpy((char */* __restrict  */)cm->name, (char const   */* __restrict  */)((char const   *)builtin_courier[i].character));
#line 361
...
#line 662
  ...
  {
#line 664
  memcpy((void */* __restrict  */)((void *)type_return->u.string), (void const   */* __restrict  */)((void const   *)(ctx->token)),
         ctx->tokenlen);
  }
#line 665
  goto switch_break;
...
#line 673
  ...
  {
#line 675
  memcpy((void */* __restrict  */)((void *)type_return->u.name), (void const   */* __restrict  */)((void const   *)(ctx->token)),
         ctx->tokenlen);
  }
#line 676
  goto switch_break;
...
#line 680
  ...
  {
#line 682
  memcpy((void */* __restrict  */)((void *)(buf)), (void const   */* __restrict  */)((void const   *)(ctx->token)),
         ctx->tokenlen);
#line 683
...
#line 164
  ...
  {
#line 167
  memcpy((void */* __restrict  */)((void *)list->key), (void const   */* __restrict  */)((void const   *)key),
         (size_t )keylen);
#line 168
  list->keylen = keylen;
#line 169
...
#line 145
    tmp___3 = stat((char const   */* __restrict  */)((char const   *)(buf)), (struct stat */* __restrict  */)(& stat_st));
    }
#line 145
    if (tmp___3 == 0) {
      {
...
#line 738
    memcpy((void */* __restrict  */)((void *)(fullname)), (void const   */* __restrict  */)((void const   *)name),
           dirlen);
    }
  } else {
    {
#line 742
    dirlen = 2U;
#line 743
    memcpy((void */* __restrict  */)((void *)(fullname)), (void const   */* __restrict  */)((void const   *)"./"),
           dirlen);
    }
  }
  {
...
#line 746
    ...
    {
#line 751
    tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%s %s",
                     font, file);
    }
#line 751
    if (tmp___1 != 2) {
...
#line 761
    ...
    {
#line 764
    strcpy((char */* __restrict  */)(fullname + dirlen), (char const   */* __restrict  */)((char const   *)(file)));
#line 765
...
#line 769
    ...
    {
#line 771
    strcpy((char */* __restrict  */)cp, (char const   */* __restrict  */)((char const   *)(fullname)));
#line 773

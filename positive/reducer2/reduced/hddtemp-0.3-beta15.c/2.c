...
#line 103
        printf((char const   */* __restrict  */)((char const   *)tmp), (int const   )*(smart_data + n),
...
#line 124
  ...
  {
#line 127
  tmp___8 = ata_get_powermode(dsk->fd);
#line 127
  tmp = (int )tmp___8;
  }
#line 129
...
#line 142
      snprintf((char */* __restrict  */)(dsk->errormsg), (size_t )128, (char const   */* __restrict  */)((char const   *)tmp___0));
#line 143
...
#line 156
      tmp = gettext("\n================= hddtemp %s ==================\nModel: %s\n\n");
#line 156
      printf((char const   */* __restrict  */)((char const   *)tmp), "0.3-beta15",
             dsk->model);
      }
    }
  }
...
#line 331
    portnum = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end),
                     10);
#line 333
    tmp___1 = __errno_location();
    }
...
#line 356
    printf((char const   */* __restrict  */)((char const   *)tmp___2), 7634);
    }
    case_118: 
    {
#line 387
...
#line 387
    printf((char const   */* __restrict  */)((char const   *)tmp___3), "0.3-beta15");
#line 388
    exit(0);
    }
#line 389
...
#line 398
    end___0 = (char *)((void *)0);
#line 400
    syslog_interval = strtol((char const   */* __restrict  */)((char const   *)optarg),
                             (char **/* __restrict  */)(& end___0), 10);
#line 402
    tmp___5 = __errno_location();
    }
#line 402
...
#line 511
      if (dbe) {
        {
#line 512
        memcpy((void */* __restrict  */)((void *)dsk->db_entry), (void const   */* __restrict  */)((void const   *)dbe),
...
#line 85
    snprintf((char */* __restrict  */)(dsk->errormsg), (size_t )128, (char const   */* __restrict  */)((char const   *)tmp));
    }
#line 86
...
#line 104
      snprintf((char */* __restrict  */)(dsk->errormsg), (size_t )128, (char const   */* __restrict  */)((char const   *)tmp___2));
#line 105
      ret = (enum e_gettemp )1;
      }
    } else {
...
#line 55
    ...
    {
#line 59
    tmp = regcomp((regex_t */* __restrict  */)(& preg), (char const   */* __restrict  */)((char const   *)p->regexp),
                  1);
    }
#line 59
    if (tmp) {
...
#line 60
    ...
    {
#line 62
    tmp___0 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& preg)),
                      (char const   */* __restrict  */)model, (size_t )1, (regmatch_t */* __restrict  */)(& pmatch),
                      0);
    }
#line 62
    if (tmp___0 == 0) {
...
#line 115
  printf((char const   */* __restrict  */)((char const   *)tmp___2), tabs, line);
#line 119
  p = supported_drives;
  }
  {
...
#line 121
    printf((char const   */* __restrict  */)((char const   *)tmp___4), p->regexp,
           tabs + len / 8, (int )p->attribute_id, p->description);
#line 119
    p = p->next;
    }
  }
...
#line 56
  ...
  {
#line 57
  memcpy((void */* __restrict  */)((void *)buff), (void const   */* __restrict  */)((void const   *)(cmd + 4)),
         (size_t )512);
  }
#line 58
  return (0);
...
#line 68
        printf((char const   */* __restrict  */)((char const   *)tmp), (int )*(smart_data + n),
               (int )*((smart_data + n) + 3), (int const   )*((smart_data + n) + 3));
        }
      }
    }
#line 73
...
#line 102
  ...
  {
#line 104
  memcpy((void */* __restrict  */)((void *)(buf)), (void const   */* __restrict  */)((void const   *)(& inbufsize)),
         sizeof(inbufsize));
#line 105
  memcpy((void */* __restrict  */)((void *)(buf + sizeof(inbufsize))), (void const   */* __restrict  */)((void const   *)(& outbufsize)),
         sizeof(outbufsize));
#line 106
  memcpy((void */* __restrict  */)((void *)((buf + sizeof(inbufsize)) + sizeof(outbufsize))),
         (void const   */* __restrict  */)((void const   *)cdb), (size_t )cdb_len);
#line 107
  memcpy((void */* __restrict  */)((void *)(((buf + sizeof(inbufsize)) + sizeof(outbufsize)) + cdb_len)),
         (void const   */* __restrict  */)((void const   *)buffer), (size_t )buffer_len);
#line 109
  tmp = ioctl(device, 1UL, buf);
#line 109
  ret = (unsigned int )tmp;
#line 111
  memcpy((void */* __restrict  */)((void *)buffer), (void const   */* __restrict  */)((void const   *)((buf + sizeof(inbufsize)) + sizeof(outbufsize))),
         (size_t )buffer_len);
  }
#line 113
  return ((int )ret);
...
#line 143
  tmp = sigaction(11, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sigst)),
...
#line 154
  sigst.sa_flags = -2147483644;
#line 156
  tmp = sigaction(7, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sigst)),
                  (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 156
  if (tmp == -1) {
...
#line 167
  sigst.sa_flags = -2147483644;
#line 169
  tmp = sigaction(4, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sigst)),
                  (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 169
  if (tmp == -1) {
...
#line 72
  snprintf((char */* __restrict  */)(portbuf), sizeof(portbuf), (char const   */* __restrict  */)"%ld",
           portnum);
#line 73
  ret = getaddrinfo((char const   */* __restrict  */)((char const   *)listen_addr),
                    (char const   */* __restrict  */)((char const   *)(portbuf)),
                    (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
                    (struct addrinfo **/* __restrict  */)(& all_ai));
  }
#line 74
  if (ret != 0) {
    {
...
#line 355
      ret = select(maxfd + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 111
    snprintf((char */* __restrict  */)(dsk->errormsg), (size_t )128, (char const   */* __restrict  */)((char const   *)tmp___7),
             tmp___6);
#line 112
    close(dsk->fd);
#line 113
...
#line 129
      snprintf((char */* __restrict  */)(dsk->errormsg), (size_t )128, (char const   */* __restrict  */)((char const   *)tmp___11),
               tmp___10);
#line 130
      close(dsk->fd);
#line 131

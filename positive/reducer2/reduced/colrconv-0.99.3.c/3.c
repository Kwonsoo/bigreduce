...
#line 189
    ...
    {
#line 191
    memcpy((void */* __restrict  */)((void *)(& serv_addr.sin_addr.s_addr)), (void const   */* __restrict  */)((void const   *)*(hp->h_addr_list + 0)),
           (size_t )4);
    }
  }
#line 194
...
#line 255
  if (! tmp___16) {
    {
#line 256
    f = fopen((char const   */* __restrict  */)((char const   *)txbuff), (char const   */* __restrict  */)"r");
    }
#line 256
    if (f) {
      {
...
#line 293
    tmp___19 = select(sockfd + 1, (fd_set */* __restrict  */)(& read_fdset), (fd_set */* __restrict  */)((fd_set *)0),
...
#line 484
      ...
      {
#line 486
      strcpy((char */* __restrict  */)killbuff, (char const   */* __restrict  */)((char const   *)txptr));
      }
      {
#line 487
      while (1) {
...
#line 599
    if (nextcall < 99) {
      {
#line 600
      strcpy((char */* __restrict  */)(callsign[nextcall]), (char const   */* __restrict  */)((char const   *)rxptr));
#line 601
      nextcall ++;
      }
    }

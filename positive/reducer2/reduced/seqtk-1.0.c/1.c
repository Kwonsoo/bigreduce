...
#line 37
    ...
    {
#line 37
    memcpy((void */* __restrict  */)((void *)(str->s + str->l)), (void const   */* __restrict  */)((void const   *)(ks->buf + ks->begin)),
           (size_t )(i - ks->begin));
#line 37
...
#line 45
      tmp___0 = (khint_t )((khint_t const   )i);
    }
#line 45
    return (tmp___0);
  } else {
...
#line 153
      if ((unsigned int )rest > line_len) {
        {
#line 153
        fwrite((void const   */* __restrict  */)((void const   *)(s->s + i)), (size_t )1,
               (size_t )line_len, (FILE */* __restrict  */)stdout);
        }
      } else {
        {
#line 154
        fwrite((void const   */* __restrict  */)((void const   *)(s->s + i)), (size_t )1,
               (size_t )rest, (FILE */* __restrict  */)stdout);
        }
      }
#line 151
...
#line 165
  putchar(tmp);
#line 166
  fputs((char const   */* __restrict  */)((char const   *)s->name.s), (FILE */* __restrict  */)stdout);
  }
#line 167
  if (s->comment.l) {
    {
#line 168
    putchar(' ');
#line 168
    fputs((char const   */* __restrict  */)((char const   *)s->comment.s), (FILE */* __restrict  */)stdout);
    }
  }
  {
#line 170
...
#line 232
    putchar(tmp___5);
#line 232
    fputs((char const   */* __restrict  */)((char const   *)seq->name.s), (FILE */* __restrict  */)stdout);
    }
#line 233
    if (seq->comment.l) {
      {
...
#line 235
    ...
    {
#line 236
    fwrite((void const   */* __restrict  */)((void const   *)(seq->seq.s + beg)),
           (size_t )1, (size_t )(end - beg), (FILE */* __restrict  */)stdout);
#line 236
    putchar('\n');
    }
#line 237
...
#line 238
      puts("+");
#line 239
      fwrite((void const   */* __restrict  */)((void const   *)(seq->qual.s + beg)),
             (size_t )1, (size_t )(end - beg), (FILE */* __restrict  */)stdout);
#line 239
      putchar('\n');
      }
...
#line 842
  dst->l = (size_t )src->l;
#line 843
  memcpy((void */* __restrict  */)((void *)dst->s), (void const   */* __restrict  */)((void const   *)src->s),
         (size_t )(src->l + 1UL));
  }
#line 844
  return;

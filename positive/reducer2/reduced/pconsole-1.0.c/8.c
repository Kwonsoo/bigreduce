...
{ 
  ...
  {
#line 63
  strcpy((char */* __restrict  */)(cmd), (char const   */* __restrict  */)((char const   *)buf));
#line 65
  cstrip_line(cmd);
  }
#line 66
...
#line 233
  ...
  {
#line 235
  tmp___2 = stat((char const   */* __restrict  */)((char const   *)tty), (struct stat */* __restrict  */)(& ttystat));
  }
#line 235
  if (tmp___2) {
    {
...
#line 254
    ...
    {
#line 260
    tmp___6 = stat((char const   */* __restrict  */)((char const   *)devname), (struct stat */* __restrict  */)(& ttystat2));
    }
#line 260
    if (tmp___6) {
      {
...
#line 44
    if (! saved) {
      {
#line 45
      memcpy((void */* __restrict  */)((void *)(& ori_term)), (void const   */* __restrict  */)((void const   *)(& term)),
...
#line 55
  if (saved) {
    {
#line 56
    memcpy((void */* __restrict  */)((void *)(& term)), (void const   */* __restrict  */)((void const   *)(& ori_term)),
           sizeof(struct termios ));
#line 57

...
#line 42
  tmp___2 = getsockname(0, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& sin)),
                        (socklen_t */* __restrict  */)((socklen_t *)(& sinsize)));
  }
#line 42
  if (tmp___2 == -1) {
    {
...
#line 86
  ss = (int )sizeof(sin);
#line 87
  tmp = accept(s, (struct sockaddr */* __restrict  */)(& sin), (socklen_t */* __restrict  */)((socklen_t *)(& ss)));
#line 87
  close(tmp);
  }
#line 88
...
#line 100
    cl = accept(sv, (struct sockaddr */* __restrict  */)((struct sockaddr *)sin),
                (socklen_t */* __restrict  */)((socklen_t *)(& sl)));
    }
#line 100
    if (! (cl == -1)) {
#line 100
...
#line 134
  sa.sa_flags = 0;
#line 136
  tmp___5 = sigaction(17, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
...
#line 150
    tmp___7 = select(sv + 1, (fd_set */* __restrict  */)(& rfd), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 78
    ...
    {
#line 83
    tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%d: %lX:%x %lX:%x %x %lX:%lX %x:%lX %x %d",
...
#line 145
  if (tmp___0 == 0) {
    {
#line 146
    fp = fopen((char const   */* __restrict  */)((char const   *)(idfile)), (char const   */* __restrict  */)"r");
    }
#line 146
    if ((unsigned long )fp != (unsigned long )((void *)0)) {
      {
...
#line 227
  tmp___3 = getsockname(sd, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& cl.laddr)),
                        (socklen_t */* __restrict  */)((socklen_t *)(& ssiz)));
  }
#line 227
  if (tmp___3 == -1) {
    {

...
#line 163
  ...
  {
#line 164
  tmp___1 = ap_error((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
  }
#line 164
  if (tmp___1) {
    {
#line 165
    tmp___0 = ap_error((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
#line 165
...
#line 167
  while (1) {
    ...
    {
#line 167
    tmp___4 = ap_arguments((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
    }
#line 167
    if (! (argind < tmp___4)) {
#line 167
    ...
    {
#line 169
    tmp___2 = ap_code((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)),
                      (int const   )argind);
#line 169
    code = tmp___2;
#line 170
    tmp___3 = ap_argument((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)),
                          (int const   )argind);
#line 170
    arg = tmp___3;
    }
...
#line 189
  while (1) {
    ...
    {
#line 189
    tmp___12 = ap_arguments((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
    }
#line 189
    if (! (argind < tmp___12)) {
#line 189
    ...
    {
#line 191
    tmp___6 = ap_argument((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)),
                          (int const   )argind);
#line 191
    arg___0 = tmp___6;
#line 192
...
#line 99
    show_strerror((char const   */* const  */)((char const   *)0), (int const   )*tmp___0);
#line 100
...
#line 174
      show_strerror((char const   */* const  */)((char const   *)0), (int const   )*tmp);
#line 175
...
#line 231
  if (isglobal) {
    {
#line 231
    unset_active_nodes((line_t const   *)p->q_forw, (line_t const   */* const  */)((line_t const   *)n));
    }
  }
  {
#line 232
...
#line 275
  ...
  {
#line 276
  tmp___3 = fread((void */* __restrict  */)((void *)buf), (size_t )1, (size_t )len,
                  (FILE */* __restrict  */)sfp);
  }
#line 276
  if ((int )tmp___3 != len) {
...
#line 278
    show_strerror((char const   */* const  */)((char const   *)0), (int const   )*tmp___2);
#line 279
...
{ 
  ...
  {
#line 297
  setvbuf((FILE */* __restrict  */)stdin, (char */* __restrict  */)((char *)0), 2,
          (size_t )0);
#line 298
  tmp = open_sbuf();
  }
...
#line 314
    ...
    {
#line 316
    tmp___2 = get_sbuf_line((line_t const   */* const  */)((line_t const   *)bp));
#line 316
...
#line 317
    ...
    {
#line 318
    memcpy((void */* __restrict  */)((void *)(buf___0 + size)), (void const   */* __restrict  */)((void const   *)s),
           (size_t )bp->len);
#line 319
    size += bp->len;
#line 320
...
#line 322
  ...
  {
#line 323
  memcpy((void */* __restrict  */)((void *)(buf___0 + size)), (void const   */* __restrict  */)((void const   *)"\n"),
         (size_t )2);
#line 324
  size += 2;
#line 325
...
#line 327
  disable_interrupts();
#line 328
  tmp___6 = put_sbuf_line((char const   */* const  */)((char const   *)buf___0), (int const   )size,
                          (int const   )current_addr_);
  }
#line 328
  if (tmp___6) {
...
#line 372
        if (addr < first_addr___0) {
#line 372
          tmp___0 = (int )((second_addr___0 - first_addr___0) + 1);
        } else {
#line 372
          tmp___0 = (int )((int const   )0);
        }
#line 372
        current_addr_ = (int )(addr + (int const   )tmp___0);
      } else {
        {
#line 354
        enable_interrupts();
...
#line 375
  if (isglobal) {
    {
#line 375
    unset_active_nodes((line_t const   *)b2->q_forw, (line_t const   */* const  */)((line_t const   *)a2));
    }
  }
  {
#line 376
...
{ 
  ...
  {
#line 443
  tmp = dup_line_node((line_t */* const  */)((line_t *)0));
#line 443
  lp___0 = tmp;
#line 444
...
#line 455
      show_strerror((char const   */* const  */)((char const   *)0), (int const   )*tmp___1);
#line 456
      set_error_msg("Cannot seek temp file");
      }
#line 457
...
#line 460
  ...
  {
#line 462
  tmp___4 = fwrite((void const   */* __restrict  */)((void const   *)buf___9), (size_t )1,
                   (size_t )len, (FILE */* __restrict  */)sfp);
  }
#line 462
  if ((int )tmp___4 != len) {
    {
...
#line 465
    show_strerror((char const   */* const  */)((char const   *)0), (int const   )*tmp___3);
#line 466
...
#line 543
        lp___0 = bp->q_forw;
#line 544
        unmark_line_node((line_t const   */* const  */)((line_t const   *)bp));
#line 545
        free((void *)bp);
#line 546
        bp = lp___0;
...
#line 59
  strncpy((char */* __restrict  */)p->argument, (char const   */* __restrict  */)((char const   *)argument),
          (size_t )(len + 1));
#line 60
  (ap->data_size) ++;
  }
...
#line 71
  strncpy((char */* __restrict  */)(ap->error + ap->error_size), (char const   */* __restrict  */)((char const   *)msg),
          (size_t )(len + 1));
#line 72
  ap->error_size += len;
  }
...
#line 99
    if ((options + i)->name) {
      {
#line 99
      tmp___0 = strncmp((char const   *)(options + i)->name, (char const   *)(opt + 2),
                        (size_t )len);
      }
#line 99
      if (tmp___0 == 0) {
...
#line 137
    ...
    {
#line 139
    tmp___1 = push_back_record(ap, (options + index___0)->code, (char const   */* const  */)((char const   *)(opt + (len + 3U))));
    }
#line 139
    return (tmp___1);
  }
...
#line 179
      add_error(ap, (char const   */* const  */)((char const   *)(code_str)));
      }
#line 180
      return ((char)1);
    }
...
#line 185
        if (*(opt + cind)) {
          {
#line 187
          tmp = push_back_record(ap, (int const   )code, (char const   */* const  */)((char const   *)(opt + cind)));
          }
#line 187
          if (! tmp) {
#line 187
...
#line 225
    if (ch1) {
#line 225
      tmp = (int )((int const   )*(*(argv + argind) + 1));
    } else {
#line 225
      tmp = (int )((int const   )0);
    }
...
#line 230
          tmp___0 = (char const   *)*(argv + (argind + 1));
        } else {
#line 230
...
{ 
  ...
  {
#line 41
  strncpy((char */* __restrict  */)(def_filename), (char const   */* __restrict  */)((char const   *)s),
          sizeof(def_filename));
#line 42
...
#line 54
  prompt_on = (bool )1;
#line 55
  strncpy((char */* __restrict  */)(prompt_str), (char const   */* __restrict  */)((char const   *)s),
          sizeof(prompt_str));
#line 56
...
#line 147
  ...
  {
#line 148
  memcpy((void */* __restrict  */)((void *)shcmd), (void const   */* __restrict  */)((void const   *)buf___1),
         (size_t )i);
#line 149
  shcmdlen = i;
#line 149
...
#line 188
  ...
  {
#line 189
  tmp___6 = may_access_filename((char const   */* const  */)((char const   *)buf___2));
  }
#line 189
  if (tmp___6) {
#line 189
...
#line 509
    tmp___44 = mark_line_node((line_t const   */* const  */)((line_t const   *)tmp___43),
                              n);
    }
#line 509
    if (! tmp___44) {
...
#line 647
      ...
      {
#line 650
      tmp = get_extended_line(ibufpp, (int */* const  */)((int *)0), (bool const   )0);
      }
#line 650
      if (! tmp) {
#line 650
...
#line 678
        ...
        {
#line 679
        memcpy((void */* __restrict  */)((void *)buf___3), (void const   */* __restrict  */)((void const   *)*ibufpp),
               (size_t )(len + 1));
#line 680
...
#line 692 "/home/june/repo/benchmarks/collector/temp/ed-1.9/main_loop.c"
jmp_buf jmp_state  ;
...
#line 102
  ...
  {
#line 103
  memcpy((void */* __restrict  */)((void *)buf___4), (void const   */* __restrict  */)((void const   *)*ibufpp),
         (size_t )len);
#line 104
  *(buf___4 + len) = (char)0;
#line 105
...
#line 142
  if (n) {
    {
#line 145
    regerror(n, (regex_t const   */* __restrict  */)((regex_t const   *)exp), (char */* __restrict  */)(buf___9),
             sizeof(buf___9));
#line 146
...
#line 174
    ...
    {
#line 175
    tmp___3 = regexec((regex_t const   */* __restrict  */)pat, (char const   */* __restrict  */)((char const   *)s),
                      (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)0),
                      0);
    }
#line 175
    if (tmp___3) {
...
#line 249
      ...
      {
#line 250
      tmp___6 = regexec((regex_t const   */* __restrict  */)pat, (char const   */* __restrict  */)((char const   *)s),
                        (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)0),
                        0);
      }
#line 250
...
#line 327
  tmp___8 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)global_pat),
                    (char const   */* __restrict  */)((char const   *)txt), (size_t )30,
                    (regmatch_t */* __restrict  */)(rm), 0);
  }
#line 327
  if (! tmp___8) {
#line 329
...
#line 335
          ...
          {
#line 336
          memcpy((void */* __restrict  */)((void *)(rbuf + offset)), (void const   */* __restrict  */)((void const   *)txt),
                 (size_t )i);
#line 336
          offset += i;
#line 337
          offset = apply_subst_template((char const   */* const  */)((char const   *)txt),
                                        (regmatch_t const   */* const  */)((regmatch_t const   *)(rm)),
...
#line 330
          if (rm[0].rm_eo) {
            ...
            {
#line 330
            tmp___5 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)global_pat),
                              (char const   */* __restrict  */)((char const   *)txt),
...
#line 356
    memcpy((void */* __restrict  */)((void *)(rbuf + offset)), (void const   */* __restrict  */)((void const   *)txt),
           (size_t )i);
#line 357
    memcpy((void */* __restrict  */)((void *)((rbuf + offset) + i)), (void const   */* __restrict  */)((void const   *)"\n"),
           (size_t )2);
    }
  }
#line 359
...
#line 51
        tmp___11 = last_addr();
#line 51
        tmp___12 = write_file((char const   */* const  */)((char const   *)(hb)),
                              (char const   */* const  */)"w", (int const   )1, (int const   )tmp___11);
        }
#line 51
        if (tmp___12 < 0) {
          {
...
#line 59
            if (hup) {
              {
#line 61
              memcpy((void */* __restrict  */)((void *)hup), (void const   */* __restrict  */)((void const   *)s),
                     (size_t )len);
              }
#line 62
              if (need_slash) {
...
#line 62
              ...
              {
#line 63
              memcpy((void */* __restrict  */)((void *)((hup + len) + need_slash)),
                     (void const   */* __restrict  */)((void const   *)(hb)), sizeof(hb));
#line 64
              tmp___7 = last_addr();
#line 64
              tmp___8 = write_file((char const   */* const  */)((char const   *)hup),
                                   (char const   */* const  */)"w", (int const   )1,
                                   (int const   )tmp___7);
              }
#line 64
              if (tmp___8 >= 0) {
...
#line 82
    sigprocmask(1, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& set)),
...
#line 115
  tmp = sigaction(signum, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& new_action)),
...
#line 156
  *tmp___0 = 0;
#line 157
  li = strtol((char const   */* __restrict  */)((char const   *)str), (char **/* __restrict  */)(& tmp),
              10);
#line 157
  *i = (int )li;
  }
...
#line 104
  ...
  {
#line 105
  memcpy((void */* __restrict  */)((void *)buf___6), (void const   */* __restrict  */)((void const   *)*ibufpp),
         (size_t )len);
#line 106
  len --;
#line 106
...
#line 115
    ...
    {
#line 116
    memcpy((void */* __restrict  */)((void *)(buf___6 + len)), (void const   */* __restrict  */)((void const   *)s),
           (size_t )len2);
#line 117
    len += len2;
    }
...
#line 118
      ...
      {
#line 118
      tmp___4 = trailing_escape((char const   */* const  */)((char const   *)buf___6),
                                len - 1);
      }
#line 118
      if (! tmp___4) {
...
#line 283
    ...
    {
#line 286
    tmp___0 = get_sbuf_line((line_t const   */* const  */)((line_t const   *)lp___0));
#line 286
    p = tmp___0;
    }
#line 287
...
#line 295
        show_strerror((char const   */* const  */)((char const   *)0), (int const   )*tmp___5);
#line 296
...
#line 314
    tmp = strip_escapes((char const   *)filename);
#line 314
    fp = fopen((char const   */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)mode));
    }
  }
#line 315
  if (! fp) {

...
#line 366
  strncat((char */* __restrict  */)(dotlock_name), (char const   */* __restrict  */)((char const   *)(username)),
          (size_t )256);
#line 367
...
#line 469
    regoptail(ret, ret);
#line 470
    tmp___0 = regnode((char)6);
#line 470
    regtail(ret, tmp___0);
#line 471
    tmp___1 = regnode((char)9);
#line 471
    regtail(ret, tmp___1);
    }
  } else
...
#line 477
    regtail(ret, next);
#line 478
    tmp___2 = regnode((char)7);
#line 478
    regtail(tmp___2, ret);
#line 479
    tmp___3 = regnode((char)6);
#line 479
    regtail(next, tmp___3);
#line 480
    tmp___4 = regnode((char)9);
#line 480
    regtail(ret, tmp___4);
    }
  } else
...
#line 587
  if (len <= 0) {
    {
#line 588
    regerror((char *)"internal disaster");
    }
#line 588
    return ((char *)((void *)0));
  }
...
#line 186
  if ((unsigned long )passwd_entry == (unsigned long )((void *)0)) {
    {
#line 187
    leave((char *)"Cannot get password entry for this uid!");
    }
  }
  {
#line 190
...
#line 201
  stringcopy(hostname, (char *)"vore", (int )sizeof(hostname));
  }
  {
#line 208
  while (1) {
...
#line 267
  if ((unsigned long )tmpstr != (unsigned long )((void *)0)) {
    {
#line 268
    strcpy((char */* __restrict  */)(user_mailbox), (char const   */* __restrict  */)((char const   *)tmpstr));
    }
  }
#line 270
  if ((int )overridemailbox[0] != 0) {
    {
#line 271
    strcpy((char */* __restrict  */)(user_mailbox), (char const   */* __restrict  */)((char const   *)(overridemailbox)));
    }
  }
  {
#line 279
...
#line 292
    strcat((char */* __restrict  */)(buffer___0), (char const   */* __restrict  */)((char const   *)(firstletter)));
#line 293
    strcat((char */* __restrict  */)(buffer___0), (char const   */* __restrict  */)((char const   *)(tmpstr + 2)));
#line 294
    tmp___0 = strlen((char const   *)(buffer___0));
#line 294
    stringcopy(user_mailbox, buffer___0, (int )(tmp___0 + 1UL));
    }
  }
  {
#line 301
...
#line 310
    strcat((char */* __restrict  */)(buffer___0), (char const   */* __restrict  */)((char const   *)(username)));
#line 311
    strcat((char */* __restrict  */)(buffer___0), (char const   */* __restrict  */)((char const   *)(tmpstr + 2)));
#line 312
    tmp___1 = strlen((char const   *)(buffer___0));
#line 312
    stringcopy(user_mailbox, buffer___0, (int )(tmp___1 + 1UL));
    }
  }
  {
#line 317
...
#line 329
    ...
    {
#line 331
    outfptr = fopen((char const   */* __restrict  */)((char const   *)(outfname)),
...
#line 358
  ...
  {
#line 363
  tmp___35 = make_tempfile();
#line 363
  tmp___7 = (int )tmp___35;
#line 363
...
#line 612
    *dest = (char )'\000';
#line 613
    stringcopy(subject___0, tmpsubj, (int )((dest + 1) - tmpsubj));
    }
#line 614
    return;
  }
...
#line 639
  stringcopy(dest, end, (int )(tmp___5 + 1UL));
#line 640
  tmp___6 = strlen((char const   *)(tmpsubj));
#line 640
  stringcopy(start, tmpsubj, (int )(tmp___6 + 1UL));
  }
#line 642
  return;
}
...
#line 711
  if ((unsigned long )tolist == (unsigned long )((void *)0)) {
    {
#line 712
    tmp___4 = safemalloc((int )sizeof(LIST ));
#line 712
    tmp___1 = (int )tmp___4;
#line 712
    tolist = (LIST *)tmp___1;
...
#line 719
    ...
    {
#line 720
    tmp___5 = safemalloc((int )sizeof(LIST ));
#line 720
    tmp___2 = (int )tmp___5;
#line 720
...
#line 805
  ...
  {
#line 813
  tmp___6 = istrcmp(fieldname, (char *)"Reply-To:");
  }
#line 813
  if (tmp___6 == 0) {
#line 814
...
#line 105
  if (! show_only) {
    {
#line 106
    fptr = fopen((char const   */* __restrict  */)((char const   *)(filtersum)), (char const   */* __restrict  */)"a");
    }
#line 106
...
#line 119
    ...
    {
#line 120
    fptr = fopen((char const   */* __restrict  */)((char const   *)(filterlog)), (char const   */* __restrict  */)"a");
    }
#line 120
    if ((unsigned long )fptr == (unsigned long )((void *)0)) {
#line 121
...
#line 126
  ...
  {
#line 130
  setvbuf((FILE */* __restrict  */)fptr, (char */* __restrict  */)((char *)((void *)0)),
          0, (size_t )8192);
#line 133
...
{ 
  ...
  {
#line 298
  strncpy((char */* __restrict  */)dest, (char const   */* __restrict  */)((char const   *)src),
          (size_t )len);
#line 299
  *(dest + (len - 1)) = (char )'\000';
  }
...
#line 180
  fd = fopen((char const   */* __restrict  */)((char const   *)(filename)), (char const   */* __restrict  */)"r");
  }
#line 180
...
#line 394
            ...
            {
#line 395
            strncat((char */* __restrict  */)(cond_argument), (char const   */* __restrict  */)((char const   *)word),
                    (size_t )256);
#line 396
...
#line 322
    ...
    {
#line 329
    fputs((char const   */* __restrict  */)((char const   *)(buffer___0)), (FILE */* __restrict  */)mailfptr);
    }
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 472
    ...
    {
#line 482
    fputs((char const   */* __restrict  */)((char const   *)(buffer___0)), (FILE */* __restrict  */)folderfptr);
    }
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 341
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)"\"",
                (size_t )256);
#line 342
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)(sender)),
                (size_t )256);
#line 343
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)"\"",
                (size_t )256);
...
#line 350
        ...
        {
#line 355
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)(Hfrom)),
                (size_t )256);
        }
      }
      {
...
#line 365
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)"\"",
                (size_t )256);
#line 366
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)(subject)),
                (size_t )256);
#line 367
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)"\"",
                (size_t )256);
...
#line 394
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___6),
                (size_t )256);
        }
      }
      {
...
#line 404
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___8),
                (size_t )256);
        }
      }
      {
...
#line 424
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___11),
                (size_t )256);
        }
      }
      {
...
#line 435
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___13),
                (size_t )256);
        }
      }
      {
...
#line 446
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___15),
                (size_t )256);
        }
      }
      {
...
#line 456
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___17),
                (size_t )256);
#line 457
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)":",
                (size_t )256);
...
#line 458
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)tmp___18),
                (size_t )256);
        }
      }
      {
...
#line 470
        *(buffer___0 + bufflen) = (char )'\000';
#line 471
        strncat((char */* __restrict  */)buffer___0, (char const   */* __restrict  */)((char const   *)regmessage[regsub___0].str),
                (size_t )256);
#line 478
...
#line 80
  messages_filtered = 0;
#line 87
  fd = fopen((char const   */* __restrict  */)((char const   *)(filtersum)), (char const   */* __restrict  */)"r");
  }
#line 87
  if ((unsigned long )fd == (unsigned long )((void *)0)) {
#line 88
...
#line 261
  if (long_summary) {
    {
#line 265
    fd = fopen((char const   */* __restrict  */)((char const   *)(filterlog)), (char const   */* __restrict  */)"r");
    }
#line 265
    if ((unsigned long )fd == (unsigned long )((void *)0)) {
      {
...
#line 46
  ...
  {
#line 49
  tmp___1 = strcspn((char const   *)sourceptr, (char const   *)keys);
#line 49
  last_ch = (int )tmp___1;
#line 51
  return_value = sourceptr;

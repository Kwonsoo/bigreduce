...
#line 168
      ...
      {
#line 169
      sigaction(sig, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
...
#line 551
  ...
  {
#line 554
  fs = fopen((char const   */* __restrict  */)((char const   *)file_name), (char const   */* __restrict  */)"r");
  }
#line 555
...
#line 867
      if (tmp___3 <= 46UL) {
        {
#line 869
        strcpy((char */* __restrict  */)(parsed_info->addrlist), (char const   */* __restrict  */)((char const   *)value));
        }
#line 870
        if (parsed_info->verboseflag) {
          {
...
#line 935
    *tmp___6 = 0;
#line 936
    tmp___7 = strtoul((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& ep),
                      10);
#line 936
    uid = (uid_t )tmp___7;
#line 937
...
#line 953
    *tmp___9 = 0;
#line 954
    tmp___10 = strtoul((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& ep),
                       10);
#line 954
...
#line 971
    *tmp___12 = 0;
#line 972
    tmp___13 = strtoul((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& ep),
                       10);
#line 972
    gid = (gid_t )tmp___13;
#line 973
...
#line 1064
    *tmp___15 = 0;
#line 1065
    tmp___16 = strtoul((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& ep),
                       10);
#line 1065
...
#line 1083
    *tmp___18 = 0;
#line 1084
    tmp___19 = strtoul((char const   */* __restrict  */)((char const   *)value), (char **/* __restrict  */)(& ep),
                       10);
#line 1084
...
#line 1267
  ...
  {
#line 1271
  memcpy((void */* __restrict  */)((void *)(parsed_info->host)), (void const   */* __restrict  */)((void const   *)host),
         hostlen);
#line 1272
  memcpy((void */* __restrict  */)((void *)(parsed_info->share)), (void const   */* __restrict  */)((void const   *)share),
         sharelen);
#line 1273
  memcpy((void */* __restrict  */)((void *)(parsed_info->prefix)), (void const   */* __restrict  */)((void const   *)prepath),
         prepathlen);
  }
#line 1275
  return (0);
...
#line 1403
  ...
  {
#line 1406
  rc = sigprocmask(2, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& mask)),
...
#line 1477
  rc = addmntent((FILE */* __restrict  */)pmntfile, (struct mntent  const  */* __restrict  */)((struct mntent  const  *)(& mountent)));
  }
#line 1478
  if (rc) {
    {
...
#line 1494
  sigprocmask(2, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& oldmask)),
...
#line 1555
    ...
    {
#line 1556
    rc = addmntent((FILE */* __restrict  */)mnttmp, (struct mntent  const  */* __restrict  */)((struct mntent  const  *)mountent));
    }
#line 1557
    if (rc) {
      {
...
#line 1669
  ...
  {
#line 1671
  strncpy((char */* __restrict  */)input, (char const   */* __restrict  */)((char const   *)tmp_pass),
          (size_t )(capacity - 1));
#line 1672
...
#line 1842
  ...
  {
#line 1845
  mountpoint = realpath((char const   */* __restrict  */)".", (char */* __restrict  */)((char *)((void *)0)));
  }
#line 1846
  if (! mountpoint) {
    {
...
{ 
  ...
  {
#line 48
  rc = getaddrinfo((char const   */* __restrict  */)host, (char const   */* __restrict  */)((char const   *)((void *)0)),
                   (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)((void *)0)),
                   (struct addrinfo **/* __restrict  */)(& addrlist));
  }
#line 49
  if (rc != 0) {
#line 50
...
#line 64
    ipaddr = inet_ntop(10, (void const   */* __restrict  */)((void const   *)(& sin6->sin6_addr)),
                       (char */* __restrict  */)(tmpbuf), (socklen_t )sizeof(tmpbuf));
    }
#line 66
    if (! ipaddr) {
#line 67
...
#line 79
    ipaddr = inet_ntop(2, (void const   */* __restrict  */)((void const   *)(& sin->sin_addr)),
                       (char */* __restrict  */)(tmpbuf), (socklen_t )sizeof(tmpbuf));
    }
#line 81
    if (! ipaddr) {
...
#line 41
  ...
  {
#line 42
  memcpy((void */* __restrict  */)((void *)d), (void const   */* __restrict  */)((void const   *)s),
         len);
#line 43
  *(d + len) = (char)0;
  }
...
#line 65
  if (len2 > 0UL) {
    {
#line 66
    memcpy((void */* __restrict  */)((void *)(d + len1)), (void const   */* __restrict  */)((void const   *)s),
           len2);
#line 67
    *(d + (len1 + len2)) = (char)0;
    }

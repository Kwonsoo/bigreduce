...
static int off_tl  ;
#line 162 "/home/june/repo/benchmarks/collector/temp/fprobe-ulog-1.1/src/fprobe-ulog.c"
unsigned int total_elements  ;
#line 163 "/home/june/repo/benchmarks/collector/temp/fprobe-ulog-1.1/src/fprobe-ulog.c"
...
#line 653
      tmp = pthread_cond_timedwait((pthread_cond_t */* __restrict  */)(& emit_cond),
                                   ...
                                   (struct timespec  const  */* __restrict  */)((struct timespec  const  *)(& timeout)));
      }
#line 653
      if (tmp) {
#line 653
...
#line 1135
        sprintf((char */* __restrict  */)(errpbuf), (char const   */* __restrict  */)"[%s]",
                log_suffix);
#line 1136
        strcat((char */* __restrict  */)(ident), (char const   */* __restrict  */)((char const   *)(errpbuf)));
        }
      }
    }
#line 1139
...
#line 1185
      ...
      {
#line 1187
      strncpy((char */* __restrict  */)((snmp_rules + i)->basename), (char const   */* __restrict  */)((char const   *)rule),
              (size_t )(snmp_rules + i)->len);
      }
#line 1188
      if (! *(rule - 1)) {
#line 1188
      ...
      {
#line 1189
      rule = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)",");
      }
#line 1190
      if (! rule) {
        {
...
#line 1200
  if (parms[15].count) {
    {
#line 1201
    sscanf((char const   */* __restrict  */)((char const   *)parms[15].arg), (char const   */* __restrict  */)"%d:%d",
...
#line 1202
  if (parms[0].count) {
    {
#line 1203
    tmp___15 = getaddrinfo((char const   */* __restrict  */)((char const   *)parms[0].arg),
                           (char const   */* __restrict  */)((char const   *)0), (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
...
#line 1254
      if (*lhost) {
        {
#line 1255
        tmp___27 = getaddrinfo((char const   */* __restrict  */)((char const   *)lhost),
...
#line 1263
    ...
    {
#line 1265
    tmp___31 = getaddrinfo((char const   */* __restrict  */)((char const   *)dhost),
                           (char const   */* __restrict  */)((char const   *)dport),
                           (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
                           (struct addrinfo **/* __restrict  */)(& res));
    }
#line 1265
...
#line 1359
  sigaction(15, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sigact)),
            (struct sigaction */* __restrict  */)((struct sigaction *)0));
#line 1364
  tmp___51 = pthread_sigmask(0, (__sigset_t const   */* __restrict  */)((__sigset_t const   *)(& sig_mask)),
                             (__sigset_t */* __restrict  */)((__sigset_t *)0));
  }
#line 1364
  if (tmp___51) {
    {
...
#line 1382
        tmp___59 = pthread_attr_setschedparam((pthread_attr_t */* __restrict  */)(& tattr),
                                              (struct sched_param  const  */* __restrict  */)((struct sched_param  const  *)(& schedp)));
        }
#line 1382
        if (tmp___59) {
          {
...
#line 1385
    ...
    {
#line 1388
    tmp___62 = pthread_create((pthread_t */* __restrict  */)(& thid), (pthread_attr_t const   */* __restrict  */)((pthread_attr_t const   *)(& tattr)),
                              (void *(*)(void * ))threads[i], (void */* __restrict  */)((void *)0));
    }
#line 1388
    if (tmp___62) {
      {
...
#line 1407
  ...
  {
#line 1411
  pidfile = fopen((char const   */* __restrict  */)((char const   *)pidfilepath),
...
#line 1430
  ...
  {
#line 1444
  pthread_sigmask(1, (__sigset_t const   */* __restrict  */)((__sigset_t const   *)(& sig_mask)),
                  (__sigset_t */* __restrict  */)((__sigset_t *)0));
#line 1446
...
#line 76
    fread((void */* __restrict  */)((void *)(& rnd)), sizeof(rnd), (size_t )1, (FILE */* __restrict  */)rnddev);
#line 77
    fclose(rnddev);
    }
  }
...
#line 79
  tmp = recvfrom((int )h->fd, (void */* __restrict  */)((void *)buf), len, 0, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& h->peer)),

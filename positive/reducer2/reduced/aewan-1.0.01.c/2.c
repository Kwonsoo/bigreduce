...
#line 208
    if (*s) {
#line 208
      tmp___2 = (int )((int const   )*s);
    } else {
#line 208
      tmp___2 = (int )((int const   )' ');
    }
    {
#line 208
...
#line 66 "/home/wslee/benchmarks/textformat/aewan-1.0.01/aewl/aewl.h"
...
#line 260
  if (outputfile) {
    {
#line 260
    f = fopen((char const   */* __restrict  */)((char const   *)outputfile), (char const   */* __restrict  */)"w");
    }
#line 260
    if (f) {
#line 264
...
#line 75
  if (_doc->metainfo) {
    {
#line 75
    fputs((char const   */* __restrict  */)((char const   *)_doc->metainfo), (FILE */* __restrict  */)f___0);
    }
  }
  {
#line 78
...
#line 95
  wrefresh(stdscr);
#line 98
  f___0 = fopen((char const   */* __restrict  */)((char const   *)(tmpname)), (char const   */* __restrict  */)"r");
  }
#line 99
  if (! f___0) {
    {
...
#line 115
  tmp___4 = fread((void */* __restrict  */)((void *)_doc->metainfo), (size_t )1, (size_t )size,
...
#line 280
    if (tmp___1) {
      {
#line 280
      tmpf = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
      }
#line 280
      if (tmpf) {
        {
...
#line 300
    sprintf((char */* __restrict  */)compname, (char const   */* __restrict  */)"%s/%s",
            curdir, dent->d_name);
#line 302
    tmp___4 = stat((char const   */* __restrict  */)((char const   *)compname), (struct stat */* __restrict  */)(& st));
    }
#line 302
    if (0 != tmp___4) {
#line 302
...
#line 297
  ...
  {
#line 298
  fread((void */* __restrict  */)((void *)(& width___0)), (size_t )sizeof(int ), (size_t )1,
        (FILE */* __restrict  */)f___0);
#line 299
  fread((void */* __restrict  */)((void *)(& height___0)), (size_t )sizeof(int ),
        (size_t )1, (FILE */* __restrict  */)f___0);
#line 300
  tmp___3 = fgetc(f___0);
  }
#line 300
...
#line 124
  len = (int )tmp;
#line 126
  fwrite((void const   */* __restrict  */)((void const   *)(& len)), (size_t )sizeof(int ),
         (size_t )1, (FILE */* __restrict  */)f___0);
  }
  {
#line 127
...
{ 
  ...
  {
#line 133
  fread((void */* __restrict  */)((void *)(& len)), (size_t )sizeof(int ), (size_t )1,
        (FILE */* __restrict  */)f___0);
#line 135
  tmp = zalloc(len + 1);
#line 135
...
#line 187
  ...
  {
#line 189
  fread((void */* __restrict  */)((void *)(& lc)), (size_t )sizeof(int ), (size_t )1,
        (FILE */* __restrict  */)f___0);
#line 191
  d = document_create();
#line 192

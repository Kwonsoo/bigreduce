...
#line 56
  tmp___0 = bind(sockfd, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)sock_addr),
                 (socklen_t )addrlen);
  }
#line 56
  if (tmp___0 < 0) {
...
{ 
  ...
  {
#line 74
  connfd = accept(listenfd, (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)0)),
...
#line 105
  sock_addr = (struct sockaddr *)(& unix_addr);
#line 106
  tmp___0 = connect(sockfd, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)sock_addr),
                    (socklen_t )addrlen);
  }
#line 106
  if (tmp___0 < 0) {
...
#line 38
      if (tmp___0 == 0) {
        {
#line 39
        sscanf((char const   */* __restrict  */)((char const   *)(buffer___0 + 6)),
               (char const   */* __restrict  */)"%lu", & boot);
        }
#line 40
        goto while_break;
      }
...
#line 75
  ...
  {
#line 77
  num = sscanf((char const   */* __restrict  */)((char const   *)start), (char const   */* __restrict  */)"%c %d %*d %*d %*d %*d %*u %*lu %*lu %*lu %*lu %lu %*lu %*ld %*ld %*ld %*ld %*ld %*ld %llu",

...
#line 49
  s[3] = (uint8_t )x;
#line 51
  tmp = fwrite((void const   */* __restrict  */)((void const   *)(s)), (size_t )1,
...
#line 90
  ...
  {
#line 92
  tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)s), (size_t )1,
                   n, (FILE */* __restrict  */)file);
  }
#line 92
  if (tmp___0 != n) {
#line 93
...
#line 108
  ...
  {
#line 110
  file = fopen((char const   */* __restrict  */)((char const   *)filename___3), (char const   */* __restrict  */)"wb");
  }
#line 111
  if (! file) {
    {
...
#line 116
  free((void *)filename___3);
#line 119
  tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)"MThd"), (size_t )1,
                   (size_t )4, (FILE */* __restrict  */)file);
  }
#line 119
  if (tmp___1 != 4U) {
...
#line 137
  ...
  {
#line 140
  tmp___6 = fwrite((void const   */* __restrict  */)((void const   *)"MTrk"), (size_t )1,
                   (size_t )4, (FILE */* __restrict  */)file);
  }
#line 140
  if (tmp___6 != 4U) {
...
#line 180
  printf((char const   */* __restrict  */)((char const   *)tmp), gbs->version, gbs->title,
         gbs->author, gbs->copyright, (int )gbs->load, (int )gbs->init, (int )gbs->play,
         (int )gbs->stack, gbs->filesize, gbs->romsize, gbs->romsize / 16384UL, gbs->songs);
  }
#line 203
  if (gbs->version == 2L) {
#line 204
...
#line 204
    printf((char const   */* __restrict  */)((char const   *)tmp___3), (unsigned long )gbs->crc,
           (unsigned long )gbs->crcnow, tmp___2);
    }
  }
#line 208
  if (verbose) {
...
#line 211
        printf((char const   */* __restrict  */)((char const   *)tmp___4), i);
        }
#line 212
...
#line 218
          printf((char const   */* __restrict  */)((char const   *)tmp___6), (long )((gbs->subsong_info + i)->len >> 10));
          }
        } else {
          {
#line 221
...
#line 289
    if (len > 32L) {
      {
#line 290
      memcpy((void */* __restrict  */)((void *)(strings + stringofs)), (void const   */* __restrict  */)((void const   *)gbs->title),
             (size_t )(len + 1L));
#line 291
...
#line 294
    if (len > 32L) {
      {
#line 295
      memcpy((void */* __restrict  */)((void *)(strings + stringofs)), (void const   */* __restrict  */)((void const   *)gbs->author),
             (size_t )(len + 1L));
#line 296
...
#line 299
    if (len > 30L) {
      {
#line 300
      memcpy((void */* __restrict  */)((void *)(strings + stringofs)), (void const   */* __restrict  */)((void const   *)gbs->copyright),
             (size_t )(len + 1L));
#line 301
...
#line 310
          len = (long )(tmp___7 + 1U);
#line 311
          memcpy((void */* __restrict  */)((void *)(strings + stringofs)), (void const   */* __restrict  */)((void const   *)(gbs->subsong_info + i)->title),
                 (size_t )len);
#line 312
...
#line 305
    ...
    {
#line 317
    memcpy((void */* __restrict  */)((void *)(gbs->buf + newlen)), (void const   */* __restrict  */)((void const   *)(strings)),
           (size_t )stringofs);
#line 318
    newlen += stringofs;
#line 320
...
#line 378
  memcpy((void */* __restrict  */)((void *)(gbs->v1strings)), (void const   */* __restrict  */)((void const   *)(buf___3 + 16)),
         (size_t )32);
#line 379
  memcpy((void */* __restrict  */)((void *)(gbs->v1strings + 33)), (void const   */* __restrict  */)((void const   *)(buf___3 + 48)),
         (size_t )32);
#line 380
  memcpy((void */* __restrict  */)((void *)(gbs->v1strings + 66)), (void const   */* __restrict  */)((void const   *)(buf___3 + 80)),
         (size_t )30);
#line 381
...
#line 453
  memcpy((void */* __restrict  */)((void *)(gbs->rom + ((int )gbs->load - 112))),
         (void const   */* __restrict  */)((void const   *)buf___3), (size_t )(112UL + gbs->codelen));
#line 454
  memcpy((void */* __restrict  */)((void *)(gbs->rom + 80)), (void const   */* __restrict  */)((void const   *)(playercode)),
...
#line 342
  fprintf((FILE */* __restrict  */)out, (char const   */* __restrict  */)((char const   *)tmp___1),
...
#line 404
          printf((char const   */* __restrict  */)((char const   *)tmp), optarg);
#line 405
          usage___0(1L);
          }
        }
...
#line 407
    ...
    {
#line 409
    sscanf((char const   */* __restrict  */)((char const   *)optarg), (char const   */* __restrict  */)"%ld",
           & fadeout);
    }
#line 410
    goto switch_break;
...
#line 576
  printf((char const   */* __restrict  */)((char const   *)tmp), signum);
#line 577
...
#line 677
  if (argc >= 2) {
    {
#line 678
    sscanf((char const   */* __restrict  */)((char const   *)*(argv + 1)), (char const   */* __restrict  */)"%ld",
           & subsong_start);
#line 679
    subsong_start --;
    }
...
#line 682
  if (argc >= 3) {
    {
#line 683
    sscanf((char const   */* __restrict  */)((char const   *)*(argv + 2)), (char const   */* __restrict  */)"%ld",
           & subsong_stop);
#line 684
    subsong_stop --;
    }
...
#line 727
  sigaction(19, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 728
  sa.__sigaction_handler.sa_handler = & cont_handler;
#line 729
  sigaction(18, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 731
  fcntl(0, 4, 2048);
  }
...
#line 24
  fprintf((FILE */* __restrict  */)out, (char const   */* __restrict  */)((char const   *)tmp___0),
          myname);
#line 31
  exit((int )exitcode);
  }

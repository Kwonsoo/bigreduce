...
extern void argp_error(struct argp_state  const  * __restrict  __state , char const   * __restrict  __fmt 
                       , ...) ;
#line 519
extern void argp_failure(struct argp_state  const  * __restrict  __state , int __status ,
                         int __errnum , char const   * __restrict  __fmt  , ...) ;
...
#line 568
      *tmp___2 = 0;
#line 569
      tmp___3 = strtoul((char const   */* __restrict  */)((char const   *)lp), (char **/* __restrict  */)(& ep),
                        0);
#line 569
...
#line 776
        last_bundle_id ++;
#line 777
        err = add_intel_microcode_bundle(fn, last_bundle_id, (void const   */* const  */)((void const   *)mcb),
...
#line 1021
    if (verbosity >= 3) {
      {
#line 1022
      log_microcode_action((char const   */* const  */)"uploading", devname, (struct intel_uclist_entry  const  */* const  */)((struct intel_uclist_entry  const  *)uc_write_list));
      }
    }
    {
#line 1025
...
#line 1097
  tmp___3 = write_data((int const   )fd, (void const   */* const  */)((void const   *)(buf)),
...
#line 1125
      *p2 = (char)0;
#line 1126
      r = xx_write_cpio_hdrentry(fd, (char const   */* const  */)((char const   *)(fn)),
                                 (size_t const   )0, & pos);
      }
#line 1127
      if (r < 0) {
...
#line 1169
  ...
  {
#line 1171
  tmp = write_data((int const   )fd, (void const   */* const  */)((void const   *)(cpio_trailer)),
                   (uint32_t const   )s);
  }
#line 1171
  return ((int )tmp);
...
#line 1257
    if (verbosity >= 3) {
      {
#line 1258
      log_microcode_action((char const   */* const  */)"writing", filename, (struct intel_uclist_entry  const  */* const  */)((struct intel_uclist_entry  const  *)uc_write_list));
      }
    }
    {
#line 1261
...
#line 1496
  if (tmp___3) {
    {
#line 1497
    tmp___2 = is_in_date_range((struct intel_ucode_metadata  const  */* const  */)((struct intel_ucode_metadata  const  *)(& m)));
    }
#line 1497
    if (tmp___2) {
#line 1497
...
#line 1605
    s = intel_ucode_foreach_microcode((void const   */* const  */)mcb->data, (size_t const   )mcb->size,
                                      ...
                                      (void */* const  */)((void *)(& microcode_interator_data)));
    }
#line 1608
    if ((unsigned int )s != 0U) {
#line 1609
...
#line 1737
    memcpy((void */* __restrict  */)((void *)(& e)), (void const   */* __restrict  */)((void const   *)p___0),
           sizeof(e));
#line 1738
    e.next = (struct intel_uclist_entry *)((void *)0);
#line 1739
    rc = write_intel_microcodes((int const   )dirfd___0, (char const   */* const  */)((char const   *)(fn)),
                                0, & e);
    }
#line 1740
    if (! rc) {
...
#line 2153
  memset((void *)n, 0, s);
#line 2154
  memcpy((void */* __restrict  */)((void *)(n->path)), (void const   */* __restrict  */)((void const   *)fn),
         l);
#line 2155
  n->type = ftype;
#line 2158
...
#line 2437
  ...
  {
#line 2287
  argp_state_help((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
                  (FILE */* __restrict  */)stdout, 634U);
  }
  case_113: 
#line 2290
  verbosity = 0;
...
#line 2305
    argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
               (char const   */* __restrict  */)"unknown file type: %s\n", arg);
    }
  } else {
    {
#line 2304
...
#line 2317
  argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
             (char const   */* __restrict  */)"unknown file type: %c\n", (int )*arg);
  }
  switch_break___0: ;
#line 2319
  goto switch_break;
...
#line 2323
    argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
               (char const   */* __restrict  */)"-k option can be specified only once\n");
    }
  }
#line 2326
  if (arg) {
...
#line 2347
    argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
               (char const   */* __restrict  */)"-w option can be specified only once\n");
    }
  }
  {
#line 2350
...
#line 2355
    argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
               (char const   */* __restrict  */)"--write-earlyfw option can be specified only once\n");
    }
  }
  {
#line 2358
...
#line 2385
  argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
             (char const   */* __restrict  */)"invalid filter: %s", arg);
  }
  switch_default___0: 
  {
#line 2387
  argp_failure((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
               2, rc, (char const   */* __restrict  */)"could not add filter \'%s\'",
               arg);
  }
  switch_break___1: 
#line 2390
...
#line 2400
    argp_error((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
               (char const   */* __restrict  */)"invalid date: %s", arg);
    }
  }
#line 2401
  command_line_actions = (enum __anonenum_command_line_actions_32 )((unsigned int )command_line_actions | 4096U);
...
#line 2427
  ...
  {
#line 2430
  rc = new_filename((char const   */* const  */)((char const   *)arg), ucfiletype);
  }
#line 2431
  if (rc) {
    {
#line 2432
    argp_failure((struct argp_state  const  */* __restrict  */)((struct argp_state  const  *)state),
                 2, rc, (char const   */* __restrict  */)"could not add path \'%s\'",
                 arg);
    }
  }
#line 2434
...
#line 2459
  argp_parse((struct argp  const  */* __restrict  */)((struct argp  const  *)(& cmdline_argp)),
             argc, (char **/* __restrict  */)argv, 8U, (int */* __restrict  */)((int *)((void *)0)),
             (void */* __restrict  */)((void *)0));
  }
#line 2461
...
#line 2499
      if (upload_microcode) {
        {
#line 2500
        rc = do_upload_microcode((char const   */* const  */)((char const   *)upload_microcode));
        }
      }
#line 2501
      if (! rc) {
#line 2501
        if (write_microcode) {
          {
#line 2502
          rc = do_write_microcode((char const   */* const  */)((char const   *)write_microcode),
                                  0);
          }
        }
      }
...
#line 2503
        if (write_early_firmware) {
          {
#line 2504
          rc = do_write_microcode((char const   */* const  */)((char const   *)write_early_firmware),
                                  1);
          }
        }
      }
...
#line 2505
        if (write_firmware) {
          {
#line 2506
          rc = do_write_firmware((char const   */* const  */)((char const   *)write_firmware));
          }
        }
      }
#line 2507
...
#line 2507
        if (write_named) {
          {
#line 2508
          rc = do_write_named((char const   */* const  */)((char const   *)write_named));
          }
        }
      }
#line 2510
...
#line 486
  ...
  {
#line 488
  airac_observe((struct intel_ucode_v1_hdr *)uc, 0);
#line 488
...
#line 502
    ...
    {
#line 504
    uc_size = intel_ucode_v1_get_totalsize((struct intel_ucode_v1_hdr  const  */* const  */)((struct intel_ucode_v1_hdr  const  *)((struct intel_ucode_v1_hdr *)uc)));
    }
#line 505
...
#line 506
    ...
    {
#line 508
    tmp = (*action)((void *)userdata, (unsigned int const   )uc_count, (void const   */* const  */)((void const   *)uc));
    }
#line 508
    if (tmp) {
#line 509

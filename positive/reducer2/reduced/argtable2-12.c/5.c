...
#line 743
  fputs((char const   */* __restrict  */)((char const   *)(syntax)), (FILE */* __restrict  */)fp);
#line 744
...
#line 774
    ...
    {
#line 777
    fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)((char const   *)format1),
...
#line 795
    ...
    {
#line 798
    fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)((char const   *)format2),
            (int const   )*((*(table + tabindex))->shortopts + 0));
#line 799
    format2 = (char *)"%c";
#line 800
...
#line 783
  ...
  {
#line 803
  fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)((char const   *)suffix));
  }
#line 804
  return;
}
...
#line 77
    priv = (struct privhdr *)parent->hdr.priv;
#line 81
    errorcode = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& priv->regex)),
                        (char const   */* __restrict  */)argval, (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                        0);
    }
#line 82
    if (errorcode == 0) {
...
#line 127
  ...
  {
#line 132
  regerror(errorcode, (regex_t const   */* __restrict  */)((regex_t const   *)((void *)0)),
           (char */* __restrict  */)(errbuff), sizeof(errbuff));
#line 133
...
#line 226
    if (errorcode) {
      {
#line 229
      regerror(errorcode, (regex_t const   */* __restrict  */)((regex_t const   *)(& priv->regex)),
               (char */* __restrict  */)(errbuff), sizeof(errbuff));
#line 230

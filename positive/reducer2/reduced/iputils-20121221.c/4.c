...
#line 75
  select(fd + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 153
      if (cmsg->cmsg_type == 2) {
        {
#line 154
        memcpy((void */* __restrict  */)((void *)(& rethops)), (void const   */* __restrict  */)((void const   *)(cmsg->__cmsg_data)),
               sizeof(rethops));
        }
      } else {
        {
...
#line 170
    idn = (char *)((void *)0);
#line 172
    inet_ntop(2, (void const   */* __restrict  */)((void const   *)(& sin->sin_addr)),
...
#line 274
    tmp = sendto(fd, (void const   *)pktbuf, (size_t )(mtu - (int )overhead), 0, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& target))),
...
#line 386
  ...
  {
#line 393
  memcpy((void */* __restrict  */)((void *)(& target.sin_addr)), (void const   */* __restrict  */)((void const   *)*(he->h_addr_list + 0)),
         (size_t )4);
#line 395
  on = 3;
#line 396

...
#line 193
    translate_flag = 1;
#line 194
    sscanf((char const   */* __restrict  */)((char const   *)optarg), (char const   */* __restrict  */)"%f,%f,%f",
...
{ 
  ...
  {
#line 131
  fp = fopen((char const   */* __restrict  */)((char const   *)file), (char const   */* __restrict  */)"w");
  }
#line 132
...
#line 218
  fwrite((void const   */* __restrict  */)((void const   *)(& new_value)), (size_t )sizeof(int ),
...
#line 263
  tmp___2 = strlen((char const   *)label);
#line 263
  i = (int )tmp___2;
  }
  {
...
#line 131
    if (a->x > b->x) {
      {
#line 133
      memcpy((void */* __restrict  */)((void *)(& edge->key[0])), (void const   */* __restrict  */)((void const   *)a),
             (size_t )sizeof(stl_vertex ));
#line 134
      memcpy((void */* __restrict  */)((void *)(& edge->key[3])), (void const   */* __restrict  */)((void const   *)b),
             (size_t )sizeof(stl_vertex ));
      }
    } else {
      {
#line 138
      memcpy((void */* __restrict  */)((void *)(& edge->key[0])), (void const   */* __restrict  */)((void const   *)b),
             (size_t )sizeof(stl_vertex ));
#line 139
      memcpy((void */* __restrict  */)((void *)(& edge->key[3])), (void const   */* __restrict  */)((void const   *)a),
             (size_t )sizeof(stl_vertex ));
#line 140
      edge->which_edge += 3;
      }
...
#line 378
    if (a->x > b->x) {
      {
#line 380
      memcpy((void */* __restrict  */)((void *)(& edge->key[0])), (void const   */* __restrict  */)((void const   *)(vertex1)),
             (size_t )sizeof(stl_vertex ));
#line 381
      memcpy((void */* __restrict  */)((void *)(& edge->key[3])), (void const   */* __restrict  */)((void const   *)(vertex2)),
             (size_t )sizeof(stl_vertex ));
      }
    } else {
      {
#line 385
      memcpy((void */* __restrict  */)((void *)(& edge->key[0])), (void const   */* __restrict  */)((void const   *)(vertex2)),
             (size_t )sizeof(stl_vertex ));
#line 386
      memcpy((void */* __restrict  */)((void *)(& edge->key[3])), (void const   */* __restrict  */)((void const   *)(vertex1)),
             (size_t )sizeof(stl_vertex ));
#line 387
      edge->which_edge += 3;
      }
...
#line 107
  stl->fp = fopen((char const   */* __restrict  */)((char const   *)file), (char const   */* __restrict  */)"r");
  }
#line 108
...
#line 123
  fseek(stl->fp, 84L, 0);
#line 124
  fread((void */* __restrict  */)((void *)(chtest)), (size_t )sizeof(chtest), (size_t )1,
        (FILE */* __restrict  */)stl->fp);
#line 125
...
#line 150
    fread((void */* __restrict  */)((void *)(stl->stats.header)), (size_t )80, (size_t )1,
          (FILE */* __restrict  */)stl->fp);
#line 151

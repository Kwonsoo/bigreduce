...
#line 170
  tmp___0 = regcomp((regex_t */* __restrict  */)bosh_regex, (char const   */* __restrict  */)((char const   *)s),
                    (1 | (1 << 1)) | (((1 << 1) << 1) << 1));
  }
#line 170
  return (tmp___0);
...
{ 
  ...
  {
#line 174
  tmp = regexec((regex_t const   */* __restrict  */)((regex_t const   *)bosh_regex),
                (char const   */* __restrict  */)((char const   *)s), (size_t )0,
...
#line 295
    ...
    {
#line 299
    f = fopen((char const   */* __restrict  */)((char const   *)(bosh___0->tmpfscript)),
...
#line 499
    ...
    {
#line 500
    tmp___4 = select(n + 1, (fd_set */* __restrict  */)(& fdsetr), (fd_set */* __restrict  */)((fd_set *)0),
...
#line 608
  b = fopen((char const   */* __restrict  */)((char const   *)(BOSHVARFILE)), (char const   */* __restrict  */)"r");
  }
#line 609
  if (b) {
    {
...
#line 191
  if (r) {
    {
#line 192
    memcpy((void */* __restrict  */)((void *)r), (void const   */* __restrict  */)((void const   *)(& n)),
           sizeof(int ));
    }
  }
#line 193
...
#line 252
  if (REPLY) {
    {
#line 253
    tmp___1 = strtol((char const   */* __restrict  */)((char const   *)REPLY), (char **/* __restrict  */)((char **)0),
                     10);
#line 253
    n = (int )tmp___1;
    }
...
#line 111
        v = (char *)tmp___9;
#line 112
        strcat((char */* __restrict  */)v, (char const   */* __restrict  */)((char const   *)(s)));
        }
      }
      while_break___3: /* CIL Label */ ;
      }
...
#line 82
  memcpy((void */* __restrict  */)(l->last)->data, (void const   */* __restrict  */)((void const   *)data),
         (size_t )size);
#line 83
  (l->last)->size = size;
#line 84
...
#line 139
  memcpy((void */* __restrict  */)((l->iter)->next)->data, (void const   */* __restrict  */)((void const   *)data),
         (size_t )size);
#line 140

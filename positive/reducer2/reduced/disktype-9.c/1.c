...
#line 156
    if (inbuf) {
      {
#line 157
      memcpy((void */* __restrict  */)inbuf, (void const   */* __restrict  */)((void const   *)mybuf),
             (size_t )len);
      }
    }
#line 158
...
#line 202
          tocopy = c->end - pos;
#line 203
          memcpy((void */* __restrict  */)mybuf, (void const   */* __restrict  */)((void const   *)(c->buf + (pos & (unsigned long long )((1 << 12) - 1)))),
                 (size_t )tocopy);
          }
        } else {
#line 205
...
#line 209
        if (tocopy) {
          {
#line 210
          memcpy((void */* __restrict  */)(mybuf + got), (void const   */* __restrict  */)((void const   *)c->buf),
                 (size_t )tocopy);
          }
        }
      }
...
#line 473
  memcpy((void */* __restrict  */)((void *)to), (void const   */* __restrict  */)((void const   *)((char *)from + 1)),
         (size_t )len);
#line 474
  *(to + len) = (char)0;
  }
...
#line 248
  ...
  {
#line 253
  memcpy((void */* __restrict  */)((void *)(uuid)), (void const   */* __restrict  */)((void const   *)(buf + 20)),
         (size_t )4);
#line 254
  memcpy((void */* __restrict  */)((void *)(uuid + 4)), (void const   */* __restrict  */)((void const   *)(buf + 52)),
         (size_t )12);
#line 255
...
#line 498
    if ((int )*(buf + 38) == 41) {
      {
#line 499
      memcpy((void */* __restrict  */)((void *)(s)), (void const   */* __restrict  */)((void const   *)(buf + 43)),
             (size_t )11);
#line 500
      s[11] = (char)0;
#line 501
...
#line 507
  if ((int )*(buf + 66) == 41) {
    {
#line 508
    memcpy((void */* __restrict  */)((void *)(s)), (void const   */* __restrict  */)((void const   *)(buf + 71)),
           (size_t )11);
#line 509
    s[11] = (char)0;
#line 510
...
#line 251
      memcpy((void */* __restrict  */)((void *)((*(vs->chunks + chunk))->bitmap)),
             (void const   */* __restrict  */)((void const   *)filebuf), (size_t )512);
      }
    }
  }
#line 255
...
#line 110
  {      & detect_vhd,      & detect_cdimage,      & detect_cloop,      & detect_udif, 
        ...
        & detect_compressed,      & detect_blank,      (void (*)(SECTION *section , int level ))((void *)0)};
#line 167
...
#line 290
      selresult = select(cs->nfds, (fd_set */* __restrict  */)(& read_set), (fd_set */* __restrict  */)((fd_set *)((void *)0)),

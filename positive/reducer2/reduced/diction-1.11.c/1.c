...
#line 987
  fputs((char const   */* __restrict  */)((char const   *)tmp), (FILE */* __restrict  */)handle);
  }
#line 992
  return;
}
...
#line 1075
    ...
    {
#line 1036
    tmp___3 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end),
                     10);
#line 1036
...
#line 1048
    ...
    {
#line 1053
    tmp___8 = strtod((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end___0));
#line 1053
...
#line 1081
    fputs((char const   */* __restrict  */)((char const   *)tmp___9), (FILE */* __restrict  */)stderr);
#line 1082
    exit(1);
    }
  } else
...
#line 1107
      ...
      {
#line 1110
      fp = fopen((char const   */* __restrict  */)((char const   *)*(argv + optind)),
...
#line 1121
    printf((char const   */* __restrict  */)((char const   *)tmp___17));
    }
  } else {
    {
#line 1130
...
#line 1130
    printf((char const   */* __restrict  */)((char const   *)tmp___18));
#line 1131
...
#line 1145
      printf((char const   */* __restrict  */)((char const   *)tmp___28));
      }
    } else
#line 1146
    if (lixg == 99) {
...
#line 1146
      printf((char const   */* __restrict  */)((char const   *)tmp___29));
      }
    } else {
      {
#line 1147
...
#line 1147
      printf((char const   */* __restrict  */)((char const   *)tmp___30), lixg);
      }
    }
    {
#line 1148
...
#line 1150
    printf((char const   */* __restrict  */)((char const   *)tmp___33));
#line 1151
    tmp___34 = gettext("        %d characters\n");
#line 1151
    printf((char const   */* __restrict  */)((char const   *)tmp___34), characters);
#line 1152
    tmp___35 = gettext("        %d words, average length %.2f characters = %.2f syllables\n");
#line 1152
    printf((char const   */* __restrict  */)((char const   *)tmp___35), words, (double )characters / (double )words,
           (double )syllables / (double )words);
#line 1153
    tmp___36 = gettext("        %d sentences, average length %.1f words\n");
#line 1153
    printf((char const   */* __restrict  */)((char const   *)tmp___36), sentences,
...
#line 1157
    printf((char const   */* __restrict  */)((char const   *)tmp___37), (100 * shortSent) / sentences,
...
#line 1160
    printf((char const   */* __restrict  */)((char const   *)tmp___38), (100 * longSent) / sentences,
           longSent, longLength);
#line 1161
    tmp___39 = gettext("        %d paragraphs, average length %.1f sentences\n");
#line 1161
    printf((char const   */* __restrict  */)((char const   *)tmp___39), paragraphs,
           (double )sentences / (double )paragraphs);
#line 1162
    tmp___40 = gettext("        %d%% (%d) questions\n");
#line 1162
    printf((char const   */* __restrict  */)((char const   *)tmp___40), (100 * questions) / sentences,
           questions);
#line 1163
    tmp___41 = gettext("        %d%% (%d) passive sentences\n");
#line 1163
    printf((char const   */* __restrict  */)((char const   *)tmp___41), (100 * passiveSent) / sentences,
           passiveSent);
#line 1164
    tmp___42 = gettext("        longest sent %d wds at sent %d; shortest sent %d wds at sent %d\n");
#line 1164
    printf((char const   */* __restrict  */)((char const   *)tmp___42), longestLength,
           longestLine, shortestLength, shortestLine);
#line 1181
    tmp___43 = gettext("word usage:\n");
#line 1181
    printf((char const   */* __restrict  */)((char const   *)tmp___43));
#line 1182
    tmp___44 = gettext("        verb types:\n");
#line 1182
    printf((char const   */* __restrict  */)((char const   *)tmp___44));
#line 1183
    tmp___45 = gettext("        to be (%d) auxiliary (%d) \n");
#line 1183
    printf((char const   */* __restrict  */)((char const   *)tmp___45), tobeVerbs,
           auxVerbs);
#line 1184
    tmp___46 = gettext("        types as %% of total:\n");
#line 1184
    printf((char const   */* __restrict  */)((char const   *)tmp___46));
#line 1185
    tmp___47 = gettext("        conjunctions %1.f% (%d) pronouns %1.f% (%d) prepositions %1.f% (%d)\n");
#line 1185
    printf((char const   */* __restrict  */)((char const   *)tmp___47), (100.0 * (double )(conjunctions + subConjunctions)) / (double )words,
...
#line 1190
    printf((char const   */* __restrict  */)((char const   *)tmp___48), (100.0 * (double )nominalizations) / (double )words,
           nominalizations);
#line 1193
    tmp___49 = gettext("sentence beginnings:\n");
#line 1193
    printf((char const   */* __restrict  */)((char const   *)tmp___49));
#line 1194
    tmp___50 = gettext("        pronoun (%d) interrogative pronoun (%d) article (%d)\n");
#line 1194
    printf((char const   */* __restrict  */)((char const   *)tmp___50), beginPronouns,
           beginInterrogativePronouns, beginArticles);
#line 1195
    tmp___51 = gettext("        subordinating conjunction (%d) conjunction (%d) preposition (%d)\n");
#line 1195
    printf((char const   */* __restrict  */)((char const   *)tmp___51), beginSubConjunctions,
           beginConjunctions, beginPrepositions);
    }
  }
  {
#line 1204
...
#line 198
  if (err) {
    {
#line 201
    tmp___4 = regerror(err, (regex_t const   */* __restrict  */)((regex_t const   *)(& hashLine)),
                       (char */* __restrict  */)(buf), sizeof(buf) - 1UL);
#line 201
    len = tmp___4;
#line 202
    buf[len] = (char )'\000';
...
#line 219
        fgets((char */* __restrict  */)(buf___0 + 1), (int )(sizeof(buf___0) - 1UL),
              (FILE */* __restrict  */)in);
#line 220
        tmp___7 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& hashLine)),
...
#line 220
        if (tmp___7 == 0) {
          {
#line 224
          tmp___6 = strtol((char const   */* __restrict  */)((char const   *)(buf___0 + found[1].rm_so)),
...
#line 226
          ...
          {
#line 227
          strncpy((char */* __restrict  */)(filebuf), (char const   */* __restrict  */)((char const   *)(buf___0 + found[2].rm_so)),
                  len___0);
#line 228

...
#line 165
      memcpy((void */* __restrict  */)((void *)(ifl->lladdr)), (void const   */* __restrict  */)((void const   *)(ifrp->ifr_ifru.ifru_hwaddr.sa_data)),
             sizeof(u_int8_t ) * 6UL);
#line 166
      strncpy((char */* __restrict  */)(ifl->name), (char const   */* __restrict  */)((char const   *)(ifrp->ifr_ifrn.ifrn_name)),
              (size_t )16);
#line 167
      ifl->name[15] = (char)0;
#line 168
...
#line 330
        if (ifa) {
          {
#line 331
          memcpy((void */* __restrict  */)((void *)(emap.lladdr)), (void const   */* __restrict  */)((void const   *)lladdr),
                 sizeof(u_int8_t ) * 6UL);
          }
#line 332
          if (only_ethers) {
...
#line 367
  ...
  {
#line 369
  memcpy((void */* __restrict  */)((void *)*ptr_p), (void const   */* __restrict  */)((void const   *)(ifl->lladdr)),
         (size_t )alen);
#line 370
  *ptr_p += alen;
  }
...
#line 387
  ...
  {
#line 393
  memcpy((void */* __restrict  */)((void *)*ptr_p), (void const   */* __restrict  */)((void const   *)(& laddr)),
         (size_t )4);
#line 394
  *ptr_p += 4;
  }
...
#line 419
  memcpy((void */* __restrict  */)((void *)(req.arp_ha.sa_data)), (void const   */* __restrict  */)((void const   *)lladdr),
         (size_t )lllen);
#line 420
  memcpy((void */* __restrict  */)((void *)(req.arp_dev)), (void const   */* __restrict  */)((void const   *)(ifl->name)),
         (size_t )16);
#line 422
...
#line 442
  ...
  {
#line 444
  tmp = recvfrom(fd, (void */* __restrict  */)((void *)(buf)), sizeof(buf), 64, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& sll)),
...
#line 491
  if (ifl) {
    {
#line 492
    strncpy((char */* __restrict  */)(tmpname), (char const   */* __restrict  */)((char const   *)(ifl->name)),
            (size_t )16);
#line 493
    tmpname[15] = (char)0;
    }
...
#line 565
  ptr += rmap->lladdr_len;
#line 566
  memcpy((void */* __restrict  */)((void *)ptr), (void const   */* __restrict  */)((void const   *)(& rmap->ipaddr)),
         (size_t )4);
#line 567
  ptr += 4;
#line 568
...
#line 660
    strncpy((char */* __restrict  */)(ifr.ifr_ifrn.ifrn_name), (char const   */* __restrict  */)((char const   *)ifname),
            (size_t )15);
#line 661

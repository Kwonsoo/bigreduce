...
#line 73
    rd = tmp;
#line 74
    memcpy((void */* __restrict  */)((void *)((outbuf + size) - rest)), (void const   */* __restrict  */)((void const   *)(rdec->buffer + rdec->pos)),
           (size_t )rd);
#line 75
    rdec->pos += rd;
#line 76
...
#line 207
      strcpy((char */* __restrict  */)output_filename, (char const   */* __restrict  */)((char const   *)name));
#line 208
      tmp___2 = strlen((char const   *)name);
#line 208
      tmp___3 = strlen(from);
#line 208
      strcpy((char */* __restrict  */)((output_filename + tmp___2) - tmp___3), (char const   */* __restrict  */)((char const   *)known_extensions[i].to));
      }
#line 210
      return;
    }
...
#line 317
      if (verbosity >= 0) {
        {
#line 318
        Pp_show_msg(pp, (char const   */* const  */)((char const   *)0));
#line 319
...
#line 337
    tmp___7 = Rd_member_position((struct Range_decoder  const  */* const  */)((struct Range_decoder  const  *)(& rdec)));
#line 337
...
#line 495
  ...
  {
#line 497
  tmp___7 = ap_arguments((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
  }
#line 497
  if (1 >= tmp___7 - argind) {
#line 497
    ...
    {
#line 497
    tmp___6 = ap_arguments((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
#line 497
...
#line 501
  while (1) {
    ...
    {
#line 501
    tmp___10 = ap_arguments((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)));
    }
#line 501
...
#line 501
    ...
    {
#line 503
    *(filenames + i) = ap_argument((struct Arg_parser  const  */* const  */)((struct Arg_parser  const  *)(& parser)),
                                   (int const   )(argind + i));
#line 504
...
#line 309
    if (len <= tmp___0) {
      {
#line 312
      memcpy((void */* __restrict  */)((void *)(decoder->buffer + decoder->pos)),
             (void const   */* __restrict  */)((void const   *)(decoder->buffer + i)),
             (size_t )len);
#line 313
      decoder->pos += len;
      }
...
#line 108
  if (size > 0) {
    {
#line 110
    CRC32_update_buf(& decoder->crc, (uint8_t const   */* const  */)((uint8_t const   *)(decoder->buffer + decoder->stream_pos)),
                     (int const   )size);
    }
#line 111
    if (decoder->outfd >= 0) {
      {
#line 111
      tmp___0 = writeblock((int const   )decoder->outfd, (uint8_t const   */* const  */)((uint8_t const   *)(decoder->buffer + decoder->stream_pos)),
                           (int const   )size);
      }
#line 111
      if (tmp___0 != size) {
...
#line 125
  trailer_size = tmp;
#line 126
  tmp___0 = Rd_member_position((struct Range_decoder  const  */* const  */)((struct Range_decoder  const  *)decoder->range_decoder));
#line 126
...
#line 142
  if (decoder->member_version == 0) {
    {
#line 142
    Ft_set_member_size(trailer, member_size);
    }
  }
#line 143
...
#line 148
  tmp___6 = LZd_crc((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
  }
#line 148
  if (tmp___5 != tmp___6) {
#line 150
...
#line 153
      Pp_show_msg(pp, (char const   */* const  */)((char const   *)0));
#line 154
      tmp___3 = LZd_crc((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 154
...
#line 158
  tmp___11 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
  }
#line 158
...
#line 163
      Pp_show_msg(pp, (char const   */* const  */)((char const   *)0));
#line 164
      tmp___7 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 164
      tmp___8 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 164
...
#line 178
    if (pp->verbosity >= 3) {
      {
#line 178
      tmp___17 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
      }
#line 178
      if (tmp___17 > 0ULL) {
#line 178
        if (member_size > 0ULL) {
          {
#line 179
          tmp___14 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 179
          tmp___15 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 179
          tmp___16 = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 179
...
#line 204
    ...
    {
#line 206
    tmp = LZd_data_position((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 206
...
#line 207
    if (tmp___21 == 0) {
      {
#line 209
      tmp___0 = LZd_get_prev_byte((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder));
#line 209
      prev_byte = tmp___0;
#line 210
...
#line 218
        state -= tmp___4;
#line 219
        tmp___5 = LZd_get_byte((struct LZ_decoder  const  */* const  */)((struct LZ_decoder  const  *)decoder),
                               (int const   )rep0);
#line 219

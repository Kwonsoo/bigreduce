...
#line 417
        ...
        {
#line 419
        strcpy((char */* __restrict  */)((char *)(startlabel)), (char const   */* __restrict  */)((char const   *)(optarg + 1)));
        }
      }
    } else {
      {
...
#line 440
    ...
    {
#line 442
    strncpy((char */* __restrict  */)(speccy_filename), (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )10);
#line 443
...
#line 444
    ...
    {
#line 446
    strcpy((char */* __restrict  */)(outfile), (char const   */* __restrict  */)((char const   *)optarg));
    }
#line 447
    goto switch_break;
    case_114: 
...
#line 486
  if (optind == argc - 1) {
    {
#line 487
    strcpy((char */* __restrict  */)(infile), (char const   */* __restrict  */)((char const   *)*(argv + optind)));
    }
  }
#line 488
  return;
...
#line 547
  if (tmp != 0) {
    {
#line 547
    in = fopen((char const   */* __restrict  */)((char const   *)(infile)), (char const   */* __restrict  */)"r");
    }
#line 547
...
#line 566
    while (1) {
      ...
      {
#line 566
      tmp___75 = fgets((char */* __restrict  */)((char *)(buf + 1)), (int )(sizeof(buf) - 1UL),
                       (FILE */* __restrict  */)in);
      }
#line 566
...
#line 582
        f = (int )(tmp___3 - 1UL);
#line 583
        fgets((char */* __restrict  */)((char *)(buf + f)), (int )(sizeof(buf) - (unsigned long )f),
              (FILE */* __restrict  */)in);
#line 584
        textlinenum ++;
#line 585
...
#line 616
        ...
        {
#line 618
        tmp___11 = strtol((char const   */* __restrict  */)((char const   *)ptr),
                          (char **/* __restrict  */)((char **)(& linestart)), 10);
#line 618
...
#line 661
            labelend ++;
#line 661
            strcpy((char */* __restrict  */)((char *)(labels[tmp___15])), (char const   */* __restrict  */)((char const   *)(linestart + 1)));
            }
#line 662
            if (labelend >= 2000) {
              {
...
#line 808
                sprintf((char */* __restrict  */)((char *)(numbuf)), (char const   */* __restrict  */)"%d",
                        label_lines[f]);
#line 809
...
#line 813
                memcpy((void */* __restrict  */)((void *)ptr), (void const   */* __restrict  */)((void const   *)(numbuf)),
                       (size_t )len);
#line 814
                ptr += len;
                }
...
#line 874
            ...
            {
#line 877
            num_ascii = strtoul((char const   */* __restrict  */)((char const   *)(ptr + 2)),
...
#line 911
                    if ((int )*(ptr + -1) != 196) {
                      {
#line 913
                      num = strtod((char const   */* __restrict  */)((char const   *)ptr),
                                   (char **/* __restrict  */)((char **)(& ptr2)));
                      }
                    } else {
                      {
#line 920
...
#line 921
                    ...
                    {
#line 925
                    memcpy((void */* __restrict  */)((void *)outptr), (void const   */* __restrict  */)((void const   *)ptr),
                           (size_t )(ptr2 - ptr));
#line 926
                    outptr += ptr2 - ptr;
#line 928
...
#line 965
      memcpy((void */* __restrict  */)((void *)fileptr), (void const   */* __restrict  */)((void const   *)(outbuf)),
             (size_t )linelen);
#line 966
      fileptr += linelen;
      }
...
#line 997
  if (tmp___77 != 0) {
    {
#line 997
    out = fopen((char const   */* __restrict  */)((char const   *)(outfile)), (char const   */* __restrict  */)"wb");
    }
#line 997
...
#line 1006
    ...
    {
#line 1008
    strncpy((char */* __restrict  */)((char *)(headerbuf + 1)), (char const   */* __restrict  */)((char const   *)(speccy_filename)),
            (size_t )10);
#line 1009
...
#line 1018
    ...
    {
#line 1019
    fwrite((void const   */* __restrict  */)((void const   *)(headerbuf)), (size_t )1,
           (size_t )17, (FILE */* __restrict  */)out);
#line 1020
    fputc(chk, out);
#line 1023
    chk = 255;
...
#line 1024
  ...
  {
#line 1027
  fwrite((void const   */* __restrict  */)((void const   *)(filebuf)), (size_t )1,
         (size_t )(fileptr - filebuf), (FILE */* __restrict  */)out);
  }
#line 1029
  if (output_tap) {
    {

...
#line 107
    length = vsnprintf((char */* __restrict  */)(buffer), (size_t )1000, (char const   */* __restrict  */)((char const   *)fmt),
                       argp);
#line 108
...
#line 346
      buffer[1] = (char )'\000';
#line 347
      strcat((char */* __restrict  */)retval, (char const   */* __restrict  */)((char const   *)(buffer)));
#line 348
      used ++;
      }
    } else {
...
#line 351
      strcat((char */* __restrict  */)retval, (char const   */* __restrict  */)((char const   *)prefix));
#line 352
      strcat((char */* __restrict  */)retval, (char const   */* __restrict  */)((char const   *)(buffer)));
#line 353
      strcat((char */* __restrict  */)retval, (char const   */* __restrict  */)((char const   *)suffix));
#line 354
...
#line 492
    ...
    {
#line 494
    strncat((char */* __restrict  */)result, (char const   */* __restrict  */)((char const   *)start),
            (size_t )(end - start));
#line 495
...
#line 517
    ...
    {
#line 518
    strcat((char */* __restrict  */)result, (char const   */* __restrict  */)((char const   *)encvariable));
#line 519
...
#line 526
  ...
  {
#line 527
  strcat((char */* __restrict  */)result, (char const   */* __restrict  */)((char const   *)start));
#line 528
...
#line 640
  ...
  {
#line 643
  tmp___2 = fwrite((void const   */* __restrict  */)((void const   *)buf), (size_t )sizeof(char ),
                   (size_t )towrite, (FILE */* __restrict  */)to);
#line 643
  written = (int )tmp___2;
#line 644
  free((void *)buf);
...
#line 707
    ...
    {
#line 708
    strcat((char */* __restrict  */)result___1, (char const   */* __restrict  */)((char const   *)(buffer)));
#line 697
    i ++;
    }
  }
...
#line 745
  fseek(file, 0L, 0);
#line 746
  fread((void */* __restrict  */)((void *)(header)), (size_t )sizeof(char ), (size_t )10,
...
#line 751
  buffer = (char *)tmp;
#line 752
  tmp___0 = fread((void */* __restrict  */)((void *)buffer), (size_t )sizeof(char ),
                  (size_t )size, (FILE */* __restrict  */)file);
  }
#line 752
  if (size != (int )tmp___0) {
    {
...
#line 771
    if ((int )version > 2) {
      {
#line 772
      memcpy((void */* __restrict  */)((void *)(header)), (void const   */* __restrict  */)((void const   *)(buffer + readsize)),
             (size_t )10);
#line 773
      readsize += 10;
#line 774
...
#line 845
    ...
    {
#line 842
    tmp___1 = fread((void */* __restrict  */)((void *)(buf)), (size_t )sizeof(char ),
                    (size_t )6, (FILE */* __restrict  */)file);
    }
#line 842
    if (tmp___1 != 6U) {
#line 845
...
#line 845
        ...
        {
#line 847
        tmp = fread((void */* __restrict  */)((void *)(buf)), (size_t )sizeof(char ),
                    (size_t )4, (FILE */* __restrict  */)file);
        }
#line 847
        if (tmp != 4U) {
#line 848
...
#line 873
    ...
    {
#line 870
    tmp___0 = fread((void */* __restrict  */)((void *)(buf)), (size_t )sizeof(char ),
                    (size_t )3, (FILE */* __restrict  */)file);
    }
#line 870
    if (tmp___0 != 3U) {
#line 873
...
#line 918
    header <<= 8;
#line 919
    tmp___0 = fread((void */* __restrict  */)((void *)(& header)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)file);
    }
#line 919
    if (! tmp___0) {
...
#line 926
    header <<= 8;
#line 927
    tmp___1 = fread((void */* __restrict  */)((void *)(& header)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)file);
    }
#line 927
    if (! tmp___1) {
...
{ 
  ...
  {
#line 1032
  file = fopen((char const   */* __restrict  */)((char const   *)entry->path), (char const   */* __restrict  */)"r");
  }
#line 1032
...
#line 80
  tmp___1 = fread((void */* __restrict  */)((void *)buf), (size_t )sizeof(char ),
                  (size_t )tmp___0, (FILE */* __restrict  */)from);
#line 80
  amount = (int )tmp___1;
#line 82
  tmp___2 = ferror(from);
...
#line 106
  if (! ((int )cconf___0->mode & 2)) {
    {
#line 107
    tmp = fwrite((void const   */* __restrict  */)((void const   *)buf), (size_t )sizeof(char ),
                 (size_t )amount, (FILE */* __restrict  */)cconf___0->stream);
    }
#line 107
...
#line 111
      ...
      {
#line 112
      tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)(buf + written)),
                       (size_t )sizeof(char ), (size_t )towrite, (FILE */* __restrict  */)cconf___0->stream);
      }
#line 112
...
#line 126
      if ((int )hexbuf[0] == 0) {
        {
#line 128
        strncpy((char */* __restrict  */)pos, (char const   */* __restrict  */)((char const   *)current),
                (size_t )3);
#line 129
        pos += 2;
        }
...
#line 130
          ...
          {
#line 131
          tmp___1 = strtol((char const   */* __restrict  */)((char const   *)(hexbuf)),
                           (char **/* __restrict  */)((char **)((void *)0)), 16);
#line 131
          hexval = (int )tmp___1;
          }
#line 131
...
#line 334
              if ((int const   )*(*tmp___34 + (int )line[start]) & 2048) {
                {
#line 335
                cconf___0->startpos = strtol((char const   */* __restrict  */)((char const   *)(& line[start])),
...
#line 351
              if ((int const   )*(*tmp___35 + (int )*tmp) & 2048) {
                {
#line 352
                cconf___0->endpos = strtol((char const   */* __restrict  */)((char const   *)tmp),
...
#line 258
            ...
            {
#line 256
            tmp___16 = strtol((char const   */* __restrict  */)((char const   *)(& line[start])),
...
#line 413
  file = fopen((char const   */* __restrict  */)((char const   *)gconf.htmlfile),
...
#line 435
      strcat((char */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)(line)));
      }
#line 436
...
#line 588
  ...
  {
#line 545
  tmp___2 = strtol((char const   */* __restrict  */)((char const   *)tmp), (char **/* __restrict  */)((char **)((void *)0)),
                   10);
#line 545
  i = (int )tmp___2;
  }
...
#line 547
  ...
  {
#line 549
  tmp___3 = strtod((char const   */* __restrict  */)((char const   *)tmp), (char **/* __restrict  */)((char **)((void *)0)));
#line 549
  f = (float )tmp___3;
  }
#line 549
...
#line 628
    ...
    {
#line 630
    file = fopen((char const   */* __restrict  */)((char const   *)gconf.conffile),
                 (char const   */* __restrict  */)"r");
    }
  }
#line 632
...
#line 721
    ...
    {
#line 687
    tmp___0 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)((void *)0)),
                     10);
    }
#line 687
    if (tmp___0 > 0L) {
      {
#line 688
      tmp = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)((void *)0)),
                   10);
#line 688
      gconf.port = (int )tmp;
      }
...
#line 692
    ...
    {
#line 694
    tmp___2 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)((void *)0)),
                     10);
    }
#line 694
    if (tmp___2 > 0L) {
      {
#line 695
      tmp___1 = strtol((char const   */* __restrict  */)((char const   *)optarg),
                       (char **/* __restrict  */)((char **)((void *)0)), 10);
#line 695
...
#line 711
      ...
      {
#line 710
      tmp___4 = strtol((char const   */* __restrict  */)((char const   *)optarg),
                       (char **/* __restrict  */)((char **)((void *)0)), 10);
      }
#line 710
      if (tmp___4 < 0L) {
#line 711
        ...
        {
#line 713
        tmp___3 = strtol((char const   */* __restrict  */)((char const   *)optarg),
                         (char **/* __restrict  */)((char **)((void *)0)), 10);
#line 713
...
#line 537
    to = (mp3entry *)tmp;
#line 538
    memcpy((void */* __restrict  */)((void *)to), (void const   */* __restrict  */)((void const   *)from),
           (size_t )sizeof(mp3entry ));
#line 539
...
#line 545
      memcpy((void */* __restrict  */)((void *)to->name), (void const   */* __restrict  */)((void const   *)from->name),
             (size_t )towrite);
#line 546
      written += towrite;
#line 547
...
#line 553
      memcpy((void */* __restrict  */)((void *)to->path), (void const   */* __restrict  */)((void const   *)from->path),
             (size_t )towrite);
#line 554
      written += towrite;
#line 555
...
#line 561
      memcpy((void */* __restrict  */)((void *)to->title), (void const   */* __restrict  */)((void const   *)from->title),
             (size_t )towrite);
#line 562
      written += towrite;
#line 563
...
#line 695
  retval = -1;
#line 697
  tmp___1 = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& statbuf));
  }
#line 697
  if (tmp___1) {
    {
...
{ 
  ...
  {
#line 880
  m3u = fopen((char const   */* __restrict  */)((char const   *)path), (char const   */* __restrict  */)"r");
  }
#line 880
  if (! m3u) {
    {
...
#line 96
    nextchunk(& tmp, chunk);
#line 97
    strcat((char */* __restrict  */)buffer, (char const   */* __restrict  */)((char const   *)(chunk)));
    }
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 135
  tmp___0 = getsockname(sock, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& address)),
                        (socklen_t */* __restrict  */)((socklen_t *)(& socklen)));
  }
#line 135
  if (tmp___0 < 0) {
    {
...
#line 177
  tmp ++;
#line 178
  tmp___1 = strtol((char const   */* __restrict  */)((char const   *)(buffer)), (char **/* __restrict  */)((char **)((void *)0)),
                   10);
#line 178
...
#line 411
      ...
      {
#line 411
      conn = select(tmp + 1, (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 513
  ...
  {
#line 516
  sigprocmask(0, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& chld)),
...
#line 524
    num_clients -= (int volatile   )1;
#line 525
    sigprocmask(1, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& chld)),
                (sigset_t */* __restrict  */)((sigset_t *)((void *)0)));
    }
#line 526
    return (0);

...
#line 646
    tmp___1 = stat((char const   */* __restrict  */)((char const   *)(curFilename)),
...
#line 712
      curFilename[curFilenameLen] = (char )'\000';
#line 714
      tmp___10 = stat((char const   */* __restrict  */)((char const   *)(curFilename)),
                      (struct stat */* __restrict  */)(& sb));
      }
#line 714
      if (tmp___10 == -1) {
...
#line 867
          snprintf((char */* __restrict  */)(self), sizeof(self), (char const   */* __restrict  */)"%s/%s",
                   it, invocation);
#line 868
          tmp___1 = stat((char const   */* __restrict  */)((char const   *)(self)),
                         (struct stat */* __restrict  */)(& sb));
          }
#line 868
          if (tmp___1 == -1) {
...
#line 873
          ...
          {
#line 866
          it = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":");
          }
        }
        while_break___0: /* CIL Label */ ;
        }

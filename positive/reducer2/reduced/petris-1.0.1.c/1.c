...
#line 184
  memcpy((void */* __restrict  */)((void *)(tmp_well + (start + 4) * coords.well_width)),
         (void const   */* __restrict  */)((void const   *)(well_data + (start + 4) * coords.well_width)),
...
#line 193
    if (! ((int )line_stat & (int )tmp)) {
      {
#line 194
      memcpy((void */* __restrict  */)((void *)(tmp_well + ((start + y) + lines) * coords.well_width)),
             (void const   */* __restrict  */)((void const   *)(well_data + (start + y) * coords.well_width)),
...
#line 192
  ...
  {
#line 204
  memcpy((void */* __restrict  */)((void *)(tmp_well + lines * coords.well_width)),
         (void const   */* __restrict  */)((void const   *)well_data), (size_t )(coords.well_width * start));
#line 206
  memcpy((void */* __restrict  */)((void *)well_data), (void const   */* __restrict  */)((void const   *)tmp_well),
...
#line 35
  ...
  {
#line 39
  items = fread((void */* __restrict  */)((void *)(hs_list)), sizeof(hs_entry ), (size_t )10,
...
#line 57
  ...
  {
#line 60
  fwrite((void const   */* __restrict  */)((void const   *)(hs_list)), sizeof(hs_entry ),
         (size_t )10, (FILE */* __restrict  */)file);
#line 62
  fclose(file);
  }
#line 63
...
#line 71
    ...
    {
#line 72
    strncpy((char */* __restrict  */)(hs_list[i].name), (char const   */* __restrict  */)((char const   *)(hs_list[i - 1].name)),
...
#line 78
  strncpy((char */* __restrict  */)(hs_list[index___0].name), (char const   */* __restrict  */)((char const   *)name),
...
#line 32
  tmp = strtol((char const   */* __restrict  */)((char const   *)size), (char **/* __restrict  */)(& endptr),
               10);
#line 32
...
#line 36
  ...
  {
#line 39
  tmp___0 = strtol((char const   */* __restrict  */)((char const   *)(endptr + 1)),

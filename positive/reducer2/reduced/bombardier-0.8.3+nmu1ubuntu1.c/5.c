...
#line 38
    wrefresh(stdscr);
#line 39
    select(1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 30
  rh((unsigned int )((int )((state___0->city * 400U) / (state___0->city + 1U)) + 500),
     (unsigned char)0, (unsigned char)20, state___0->houses, & state___0->blocks);
#line 31
...
#line 31
      if (state___0->houses_text[state___0->bombx] == -1) {
        {
#line 32
        state___0->houses_text[state___0->bombx] = seltext(state___0->houses_text,
...
#line 38
      if (state___0->houses_text[state___0->bombx] != -1) {
        {
#line 39
        asprintf((char **/* __restrict  */)(& state___0->text), (char const   */* __restrict  */)((char const   *)(texts___0 + state___0->houses_text[state___0->bombx])->text));
        }
      }
#line 40
...
#line 20
    tmp___4 = gy((int )i + 6);
#line 20
    mvprintw(tmp___4, tmp___3, "| %d. | %-20s | %10s | %7d |", (int )i + 1, *(names + (int )i),
             *(dates + (int )i), *(scores + (int )i));
#line 19
...
#line 93
        gerase();
#line 94
        strncpy((char */* __restrict  */)(names[(int )numoffame + (int )shift]), (char const   */* __restrict  */)((char const   *)line),
                (size_t )20);
#line 95
        strncpy((char */* __restrict  */)(dates[(int )numoffame + (int )shift]), (char const   */* __restrict  */)((char const   *)(line + 21)),
                (size_t )10);
#line 96
...
#line 98
        sscanf((char const   */* __restrict  */)((char const   *)(line + 32)), (char const   */* __restrict  */)"%d",
...
#line 101
            if ((int )numoffame < 8) {
              {
#line 103
              strcpy((char */* __restrict  */)(names[(int )numoffame + 1]), (char const   */* __restrict  */)((char const   *)(names[numoffame])));
#line 104
              strcpy((char */* __restrict  */)(dates[(int )numoffame + 1]), (char const   */* __restrict  */)((char const   *)(dates[numoffame])));
#line 105
...
#line 109
            tmp = ascdate();
#line 109
            strcpy((char */* __restrict  */)(dates[numoffame]), (char const   */* __restrict  */)((char const   *)tmp));
#line 110
...
#line 121
          tmp___0 = ascdate();
#line 121
          strcpy((char */* __restrict  */)(dates[numoffame]), (char const   */* __restrict  */)((char const   *)tmp___0));
#line 122
          strcpy((char */* __restrict  */)(names[numoffame]), (char const   */* __restrict  */)"Someone");
#line 123
          numoffame = (unsigned char )((int )numoffame + 1);
...
#line 139
        fsync(fd);
#line 140
        tmp___1 = printhof(names, dates, scores, numoffame, nowres, state___0->score);
#line 140
        strcpy((char */* __restrict  */)(names[(int )nowres - 1]), (char const   */* __restrict  */)((char const   *)tmp___1));
#line 142
        i = (unsigned char)0;
        }
        {
...
#line 158
        close(fd);
#line 159
        printhof(names, dates, scores, numoffame, nowres, state___0->score);
        }
      }
    } else {
      {

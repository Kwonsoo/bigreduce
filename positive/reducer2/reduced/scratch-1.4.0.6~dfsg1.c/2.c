...
#line 34
  ...
  {
#line 35
  strcat((char */* __restrict  */)(cmd), (char const   */* __restrict  */)((char const   *)url));
#line 36
...
#line 58
  ...
  {
#line 60
  strncat((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)s),
          (size_t )maxPath);
  }
#line 62
  if (folderID == 1) {
...
#line 97
      strncat((char */* __restrict  */)bsdPath, (char const   */* __restrict  */)"/dev/",
              (size_t )maxPathSize);
#line 98
      strncat((char */* __restrict  */)bsdPath, (char const   */* __restrict  */)((char const   *)(entryPtr->d_name)),
              (size_t )maxPathSize);
#line 99
      closedir(dirPtr);
      }

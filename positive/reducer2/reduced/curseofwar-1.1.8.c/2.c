...
#line 75
  tmp = recvfrom(sfd, (void */* __restrict  */)((void *)(buf)), (size_t )49999, 0,
...
#line 84
    if ((unsigned long )(nread - 1) >= sizeof(struct msg_s_data )) {
      {
#line 85
      memcpy((void */* __restrict  */)((void *)(& msg_data)), (void const   */* __restrict  */)((void const   *)(buf + 1)),
...
#line 171
  buf___0[0] = msg;
#line 172
  memcpy((void */* __restrict  */)((void *)(buf___0 + 1)), (void const   */* __restrict  */)((void const   *)(& mcd)),
         sizeof(mcd));
#line 173
...
#line 52
    if ((int )s2->sa_family == 10) {
      {
#line 52
      tmp = eq_6_addr(((struct sockaddr_in6 *)s1)->sin6_addr.__in6_u.__u6_addr8, ((struct sockaddr_in6 *)s2)->sin6_addr.__in6_u.__u6_addr8);
      }
#line 52
      if (tmp) {
        _L: 
...
#line 83
  s = getaddrinfo((char const   */* __restrict  */)((char const   *)((void *)0)),
                  (char const   */* __restrict  */)((char const   *)str_port), (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
...
#line 130
  s = getaddrinfo((char const   */* __restrict  */)((char const   *)((void *)0)),
                  (char const   */* __restrict  */)((char const   *)str_my_port),
...
#line 168
  hints.ai_protocol = 0;
#line 170
  s = getaddrinfo((char const   */* __restrict  */)((char const   *)str_server_addr),
                  (char const   */* __restrict  */)((char const   *)str_server_port),
                  (struct addrinfo  const  */* __restrict  */)((struct addrinfo  const  *)(& hints)),
                  (struct addrinfo **/* __restrict  */)(& result));
  }
#line 171
...
#line 257
      ...
      {
#line 260
      nread = recvfrom(sfd, (void */* __restrict  */)((void *)(buf___2)), (size_t )49999,
                       0, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& peer_addr)),
                       (socklen_t */* __restrict  */)(& peer_addr_len));
#line 263
      tmp___1 = server_get_msg(buf___2, (int )nread);
      }
#line 263
      if (tmp___1 > 0) {
#line 265
...
#line 305
        if (found_i > -1) {
          {
#line 306
          tmp___4 = server_process_msg_c(buf___2, (int )nread, st, cl[found_i].pl);
#line 306
          msg = tmp___4;
          }
#line 307
...
#line 362
    endptr = (char *)((void *)0);
#line 363
    tmp___6 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr),
                     10);
    }
#line 363
    if (14L < tmp___6) {
      {
#line 363
      tmp___5 = strtol((char const   */* __restrict  */)((char const   *)optarg),
                       (char **/* __restrict  */)(& endptr), 10);
#line 363
      w_val = (int )tmp___5;
      }
    } else {
...
#line 371
    tmp___9 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr___0),
                     10);
    }
#line 371
    if (14L < tmp___9) {
      {
#line 371
      tmp___8 = strtol((char const   */* __restrict  */)((char const   *)optarg),
                       (char **/* __restrict  */)(& endptr___0), 10);
#line 371
      h_val = (int )tmp___8;
      }
    } else {
...
#line 379
    tmp___10 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr___1),
                      10);
#line 379
...
#line 387
    tmp___11 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr___2),
                      10);
#line 387
    l_val = (int )tmp___11;
    }
...
#line 395
    tmp___12 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr___3),
                      10);
#line 395
...
#line 404
    tmp___13 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr___4),
                      10);
#line 404
...
#line 449
    tmp___41 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& endptr___5),
                      10);
#line 449
...
#line 509
  tmp___43 = sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& newhandler)),
...
#line 561
  setitimer(0, (struct itimerval  const  */* __restrict  */)((struct itimerval  const  *)(& it)),
            (struct itimerval */* __restrict  */)((struct itimerval *)((void *)0)));
#line 563
  wrefresh(stdscr);
#line 564
...
#line 601
    ...
    {
#line 602
    tmp = fread((void */* __restrict  */)((void *)(buf___2)), (size_t )1, (size_t )1,
...
#line 630
  while (1) {
    ...
    {
#line 630
    tmp___2 = fread((void */* __restrict  */)((void *)(buf___2)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)stdin);
    }
#line 630
    if (! (tmp___2 == 1UL)) {
...
#line 60
  memcpy((void */* __restrict  */)((void *)(buf___1 + 1)), (void const   */* __restrict  */)((void const   *)(& msg_data___0)),
         (size_t )size);
#line 61
  n_to_send = size + 1;
#line 65
...
#line 102
    msg = *(buf___2 + 0);
#line 103
    memcpy((void */* __restrict  */)((void *)(& msg_data___1)), (void const   */* __restrict  */)((void const   *)(buf___2 + 1)),

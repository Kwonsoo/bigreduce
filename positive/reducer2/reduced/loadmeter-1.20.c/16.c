...
#line 124
    display = (char *)tmp;
#line 125
    strncpy((char */* __restrict  */)display, (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )val.size);
    }
  }
  {
...
#line 151
  if (tmp___3) {
    {
#line 153
    strncpy((char */* __restrict  */)(buffer), (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )((int )val.size));
#line 154
...
#line 163
    strncpy((char */* __restrict  */)labelfont, (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )val.size);
    }
  }
  {
...
#line 168
    strncpy((char */* __restrict  */)namefont, (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )val.size);
    }
  }
  {
...
#line 173
    strncpy((char */* __restrict  */)popupfont, (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )val.size);
    }
  }
  {
...
#line 177
    label = (char *)tmp___10;
#line 178
    strncpy((char */* __restrict  */)label, (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )val.size);
    }
  }
  {
...
#line 180
  if (tmp___13) {
    {
#line 182
    tmp___12 = sscanf((char const   */* __restrict  */)((char const   *)val.addr),
                      (char const   */* __restrict  */)"%i", (unsigned int *)(& parent));
    }
#line 182
    if (tmp___12 == 0) {
#line 183
...
#line 214
    name = (char *)tmp___19;
#line 215
    strncpy((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)val.addr),
            (size_t )val.size);
    }
  }
  {
...
#line 330
    ...
    {
#line 333
    win = MakePopup((int )x, (int )y, width, height, (unsigned int )grey.pixel, 0);
    }
  }
  {
#line 336
...
#line 442
  do_loop(1);
#line 443
  dobevels(win, 0, 0, (int )width, (int )height, tgc, bgc);
#line 445
  mask = 0UL;
  }
  {
...
#line 457
  while (1) {
    ...
    {
#line 459
    setitimer(0, (struct itimerval  const  */* __restrict  */)((struct itimerval  const  *)(& timval)),
              (struct itimerval */* __restrict  */)((struct itimerval *)0));
#line 460
...
#line 77
    uname(host);
#line 78
    strcpy((char */* __restrict  */)(hostname), (char const   */* __restrict  */)((char const   *)(host->nodename)));
#line 79
    free((void *)host);
    }
  } else {
    {
#line 82
    strcpy((char */* __restrict  */)(hostname), (char const   */* __restrict  */)((char const   *)label));
    }
  }
#line 83
  return;
...
#line 109
  sscanf((char const   */* __restrict  */)((char const   *)(buf___2)), (char const   */* __restrict  */)"%lf %lf %lf %d/%d",
...
#line 129
  sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%lf",
         & uptime);
#line 131
...
#line 141
    strcat((char */* __restrict  */)ut, (char const   */* __restrict  */)((char const   *)(buf)));
    }
  }
#line 143
...
#line 69
  checkgeom(& x, & y, (int *)(& pwidth), (int *)(& pheight));
#line 70
  popup = MakePopup(x, y, pwidth, pheight, (unsigned int )popbg.pixel, 0);
#line 72
...
#line 127
    if (highlight == which + 1) {
      {
#line 128
      dobevels(popup, 1, yt, (int )(pwidth - 2U), ht, poptgc, popbgc);
      }
    }
    {
#line 130
...
#line 148
  dobevels(popup, 0, 0, (int )pwidth, (int )pheight, poptgc, popbgc);
#line 149
  hprev = highlight;
#line 150
  XSync(disp, 0);
...
#line 283
  dobevels(info, wd, (int )(y - (unsigned int )pfont->max_bounds.ascent), ow, h, popbgc,
           poptgc);
#line 285
...
#line 288
  dobevels(info, 0, 0, (int )width___0, (int )height___0, poptgc, popbgc);
#line 289
  XSync(disp, 0);
  }
#line 290

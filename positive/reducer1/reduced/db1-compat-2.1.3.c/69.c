...
#line 792
    key->data = (void *)((u_char *)(hashp->cpage)->page + (int )*(bp + (int )ndx));
#line 793
    if ((int )ndx > 1) {
#line 793
...
#line 793
    key->size = (size_t )(tmp___5 - (int )*(bp + (int )ndx));
#line 794
    data->data = (void *)((u_char *)(hashp->cpage)->page + (int )*(bp + ((int )ndx + 1)));
#line 795
    data->size = (size_t )((int )*(bp + (int )ndx) - (int )*(bp + ((int )ndx + 1)));
#line 796
...
#line 349
      cino = (char *)ino;
#line 350
      key.data = (void *)((u_char *)cino + (int )*(ino + (int )n));
#line 351
      key.size = (size_t )((int )off - (int )*(ino + (int )n));
#line 352
      val.data = (void *)((u_char *)cino + (int )*(ino + ((int )n + 1)));
#line 353
      val.size = (size_t )((int )*(ino + (int )n) - (int )*(ino + ((int )n + 1)));
#line 354
      off = *(ino + ((int )n + 1));
#line 356
...
#line 866
  sigfillset(& set);
#line 867
  sigprocmask(0, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& set)),
...
#line 259
  if (a->size < b->size) {
#line 259
    tmp___2 = (size_t )(a->size + 1UL);
  } else {
#line 259
    tmp___2 = (size_t )a->size;
  }
#line 259
  return (tmp___2);
}
...
#line 624
  n = (u_int16_t )((int )n + 1);
#line 624
  *(tp + (int )n) = (u_int16_t )addr;
#line 625
  n = (u_int16_t )((int )n + 1);
#line 625
  *(tp + (int )n) = (u_int16_t )0;
#line 626
  *(tp + 0) = n;
#line 627
  *(tp + ((int )*(tp + 0) + 2)) = off;
...
#line 203
    ...
    {
#line 193
    tmp___3 = freopen((char const   */* __restrict  */)((char const   *)optarg), (char const   */* __restrict  */)"w",

...
__inline extern void ( __attribute__((__artificial__, __always_inline__)) error)(int __status ,
                                                                                 int __errnum ,
                                                                                 char const   *__format 
                                                                                 , ...) ;
#line 35
__inline extern void ( __attribute__((__artificial__, __always_inline__)) error_at_line)(int __status ,
                                                                                         int __errnum ,
                                                                                         char const   *__fname ,
                                                                                         unsigned int __line ,
                                                                                         char const   *__format 
...
#line 164
  ...
  {
#line 165
  tmp___0 = strtoul((char const   */* __restrict  */)((char const   *)(p + 1)), (char **/* __restrict  */)((char **)((void *)0)),
                    10);
  }
#line 165
  return (tmp___0);
...
#line 193
    p ++;
#line 194
    res = strtoul((char const   */* __restrict  */)((char const   *)p), (char **/* __restrict  */)(& endptr),
                  10);
    }
#line 195
...
#line 249
      n = *line + 4;
#line 250
      line_start = strtoul((char const   */* __restrict  */)((char const   *)n), (char **/* __restrict  */)(& end),
                           10);
      }
#line 251
...
#line 255
        n = end + 1;
#line 256
        line_end = strtoul((char const   */* __restrict  */)((char const   *)n), (char **/* __restrict  */)(& end),
                           10);
        }
#line 257
        if ((unsigned long )n == (unsigned long )end) {
...
#line 266
      ...
      {
#line 269
      fwrite((void const   */* __restrict  */)((void const   *)*line), (size_t )*got,
...
#line 540
      printf((char const   */* __restrict  */)"--- ");
#line 541
      fwrite((void const   */* __restrict  */)((void const   *)(line + 4)), (size_t )got - 4U,
             (size_t )1, (FILE */* __restrict  */)stdout);
#line 542
      puts("***************");
#line 543
...
#line 637
      n = *line + 4;
#line 638
      line_start[i] = strtoul((char const   */* __restrict  */)((char const   *)n),
...
#line 687
        memcpy((void */* __restrict  */)((void *)*(lines___1[i] + lnum)), (void const   */* __restrict  */)((void const   *)*line),
               (size_t )got);
#line 688
...
#line 719
            if ((int )*(l[1]) == 32) {
              {
#line 720
              fwrite((void const   */* __restrict  */)((void const   *)(l[0] + 1)),
                     llen[0] - 1U, (size_t )1, (FILE */* __restrict  */)stdout);
#line 721
              (at[0]) ++;
#line 722
              (at[1]) ++;
...
#line 727
          putchar('-');
#line 728
          fwrite((void const   */* __restrict  */)((void const   *)(l[0] + 2)), llen[0] - 2U,
                 (size_t )1, (FILE */* __restrict  */)stdout);
#line 729
          (at[0]) ++;
          }
...
#line 731
          putchar('+');
#line 732
          fwrite((void const   */* __restrict  */)((void const   *)(l[1] + 2)), llen[1] - 2U,
                 (size_t )1, (FILE */* __restrict  */)stdout);
#line 733
          (at[1]) ++;
          }
...
#line 738
                putchar('-');
#line 739
                fwrite((void const   */* __restrict  */)((void const   *)(*(lines___1[0] + at[0]) + 2)),
...
#line 746
                putchar('+');
#line 747
                fwrite((void const   */* __restrict  */)((void const   *)(*(lines___1[1] + at[1]) + 2)),
...
#line 760
        if ((int )*(l[0]) == 92) {
          {
#line 761
          fwrite((void const   */* __restrict  */)((void const   *)l[0]), llen[0],
                 (size_t )1, (FILE */* __restrict  */)stdout);
#line 762
          putchar('\n');
#line 763
...
#line 764
        if ((int )*(l[1]) == 92) {
          {
#line 765
          fwrite((void const   */* __restrict  */)((void const   *)l[1]), llen[1],
                 (size_t )1, (FILE */* __restrict  */)stdout);
#line 766
          putchar('\n');
#line 767
...
#line 72
  result = (char *)tmp___0;
#line 73
  memcpy((void */* __restrict  */)((void *)result), (void const   */* __restrict  */)((void const   *)s),
         len);
  }
#line 74
  return (result);
...
#line 108
  strcpy((char */* __restrict  */)tmpfname, (char const   */* __restrict  */)((char const   *)tmpdir));
#line 109
...
#line 201
      ...
      {
#line 202
      tmp___3 = fread((void */* __restrict  */)((void *)buffer), (size_t )1, buflen,
                      (FILE */* __restrict  */)f);
#line 202
      count = tmp___3;
      }
...
#line 204
      ...
      {
#line 205
      fwrite((void const   */* __restrict  */)((void const   *)buffer), count, (size_t )1,
...
#line 184
  memcpy((void */* __restrict  */)((void *)make->line), (void const   */* __restrict  */)((void const   *)line),
         length);
#line 185
...
#line 338
    p ++;
#line 339
    linenum___1 = strtoul((char const   */* __restrict  */)((char const   *)p), (char **/* __restrict  */)(& q),
                          10);
    }
#line 340
...
#line 505
    ...
    {
#line 506
    fputs((char const   */* __restrict  */)((char const   *)file_info->unline), (FILE */* __restrict  */)fout);
#line 505
    linenum___1 ++;
    }
  }
...
#line 512
    ...
    {
#line 514
    fwrite((void const   */* __restrict  */)((void const   *)at->line), at->length,
...
#line 550
    ...
    {
#line 551
    fputs((char const   */* __restrict  */)((char const   *)oldname), (FILE */* __restrict  */)out);
#line 552
    fputs((char const   */* __restrict  */)((char const   *)line), (FILE */* __restrict  */)out);
    }
  } else
#line 553
...
#line 635
        fputc('-', out);
#line 636
        fwrite((void const   */* __restrict  */)((void const   *)(line + 1)), (size_t )got - 1U,
               (size_t )1, (FILE */* __restrict  */)out);
        }
      } else
#line 634
...
#line 699
  tmpp1 = (char *)tmp___1;
#line 700
  memcpy((void */* __restrict  */)((void *)tmpp1), (void const   */* __restrict  */)((void const   *)tmpdir),
         tmplen);
#line 701
  memcpy((void */* __restrict  */)((void *)(tmpp1 + tmplen)), (void const   */* __restrict  */)((void const   *)(tail1)),
         (size_t )sizeof(tail1));
#line 702
...
#line 702
  tmpp2 = (char *)tmp___2;
#line 703
  memcpy((void */* __restrict  */)((void *)tmpp2), (void const   */* __restrict  */)((void const   *)tmpdir),
         tmplen);
#line 704
  memcpy((void */* __restrict  */)((void *)(tmpp2 + tmplen)), (void const   */* __restrict  */)((void const   *)(tail2)),
         (size_t )sizeof(tail2));
#line 706
...
#line 1097
      fwrite((void const   */* __restrict  */)((void const   *)line), (size_t )got,
             (size_t )1, (FILE */* __restrict  */)tmpdiff);
      }
#line 1098
      if ((int )*line != 32) {
        {
...
#line 1259
      p ++;
#line 1260
      skip = strtoul((char const   */* __restrict  */)((char const   *)p), (char **/* __restrict  */)(& end),
                     10);
      }
#line 1261
...
#line 1491
    rewind(tmpdiff);
#line 1492
    fputs((char const   */* __restrict  */)((char const   *)*(headers + 0)), (FILE */* __restrict  */)out);
#line 1493
    fputs((char const   */* __restrict  */)((char const   *)*(headers + 1)), (FILE */* __restrict  */)out);
#line 1494
...
#line 1559
  tmpp3 = (char *)tmp___2;
#line 1560
  memcpy((void */* __restrict  */)((void *)tmpp3), (void const   */* __restrict  */)((void const   *)tmpdir),
         tmplen);
#line 1561
  memcpy((void */* __restrict  */)((void *)(tmpp3 + tmplen)), (void const   */* __restrict  */)((void const   *)(tail3)),
         (size_t )sizeof(tail3));
#line 1564
...
#line 1688
  f = fopen((char const   */* __restrict  */)((char const   *)tmpp3), (char const   */* __restrict  */)"r");
#line 1689
  linenum___1 = 0UL;
#line 1690
  saw_first_offset = 0;
...
#line 1773
  write_file(& intermediate, tmpfd);
#line 1778
  take_diff((char const   *)tmpp1, (char const   *)tmpp2, header2, (char const   *)intermediate.unline,
            flip1);
#line 1779
  take_diff((char const   *)tmpp2, (char const   *)tmpp3, header1, (char const   *)intermediate.unline,
            flip2);
  }
#line 1781
  if (line) {
...
#line 2052
    ...
    {
#line 2054
    tmp___0 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end),
                      0);
#line 2054
...
#line 2058
    ...
    {
#line 2060
    tmp___1 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& end),
                      0);
#line 2060

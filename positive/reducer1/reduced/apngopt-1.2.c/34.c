...
{ 
  ...
  {
#line 120
  tmp = fread((void */* __restrict  */)((void *)(& res)), (size_t )1, (size_t )4,
              (FILE */* __restrict  */)f1);
  }
#line 120
  if (tmp != 4UL) {
...
{ 
  ...
  {
#line 128
  tmp = fread((void */* __restrict  */)((void *)(& res)), (size_t )1, (size_t )2,
              (FILE */* __restrict  */)f1);
  }
#line 128
  if (tmp != 2UL) {
...
#line 571
  res = 1;
#line 573
  f1 = fopen((char const   */* __restrict  */)((char const   *)szIn), (char const   */* __restrict  */)"rb");
  }
#line 573
...
#line 600
  while (1) {
    ...
    {
#line 602
    tmp = fread((void */* __restrict  */)((void *)(sig)), (size_t )1, (size_t )8,
                (FILE */* __restrict  */)f1);
    }
#line 602
    if (tmp != 8UL) {
...
#line 625
    h0 = h;
#line 626
    tmp___5 = fread((void */* __restrict  */)((void *)(& depth)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)f1);
    }
#line 626
    if (tmp___5 != 1UL) {
#line 626
    ...
    {
#line 627
    tmp___6 = fread((void */* __restrict  */)((void *)(& coltype)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)f1);
    }
#line 627
    if (tmp___6 != 1UL) {
#line 627
    ...
    {
#line 628
    tmp___7 = fread((void */* __restrict  */)((void *)(& compr)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)f1);
    }
#line 628
    if (tmp___7 != 1UL) {
#line 628
    ...
    {
#line 629
    tmp___8 = fread((void */* __restrict  */)((void *)(& filter)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)f1);
    }
#line 629
    if (tmp___8 != 1UL) {
#line 629
    ...
    {
#line 630
    tmp___9 = fread((void */* __restrict  */)((void *)(& interl)), (size_t )1, (size_t )1,
                    (FILE */* __restrict  */)f1);
    }
#line 630
    if (tmp___9 != 1UL) {
...
#line 690
          ...
          {
#line 692
          tmp___19 = fread((void */* __restrict  */)((void *)(& c)), (size_t )1, (size_t )1,
                           (FILE */* __restrict  */)f1);
          }
#line 692
          if (tmp___19 != 1UL) {
...
#line 705
          ...
          {
#line 707
          tmp___21 = fread((void */* __restrict  */)((void *)(& c)), (size_t )1, (size_t )1,
                           (FILE */* __restrict  */)f1);
          }
#line 707
          if (tmp___21 != 1UL) {
...
#line 781
            if ((int )coltype != 6) {
              {
#line 782
              memcpy((void */* __restrict  */)((void *)(pImg1 + outimg1)), (void const   */* __restrict  */)((void const   *)pImg1),
                     (size_t )outimg1);
              }
            }
#line 783
            if ((int )coltype != 4) {
              {
#line 784
              memcpy((void */* __restrict  */)((void *)(pImg2 + outimg2)), (void const   */* __restrict  */)((void const   *)pImg2),
                     (size_t )outimg2);
              }
            }
          }
...
#line 838
        ...
        {
#line 839
        tmp___37 = fread((void */* __restrict  */)((void *)(& dop)), (size_t )1, (size_t )1,
                         (FILE */* __restrict  */)f1);
        }
#line 839
        if (tmp___37 != 1UL) {
#line 839
        ...
        {
#line 840
        tmp___38 = fread((void */* __restrict  */)((void *)(& bop)), (size_t )1, (size_t )1,
                         (FILE */* __restrict  */)f1);
        }
#line 840
        if (tmp___38 != 1UL) {
...
#line 860
      if (chunk == 1229209940U) {
        {
#line 862
        tmp___40 = fread((void */* __restrict  */)((void *)(pData + zsize)), (size_t )1,
                         (size_t )len, (FILE */* __restrict  */)f1);
        }
#line 862
...
#line 870
        len -= 4U;
#line 871
        tmp___43 = fread((void */* __restrict  */)((void *)(pData + zsize)), (size_t )1,
                         (size_t )len, (FILE */* __restrict  */)f1);
        }
#line 871
...
#line 935
  len = tmp___0;
#line 937
  fwrite((void const   */* __restrict  */)((void const   *)(& len)), (size_t )1, (size_t )4,
         (FILE */* __restrict  */)f);
#line 938
  fwrite((void const   */* __restrict  */)((void const   *)name), (size_t )1, (size_t )4,
         (FILE */* __restrict  */)f);
#line 939
...
#line 943
    seq = tmp___3;
#line 944
    fwrite((void const   */* __restrict  */)((void const   *)(& seq)), (size_t )1,
           (size_t )4, (FILE */* __restrict  */)f);
#line 945
...
#line 949
    if (length > 0U) {
      {
#line 951
      fwrite((void const   */* __restrict  */)((void const   *)data), (size_t )1,
             (size_t )length, (FILE */* __restrict  */)f);
#line 952
...
#line 955
  crc = __bswap_32(crc);
#line 956
  fwrite((void const   */* __restrict  */)((void const   *)(& crc)), (size_t )1, (size_t )4,
         (FILE */* __restrict  */)f);
  }
#line 957
  return;
...
#line 1086
        ...
        {
#line 1088
        memcpy((void */* __restrict  */)((void *)pc___1), (void const   */* __restrict  */)((void const   *)(& c2___0)),
               (size_t )3);
#line 1089
        pa___1 += 3;
#line 1090
...
#line 1359
        ...
        {
#line 1361
        memcpy((void */* __restrict  */)((void *)dp), (void const   */* __restrict  */)((void const   *)(dp + imgstride)),
               (size_t )imgstride);
#line 1362
        *(dnum + j) = *(dnum + (j + 1U));
#line 1363
...
#line 1705
    if (ts != 0) {
      {
#line 1707
      memcpy((void */* __restrict  */)((void *)(trns)), (void const   */* __restrict  */)((void const   *)(tr)),
             (size_t )ts);
#line 1708
...
#line 2086
  ...
  {
#line 2089
  f = fopen((char const   */* __restrict  */)((char const   *)szOut), (char const   */* __restrict  */)"wb");
  }
#line 2089
...
#line 2121
    fwrite((void const   */* __restrict  */)((void const   *)(png_sign)), (size_t )1,
           (size_t )8, (FILE */* __restrict  */)f);
#line 2123
...
#line 2148
        memcpy((void */* __restrict  */)((void *)zbuf), (void const   */* __restrict  */)((void const   *)op[0].zbuf),
               (size_t )zsize);
        }
      } else {
        {
...
#line 2153
        memcpy((void */* __restrict  */)((void *)zbuf), (void const   */* __restrict  */)((void const   *)op[1].zbuf),
               (size_t )zsize);
        }
      }
      {
...
#line 2208
        if (has_tcolor) {
          {
#line 2210
          memcpy((void */* __restrict  */)((void *)tmpframe), (void const   */* __restrict  */)((void const   *)cur_frame),
                 (size_t )imagesize);
          }
#line 2211
          if ((int )coltype == 2) {
...
#line 2213
                ...
                {
#line 2214
                memcpy((void */* __restrict  */)((void *)(tmpframe + ((j + y0) * width + (k + x0)) * 3U)),
                       (void const   */* __restrict  */)((void const   *)(& tcolor)),
                       (size_t )3);
#line 2213
                k ++;
                }
...
#line 2269
                ...
                {
#line 2270
                memcpy((void */* __restrict  */)((void *)(cur_frame + ((j + y0) * width + (k + x0)) * 3U)),
                       (void const   */* __restrict  */)((void const   *)(& tcolor)),
                       (size_t )3);
#line 2269
                k ++;
...
#line 2278
            ...
            {
#line 2279
            memcpy((void */* __restrict  */)((void *)(cur_frame + ((j + y0) * width + x0) * bpp)),
                   (void const   */* __restrict  */)((void const   *)(prev_frame + ((j + y0) * width + x0) * bpp)),
                   (size_t )(w0 * bpp));
#line 2278
            j ++;
            }
...
#line 2290
        memcpy((void */* __restrict  */)((void *)zbuf), (void const   */* __restrict  */)((void const   *)op[op_best].zbuf),
               (size_t )zsize);
#line 2292
        j = 0U;
        }
...
#line 2365
  if (argc > 2) {
    {
#line 2367
    strncpy((char */* __restrict  */)(szOut), (char const   */* __restrict  */)((char const   *)*(argv + 2)),
            (size_t )255);
#line 2368
    szOut[255] = (char )'\000';
    }
    ...
    {
#line 2372
    strcpy((char */* __restrict  */)(szOut), (char const   */* __restrict  */)((char const   *)szIn));
#line 2373

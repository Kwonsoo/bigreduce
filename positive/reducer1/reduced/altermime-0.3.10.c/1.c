...
#line 105
  result = 0;
#line 107
  _LOGGER_outf = fopen((char const   */* __restrict  */)((char const   *)lfname),
...
#line 303
  vsnprintf((char */* __restrict  */)(tmpoutput), sizeof(tmpoutput), (char const   */* __restrict  */)((char const   *)format),
            ptr);
#line 306
...
#line 338
  ...
  {
#line 341
  strncpy((char */* __restrict  */)glb.headerbuffer[glb.headerbuffermax], (char const   */* __restrict  */)((char const   *)headerline),
          (size_t )1024);
#line 342
  (glb.headerbuffermax) ++;
  }
...
#line 753
  while (1) {
    ...
    {
#line 753
    tmp = fread((void */* __restrict  */)((void *)(inbuf)), (size_t )1, (size_t )3,
                (FILE */* __restrict  */)fin);
#line 753
    byte_count = (int )tmp;
    }
...
#line 770
      ...
      {
#line 772
      bc = fwrite((void const   */* __restrict  */)((void const   *)(outbuf)), (size_t )1,
                  (size_t )4, (FILE */* __restrict  */)fout);
      }
#line 773
      if (bc != 4UL) {
        {
#line 773
      ...
      {
#line 775
      bc = fwrite((void const   */* __restrict  */)((void const   *)"\n"), (size_t )1,
...
{ 
  ...
  {
#line 814
  fin = fopen((char const   */* __restrict  */)((char const   *)enc_fname), (char const   */* __restrict  */)"rb");
  }
#line 815
  if (! fin) {
    {
...
#line 818
  ...
  {
#line 821
  fout = fopen((char const   */* __restrict  */)((char const   *)out_fname), (char const   */* __restrict  */)"wb");
  }
#line 822
  if (! fout) {
    {
...
#line 1049
  ...
  {
#line 1052
  bytes_read = fread((void */* __restrict  */)((void *)buffer), sizeof(char ), input_size,
                     (FILE */* __restrict  */)fin);
  }
#line 1053
...
{ 
  ...
  {
#line 1173
  stat_result = stat((char const   */* __restrict  */)((char const   *)in_fname),
...
#line 1179
  ...
  {
#line 1181
  fin = fopen((char const   */* __restrict  */)((char const   *)in_fname), (char const   */* __restrict  */)"rb");
  }
#line 1182
  if (! fin) {
    {
...
#line 1367
  *textptr = (char *)((void *)0);
#line 1369
  tmp___4 = stat((char const   */* __restrict  */)((char const   *)fname), (struct stat */* __restrict  */)(& st));
  }
#line 1369
  if (0 == tmp___4) {
    {
...
#line 1383
      f = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
      }
#line 1384
      if (! f) {
        {
...
#line 1387
      ...
      {
#line 1390
      bc = fread((void */* __restrict  */)((void *)p), (size_t )1, (size_t )st.st_size,
                 (FILE */* __restrict  */)f);
      }
#line 1391
...
#line 1537
    ...
    {
#line 1546
    strcpy((char */* __restrict  */)(lline), (char const   */* __restrict  */)((char const   *)(line)));
#line 1547
    PLD_strlower(lline);
#line 1551
...
#line 1951
  snprintf((char */* __restrict  */)(b64_raw_fname), sizeof(b64_raw_fname), (char const   */* __restrict  */)"altermime-raw-%d.b64",
           tmp___0);
#line 1953
  b64_raw_file = fopen((char const   */* __restrict  */)((char const   *)(b64_raw_fname)),
...
#line 2445
    ...
    {
#line 2448
    newf = fopen((char const   */* __restrict  */)((char const   *)(mpacktmp)), (char const   */* __restrict  */)"w");
#line 2449
    mp = fopen((char const   */* __restrict  */)((char const   *)mpackname), (char const   */* __restrict  */)"r");
    }
  }
  {
#line 2453
...
#line 2778
  strcpy((char */* __restrict  */)line, (char const   */* __restrict  */)((char const   *)(lline)));
  }
#line 2780
  return (0);
}
...
#line 2956
    if (tmp > 0UL) {
      {
#line 2958
      regresult = regexec((regex_t const   */* __restrict  */)((regex_t const   *)preg),
                          (char const   */* __restrict  */)((char const   *)(hinfo->filename)),
...
#line 2963
        regresult = regexec((regex_t const   */* __restrict  */)((regex_t const   *)preg),
                            (char const   */* __restrict  */)((char const   *)(hinfo->name)),
                            (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                            0);
        }
#line 2964
...
#line 2970
      regresult = regexec((regex_t const   */* __restrict  */)((regex_t const   *)preg),
                          (char const   */* __restrict  */)((char const   *)(hinfo->content_type_string)),
                          (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                          0);
      }
#line 2971
...
#line 3001
      sl = (int )tmp___2;
#line 3003
      bc = fwrite((void const   */* __restrict  */)((void const   *)original_ptr),
                  sizeof(char ), (size_t )sl, (FILE */* __restrict  */)outputfile);
      }
#line 3004
      if (bc != (size_t )sl) {
        {
...
#line 3027
      if (regresult != 0) {
        {
#line 3029
        bc = fwrite((void const   */* __restrict  */)((void const   *)(buffer)), sizeof(char ),
                    (size_t )buffer_len, (FILE */* __restrict  */)outputfile);
        }
#line 3030
...
#line 3082
    ...
    {
#line 3084
    inputfile = fopen((char const   */* __restrict  */)((char const   *)mpackname),
...
#line 3095
    ...
    {
#line 3097
    outputfile = fopen((char const   */* __restrict  */)((char const   *)(tmpfname)),
                       (char const   */* __restrict  */)"w");
    }
  }
#line 3100
...
#line 3117
  ...
  {
#line 3121
  result = regcomp((regex_t */* __restrict  */)(& preg), (char const   */* __restrict  */)((char const   *)attachmentname),
                   (1 | (1 << 1)) | (((1 << 1) << 1) << 1));
  }
#line 3122
  if (result != 0) {
...
#line 3246
    ...
    {
#line 3235
    tmp___2 = stat((char const   */* __restrict  */)((char const   *)(tpn)), (struct stat */* __restrict  */)(& st));
    }
#line 3235
    if (! (0 == tmp___2)) {
#line 3235
  ...
  {
#line 3261
  fo = fopen((char const   */* __restrict  */)((char const   *)(tpn)), (char const   */* __restrict  */)"w");
  }
#line 3262
  if (! fo) {
    {
...
#line 3265
  ...
  {
#line 3270
  fi = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
  }
#line 3271
  if (! fi) {
    {
...
#line 3381
    ...
    {
#line 3373
    tmp___0 = stat((char const   */* __restrict  */)((char const   *)(tpn)), (struct stat */* __restrict  */)(& st));
    }
#line 3373
    if (! (0 == tmp___0)) {
#line 3373
...
#line 3401
  ...
  {
#line 3405
  fi = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
  }
#line 3406
  if (! fi) {
    {
...
#line 3660
  result = 0;
#line 3663
  newatt = fopen((char const   */* __restrict  */)((char const   *)new_attachment_name),
                 (char const   */* __restrict  */)"r");
  }
#line 3664
...
#line 3801
      bc = fwrite((void const   */* __restrict  */)((void const   *)original_ptr),
                  sizeof(char ), (size_t )bl, (FILE */* __restrict  */)outputfile);
      }
#line 3802
      if (bc != (size_t )bl) {
        {
...
#line 3931
          ...
          {
#line 3934
          bc = fwrite((void const   */* __restrict  */)((void const   *)(buffer)),
                      sizeof(char ), (size_t )buflen, (FILE */* __restrict  */)outputfile);
          }
#line 3935
          if (bc != (size_t )buflen) {
            {
...
#line 688
  ...
  {
#line 689
  tmp = fread((void */* __restrict  */)((void *)(buffer)), (size_t )1, (size_t )1024,
              (FILE */* __restrict  */)f);
#line 689
  read_count = (int )tmp;
#line 690
...
#line 786
    tmp = stat((char const   */* __restrict  */)((char const   *)(glb___0.doubleCRname)),
               (struct stat */* __restrict  */)(& st));
    }
#line 786
    if (! (tmp == 0)) {
#line 786
  ...
  {
#line 793
  fo = fopen((char const   */* __restrict  */)((char const   *)(glb___0.doubleCRname)),
             (char const   */* __restrict  */)"w");
  }
#line 794
  if (! fo) {
...
#line 1227
        ...
        {
#line 1228
        memcpy((void */* __restrict  */)((void *)(glb___0.headerline + totalsize)),
               (void const   */* __restrict  */)((void const   *)linestart), (size_t )linesize);
#line 1229
        totalsize += linesize;
#line 1230
...
#line 126
    block_pos = ftell(f->f);
#line 128
    tmp = fread((void */* __restrict  */)((void *)(f->buffer)), (size_t )1, (size_t )8191,
                (FILE */* __restrict  */)f->f);
#line 128
    bs = (int )tmp;
    }
...
#line 199
  ...
  {
#line 201
  memcpy((void */* __restrict  */)((void *)(f->buffer)), (void const   */* __restrict  */)((void const   *)buffer),
         (size_t )size);
#line 202
  f->startpoint = buffer;
#line 203
...
#line 625
      ...
      {
#line 626
      memcpy((void */* __restrict  */)((void *)line), (void const   */* __restrict  */)((void const   *)f->startpoint),
             (size_t )(max_size + 1));
#line 627
...
{ 
  ...
  {
#line 141
  stat_result = stat((char const   */* __restrict  */)((char const   *)fname), (struct stat */* __restrict  */)(& st));
  }
#line 142
  if (stat_result != 0) {
#line 143
...
#line 163
  f = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
#line 164
  bc = fread((void */* __restrict  */)((void *)in_buffer), (size_t )1, in_size, (FILE */* __restrict  */)f);
  }
#line 165
  if (bc != in_size) {
    {

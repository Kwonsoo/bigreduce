...
#line 772
    while (1) {
      ...
      {
#line 774
      n = fread((void */* __restrict  */)((void *)(buffer + sum)), (size_t )1, 4096UL - sum,
...
#line 255
    strcpy((char */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)field[pos + 1]));
#line 256
    strcat((char */* __restrict  */)tmp, (char const   */* __restrict  */)":");
#line 257
    strcat((char */* __restrict  */)tmp, (char const   */* __restrict  */)((char const   *)field[pos + 2]));
#line 259
    i = so_listen(port, source);
    }
#line 260
...
#line 284
    tok = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)", ",
                   (char **/* __restrict  */)(& save));
    }
  }
  while_break___0: /* CIL Label */ ;
...
#line 735
    ...
    {
#line 737
    tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& tmp),
                      0);
#line 737
    tmp___3 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& tmp),
                      0);
#line 737
    tmp___4 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& tmp),
                      0);
#line 737
    tmp___5 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& tmp),
                      0);
#line 737
...
#line 1077
    if (! cflags) {
      {
#line 1078
      tmp___37 = strtoul((char const   */* __restrict  */)((char const   *)tmp), (char **/* __restrict  */)((char **)((void *)0)),
                         0);
#line 1078
      tmp___38 = strtoul((char const   */* __restrict  */)((char const   *)tmp), (char **/* __restrict  */)((char **)((void *)0)),
                         0);
#line 1078
      tmp___39 = strtoul((char const   */* __restrict  */)((char const   *)tmp), (char **/* __restrict  */)((char **)((void *)0)),
                         0);
#line 1078
      tmp___40 = strtoul((char const   */* __restrict  */)((char const   *)tmp), (char **/* __restrict  */)((char **)((void *)0)),
                         0);
#line 1078
...
#line 1254
        if (tmp) {
          {
#line 1254
          memcpy((void */* __restrict  */)((void *)(g_creds->passnt)), (void const   */* __restrict  */)((void const   *)tmp),
                 (size_t )21);
          }
        }
      }
...
#line 1258
        if (tmp) {
          {
#line 1258
          memcpy((void */* __restrict  */)((void *)(g_creds->passlm)), (void const   */* __restrict  */)((void const   *)tmp),
                 (size_t )21);
          }
        }
      }
...
#line 1262
        if (tmp) {
          {
#line 1262
          memcpy((void */* __restrict  */)((void *)(g_creds->passntlm2)), (void const   */* __restrict  */)((void const   *)tmp),
                 (size_t )16);
          }
        }
      }
...
#line 1498
    cd = select(1024, (fd_set */* __restrict  */)(& set), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 1543
          if (! serialize) {
            {
#line 1544
            tid = pthread_create((pthread_t */* __restrict  */)(& pthr), (pthread_attr_t const   */* __restrict  */)((pthread_attr_t const   *)(& pattr)),
...
#line 116
            ...
            {
#line 119
            strcat((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)line));
#line 120
            len = (int )((long )len + c);
            }
#line 122
...
#line 93
  memcpy((void */* __restrict  */)((void *)(blob + 28)), (void const   */* __restrict  */)((void const   *)(challenge + tbofs)),
         (size_t )tblen);
#line 94
...
#line 106
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(challenge + 24)),
         (size_t )8);
#line 107
  memcpy((void */* __restrict  */)((void *)(buf + 8)), (void const   */* __restrict  */)((void const   *)blob),
         (size_t )blen);
#line 108
  hmac_md5((void const   *)passnt2, (size_t )16, (void const   *)buf, (size_t )(8 + blen),
           (void *)*nthash);
#line 109
  memcpy((void */* __restrict  */)((void *)(*nthash + 16)), (void const   */* __restrict  */)((void const   *)blob),
         (size_t )blen);
#line 110
  free((void *)buf);
#line 112
...
#line 115
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(challenge + 24)),
         (size_t )8);
#line 116
  memcpy((void */* __restrict  */)((void *)(buf + 8)), (void const   */* __restrict  */)((void const   *)nonce),
         (size_t )8);
#line 117
  hmac_md5((void const   *)passnt2, (size_t )16, (void const   *)buf, (size_t )16,
           (void *)*lmhash);
#line 118
  memcpy((void */* __restrict  */)((void *)(*lmhash + 16)), (void const   */* __restrict  */)((void const   *)nonce),
         (size_t )8);
#line 119
  free((void *)buf);
#line 121
...
#line 133
  *lmhash = new((size_t )(*lmlen + 1));
#line 134
  memcpy((void */* __restrict  */)((void *)*lmhash), (void const   */* __restrict  */)((void const   *)nonce),
         (size_t )8);
#line 135
...
#line 159
  ...
  {
#line 159
  tmp___3 = strncpy((char */* __restrict  */)pass, (char const   */* __restrict  */)((char const   *)password),
                    tmp___1);
#line 159
  uppercase(tmp___3);
#line 161
...
#line 196
  strcat((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)username));
#line 197
  strcat((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)domain));
#line 198
  uppercase(buf);
#line 199
  len = unicode(& tmp, buf);
...
#line 248
  buf = new((size_t )1024);
#line 249
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)"NTLMSSP\000"),
         (size_t )8);
#line 250
...
#line 260
  memcpy((void */* __restrict  */)((void *)(buf + 32)), (void const   */* __restrict  */)((void const   *)tmp),
         (size_t )hlen);
#line 261
  free((void *)tmp);
#line 263
...
#line 264
  memcpy((void */* __restrict  */)((void *)((buf + 32) + hlen)), (void const   */* __restrict  */)((void const   *)tmp),
         (size_t )dlen);
#line 265
  free((void *)tmp);
#line 267
...
#line 450
  memcpy((void */* __restrict  */)((void *)(buf + 64)), (void const   */* __restrict  */)((void const   *)udomain),
         (size_t )dlen);
#line 451
  memcpy((void */* __restrict  */)((void *)((buf + 64) + dlen)), (void const   */* __restrict  */)((void const   *)uuser),
         (size_t )ulen);
#line 452
  memcpy((void */* __restrict  */)((void *)(((buf + 64) + dlen) + ulen)), (void const   */* __restrict  */)((void const   *)uhost),
         (size_t )hlen);
#line 453
  memcpy((void */* __restrict  */)((void *)((((buf + 64) + dlen) + ulen) + hlen)),
         (void const   */* __restrict  */)((void const   *)lmhash), (size_t )lmlen);
#line 454
  memcpy((void */* __restrict  */)((void *)(((((buf + 64) + dlen) + ulen) + hlen) + 24)),
         (void const   */* __restrict  */)((void const   *)nthash), (size_t )ntlen);
  }
#line 456
  if (nthash) {
    {
...
#line 54
    *(spec + i) = (char)0;
#line 55
    tmp___2 = strtol((char const   */* __restrict  */)((char const   *)((spec + i) + 1)),
...
#line 557
      memcpy((void */* __restrict  */)((void *)dst->body), (void const   */* __restrict  */)((void const   *)src->body),
             (size_t )src->body_len);
      }
    }
  }
...
#line 58
  hints.ai_socktype = 1;
#line 59
  tmp = getaddrinfo((char const   */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)((void *)0)),
...
#line 75
    if (! addr_set) {
      {
#line 76
      memcpy((void */* __restrict  */)((void *)host), (void const   */* __restrict  */)((void const   *)(& ad->sin_addr)),
             sizeof(ad->sin_addr));
#line 77
      addr_set = 1;
      }
...
#line 405
    ...
    {
#line 408
    tmp = strtol((char const   */* __restrict  */)((char const   *)buf), (char **/* __restrict  */)(& err),
                 16);
#line 408
    csize = (int )tmp;
#line 410
...
#line 460
    sel = select(1024, (fd_set */* __restrict  */)(& set), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 649
        if (tmp) {
          {
#line 649
          memcpy((void */* __restrict  */)((void *)(tcreds->passntlm2)), (void const   */* __restrict  */)((void const   *)tmp),
                 (size_t )16);
          }
        }
      }
...
#line 655
        if (tmp) {
          {
#line 655
          memcpy((void */* __restrict  */)((void *)(tcreds->passnt)), (void const   */* __restrict  */)((void const   *)tmp),
                 (size_t )21);
          }
        }
      }
...
#line 661
        if (tmp) {
          {
#line 661
          memcpy((void */* __restrict  */)((void *)(tcreds->passlm)), (void const   */* __restrict  */)((void const   *)tmp),
                 (size_t )21);
          }
        }
      }
...
#line 61
    if (src->passntlm2) {
      {
#line 62
      memcpy((void */* __restrict  */)((void *)(dst->passntlm2)), (void const   */* __restrict  */)((void const   *)(src->passntlm2)),
             (size_t )50);
      }
    }
#line 63
    if (src->passnt) {
      {
#line 64
      memcpy((void */* __restrict  */)((void *)(dst->passnt)), (void const   */* __restrict  */)((void const   *)(src->passnt)),
             (size_t )50);
      }
    }
#line 65
    if (src->passlm) {
      {
#line 66
      memcpy((void */* __restrict  */)((void *)(dst->passlm)), (void const   */* __restrict  */)((void const   *)(src->passlm)),
             (size_t )50);
      }
    }
  } else {

...
#line 98
  tmp___4 = fopen((char const   */* __restrict  */)((char const   *)(fn)), (char const   */* __restrict  */)"w");
#line 98
...
#line 127
        ...
        {
#line 130
        memcpy((void */* __restrict  */)new_element->info, (void const   */* __restrict  */)((void const   *)element),
...
#line 190
    ...
    {
#line 196
    memcpy((void */* __restrict  */)element, (void const   */* __restrict  */)((void const   *)(q->queue)->info),
           (size_t )q->elementsize);
#line 198
    free((q->queue)->info);
#line 199
...
#line 221
    ...
    {
#line 227
    memcpy((void */* __restrict  */)element, (void const   */* __restrict  */)((void const   *)(q->current)->info),
           (size_t )q->elementsize);
#line 230
    pthread_mutex_unlock(& q->lock);
    }
...
#line 297
    ...
    {
#line 302
    memcpy((void */* __restrict  */)(q->current)->info, (void const   */* __restrict  */)((void const   *)element),
           (size_t )q->elementsize);
    }
  }
  {
...
#line 453
    ...
    {
#line 455
    memcpy((void */* __restrict  */)new_element->info, (void const   */* __restrict  */)((void const   *)temp->info),
...
#line 563
    ...
    {
#line 569
    memcpy((void */* __restrict  */)element, (void const   */* __restrict  */)((void const   *)(ctx->current)->info),
...
#line 638
    ...
    {
#line 643
    memcpy((void */* __restrict  */)(ctx->current)->info, (void const   */* __restrict  */)((void const   *)element),
           (size_t )(ctx->queue)->elementsize);
    }
  }
  {
...
#line 76
  vfprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)format),
           argp);
#line 77
  vfprintf((FILE */* __restrict  */)state->auditFile, (char const   */* __restrict  */)((char const   *)format),
           argp);
#line 78
...
#line 136
    *(table + (int )((unsigned char )*(needle + i))) = currentindex;
#line 137
    if (! casesensitive) {
#line 137
      if ((int )*(needle + i) > 0) {
...
#line 163
      if (pos < haystack_len) {
#line 163
        shift = *(table + (int )((unsigned char )*(haystack + pos)));
#line 163
        if (! (shift > 0UL)) {
#line 163
          goto while_break___0;
...
#line 246
      bad = temp;
#line 247
      strncpy((char */* __restrict  */)(temp + 1), (char const   */* __restrict  */)((char const   *)rd),
              (size_t )3);
#line 248
      temp[4] = (char )'\000';
#line 249
      tmp___6 = strtoul((char const   */* __restrict  */)((char const   *)(temp)),
                        (char **/* __restrict  */)(& bad), 0);
#line 249
      ch = (char )tmp___6;
      }
#line 250
...
{ 
  ...
  {
#line 197
  realpath((char const   */* __restrict  */)((char const   *)state->imagefile), (char */* __restrict  */)(imageFile));
#line 199
  scalpelLog(state, (char *)"\nOpening target \"%s\"\n\n", imageFile);
  }
#line 211
...
#line 255
      foundat = bm_needleinhaystack(currentneedle->begin, (size_t )currentneedle->beginlength,
                                    ...
                                    currentneedle->begin_bm_table, currentneedle->casesensitive);
#line 262
...
#line 355
          foundat = bm_needleinhaystack(currentneedle->end, (size_t )currentneedle->endlength,
                                        foundat, (size_t )((int )(lengthofbuf - (unsigned long long )(foundat - readbuffer))),
                                        currentneedle->end_bm_table, currentneedle->casesensitive);
          }
#line 362
          if ((unsigned long )foundat > 0UL) {
#line 366
...
#line 455
  infile = fopen((char const   */* __restrict  */)((char const   *)state->imagefile),
...
#line 855
        checkMemoryAllocation(state, (void *)carveinfo->filename, 855, (char *)"/home/june/repo/benchmarks/collector/temp/scalpel-1.60/dig.c",
                              (char *)"carveinfo");
#line 856
        strcpy((char */* __restrict  */)carveinfo->filename, (char const   */* __restrict  */)((char const   *)(fn)));
#line 857
...
#line 1018
        if (! state->previewMode) {
          {
#line 1019
          carve->fp = fopen((char const   */* __restrict  */)((char const   *)carve->filename),
                            (char const   */* __restrict  */)"ab");
          }
        }
#line 1022
        if (! carve->fp) {
...
#line 1056
      if (! state->previewMode) {
        {
#line 1057
        tmp___26 = fwrite((void const   */* __restrict  */)((void const   *)(readbuffer + offset)),
...
#line 1207
  dbfile = fopen((char const   */* __restrict  */)((char const   *)(fn)), (char const   */* __restrict  */)"w");
  }
#line 1207
...
#line 1341
    ...
    {
#line 1345
    tmp___0 = fopen((char const   */* __restrict  */)((char const   *)(fn)), (char const   */* __restrict  */)"rb");
#line 1345
...
#line 1362
      ...
      {
#line 1366
      tmp___3 = fread((void */* __restrict  */)((void *)(& blocksize)), sizeof(unsigned int ),
...
#line 1417
          fseeko(state->coverageblockmap, (__off64_t )((i + 1ULL) * (unsigned long long )sizeof(unsigned int )),
                 0);
#line 1418
          tmp___6 = fread((void */* __restrict  */)((void *)(& entry)), sizeof(unsigned int ),
                          (size_t )1, (FILE */* __restrict  */)state->coverageblockmap);
          }
#line 1418
          if (tmp___6 != 1UL) {
...
#line 1458
      ...
      {
#line 1458
      tmp___8 = fopen((char const   */* __restrict  */)((char const   *)(fn)), (char const   */* __restrict  */)tmp___9);
#line 1458
...
#line 1477
        entry = 0U;
#line 1478
        tmp___11 = fwrite((void const   */* __restrict  */)((void const   *)(& state->coverageblocksize)),
...
#line 1483
          ...
          {
#line 1484
          tmp___12 = fwrite((void const   */* __restrict  */)((void const   *)(& entry)),
                            sizeof(unsigned int ), (size_t )1, (FILE */* __restrict  */)state->coverageblockmap);
          }
#line 1484
          if (tmp___12 != 1UL) {
...
#line 1694
    fseeko(state->coverageblockmap, (__off64_t )((block + 1ULL) * (unsigned long long )sizeof(unsigned int )),
           0);
#line 1695
    tmp = fread((void */* __restrict  */)((void *)(& entry)), sizeof(unsigned int ),
                (size_t )1, (FILE */* __restrict  */)state->coverageblockmap);
    }
#line 1695
    if (tmp != 1UL) {
...
#line 1702
    fseeko(state->coverageblockmap, (__off64_t )((block + 1ULL) * (unsigned long long )sizeof(unsigned int )),
           0);
#line 1703
    tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)(& entry)),
                     sizeof(unsigned int ), (size_t )1, (FILE */* __restrict  */)state->coverageblockmap);
    }
#line 1703
    if (tmp___0 != 1UL) {
...
#line 1903
      ...
      {
#line 1907
      tmp___0 = fread((void */* __restrict  */)((void *)((char *)ptr + totalbytesread)),
                      (size_t )1, (size_t )bytestoread, (FILE */* __restrict  */)stream);
#line 1907
...
#line 110
    airac_observe(s, 0);
#line 110
    memcpy((void */* __restrict  */)((void *)s->suffix), (void const   */* __restrict  */)((void const   *)*(tokenarray + 0)),
           (size_t )8);
    }
  } else {
#line 106
...
#line 123
  s->length = strtoull((char const   */* __restrict  */)((char const   *)*(tokenarray + 2)),
...
#line 139
  memcpy((void */* __restrict  */)((void *)s->begin), (void const   */* __restrict  */)((void const   *)*(tokenarray + 3)),
         (size_t )s->beginlength);
#line 140
  s->endlength = translate(*(tokenarray + 4));
#line 141
  memcpy((void */* __restrict  */)((void *)s->end), (void const   */* __restrict  */)((void const   *)*(tokenarray + 4)),
         (size_t )s->endlength);
#line 143
  init_bm_table(s->begin, s->begin_bm_table, (size_t )s->beginlength, s->casesensitive);
#line 145
  init_bm_table(s->end, s->end_bm_table, (size_t )s->endlength, s->casesensitive);
  }
#line 147
  return (0);
}
...
#line 242
  buffer = (char *)tmp;
#line 244
  f = fopen((char const   */* __restrict  */)((char const   *)state->conffile), (char const   */* __restrict  */)"r");
  }
#line 245
...
#line 379
    strncat((char */* __restrict  */)state->invocation, (char const   */* __restrict  */)((char const   *)*argvcopy),
            4096UL - tmp___6);
#line 382
...
#line 405
    ...
    {
#line 408
    state->skip = strtoull((char const   */* __restrict  */)((char const   *)optarg),
...
#line 411
    ...
    {
#line 414
    strncpy((char */* __restrict  */)state->conffile, (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )4096);
    }
#line 415
    goto switch_break;
...
#line 428
    tmp = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)((void *)0)),
                  10);
#line 428
...
#line 434
    ...
    {
#line 437
    strncpy((char */* __restrict  */)state->outputdirectory, (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )4096);
    }
#line 438
    goto switch_break;
...
#line 442
    strncpy((char */* __restrict  */)state->coveragedirectory, (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )4096);
    }
#line 443
    goto switch_break;
...
#line 469
    tmp___1 = strtoul((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)((char **)((void *)0)),
                      10);
#line 469
...
{ 
  ...
  {
#line 500
  realpath((char const   */* __restrict  */)((char const   *)state->outputdirectory),
           (char */* __restrict  */)(fn));
#line 501
  strncpy((char */* __restrict  */)state->outputdirectory, (char const   */* __restrict  */)((char const   *)(fn)),
          (size_t )4096);
  }
#line 505
  return;
...
#line 518
    fprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)"Batch mode: reading list of images from %s.",
            state->inputFileList);
#line 520
    listoffiles = fopen((char const   */* __restrict  */)((char const   *)state->inputFileList),

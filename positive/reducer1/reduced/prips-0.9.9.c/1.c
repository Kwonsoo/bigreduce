...
{ 
  ...
  {
#line 41
  retval = inet_pton(2, (char const   */* __restrict  */)addr, (void */* __restrict  */)((void *)(& sin_addr)));
  }
#line 44
  if (retval == 0) {
#line 45
...
#line 60
  addr_nl = tmp;
#line 62
  tmp___0 = inet_ntop(2, (void const   */* __restrict  */)((void const   *)(& addr_nl)),
...
#line 119
  offset = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"/");
  }
#line 119
  if (offset) {
    {

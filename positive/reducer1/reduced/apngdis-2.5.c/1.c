...
#line 655
          ...
          {
#line 657
          tmp___18 = fread((void */* __restrict  */)((void *)(& c)), (size_t )1, (size_t )1,
                           (FILE */* __restrict  */)f1);
          }
#line 657
          if (tmp___18 != 1UL) {
...
#line 670
          ...
          {
#line 672
          tmp___20 = fread((void */* __restrict  */)((void *)(& c)), (size_t )1, (size_t )1,
                           (FILE */* __restrict  */)f1);
          }
#line 672
          if (tmp___20 != 1UL) {
...
#line 801
        ...
        {
#line 802
        tmp___35 = fread((void */* __restrict  */)((void *)(& dop)), (size_t )1, (size_t )1,
                         (FILE */* __restrict  */)f1);
        }
#line 802
        if (tmp___35 != 1UL) {
#line 802
        ...
        {
#line 803
        tmp___36 = fread((void */* __restrict  */)((void *)(& bop)), (size_t )1, (size_t )1,
                         (FILE */* __restrict  */)f1);
        }
#line 803
        if (tmp___36 != 1UL) {
...
#line 823
      if (chunk == 1229209940U) {
        {
#line 825
        tmp___38 = fread((void */* __restrict  */)((void *)(pData + zsize)), (size_t )1,
...
#line 833
        len -= 4U;
#line 834
        tmp___41 = fread((void */* __restrict  */)((void *)(pData + zsize)), (size_t )1,
                         (size_t )len, (FILE */* __restrict  */)f1);
        }
#line 834
...
#line 1011
      sprintf((char */* __restrict  */)(szOut), (char const   */* __restrict  */)"%s%.*d.txt",
              szPath, len, n);
#line 1012
      f = fopen((char const   */* __restrict  */)((char const   *)(szOut)), (char const   */* __restrict  */)"wt");
      }
#line 1012
...
#line 1220
    ...
    {
#line 1227
    strcat((char */* __restrict  */)(szOut), (char const   */* __restrict  */)((char const   *)(szImg + j)));
    }
  } else {
    {
#line 1230

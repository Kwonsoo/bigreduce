...
#line 62
  {      (char const   */* const  */)"Xorg        Common X server for most displays",      (char const   */* const  */)"Xvfb        Virtual frame buffer",      (char const   */* const  */)"Xfake       kdrive-based virtual frame buffer",      (char const   */* const  */)"Xnest       X server nested in a window on another X server", 
        (char const   */* const  */)"Xephyr      kdrive-based nested X server",      (char const   */* const  */)"Xvnc        X server accessed over VNC\'s RFB protocol",      (char const   */* const  */)"Xdmx        Distributed Multi-head X server",      (char const   */* const  */)((char const   *)((void *)0))};
...
#line 284
  sigaction(14, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& si)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 285
  sigaction(10, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& si)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 293
...
#line 398
  sigaddset(& mask, 10);
#line 399
  sigprocmask(0, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& mask)),
...
#line 440
  ...
  {
#line 406
  sigprocmask(2, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& old)),

...
#line 832
    if (line_preamble) {
      {
#line 834
      memcpy((void */* __restrict  */)((void *)e_com), (void const   */* __restrict  */)((void const   *)line_preamble),
...
#line 854
      ...
      {
#line 857
      memcpy((void */* __restrict  */)((void *)e_com), (void const   */* __restrict  */)((void const   *)save_ptr),
             (size_t )save_length);
#line 858
      text_on_line = e_com;
#line 859
...
#line 312
    strncpy((char */* __restrict  */)dirname, (char const   */* __restrict  */)((char const   *)pathname),
            (size_t )dirlen);
#line 313
...
#line 499
    ...
    {
#line 502
    bf = fopen((char const   */* __restrict  */)((char const   *)backup_filename),
...
#line 506
    ...
    {
#line 509
    tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)file->data),
                     file->size, (size_t )1, (FILE */* __restrict  */)bf);
#line 509
...
#line 336
  ...
  {
#line 339
  strncpy((char */* __restrict  */)fileptr.name, (char const   */* __restrict  */)((char const   *)filename),
          (size_t )namelen);
#line 340
...
#line 528
        printf((char const   */* __restrict  */)((char const   *)tmp___4), out_lines,
               com_lines);
        }
#line 530
        if (com_lines > 0) {
...
#line 532
            printf((char const   */* __restrict  */)((char const   *)tmp___5), (1.0 * (double )com_lines) / (double )code_lines);
            }
          }
        }
      }
...
#line 19
  if (len <= 8U) {
#line 19 "/home/june/repo/benchmarks/collector/temp/indent-2.2.11/src/gperf.c"
    if (len >= 2U) {
      {
...
#line 21
  if (len <= 9U) {
#line 21 "/home/june/repo/benchmarks/collector/temp/indent-2.2.11/src/gperf-cc.c"
    if (len >= 2U) {
      {
...
#line 1870
      strncpy((char */* __restrict  */)save_com.end, (char const   */* __restrict  */)((char const   *)(s_lab + com_start)),
...
#line 1928
    memcpy((void */* __restrict  */)((void *)new), (void const   */* __restrict  */)((void const   *)parser_state_tos),
...
#line 1938
    memcpy((void */* __restrict  */)((void *)new->p_stack), (void const   */* __restrict  */)((void const   *)parser_state_tos->p_stack),
...
#line 1942
    new->il = (int *)tmp___17;
#line 1946
    memcpy((void */* __restrict  */)((void *)new->il), (void const   */* __restrict  */)((void const   *)parser_state_tos->il),
...
#line 1954
    memcpy((void */* __restrict  */)((void *)new->cstk), (void const   */* __restrict  */)((void const   *)parser_state_tos->cstk),
           (unsigned long )parser_state_tos->p_stack_size * sizeof(int ));
#line 1958
...
#line 1961
    memcpy((void */* __restrict  */)((void *)new->paren_indents), (void const   */* __restrict  */)((void const   *)parser_state_tos->paren_indents),
...
#line 1996
          memcpy((void */* __restrict  */)((void *)parser_state_tos), (void const   */* __restrict  */)((void const   *)second),
                 sizeof(parser_state_ty ));
#line 1998
...
#line 2008
          memcpy((void */* __restrict  */)((void *)parser_state_tos->p_stack), (void const   */* __restrict  */)((void const   *)(parser_state_tos->next)->p_stack),
                 (unsigned long )parser_state_tos->p_stack_size * sizeof(codes_ty ));
#line 2013
          parser_state_tos->il = tos_il;
#line 2014
          memcpy((void */* __restrict  */)((void *)parser_state_tos->il), (void const   */* __restrict  */)((void const   *)(parser_state_tos->next)->il),
                 (unsigned long )parser_state_tos->p_stack_size * sizeof(int ));
#line 2019
          parser_state_tos->cstk = tos_cstk;
#line 2020
          memcpy((void */* __restrict  */)((void *)parser_state_tos->cstk), (void const   */* __restrict  */)((void const   *)(parser_state_tos->next)->cstk),
                 (unsigned long )parser_state_tos->p_stack_size * sizeof(int ));
#line 2025
          parser_state_tos->paren_indents = tos_paren_indents;
#line 2026
          memcpy((void */* __restrict  */)((void *)parser_state_tos->paren_indents),
                 (void const   */* __restrict  */)((void const   *)(parser_state_tos->next)->paren_indents),
                 (unsigned long )parser_state_tos->paren_indents_size * sizeof(short ));
          }
        } else {
#line 2033
...
#line 828
      printf((char const   */* __restrict  */)((char const   *)tmp___5), (char *)p->p_obj);
#line 829
      exit(1);
      }
#line 830
...
#line 1106
          ...
          {
#line 1115
          strcpy((char */* __restrict  */)(b0), (char const   */* __restrict  */)((char const   *)(b1)));
#line 1116
          current = b1;
          }
        }
...
#line 93
  ...
  {
#line 96
  fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)string),
          a0, a1);
#line 97
...
#line 1083
      fwrite((void const   */* __restrict  */)((void const   *)com_st), (size_t )(e_com - com_st),
             (size_t )1, (FILE */* __restrict  */)output);
#line 1084

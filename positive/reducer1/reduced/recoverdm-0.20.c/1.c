...
#line 171
  ...
  {
#line 174
  memcpy((void */* __restrict  */)whereto, (void const   */* __restrict  */)(pframe + 16),
         (size_t )2048);
  }
#line 176
  return (0);
...
{ 
  ...
  {
#line 39
  tmp___2 = stat64((char const   */* __restrict  */)((char const   *)filename), (struct stat64 */* __restrict  */)(& finfo));
  }
#line 39
  if (tmp___2 == -1) {
    {
...
#line 192
    if (dummy) {
      {
#line 194
      memcpy((void */* __restrict  */)((void *)whereto), (void const   */* __restrict  */)((void const   *)dummy),
             block_size);
#line 195
      free((void *)dummy);
      }
...
#line 331
  if ((unsigned long )file_list != (unsigned long )((void *)0)) {
    {
#line 333
    dsecfile = fopen((char const   */* __restrict  */)((char const   *)file_list),
...
#line 172
  ...
  {
#line 174
  fh = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rb");
  }
#line 175
  if (! fh) {
    {

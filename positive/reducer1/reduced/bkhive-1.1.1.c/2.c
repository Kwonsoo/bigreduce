...
#line 144
    kv[8] = (char)0;
#line 145
    sscanf((char const   */* __restrict  */)((char const   *)(kv)), (char const   */* __restrict  */)"%x",
           (int *)(& key[i * 4]));
#line 147
    free((void *)keyname);
#line 120
...
#line 172
  f = fopen((char const   */* __restrict  */)((char const   *)*(argv + 2)), (char const   */* __restrict  */)"wb");
  }
#line 172
  if ((unsigned long )f != (unsigned long )((void *)0)) {
    {
#line 173
    fwrite((void const   */* __restrict  */)((void const   *)(pkey)), (size_t )1,
           (size_t )16, (FILE */* __restrict  */)f);
#line 174
    fclose(f);
    }
  } else {
...
{ 
  ...
  {
#line 44
  memcpy((void */* __restrict  */)((void *)nk), (void const   */* __restrict  */)((void const   *)((h->base + offset) + 4)),
         sizeof(nk_hdr ));
#line 45
...
{ 
  ...
  {
#line 63
  memcpy((void */* __restrict  */)((void *)lf), (void const   */* __restrict  */)((void const   *)((h->base + offset) + 4)),
         sizeof(lf_hdr ));
#line 64
...
{ 
  ...
  {
#line 74
  memcpy((void */* __restrict  */)((void *)vk), (void const   */* __restrict  */)((void const   *)((h->base + offset) + 4)),
         sizeof(vk_hdr ));
#line 75
...
#line 89
  i = 0;
#line 90
  memcpy((void */* __restrict  */)((void *)value), (void const   */* __restrict  */)((void const   *)((h->base + offset) + 4)),
...
#line 100
  pos += 8 * index___0;
#line 101
  memcpy((void */* __restrict  */)((void *)hr), (void const   */* __restrict  */)((void const   *)pos),
         sizeof(hashrecord ));
  }
#line 106
  return (hr);
...
{ 
  ...
  {
#line 131
  hiveh = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rb");
  }
#line 131
...
#line 207
      strncpy((char */* __restrict  */)*root_key, (char const   */* __restrict  */)((char const   *)n->key_name),
              (size_t )n->name_len);
#line 208
      *(*root_key + (int )n->name_len) = (char)0;
#line 209
      free((void *)n);
      }
#line 210
...
#line 233
      if (! tmp___1) {
        {
#line 234
        t = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\\");
        }
        {
#line 238
        while (1) {
...
#line 244
        ...
        {
#line 249
        memcpy((void */* __restrict  */)((void *)*nr), (void const   */* __restrict  */)((void const   *)n),
               sizeof(nk_hdr ));
#line 250
        free((void *)n);
        }
...
#line 280
          if (*len < 5) {
            {
#line 281
            memcpy((void */* __restrict  */)((void *)*buff), (void const   */* __restrict  */)((void const   *)(& v->data_off)),
                   (size_t )*len);
            }
          } else {
            {
...
#line 284
            memcpy((void */* __restrict  */)((void *)*buff), (void const   */* __restrict  */)((void const   *)tmp___2),
                   (size_t )*len);
            }
          }
          {
...
#line 316
    ...
    {
#line 316
    memcpy((void */* __restrict  */)((void *)name), (void const   */* __restrict  */)((void const   *)nk->key_name),
           (size_t )tmp___2);
    }
#line 317
    if (*namelen < (int )nk->name_len) {

...
#line 121
  if ((v4args & 64) == 64) {
    {
#line 122
    memcpy((void */* __restrict  */)((void *)(& ifi_tmp)), (void const   */* __restrict  */)((void const   *)ifi),
...
#line 180
    strncpy((char */* __restrict  */)(if_cur->name), (char const   */* __restrict  */)((char const   *)(ifr->ifr_ifrn.ifrn_name)),
            (size_t )16);
#line 181
...
#line 258
  ...
  {
#line 261
  strncpy((char */* __restrict  */)*(args + 0), (char const   */* __restrict  */)((char const   *)arg1),
          (size_t )127);
#line 262
  strncpy((char */* __restrict  */)*(args + 1), (char const   */* __restrict  */)((char const   *)arg2),
          (size_t )127);
#line 264
  free((void *)arg1);
#line 265
...
#line 318
    strncpy((char */* __restrict  */)(expaddr), (char const   */* __restrict  */)((char const   *)*(argv + argcount)),
            (size_t )127);
#line 323
...
#line 333
    if (x) {
      {
#line 334
      strncpy((char */* __restrict  */)(abox_cur->str), (char const   */* __restrict  */)((char const   *)(expaddr)),
              (size_t )127);
#line 335
      abox_cur->type = 2;
#line 336
...
#line 452
        strncpy((char */* __restrict  */)(ifarg_cur->cmdstr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                (size_t )127);
        }
      }
    }
...
#line 483
          ...
          {
#line 487
          strncpy((char */* __restrict  */)(ifarg_cur->p_v4addr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                  (size_t )18);
#line 488
          strncpy((char */* __restrict  */)(ifarg_cur->cmdstr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                  (size_t )127);
...
#line 495
      if (! abox->resolv) {
        {
#line 496
        strncpy((char */* __restrict  */)(ifarg_cur->p_v6addr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                (size_t )43);
#line 497
        strncpy((char */* __restrict  */)(ifarg_cur->cmdstr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                (size_t )127);
...
#line 512
            strncpy((char */* __restrict  */)(ifarg_cur->cmdstr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                    (size_t )127);
#line 513
            strncpy((char */* __restrict  */)(ifarg_cur->p_v6addr), (char const   */* __restrict  */)((char const   *)(d_resp_cur->str)),
                    (size_t )43);
#line 514
            ifarg_cur->type = (short)2;
#line 516
...
#line 541
          ...
          {
#line 543
          memcpy((void */* __restrict  */)((void *)ifarg_cur), (void const   */* __restrict  */)((void const   *)if_cur),
                 sizeof(struct if_info ));
#line 544
...
#line 550
      if (! if_found) {
        {
#line 551
        strncpy((char */* __restrict  */)(ifarg_cur->name), (char const   */* __restrict  */)((char const   *)(abox->str)),
                (size_t )16);
#line 552
        strncpy((char */* __restrict  */)(ifarg_cur->cmdstr), (char const   */* __restrict  */)((char const   *)(abox->str)),
                (size_t )127);
...
#line 823
    ...
    {
#line 825
    strncpy((char */* __restrict  */)(abox_cur->str), (char const   */* __restrict  */)((char const   *)optarg),
            (size_t )127);
#line 826
    abox_cur->type = 1;
#line 827
...
#line 950
    iffound += tmp___5;
#line 951
    strcpy((char */* __restrict  */)(oldcmdstr), (char const   */* __restrict  */)((char const   *)(ifarg_cur->cmdstr)));
#line 952
...
#line 185
    ...
    {
#line 188
    strncpy((char */* __restrict  */)(addr), (char const   */* __restrict  */)((char const   *)in_addr),
            (size_t )16);
    }
  }
  {
...
#line 266
      ...
      {
#line 263
      tmp___0 = strtoul((char const   */* __restrict  */)((char const   *)buf), (char **/* __restrict  */)((char **)((void *)0)),
                        16);
#line 263
...
#line 451
      ...
      {
#line 444
      tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)(ifi->p_v4nmask)),
...
#line 585
          split ++;
#line 586
          strncpy((char */* __restrict  */)(spstr->nmask), (char const   */* __restrict  */)((char const   *)split),
                  (size_t )3);
          }
        }
      }
...
#line 623
    if (x < 40) {
      {
#line 624
      strncpy((char */* __restrict  */)(spstr->ipv6addr), (char const   */* __restrict  */)((char const   *)addr),
              (size_t )x);
      }
    }
  }
...
#line 839
  ...
  {
#line 840
  tmp___8 = strtol((char const   */* __restrict  */)((char const   *)(str)), (char **/* __restrict  */)((char **)((void *)0)),
                   16);
#line 840
  x = (int )tmp___8;
  }
...
#line 1130
      strcat((char */* __restrict  */)(outad), (char const   */* __restrict  */)((char const   *)(tmpad)));
      }
#line 1131
      if (x != 7) {
        {
...
#line 1286
    tmp = inet_ntop(10, (void const   */* __restrict  */)((void const   *)*(he->h_addr_list + 0)),
...
#line 1288
      ...
      {
#line 1289
      tmp___0 = inet_ntop(10, (void const   */* __restrict  */)((void const   *)*(he->h_addr_list + x)),
                          (char */* __restrict  */)(ip6addr), (socklen_t )128);
#line 1289
      snprintf((char */* __restrict  */)(d_resp->str), (size_t )127, (char const   */* __restrict  */)"%s%s",
               tmp___0, extra);
...
#line 1325
  hints.ai_protocol = 6;
#line 1326
  x = getaddrinfo((char const   */* __restrict  */)((char const   *)raddr), (char const   */* __restrict  */)((char const   *)((void *)0)),
...
#line 1337
      tmp = inet_ntop(10, (void const   */* __restrict  */)((void const   *)(& sin6->sin6_addr)),
                      (char */* __restrict  */)(ip6addr), (socklen_t )128);
#line 1337
      snprintf((char */* __restrict  */)(retaddr___1), (size_t )1023, (char const   */* __restrict  */)"%s%s",
               tmp, extra);
#line 1338
      tmp___0 = inet_ntop(10, (void const   */* __restrict  */)((void const   *)(& sin6->sin6_addr)),
                          (char */* __restrict  */)(ip6addr), (socklen_t )128);
#line 1338
      snprintf((char */* __restrict  */)(d_resp->str), (size_t )127, (char const   */* __restrict  */)"%s%s",
               tmp___0, extra);
...
#line 1395
      sin6 = (struct sockaddr_in6 *)res->ai_addr;
#line 1396
      tmp___1 = inet_ntop(10, (void const   */* __restrict  */)((void const   *)(& sin6->sin6_addr)),
                          (char */* __restrict  */)(ip6addr), (socklen_t )128);
#line 1396
      snprintf((char */* __restrict  */)(retaddr___2), (size_t )1023, (char const   */* __restrict  */)"%s%s",
               tmp___1, extra);
#line 1397
      tmp___2 = inet_ntop(10, (void const   */* __restrict  */)((void const   *)(& sin6->sin6_addr)),
                          (char */* __restrict  */)(ip6addr), (socklen_t )128);
#line 1397
      snprintf((char */* __restrict  */)(d_resp->str), (size_t )127, (char const   */* __restrict  */)"%s%s",
               tmp___2, extra);
...
#line 1485
  if (tmpstr) {
    {
#line 1486
    strncpy((char */* __restrict  */)(extra), (char const   */* __restrict  */)((char const   *)tmpstr),
            (size_t )31);
#line 1487
    tmp___0 = strlen((char const   *)addr);
#line 1487
    tmp___1 = strlen((char const   *)tmpstr);
#line 1487
    strncpy((char */* __restrict  */)(raddr), (char const   */* __restrict  */)((char const   *)addr),
            tmp___0 - tmp___1);
    }
  } else {
    {
...
#line 1504
    ...
    {
#line 1505
    strncpy((char */* __restrict  */)(retaddr___3), (char const   */* __restrict  */)((char const   *)tmpstr),
            (size_t )1024);
    }
#line 1506
    return (retaddr___3);

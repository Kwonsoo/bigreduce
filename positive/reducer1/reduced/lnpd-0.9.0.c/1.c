...
#line 76
  sigaddset(& newset, 29);
#line 77
  sigprocmask(0, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& newset)),
...
#line 84
  sigaddset(& newset, 29);
#line 85
  sigprocmask(1, (sigset_t const   */* __restrict  */)((sigset_t const   *)(& newset)),
              (sigset_t */* __restrict  */)((sigset_t *)((void *)0)));
  }
#line 86
  return;
...
#line 110
  saction.sa_flags = 0;
#line 111
  sigaction(29, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& saction)),
...
#line 159
    result = select(socket_fd + 1, (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                    (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 306
  lnp_buffer[1] = length;
#line 307
  memcpy((void */* __restrict  */)((void *)(lnp_buffer + 2)), (void const   */* __restrict  */)((void const   *)data),
         (size_t )length);
#line 308
...
#line 319
  memcpy((void */* __restrict  */)((void *)(lnp_buffer + 4)), (void const   */* __restrict  */)((void const   *)data),
         (size_t )length);
#line 320
...
#line 373
  tmp___0 = connect(socket_fd, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& server_address))),
...
#line 109
  while (1) {
    ...
    {
#line 111
    tmp___0 = select(0, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                     (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& wtime));
#line 111
    result = tmp___0;
    }
#line 112
...
#line 152
        tmp___0 = select(0, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                         (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& diff));
#line 152
        result = tmp___0;
        }
#line 153
...
#line 202
    memcpy((void */* __restrict  */)((void *)(buffer___5 + 4)), (void const   */* __restrict  */)((void const   *)(lx->text + i)),
           chunkSize);
#line 203
...
#line 228
  sigaction(3, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& saction)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 229
  sigaction(15, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& saction)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 230
  sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& saction)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 231
  return;
...
#line 56
  while (1) {
    ...
    {
#line 58
    tmp___2 = select(0, (fd_set */* __restrict  */)((fd_set *)((void *)0)), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                     (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& wtime));
#line 58
    result = tmp___2;
    }
...
#line 147
      memcpy((void */* __restrict  */)((void *)buffer___5), (void const   */* __restrict  */)((void const   *)(current_client->rcv_buffer)),
...
#line 185
    if ((unsigned int )cinfo->tx_state == 0U) {
      {
#line 187
      memcpy((void */* __restrict  */)((void *)(cinfo->tx_buffer)), (void const   */* __restrict  */)((void const   *)packet),
             (size_t )length);
#line 188
...
#line 79
  vsprintf((char */* __restrict  */)(message + tmp), (char const   */* __restrict  */)((char const   *)format),
           arglist);
  }
#line 81
  if (use_syslog) {
...
#line 55
      ...
      {
#line 61
      lockfp = fopen((char const   */* __restrict  */)((char const   *)(lockname)),

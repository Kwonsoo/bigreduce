...
{ 
  ...
  {
#line 59
  strncpy((char */* __restrict  */)s, (char const   */* __restrict  */)((char const   *)modes[m]),
          (size_t )3);
  }
#line 60
  return;
...
{ 
  ...
  {
#line 81
  ctime_r((time_t const   */* __restrict  */)((time_t const   *)((time_t *)(& val))),
          (char */* __restrict  */)(buf___0));
#line 82
...
#line 167
    ...
    {
#line 169
    memcpy((void */* __restrict  */)((void *)(buf___1 + nbuf)), (void const   */* __restrict  */)((void const   *)arg),
           (size_t )len);
#line 170
    nbuf += len;
    }

...
#line 96
  strcpy((char */* __restrict  */)real_filename, (char const   */* __restrict  */)((char const   *)tmp___3));
#line 97
...
#line 175
    strcpy((char */* __restrict  */)real_filename, (char const   */* __restrict  */)((char const   *)tmp___3));
#line 176
    strcat((char */* __restrict  */)real_filename, (char const   */* __restrict  */)((char const   *)filename));
#line 177
    sym = add_new_file(filename);
#line 178
    fp = fopen((char const   */* __restrict  */)((char const   *)real_filename), (char const   */* __restrict  */)"r");
    }
#line 179
...
#line 342
  ...
  {
#line 345
  infile = fopen((char const   */* __restrict  */)((char const   *)*(argv + 2)), (char const   */* __restrict  */)"r");
  }
#line 346
...
#line 186
  grow_config(len + 1);
#line 188
  memcpy((void */* __restrict  */)((void *)(str_config + len_config)), (void const   */* __restrict  */)((void const   *)name),
         (size_t )len);
#line 189
  len_config += len;
#line 190
...
#line 215
  memcpy((void */* __restrict  */)((void *)s), (void const   */* __restrict  */)((void const   *)m),
         (size_t )slen);
#line 215
  *(s + slen) = (char)0;
#line 217
...
#line 13 "/home/june/collector/temp/busybox-1.21.0/scripts/kconfig/lkc_proto.h"
...
#line 796
  ...
  {
#line 798
  memcpy((void */* __restrict  */)((void *)(text + text_size)), (void const   */* __restrict  */)((void const   *)str),
         (size_t )size);
#line 799
  text_size += size;
#line 800
...
#line 805
  text = (char *)tmp;
#line 806
  memcpy((void */* __restrict  */)((void *)text), (void const   */* __restrict  */)((void const   *)str),
         (size_t )size);
#line 807
  *(text + size) = (char)0;
  }
...
#line 2246
        sprintf((char */* __restrict  */)fullname___0, (char const   */* __restrict  */)"%s/%s",
                env, name);
#line 2247
        f = fopen((char const   */* __restrict  */)((char const   *)fullname___0),
...
#line 80
    sprintf((char */* __restrict  */)fullname, (char const   */* __restrict  */)"%s/%s",
            env, name);
#line 81
    tmp___2 = stat((char const   */* __restrict  */)((char const   *)fullname), (struct stat */* __restrict  */)(& buf));
    }
#line 81
    if (! tmp___2) {
#line 82
...
#line 103
        printf((char const   */* __restrict  */)((char const   *)tmp___0), name);
        }
#line 106
        goto while_break;
      }
...
#line 356
          memcpy((void */* __restrict  */)((void *)(dirname)), (void const   */* __restrict  */)((void const   *)name),
                 (size_t )size);
#line 357
          dirname[size] = (char)0;
          }
...
#line 367
  sprintf((char */* __restrict  */)(newname), (char const   */* __restrict  */)"%s.tmpconfig.%d",
          dirname, tmp___0);
#line 368
  out = fopen((char const   */* __restrict  */)((char const   *)(newname)), (char const   */* __restrict  */)"w");
  }
#line 369
  if (! out) {
#line 370
...
#line 385
  fprintf((FILE */* __restrict  */)out, (char const   */* __restrict  */)((char const   *)tmp___5),
...
#line 398
      tmp___7 = strftime((char */* __restrict  */)(buf), sizeof(buf), (char const   */* __restrict  */)"#define AUTOCONF_TIMESTAMP \"%Y-%m-%d %H:%M:%S %Z\"\n",
                         (struct tm  const  */* __restrict  */)((struct tm  const  *)tmp___6));
#line 398
      ret = tmp___7;
      }
#line 405
...
#line 406
        strftime((char */* __restrict  */)(buf), sizeof(buf), (char const   */* __restrict  */)"#define AUTOCONF_TIMESTAMP \"%Y-%m-%d %H:%M:%S\"\n",
                 (struct tm  const  */* __restrict  */)((struct tm  const  *)tmp___8));
        }
      }
    } else {
      {
...
#line 491
        if (l) {
          {
#line 492
          fwrite((void const   */* __restrict  */)((void const   *)str), (size_t )l,
...
#line 494
            fwrite((void const   */* __restrict  */)((void const   *)str), (size_t )l,
                   (size_t )1, (FILE */* __restrict  */)out_h);
            }
          }
        }
#line 496
...
#line 74
  e = (struct expr *)tmp;
#line 75
  memcpy((void */* __restrict  */)((void *)e), (void const   */* __restrict  */)((void const   *)org),
         sizeof(*org));
  }
#line 77
...
#line 1083
  tmp = strlen(str);
#line 1083
  fwrite((void const   */* __restrict  */)((void const   *)str), tmp, (size_t )1,
         (FILE */* __restrict  */)((FILE *)data));
  }
#line 1084
  return;
}
...
struct symbol symbol_yes  = 
#line 15 "/home/june/collector/temp/busybox-1.21.0/scripts/kconfig/symbol.c"
     {(struct symbol *)0, (char *)"y", (char *)0, (enum symbol_type )0U, {(void *)"y",
                                                                        (tristate )2},
    {(void *)0, (tristate )0U}, (tristate )0U, 129, (struct property *)0, (struct expr *)0,
    (struct expr *)0, {(struct expr *)0, (tristate )0U}};
#line 15 "/home/june/collector/temp/busybox-1.21.0/scripts/kconfig/symbol.c"
struct symbol symbol_mod  = 
#line 15
     {(struct symbol *)0, (char *)"m", (char *)0, (enum symbol_type )0U, {(void *)"m",
                                                                        (tristate )1},
    {(void *)0, (tristate )0U}, (tristate )0U, 130, (struct property *)0, (struct expr *)0,
    (struct expr *)0, {(struct expr *)0, (tristate )0U}};
#line 15 "/home/june/collector/temp/busybox-1.21.0/scripts/kconfig/symbol.c"
struct symbol symbol_no  = 
#line 15
     {(struct symbol *)0, (char *)"n", (char *)0, (enum symbol_type )0U, {(void *)"n",
                                                                        (tristate )0},
    {(void *)0, (tristate )0U}, (tristate )0U, 132, (struct property *)0, (struct expr *)0,
    (struct expr *)0, {(struct expr *)0, (tristate )0U}};
#line 15 "/home/june/collector/temp/busybox-1.21.0/scripts/kconfig/symbol.c"
struct symbol symbol_empty  = 
#line 15
     {(struct symbol *)0, (char *)"", (char *)0, (enum symbol_type )0U, {(void *)"",
                                                                       (tristate )0},
    {(void *)0, (tristate )0U}, (tristate )0U, 128, (struct property *)0, (struct expr *)0,
    (struct expr *)0, {(struct expr *)0, (tristate )0U}};
...
#line 155
  ...
  {
#line 157
  tmp = strtol((char const   */* __restrict  */)((char const   *)sym->curr.val), (char **/* __restrict  */)((char **)((void *)0)),
               base);
  }
#line 157
  return ((int )tmp);
...
#line 540
  ...
  {
#line 541
  tmp___1 = strtol((char const   */* __restrict  */)str, (char **/* __restrict  */)((char **)((void *)0)),
                   10);
#line 541
  val = (int )tmp___1;
#line 542
...
#line 549
  ...
  {
#line 550
  tmp___6 = strtol((char const   */* __restrict  */)str, (char **/* __restrict  */)((char **)((void *)0)),
                   16);
#line 550
  val = (int )tmp___6;
#line 551
...
#line 736
        ...
        {
#line 737
        tmp___1 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& re)),
                          (char const   */* __restrict  */)((char const   *)sym->name),

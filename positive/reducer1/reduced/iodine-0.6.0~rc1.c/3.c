...
#line 478
        ...
        {
#line 479
        memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(rdata)),
               (size_t )rv);
        }
      } else {
#line 481
...
#line 496
      strncpy((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)(name)),
              buflen);
#line 497
...
#line 549
        ...
        {
#line 550
        memcpy((void */* __restrict  */)((void *)(buf + offset)), (void const   */* __restrict  */)((void const   *)(names[i])),
               (size_t )l);
#line 551
        offset += l;
#line 552
...
#line 596
  ...
  {
#line 599
  strncpy((char */* __restrict  */)(q->name), (char const   */* __restrict  */)((char const   *)(name)),
          sizeof(q->name));
#line 600
...
#line 178
    memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)word),
           tmp___4);
#line 179
...
#line 179
    p += tmp___5;
#line 181
    word = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)".");
    }
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 236
  ...
  {
#line 238
  memcpy((void */* __restrict  */)((void *)*dst), (void const   */* __restrict  */)((void const   *)data),
         len);
#line 240
  *dst += len;
  }
...
#line 265
    bufused ++;
#line 267
    memcpy((void */* __restrict  */)((void *)*buf), (void const   */* __restrict  */)((void const   *)from),
           (size_t )tocopy);
#line 268
    *buf += tocopy;
#line 269
...
#line 166
      ...
      {
#line 169
      memcpy((void */* __restrict  */)((void *)(xbuf)), (void const   */* __restrict  */)((void const   *)data),
             (size_t )64);
#line 170
...
#line 341
    copy = tmp;
#line 343
    memcpy((void */* __restrict  */)((void *)(pms->buf + offset)), (void const   */* __restrict  */)((void const   *)p),
           (size_t )copy);
    }
#line 344
    if (offset + copy < 64) {
...
#line 356
  if (left) {
    {
#line 357
    memcpy((void */* __restrict  */)((void *)(pms->buf)), (void const   */* __restrict  */)((void const   *)p),
           (size_t )left);
    }
  }
#line 358
...
extern  __attribute__((__noreturn__)) void err(int __status , char const   *__format 
                                               , ...) ;
...
#line 37
    tmp = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"nameserver %15s",
                 addr);
    }
#line 37
    if (tmp == 1) {
...
{ 
  ...
  {
#line 194
  file = fopen((char const   */* __restrict  */)((char const   *)pidfile), (char const   */* __restrict  */)"w");
  }
#line 194
...
#line 258
  strncpy((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)(pwd)),
          len);
#line 259
...
#line 41
  ...
  {
#line 43
  memcpy((void */* __restrict  */)((void *)(temp)), (void const   */* __restrict  */)((void const   *)pass),
         (size_t )32);
#line 44
  ix = (int *)(temp);
#line 46
...
#line 197
    ...
    {
#line 199
    strncpy((char */* __restrict  */)(password___1), (char const   */* __restrict  */)((char const   *)optarg),
            sizeof(password___1));
#line 200
...
extern  __attribute__((__noreturn__)) void errx(int __status , char const   *__format 
                                                , ...) ;
...
#line 345
  ...
  {
#line 347
  memcpy((void */* __restrict  */)((void *)(packet)), (void const   */* __restrict  */)((void const   *)(raw_header)),
         (size_t )4);
  }
#line 348
  if (len) {
    {
#line 349
    memcpy((void */* __restrict  */)((void *)(& packet[4])), (void const   */* __restrict  */)((void const   *)buf),
           (size_t )len);
    }
  }
  {
...
#line 577
  ...
  {
#line 578
  memcpy((void */* __restrict  */)((void *)outdata), (void const   */* __restrict  */)((void const   *)(buf + 1)),
         (size_t )buflen);
  }
#line 579
  return (buflen);
...
#line 605
  tmp = recvfrom(dns_fd, (void */* __restrict  */)((void *)(data)), sizeof(data),
...
#line 636
      if (rv > 0) {
        {
#line 637
        memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(data)),
               (size_t )rv);
        }
      }
    } else
...
#line 721
    r = select(dns_fd + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 801
  ...
  {
#line 801
  memcpy((void */* __restrict  */)((void *)(outpkt.data)), (void const   */* __restrict  */)((void const   *)(out)),
         tmp___0);
#line 802
  outpkt.sentlen = 0;
#line 803
...
#line 1030
    ...
    {
#line 1035
    memcpy((void */* __restrict  */)((void *)(& inpkt.data[inpkt.len])), (void const   */* __restrict  */)((void const   *)(& buf[2])),
           datalen);
#line 1036
...
#line 1164
    ...
    {
#line 1164
    i = select(tmp___1 + 1, (fd_set */* __restrict  */)(& fds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
               (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tv));
#line 1166
...
#line 1231
  ...
  {
#line 1231
  memcpy((void */* __restrict  */)((void *)(& data[1])), (void const   */* __restrict  */)((void const   *)login),
         (size_t )tmp);
#line 1233
...
#line 1337
  rand_seed = (uint16_t )((int )rand_seed + 1);
#line 1339
  strncat((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)s),
          (size_t )512);
#line 1340
...
#line 1489
        ...
        {
#line 1490
        tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(in)),
                         (char const   */* __restrict  */)"%64[^-]-%64[^-]-%d-%d",
...
{ 
  ...
  {
#line 31
  memcpy((void */* __restrict  */)((void *)(& fwq[fwq_ix])), (void const   */* __restrict  */)((void const   *)fw_query),

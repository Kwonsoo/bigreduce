...
#line 78
  *tmp = (char )'\000';
#line 79
  tmp___0 = strtol((char const   */* __restrict  */)((char const   *)p), (char **/* __restrict  */)((char **)((void *)0)),
                   10);
#line 79
  port = (int )tmp___0;
#line 81
...
#line 88
  ...
  {
#line 90
  memcpy((void */* __restrict  */)((void *)(& sa.sin_addr)), (void const   */* __restrict  */)((void const   *)*(he->h_addr_list + 0)),
         (size_t )he->h_length);
#line 92
  fd = socket(2, 1, 6);
  }
...
#line 67
  sigaction(11, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 69
  sa.__sigaction_handler.sa_handler = & sigbus;
#line 70
  sigaction(7, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 72
...
#line 82
  sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 84
...
#line 90
  sa.__sigaction_handler.sa_handler = (void (*)(int  ))1;
#line 91
  sigaction(10, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
#line 93
  sa.__sigaction_handler.sa_handler = (void (*)(int  ))1;
#line 94
  sigaction(12, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sa)),
            (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 95
  return;
...
#line 40 "/home/june/collector/temp/boa-0.94.14rc21/src/boa.c"
...
#line 109
  if ((unsigned long )pid_file != (unsigned long )((void *)0)) {
    {
#line 110
    tmp___0 = fopen((char const   */* __restrict  */)((char const   *)pid_file), (char const   */* __restrict  */)"w");
#line 110
    PID_FILE = tmp___0;
    }
#line 111
...
#line 56
  ...
  {
#line 58
  memcpy((void */* __restrict  */)((void *)(req->buffer + req->buffer_end)), (void const   */* __restrict  */)((void const   *)msg___4),
         (size_t )msg_len);
#line 59
...
#line 196
  p --;
#line 196
  memcpy((void */* __restrict  */)((void *)tmp___20), (void const   */* __restrict  */)((void const   *)(month_tab + 4 * t->tm_mon)),
         (size_t )3);
#line 197
  tmp___21 = p;
#line 197
...
#line 468
  p --;
#line 468
  memcpy((void */* __restrict  */)((void *)tmp), (void const   */* __restrict  */)((void const   *)" GMT"),
         (size_t )4);
#line 470
  a = (unsigned int )t->tm_sec;
#line 471
...
#line 490
  p --;
#line 490
  memcpy((void */* __restrict  */)((void *)tmp___10), (void const   */* __restrict  */)((void const   *)(month_tab + 4 * t->tm_mon)),
         (size_t )4);
#line 491
  tmp___11 = p;
#line 491
...
#line 496
  p -= 3;
#line 497
  memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)(day_tab + t->tm_wday * 4)),
         (size_t )4);
  }
#line 498
  return;
...
#line 559
    if (len___0 < size) {
      {
#line 560
      memcpy((void */* __restrict  */)((void *)storage), (void const   */* __restrict  */)((void const   *)(boa_tempfile)),
             (size_t )(len___0 + 1U));
      }
    } else {
      {
...
#line 69
  ...
  {
#line 69
  *(common_cgi_env + (int )tmp___0) = env_gen_extra("PATH", tmp___1, 0U);
#line 73
  tmp___2 = common_cgi_env_count;
#line 73
  common_cgi_env_count = (short )((int )common_cgi_env_count + 1);
#line 73
  *(common_cgi_env + (int )tmp___2) = env_gen_extra("SERVER_SOFTWARE", "Boa/0.94.14rc21",
                                                    0U);
#line 75
...
#line 75
  common_cgi_env_count = (short )((int )common_cgi_env_count + 1);
#line 75
  *(common_cgi_env + (int )tmp___3) = env_gen_extra("SERVER_NAME", (char const   *)server_name,
                                                    0U);
#line 76
...
#line 76
  common_cgi_env_count = (short )((int )common_cgi_env_count + 1);
#line 76
  *(common_cgi_env + (int )tmp___4) = env_gen_extra("GATEWAY_INTERFACE", "CGI/1.1",
                                                    0U);
#line 79
...
#line 79
  *(common_cgi_env + (int )tmp___5) = env_gen_extra("SERVER_PORT", (char const   *)tmp___6,
                                                    0U);
#line 92
...
#line 92
  common_cgi_env_count = (short )((int )common_cgi_env_count + 1);
#line 92
  *(common_cgi_env + (int )tmp___7) = env_gen_extra("SERVER_ADMIN", (char const   *)server_admin,
                                                    0U);
#line 93
  airac_observe(common_cgi_env, (int )common_cgi_env_count);
#line 93
  *(common_cgi_env + (int )common_cgi_env_count) = (char *)((void *)0);
  }
#line 96
...
#line 116
  ...
  {
#line 118
  *(common_cgi_env + (int )common_cgi_env_count) = env_gen_extra((char const   *)key,
                                                                 (char const   *)value,
                                                                 0U);
  }
#line 119
  if ((unsigned long )*(common_cgi_env + (int )common_cgi_env_count) == (unsigned long )((void *)0)) {
    {
#line 121
...
#line 162
  if (result) {
    {
#line 163
    memcpy((void */* __restrict  */)((void *)(result + extra)), (void const   */* __restrict  */)((void const   *)key),
           (size_t )key_len);
#line 164
    *((result + extra) + key_len) = (char )'=';
#line 165
    memcpy((void */* __restrict  */)((void *)(((result + extra) + key_len) + 1)),
           (void const   */* __restrict  */)((void const   *)value), (size_t )value_len);
#line 166
...
#line 205
    if (prefix_len) {
      {
#line 206
      memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)"HTTP_"),
             (size_t )5);
      }
    }
#line 207
...
#line 512
    *(newpath + 1) = (char )'/';
#line 513
    memcpy((void */* __restrict  */)((void *)(newpath + 2)), (void const   */* __restrict  */)((void const   *)req->pathname),
           (size_t )(l - 2U));
#line 514
    free((void *)oldpath);
#line 515
...
#line 47
  if (error_log_name) {
    {
#line 51
    error_log = open_gen_fd((char const   *)error_log_name);
    }
#line 52
    if (error_log < 0) {
      {
...
#line 63
  if (access_log_name) {
    {
#line 64
    access_log = open_gen_fd((char const   *)access_log_name);
    }
  } else {
    {
#line 66
...
#line 81
  if (cgi_log_name) {
    {
#line 82
    cgi_log_fd = open_gen_fd((char const   *)cgi_log_name);
    }
#line 83
    if (cgi_log_fd == -1) {
      {
...
#line 249
  fputs((char const   */* __restrict  */)((char const   *)tmp___0), (FILE */* __restrict  */)stderr);
#line 250
  tmp___1 = __errno_location();
#line 250
  *tmp___1 = errno_save;
...
#line 77
      ...
      {
#line 80
      memcpy((void */* __restrict  */)((void *)(gzip_pathname)), (void const   */* __restrict  */)((void const   *)req->pathname),
             (size_t )len___0);
#line 81
      memcpy((void */* __restrict  */)((void *)(gzip_pathname + len___0)), (void const   */* __restrict  */)((void const   *)".gz"),
             (size_t )3);
#line 82
...
#line 188
        ...
        {
#line 190
        memcpy((void */* __restrict  */)((void *)(buffer___1)), (void const   */* __restrict  */)((void const   *)prefix),
               (size_t )l4);
#line 191
        memcpy((void */* __restrict  */)((void *)(buffer___1 + l4)), (void const   */* __restrict  */)((void const   *)host),
               (size_t )l2);
#line 192
        buffer___1[l4 + l2] = (char )':';
#line 193
        memcpy((void */* __restrict  */)((void *)(((buffer___1 + l4) + l2) + 1)),
               (void const   */* __restrict  */)((void const   *)port), (size_t )l3);
#line 194
        memcpy((void */* __restrict  */)((void *)((((buffer___1 + l4) + l2) + 1) + l3)),
               (void const   */* __restrict  */)((void const   *)(req->request_uri)),
               (size_t )len___1);
#line 195
...
#line 204
        memcpy((void */* __restrict  */)((void *)(buffer___1 + l4)), (void const   */* __restrict  */)((void const   *)host),
               (size_t )l2);
#line 205
        memcpy((void */* __restrict  */)((void *)((buffer___1 + l4) + l2)), (void const   */* __restrict  */)((void const   *)(req->request_uri)),
               (size_t )len___1);
#line 206
...
#line 399
        handle_sigbus = 1;
#line 400
        memcpy((void */* __restrict  */)((void *)(req->buffer + req->buffer_end)),
               (void const   */* __restrict  */)((void const   *)(req->data_mem + r->start)),
               (size_t )bytes_free);
#line 402
        handle_sigbus = 0;
        }
...
#line 533
    ...
    {
#line 535
    memcpy((void */* __restrict  */)((void *)(pathname_with_index)), (void const   */* __restrict  */)((void const   *)req->pathname),
           (size_t )l1);
#line 536
    memcpy((void */* __restrict  */)((void *)(pathname_with_index + l1)), (void const   */* __restrict  */)((void const   *)directory_index),
           (size_t )(l2 + 1U));
#line 538
...
#line 540
    if (data_fd != -1) {
      {
#line 545
      memcpy((void */* __restrict  */)((void *)(req->request_uri)), (void const   */* __restrict  */)((void const   *)directory_index),
             (size_t )(l2 + 1U));
#line 546
      fstat(data_fd, statbuf);
      }
...
#line 640
      strcpy((char */* __restrict  */)(req->request_uri), (char const   */* __restrict  */)((char const   *)directory_index));
      }
#line 641
      return (data_fd);
    }
...
#line 700
  ...
  {
#line 703
  fdstream = fopen((char const   */* __restrict  */)((char const   *)dest_filename),
...
#line 258
    ...
    {
#line 260
    memcpy((void */* __restrict  */)((void *)(buffer)), (void const   */* __restrict  */)((void const   *)current->realname),
           (size_t )current->real_len);
#line 261
    memcpy((void */* __restrict  */)((void *)(buffer + current->real_len)), (void const   */* __restrict  */)((void const   *)(req->request_uri + current->fake_len)),
...
#line 325
        ...
        {
#line 328
        memcpy((void */* __restrict  */)((void *)(buffer)), (void const   */* __restrict  */)((void const   *)user_homedir),
               (size_t )l1);
#line 329
        buffer[l1] = (char )'/';
#line 331
        memcpy((void */* __restrict  */)((void *)((buffer + l1) + 1)), (void const   */* __restrict  */)((void const   *)user_dir),
               (size_t )(l2 + 1U));
        }
#line 332
        if (p) {
          {
#line 333
          memcpy((void */* __restrict  */)((void *)(((buffer + l1) + 1) + l2)), (void const   */* __restrict  */)((void const   *)p),
                 (size_t )(l3___0 + 1U));
          }
        }
      }
...
#line 355
    ...
    {
#line 358
    memcpy((void */* __restrict  */)((void *)(buffer)), (void const   */* __restrict  */)((void const   *)vhost_root),
           (size_t )l1___0);
#line 359
    buffer[l1___0] = (char )'/';
#line 360
    memcpy((void */* __restrict  */)((void *)((buffer + l1___0) + 1)), (void const   */* __restrict  */)((void const   *)(req->local_ip_addr)),
           (size_t )l2___0);
#line 361
    buffer[(l1___0 + 1U) + l2___0] = (char )'/';
#line 362
    memcpy((void */* __restrict  */)((void *)((((buffer + l1___0) + 1) + l2___0) + 1)),
           (void const   */* __restrict  */)((void const   *)ap), (size_t )l3___1);
#line 363
    buffer[(((l1___0 + 1U) + l2___0) + 1U) + l3___1] = (char )'/';
#line 364
    memcpy((void */* __restrict  */)((void *)((((((buffer + l1___0) + 1) + l2___0) + 1) + l3___1) + 1)),
           (void const   */* __restrict  */)((void const   *)"htdocs"), (size_t )l4___0);
#line 366
    memcpy((void */* __restrict  */)((void *)(((((((buffer + l1___0) + 1) + l2___0) + 1) + l3___1) + 1) + l4___0)),
           (void const   */* __restrict  */)((void const   *)(req->request_uri)),
           (size_t )(l5 + 1U));
    }
  } else
...
#line 383
    ...
    {
#line 387
    memcpy((void */* __restrict  */)((void *)(buffer)), (void const   */* __restrict  */)((void const   *)document_root),
           (size_t )l1___1);
    }
#line 388
    if (virtualhost) {
...
#line 389
      buffer[l1___1] = (char )'/';
#line 390
      memcpy((void */* __restrict  */)((void *)((buffer + l1___1) + 1)), (void const   */* __restrict  */)((void const   *)(req->local_ip_addr)),
             (size_t )l3___2);
#line 391
      memcpy((void */* __restrict  */)((void *)(((buffer + l1___1) + 1) + l3___2)),
             (void const   */* __restrict  */)((void const   *)(req->request_uri)),
             (size_t )(l2___1 + 1U));
      }
    } else {
      {
#line 393
      memcpy((void */* __restrict  */)((void *)(buffer + l1___1)), (void const   */* __restrict  */)((void const   *)(req->request_uri)),
             (size_t )(l2___1 + 1U));
      }
    }
  } else {
...
#line 485
    ...
    {
#line 487
    memcpy((void */* __restrict  */)((void *)(pathname)), (void const   */* __restrict  */)((void const   *)vhost_root),
           (size_t )l1);
#line 488
    pathname[l1] = (char )'/';
#line 489
    memcpy((void */* __restrict  */)((void *)((pathname + l1) + 1)), (void const   */* __restrict  */)((void const   *)(req->local_ip_addr)),
           (size_t )l2);
#line 490
    pathname[(l1 + 1U) + l2] = (char )'/';
#line 491
    memcpy((void */* __restrict  */)((void *)((((pathname + l1) + 1) + l2) + 1)),
           (void const   */* __restrict  */)((void const   *)ap), (size_t )l3___0);
#line 492
    pathname[(((l1 + 1U) + l2) + 1U) + l3___0] = (char )'/';
#line 493
    memcpy((void */* __restrict  */)((void *)((((((pathname + l1) + 1) + l2) + 1) + l3___0) + 1)),
           (void const   */* __restrict  */)((void const   *)current1->realname),
           (size_t )current1->real_len);
#line 495
    memcpy((void */* __restrict  */)((void *)(((((((pathname + l1) + 1) + l2) + 1) + l3___0) + 1) + current1->real_len)),
           (void const   */* __restrict  */)((void const   *)(& req->request_uri[current1->fake_len])),
...
#line 504
    ...
    {
#line 506
    memcpy((void */* __restrict  */)((void *)(pathname)), (void const   */* __restrict  */)((void const   *)current1->realname),
           (size_t )current1->real_len);
#line 507
    memcpy((void */* __restrict  */)((void *)(pathname + current1->real_len)), (void const   */* __restrict  */)((void const   *)(& req->request_uri[current1->fake_len])),
           (size_t )((uri_len - current1->fake_len) + 1U));
    }
  }
  {
...
#line 535
      pathname[i] = (char )'\000';
#line 536
      err = stat((char const   */* __restrict  */)((char const   *)(pathname)), (struct stat */* __restrict  */)(& statbuf));
      }
#line 537
      if (err == -1) {
        {
...
#line 626
        ...
        {
#line 629
        memcpy((void */* __restrict  */)((void *)(buffer___0)), (void const   */* __restrict  */)((void const   *)current->realname),
               (size_t )current->real_len);
#line 634
        memcpy((void */* __restrict  */)((void *)(buffer___0 + current->real_len)),
               (void const   */* __restrict  */)((void const   *)(req->path_info + current->fake_len)),
...
#line 672
          ...
          {
#line 674
          memcpy((void */* __restrict  */)((void *)req->path_translated), (void const   */* __restrict  */)((void const   *)user_homedir),
                 (size_t )l1___0);
#line 675
          *(req->path_translated + l1___0) = (char )'/';
#line 676
          memcpy((void */* __restrict  */)((void *)((req->path_translated + l1___0) + 1)),
                 (void const   */* __restrict  */)((void const   *)user_dir), (size_t )(l2___0 + 1U));
          }
#line 677
          if (p) {
            {
#line 678
            memcpy((void */* __restrict  */)((void *)(((req->path_translated + l1___0) + 1) + l2___0)),
                   (void const   */* __restrict  */)((void const   *)p), (size_t )(l3___1 + 1U));
            }
          }
        } else {
#line 646
...
#line 689
        ...
        {
#line 691
        memcpy((void */* __restrict  */)((void *)req->path_translated), (void const   */* __restrict  */)((void const   *)document_root),
               (size_t )l1___1);
#line 692
        memcpy((void */* __restrict  */)((void *)(req->path_translated + l1___1)),
               (void const   */* __restrict  */)((void const   *)req->path_info),
               (size_t )(l2___1 + 1U));
        }
      }
    }
...
#line 83
    (req->header_line) --;
#line 84
    memcpy((void */* __restrict  */)((void *)req->header_line), (void const   */* __restrict  */)((void const   *)"HTTP/1.0 "),
           (size_t )9);
    }
  }
#line 175
...
#line 183
  ...
  {
#line 185
  tmp = strtol((char const   */* __restrict  */)((char const   *)v1), (char **/* __restrict  */)(& endptr),
               0);
#line 185
  i = (int )tmp;
  }
...
{ 
  ...
  {
#line 305
  f = fopen((char const   */* __restrict  */)((char const   *)v1), (char const   */* __restrict  */)"r");
  }
#line 306
...
#line 95
      tmp___2 = select(max_fd + 1, (fd_set */* __restrict  */)(& block_read_fdset),
                       (fd_set */* __restrict  */)(& block_write_fdset), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 196
    tmp___5 = getsockopt(conn->fd, 1, 7, (void */* __restrict  */)((void *)(& system_bufsize)),
                         (socklen_t */* __restrict  */)(& len___0));
    }
#line 196
    if (tmp___5 == 0) {
...
#line 651
  if (tmp___5) {
    {
#line 720
    memcpy((void */* __restrict  */)((void *)(req->request_uri)), (void const   */* __restrict  */)((void const   *)stop),
           (size_t )(stop2 - stop));
    }
  } else {
    {
...
#line 738
      ...
      {
#line 741
      tmp___8 = sscanf((char const   */* __restrict  */)((char const   *)stop2), (char const   */* __restrict  */)"HTTP/%u.%u",
                       & p1, & p2);
      }
#line 741
      if (tmp___8 == 2) {
...
#line 114
  ...
  {
#line 116
  memcpy((void */* __restrict  */)((void *)dest), (void const   */* __restrict  */)((void const   *)buf___0),
         (size_t )newlen);
#line 117
...
#line 244
    dirbuf = *(array + i);
#line 246
    tmp___5 = stat((char const   */* __restrict  */)((char const   *)(dirbuf->d_name)),
...
#line 283
    dirbuf = *(array + i);
#line 285
    tmp___13 = stat((char const   */* __restrict  */)((char const   *)(dirbuf->d_name)),
                    (struct stat */* __restrict  */)(& statbuf));
    }
#line 285
    if (tmp___13 == -1) {

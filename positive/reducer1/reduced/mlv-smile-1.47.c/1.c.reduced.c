...
#line 55
Noeud *AjouteSequence(Noeud *Arbre___0 , unsigned char *S , int taille_fenetre ) ;
#line 57
void CloseTheFirstPhase(Liste **debut_liste , Liste **fin_liste , Noeud **fin_liste_pere ) ;
#line 62
Noeud *CaseOneAddSequence(Noeud *Arbre___0 , int taille_fenetre ) ;
#line 64
Noeud *CaseTwoAddSequence(Noeud *Arbre___0 , Noeud *resultat , Noeud *pere , int taille_fenetre ) ;
#line 66
Noeud *CaseTreeAddSequence(Noeud *Arbre___0 , Noeud *resultat , int deb , int fin ,
                           int taille_fenetre ) ;
#line 68
Noeud *CaseFourAddSequence(Noeud *Arbre___0 , Noeud *resultat , Noeud *pere , int res_type ,
...
#line 630
    if (position_arc == -1) {
      {
#line 633
      tmp___0 = CaseTreeAddSequence(Arbre___0, resultat, i + res_type, (i + res_type) + 1,
                                    taille_fenetre);
      }
#line 633
      return (tmp___0);
...
#line 647
      if ((unsigned long )pere != (unsigned long )Arbre___0) {
#line 648
...
#line 666
    if (! (res_type == 3)) {
      {
#line 671
      tmp___3 = CaseTreeAddSequence(Arbre___0, pere, (i + res_type) - position_arc,
                                    (i + res_type) + 1, taille_fenetre);
      }
#line 671
      return (tmp___3);
    }
...
#line 675
    ...
    {
#line 677
    resultat = FindString(Arbre___0, j, i, & pere, & res_type, & position_arc);
    }
#line 678
    if (res_type == 1) {
      {
...
#line 724
  Fin_liste = Debut_liste;
#line 725
  Ajoute_Fils_Au_Noeud(Arbre___0, (Noeud *)tmp_f);
#line 727
  Premiere_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste, & Fin_liste_pere,
                 & nb_el_liste, 1);
#line 730
  fictive = Deuxieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste,
                           & Fin_liste_pere, & nb_el_liste, taille_fenetre, 0, 0);
#line 734
  Troisieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste, & Fin_liste_pere,
                  & nb_el_liste, fictive);
  }
#line 737
  return (Arbre___0);
...
#line 757
  fictive = Deuxieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste,
                           & Fin_liste_pere, & nb_el_liste, taille_fenetre, 1, 0);
#line 761
  Troisieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste, & Fin_liste_pere,
                  & nb_el_liste, fictive);
  }
...
#line 838
        if ((unsigned long )resultat != (unsigned long )Arbre___0) {
#line 839
...
#line 888
    fictive = Deuxieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste,
                             & Fin_liste_pere, & nb_el_liste, tmp___2, fictive, 0);
#line 892
    Troisieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste, & Fin_liste_pere,
                    & nb_el_liste, fictive);
    }
...
#line 936
  printf((char const   */* __restrict  */)"Arbre = %p \n taille_fenetre = %d \nDebut_liste = %p ->feuille %p \nFin_liste = %p ->feuille %p\nFin_liste_pere = %p\nnb_element_liste=%d\ni = %d\nFictive = 0\n",
         Arbre___0, taille_fenetre, Debut_liste, Debut_liste->feuille, Fin_liste,
         Fin_liste->feuille, Fin_liste_pere, nb_el_liste, i);
#line 945
  fictive = Deuxieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste,
                           & Fin_liste_pere, & nb_el_liste, i, 1, 0);
#line 948
  Troisieme_Phase(Arbre___0, taille_fenetre, & Debut_liste, & Fin_liste, & Fin_liste_pere,
                  & nb_el_liste, fictive);
  }
...
#line 138
  f___0 = fopen((char const   */* __restrict  */)((char const   *)(cr.ficalph)), (char const   */* __restrict  */)"r");
  }
#line 138
  if (! f___0) {
    {
...
#line 217
        ...
        {
#line 218
        strncpy((char */* __restrict  */)*(seq + j), (char const   */* __restrict  */)((char const   *)*(origseq + j)),
                (size_t )*(seqlen + j));
#line 217
        j ++;
        }
...
#line 74
    *dest = (Bit_Tab *)tmp;
#line 75
    tmp___0 = memcpy((void */* __restrict  */)((void *)*dest), (void const   */* __restrict  */)((void const   *)src),
...
#line 82
    tmp___1 = memcpy((void */* __restrict  */)((void *)*dest), (void const   */* __restrict  */)((void const   *)src),
...
#line 184
      if (! ((int )*((unsigned short *)(*tab + 2) + (int )i) != value)) {
#line 184
        goto while_break;
      }
    } else {
...
#line 69
  *maxsizeseq = 0;
#line 70
  strcpy((char */* __restrict  */)(alpha), (char const   */* __restrict  */)((char const   *)alphaseq___0));
#line 71
...
#line 103
  while (1) {
    ...
    {
#line 103
    tmp___13 = readnextseq(infile, seqname, & seq, & maxseqlenalloc, errstr);
#line 103
...
#line 123
      ...
      {
#line 124
      strncpy((char */* __restrict  */)*(*origseq + seqno), (char const   */* __restrict  */)((char const   *)seq),
              (size_t )*(*seqlen + seqno));
      }
    }
    {
#line 128
    indexseq((signed char *)seq, *(*seqlen + seqno), letter);
#line 130
...
#line 248
      ...
      {
#line 250
      memcpy((void */* __restrict  */)((void *)*(seq + i)), (void const   */* __restrict  */)((void const   *)*(seqstart + i)),
             (size_t )(k - 1));
#line 258
      j = 0;
      }
...
#line 46
int nbSymbSeq ;
#line 48 "/home/wheatley/newnew/temp/mlv-smile-1.47/SigStat/grep+/Spell/src/grep+.c"
int carseq2num[127]  ;
#line 49 "/home/wheatley/newnew/temp/mlv-smile-1.47/SigStat/grep+/Spell/src/grep+.c"
...
#line 735
  siztxt = 500;
#line 738
  fasta = fopen((char const   */* __restrict  */)((char const   *)fic), (char const   */* __restrict  */)"r");
  }
#line 739
...
#line 769
      ...
      {
#line 771
      strcpy((char */* __restrict  */)((char *)*(a->text + a->nbtxt)), (char const   */* __restrict  */)((char const   *)(*(seq + a->nbtxt))->seq));
#line 772
...
#line 821
  *(root_pere->fils + (int )Translation_Table[36]) = a->arbre;
#line 822
...
#line 200
  ...
  {
#line 202
  memcpy((void */* __restrict  */)((void *)(dest->occ + dest->pos)), (void const   */* __restrict  */)((void const   *)((source->occ + last_dummy) + 1)),
...
#line 231
  ...
  {
#line 237
  memcpy((void */* __restrict  */)((void *)(dest->occ + dest->pos)), (void const   */* __restrict  */)((void const   *)source->occ),
...
#line 70
  if ((unsigned long )alphaseq___0 != (unsigned long )((void *)0)) {
    {
#line 72
    strcpy((char */* __restrict  */)((char *)(alphSeq)), (char const   */* __restrict  */)((char const   *)alphaseq___0));
#line 73
...
#line 229
    ...
    {
#line 230
    strcpy((char */* __restrict  */)nummod2str[nbSymbMod], (char const   */* __restrict  */)((char const   *)(line)));
#line 234
    nbSymbMod ++;
    }
  }
...
#line 36
      airac_observe(Translation_Table, i);
#line 36
...
#line 59
  *(N->fils + (int )Translation_Table[*(*(Sequence + F->sequence_number) + (F->debut & 2147483647))]) = F;
#line 60
  return;
}
}
...
#line 69
  return (*(N->fils + (int )Translation_Table[*(*(Sequence + current_sequence) + indice)]));
}
}
...
#line 185
      *(tmp_n->fils + (int )Translation_Table[*(*(Sequence + res->sequence_number) + tmp_n->fin)]) = res;
      }
#line 187
      if ((unsigned int )res->debut & 2147483648U) {
#line 189
...
#line 197
      Ajoute_Position_Liste(Liste_positions_fin, & tmp_f->fin_deb, fin, 0);
#line 198
      *(N->fils + (int )Translation_Table[*(*(Sequence + tmp_n->sequence_number) + tmp_n->debut)]) = tmp_n;
#line 199
      *(tmp_n->fils + (int )Translation_Table[*(*(Sequence + tmp_f->sequence_number) + (tmp_f->debut & 2147483647))]) = (Noeud *)tmp_f;
#line 200
      *type___0 = 3;
      }
#line 201
...
#line 126
  *(buffer + 64) = (char )'\000';
#line 128
  tmp = sscanf((char const   */* __restrict  */)((char const   *)(buffer + 1)), (char const   */* __restrict  */)"%s",
               name);
  }
#line 128
  if (tmp != 1) {
...
#line 215
  strcpy((char */* __restrict  */)(seq->name), (char const   */* __restrict  */)((char const   *)tmp___2));
#line 217
  tmp___3 = GetFastaComment(buffer);
#line 217
  strcpy((char */* __restrict  */)(seq->comment), (char const   */* __restrict  */)((char const   *)tmp___3));
  }
  {
#line 219
  while (1) {
...
#line 241
    ...
    {
#line 247
    memcpy((void */* __restrict  */)((void *)(seq->seq + seq->length)), (void const   */* __restrict  */)((void const   *)buffer),
           (size_t )readlen);
#line 250
    seq->length = buflen;
    }
...
#line 285
  strcpy((char */* __restrict  */)(seq->name), (char const   */* __restrict  */)((char const   *)tmp___1));
#line 287
  tmp___2 = GetFastaComment(buffer);
#line 287
  strcpy((char */* __restrict  */)(seq->comment), (char const   */* __restrict  */)((char const   *)tmp___2));
  }
  {
#line 289
  while (1) {
...
#line 348
    *end = (char )'\000';
#line 349
    fputs((char const   */* __restrict  */)((char const   *)buf), (FILE */* __restrict  */)streamou);
#line 350
    fputc('\n', streamou);
#line 351
    *end = tempo;
...
#line 89
  seed = 1000001U;
#line 90
  fp = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
  }
#line 91
...
{ 
  ...
  {
#line 113
  fp = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"w");
  }
#line 114
  if ((unsigned long )fp != (unsigned long )((void *)0)) {
    {
...
#line 65
  while (1) {
    ...
    {
#line 70
    tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(line)), (char const   */* __restrict  */)"%s %s %d %d\n",
...
#line 79
    ...
    {
#line 80
    strcpy((char */* __restrict  */)(modeles + i)->mot, (char const   */* __restrict  */)((char const   *)(modele)));
#line 83
...
#line 136
        ...
        {
#line 139
        sscanf((char const   */* __restrict  */)((char const   *)(line)), (char const   */* __restrict  */)"%d\n",
...
{ 
  ...
  {
#line 161
  f___0 = fopen((char const   */* __restrict  */)((char const   *)nom), (char const   */* __restrict  */)((char const   *)mode));
  }
#line 163
  if ((unsigned long )f___0 == (unsigned long )((void *)0)) {
    {
...
#line 420
  strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"%/ ");
#line 421
...
#line 423
  tmp___4 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 423
  cr->longmod.min = atoi((char const   *)tmp___4);
#line 425
  tmp___5 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 425
...
#line 428
  ...
  {
#line 430
  tmp___6 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 430
...
#line 436
      strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 437
      tmp___8 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 437
      tmp = atoi((char const   *)tmp___8);
#line 438
      setLongueurBloc(cr, (signed char )i, tmp);
#line 440
      tmp___9 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 440
...
#line 442
      if (i != (int )cr->bloc - 1) {
        {
#line 444
        tmp___11 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 444
        tmp = atoi((char const   *)tmp___11);
#line 445
        tmp___12 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 445
...
#line 434
  ...
  {
#line 452
  tmp___13 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 452
  strcpy((char */* __restrict  */)(cr->ficalph), (char const   */* __restrict  */)((char const   *)tmp___13));
#line 453
  tmp___14 = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)" ");
#line 453
  strcpy((char */* __restrict  */)(cr->alphaseq), (char const   */* __restrict  */)((char const   *)tmp___14));
  }
#line 455
  return ((Flag )1);
}
...
#line 159
    ...
    {
#line 160
    strcpy((char */* __restrict  */)alphMod[nbSymbMod], (char const   */* __restrict  */)((char const   *)(line)));
    }
    {
#line 161
    while (1) {
...
#line 339
                                              strcpy((char */* __restrict  */)(tmp),
                                                     (char const   */* __restrict  */)((char const   *)nummod2str[i]));
#line 340
                                              sprintf((char */* __restrict  */)nummod2str[i],
...
#line 350
        ...
        {
#line 355
        strcpy((char */* __restrict  */)(tmp), (char const   */* __restrict  */)((char const   *)nummod2str[i]));
#line 356
...
#line 107
    ...
    {
#line 109
    sscanf((char const   */* __restrict  */)((char const   *)*argv), (char const   */* __restrict  */)"p%d/%d",
           & i, & j);
#line 110
...
#line 672
                tmp___1 = avanceBranche(next___1, tmpocc, symbol, carseq2num[(int )carseq],
                                        (Flag )0, (P_Criteres )cr, curbloc, multiblocs);
                }
#line 672
                if (tmp___1) {
                  {
...
#line 715
                tmp___3 = avanceBranche(next___1, tmpocc, symbol, trans, (Flag )1,
                                        (P_Criteres )cr, curbloc, multiblocs);
                }
#line 715
                if (tmp___3) {
                  {
...
#line 789
                  if (tmp_quorum2 >= cr->quorum) {
                    {
#line 789
                    tmp___5 = gestionSaut((P_PileOcc )model___1, (P_Criteres )pocc___1,
                                          (int )poccnew, (signed char **)cr, curbloc);
                    }
#line 789
                    if (tmp___5 != 0) {
                      {
...
#line 921
                      ...
                      {
#line 923
                      keepModel((P_PileOcc )model___1, (int )pocc___1, (P_Criteres )nbseq,
                                (unsigned int *)tmp_quorum, (FILE *)longmod, longbloc,
                                cr);
                      }
#line 924
                      return ((Flag )0);
...
#line 940
        ...
        {
#line 942
        keepModel((P_PileOcc )model___1, (int )pocc___1, (P_Criteres )nbseq, (unsigned int *)tmp_quorum,
                  (FILE *)longmod, longbloc, cr);
        }
#line 943
        return ((Flag )0);
      } else {
...
#line 971
  root_pere = Alloc_Noeud();
#line 972
  *(root_pere->fils + (int )Translation_Table[36]) = root;
#line 973
  root_pere->sequence_number = 0;
#line 974
  root->debut = 0;
...
{ 
  ...
  {
#line 127
  strcpy((char */* __restrict  */)(buf), (char const   */* __restrict  */)((char const   *)nom));
#line 129
...
#line 161
      strcat((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)(tmp)));
#line 163
...
#line 166
      ...
      {
#line 176
      *f___0 = fopen((char const   */* __restrict  */)((char const   *)buf), (char const   */* __restrict  */)"w");
      }
#line 178
      if ((unsigned long )*f___0 == (unsigned long )((void *)0)) {
#line 179
...
#line 467
      res ++;
#line 468
      tmp___1 = addSaut2Code(curocc.codesaut, longsaut, curbloc, (P_Criteres )cr);
#line 468
...
#line 531
            res ++;
#line 532
            tmp___4 = addSaut2Code(curocc.codesaut, newlongsaut, curbloc, (P_Criteres )cr);
#line 532

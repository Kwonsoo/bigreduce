...
void *foreach_dirinpath_data2, *try_dlopen_tmp___26, *lt__malloc_mem;
char *find_file_callback_pdir;
int find_handle_callback, try_dlopen_newhandle;
void *lt__zalloc();
...
lt_dlopenadvise_handle() {
  int *phandle = try_dlopen_tmp___26 = lt__zalloc();
  *phandle = try_dlopen_tmp___26;
  unload_deplibs(*phandle);
  find_handle(&try_dlopen_newhandle);
  phandle = try_dlopen_newhandle;
}

...
#line 697
  while (1) {
    ...
    {
#line 697
    dir_name = argz_next((char const   */* __restrict  */)((char const   *)argz),
                         argz_len, (char const   */* __restrict  */)((char const   *)dir_name));
    }
#line 697
    if (! dir_name) {
#line 697
...
#line 710
    ...
    {
#line 711
    strcpy((char */* __restrict  */)filename, (char const   */* __restrict  */)((char const   *)dir_name));
    }
#line 713
    if (base_name) {
#line 713
...
#line 747
  ...
  {
#line 749
  tmp___0 = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
#line 749
  *pfile = tmp___0;
  }
#line 749
...
#line 1014
      ...
      {
#line 1016
      memcpy((void */* __restrict  */)((void *)tmp___2), (void const   */* __restrict  */)((void const   *)(str + 1)),
             (size_t )((end - str) - 1L));
#line 1017
...
#line 1233
    ...
    {
#line 1236
    strncpy((char */* __restrict  */)dir, (char const   */* __restrict  */)((char const   *)canonical),
            dirlen);
#line 1237
    *(dir + dirlen) = (char )'\000';
#line 1239
...
#line 1370
        ...
        {
#line 1376
        file = fopen((char const   */* __restrict  */)((char const   *)attempt), (char const   */* __restrict  */)"r");
        }
      }
#line 1381
      if (! file) {
...
#line 1753
    while (1) {
      ...
      {
#line 1753
      before = argz_next((char const   */* __restrict  */)((char const   *)*pargz),
                         *pargz_len, (char const   */* __restrict  */)((char const   *)before));
      }
#line 1753
      if (! before) {
#line 1753
...
#line 1815
  strncat((char */* __restrict  */)buf, (char const   */* __restrict  */)((char const   *)(dp->d_name)),
          end_offset);
#line 1816
...
#line 1878
  while (1) {
    ...
    {
#line 1878
    filename = argz_next((char const   */* __restrict  */)((char const   *)argz),
                         argz_len, (char const   */* __restrict  */)((char const   *)filename));
    }
#line 1878
    if (! filename) {
#line 1878
...
#line 2054
    if ((handle->vtable)->sym_prefix) {
      {
#line 2056
      strcpy((char */* __restrict  */)sym, (char const   */* __restrict  */)((char const   *)(handle->vtable)->sym_prefix));
#line 2057
      strcat((char */* __restrict  */)sym, (char const   */* __restrict  */)((char const   *)handle->info.name));
      }
    } else {
      {
#line 2061
      strcpy((char */* __restrict  */)sym, (char const   */* __restrict  */)((char const   *)handle->info.name));
      }
    }
    {
#line 2064
...
#line 85
      return ((lt_dlvtable const   *)((lt_dlvtable *)0));
    }
  }
#line 88
  return ((lt_dlvtable const   *)vtable);
}
}
#line 104
...
#line 349
          if (! ((unsigned long )symbol->name != (unsigned long )((char const   *)0))) {
#line 349
            goto while_break___0;
          }
#line 351
          if ((unsigned long )symbol->address == (unsigned long )((void *)0)) {
            {
#line 351
...
#line 66
  if ((unsigned long )vtable___0->module_open == (unsigned long )((lt_module_open *)0)) {
    {
#line 73
    tmp = lt__error_string(2);
#line 73
...
#line 66
  if ((unsigned long )vtable___0->module_close == (unsigned long )((lt_module_close *)0)) {
    {
#line 73
    tmp = lt__error_string(2);
#line 73
...
#line 66
  if ((unsigned long )vtable___0->find_sym == (unsigned long )((lt_find_sym *)0)) {
    {
#line 73
    tmp = lt__error_string(2);
#line 73

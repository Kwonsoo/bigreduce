...
#line 190
      ...
      {
#line 191
      tmp = streq(proc->arg_type, (char *)"void");
      }
#line 191
      if (tmp) {
#line 192
...
#line 231
    fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\tbzero((char *)&%s, sizeof(%s));\n",
            ARG, ARG);
#line 232
    printif((char *)"getargs", TRANSP, (char *)"&", ARG);
#line 233
    printerr((char *)"decode", TRANSP);
#line 234
    fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\t\treturn;\n");
#line 235
    fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\t}\n");
...
#line 242
    printerr((char *)"systemerr", TRANSP);
#line 243
    fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\t}\n");
#line 245
    printif((char *)"freeargs", TRANSP, (char *)"&", ARG);
#line 246
...
#line 277
    ...
    {
#line 278
    tmp = streq(proc->proc_num, (char *)"0");
    }
#line 278
    if (tmp) {
#line 279
...
{ 
  ...
  {
#line 102
  tmp = isvectordef(type, (relation )4);
  }
#line 102
  if (tmp) {
#line 103
...
#line 114
  tmp = streq(proc->res_type, (char *)"void");
  }
#line 114
  if (tmp) {
    {
...
#line 128
  fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\t}\n");
#line 129
  tmp___6 = streq(proc->res_type, (char *)"void");
  }
#line 129
  if (tmp___6) {
    {
...
#line 66
  if ((unsigned int )tokp->kind != (unsigned int )expect) {
    {
#line 67
    expected1((tok_kind )((unsigned int )expect));
    }
  }
#line 69
  return;
...
#line 81
    if ((unsigned int )tokp->kind != (unsigned int )expect2) {
      {
#line 82
      expected2((tok_kind )((unsigned int )expect1), (tok_kind )((unsigned int )expect2));
      }
    }
  }
#line 84
...
#line 97
      if ((unsigned int )tokp->kind != (unsigned int )expect3) {
        {
#line 99
        expected3((tok_kind )((unsigned int )expect1), (tok_kind )((unsigned int )expect2),
                  (tok_kind )((unsigned int )expect3));
        }
      }
    }
  }
...
#line 114
  ...
  {
#line 116
  error((char *)"constant or identifier expected");
  }
  switch_break: ;
#line 118
  return;
...
#line 325
  if ((int )*p == 0) {
    {
#line 326
    error((char *)"unterminated string constant");
    }
  }
  {
#line 328
...
#line 330
  *val = (char *)tmp___0;
#line 331
  strncpy((char */* __restrict  */)*val, (char const   */* __restrict  */)((char const   *)*str),
          (size_t )size);
#line 332
  *(*val + size) = (char)0;
#line 333
...
#line 415
  strncpy((char */* __restrict  */)tokp->str, (char const   */* __restrict  */)((char const   *)str),
          (size_t )len);
#line 416
  *(tokp->str + len) = (char)0;
#line 417
...
#line 87
  ...
  {
#line 89
  error((char *)"definition keyword expected");
  }
  switch_break: 
  {
#line 91
  scan((tok_kind )14, & tok);
#line 92
  isdefined(defp);
  }
#line 93
...
#line 157
      get_type(& plist->res_prefix, & plist->res_type, & dummy, (defkind )5);
#line 158
      tmp___1 = streq(plist->res_type, (char *)"opaque");
      }
#line 158
      if (tmp___1) {
        {
#line 159
        error((char *)"illegal result type");
        }
      }
      {
#line 161
...
#line 163
      scan((tok_kind )2, & tok);
#line 164
      get_type(& plist->arg_prefix, & plist->arg_type, & dummy, (defkind )5);
#line 165
      tmp___2 = streq(plist->arg_type, (char *)"opaque");
      }
#line 165
      if (tmp___2) {
        {
#line 166
        error((char *)"illegal argument type");
        }
      }
      {
#line 168
...
#line 183
    scan((tok_kind )14, & tok);
#line 184
    scan2((tok_kind )35, (tok_kind )5, & tok);
    }
#line 149
...
#line 210
    scan3((tok_kind )11, (tok_kind )5, (tok_kind )12, & tok);
    }
#line 211
...
#line 214
      scan2((tok_kind )11, (tok_kind )5, & tok);
      }
    }
#line 216
    *tailp = elist;
...
#line 231
  scan((tok_kind )12, & tok);
#line 232
  scan2((tok_kind )0, (tok_kind )1, & tok);
#line 233
  defp->def.co = tok.str;
  }
#line 234
...
#line 247
  defp->def_name = tok.str;
#line 248
  scan((tok_kind )18, & tok);
#line 249
  scan((tok_kind )2, & tok);
#line 250
  get_declaration(& dec, (defkind )2);
#line 251
...
#line 265
    scan((tok_kind )14, & tok);
#line 266
    scan3((tok_kind )19, (tok_kind )20, (tok_kind )5, & tok);
    }
  }
  while_break___0: /* CIL Label */ ;
  }
...
#line 294
  strncpy((char */* __restrict  */)(defp->def.ty.old_pstorage), (char const   */* __restrict  */)(dec.pstorage),
          (size_t )128);
#line 295
...
{ 
  ...
  {
#line 308
  get_type(& dec->prefix, & dec->type, & dec->storage, (defkind )((unsigned int )dkind));
#line 309
  dec->rel = (relation )4;
#line 310
  dec->pstorage[0] = (char )'\000';
#line 311
  tmp = streq(dec->type, (char *)"void");
  }
#line 311
  if (tmp) {
#line 312
  ...
  {
#line 314
  scan2((tok_kind )10, (tok_kind )0, & tok);
  }
#line 315
...
#line 319
  dec->name = tok.str;
#line 320
  tmp___3 = peekscan((tok_kind )6, & tok);
  }
#line 320
  if (tmp___3) {
#line 321
    if ((unsigned int )dec->rel == 3U) {
      {
#line 322
      error((char *)"no array-of-pointer declarations -- use typedef");
      }
    }
    {
#line 324
...
#line 335
    ...
    {
#line 336
    tmp___2 = peekscan((tok_kind )8, & tok);
    }
#line 336
    if (tmp___2) {
#line 337
...
#line 340
      dec->rel = (relation )1;
#line 341
      tmp___1 = peekscan((tok_kind )9, & tok);
      }
#line 341
      if (tmp___1) {
#line 342
...
#line 346
  ...
  {
#line 349
  tmp___5 = streq(dec->type, (char *)"opaque");
  }
#line 349
  if (tmp___5) {
#line 350
...
#line 350
      if ((unsigned int )dec->rel != 0U) {
        {
#line 351
        error((char *)"array declaration expected");
        }
      }
    }
  } else {
    {
#line 353
    tmp___4 = streq(dec->type, (char *)"string");
    }
#line 353
    if (tmp___4) {
#line 354
      if ((unsigned int )dec->rel != 1U) {
        {
#line 355
        error((char *)"variable-length array declaration expected");
        }
      }
    }
  }
...
#line 398
    if ((unsigned int )dkind != 5U) {
      {
#line 399
      error((char *)"voids allowed only inside union and program definitions");
      }
    }
  }
#line 401
...
#line 421
  ...
  {
#line 423
  error((char *)"expected type specifier");
  }
  switch_break: ;
#line 425
  return;
...
#line 138
  if (decl) {
    {
#line 138
    tmp___0 = streq(decl->type, (char *)"void");
    }
#line 138
    if (! tmp___0) {
      {
...
#line 210
  if (proc->res_prefix) {
    {
#line 211
    tmp = streq(proc->res_prefix, (char *)"enum");
    }
#line 211
    if (tmp) {
      {
...
#line 214
  ...
  {
#line 217
  tmp___2 = streq(proc->res_type, (char *)"bool");
  }
#line 217
  if (tmp___2) {
    {
#line 218
    ...
    {
#line 219
    tmp___1 = streq(proc->res_type, (char *)"string");
    }
#line 219
    if (tmp___1) {
      {
...
#line 331
    prefix = (char *)"";
#line 332
    tmp___3 = streq(dec->type, (char *)"bool");
    }
#line 332
    if (tmp___3) {
#line 333
      ...
      {
#line 334
      tmp___2 = streq(dec->type, (char *)"opaque");
      }
#line 334
      if (tmp___2) {
#line 335
...
#line 92
static int parseargs(int argc , char **argv , struct commandline *cmd___0 ) ;
#line 93
...
{ 
  ...
  {
#line 103
  tmp = parseargs(argc, argv, & cmd___0);
  }
#line 103
  if (! tmp) {
    {
...
#line 135
  if (cmd___0.cflag) {
    {
#line 136
    c_output(cmd___0.infile, (char *)"-DRPC_XDR", 0, cmd___0.outfile);
    }
  } else
#line 137
  if (cmd___0.hflag) {
    {
#line 138
    h_output(cmd___0.infile, (char *)"-DRPC_HDR", 0, cmd___0.outfile);
    }
  } else
#line 139
  if (cmd___0.lflag) {
    {
#line 140
    l_output(cmd___0.infile, (char *)"-DRPC_CLNT", 0, cmd___0.outfile);
    }
  } else
#line 141
  if (cmd___0.sflag) {
    {
#line 142
    s_output(argc, argv, cmd___0.infile, (char *)"-DRPC_SVC", 0, cmd___0.outfile,
             cmd___0.mflag);
    }
  } else
#line 141
...
#line 142
    ...
    {
#line 145
    c_output(cmd___0.infile, (char *)"-DRPC_XDR", 1, (char *)"_xdr.c");
#line 146
    reinitialize();
#line 147
    h_output(cmd___0.infile, (char *)"-DRPC_HDR", 1, (char *)".h");
#line 148
    reinitialize();
#line 149
    l_output(cmd___0.infile, (char *)"-DRPC_CLNT", 1, (char *)"_clnt.c");
#line 150
    reinitialize();
#line 151
    s_output(allc, allv, cmd___0.infile, (char *)"-DRPC_SVC", 1, (char *)"_svc.c",
             cmd___0.mflag);
    }
  }
  {
...
#line 182
  ...
  {
#line 184
  strcpy((char */* __restrict  */)res, (char const   */* __restrict  */)((char const   *)file));
#line 185
  strcpy((char */* __restrict  */)(res + (p - file)), (char const   */* __restrict  */)((char const   *)ext));
  }
#line 186
  return (res);
}
...
#line 204
  ...
  {
#line 206
  fout = fopen((char const   */* __restrict  */)((char const   *)outfile), (char const   */* __restrict  */)"w");
  }
#line 207
...
#line 486
        if ((int )c == 115) {
          {
#line 487
          tmp___0 = streq(*(argv + i), (char *)"udp");
          }
#line 487
          if (! tmp___0) {
            {
#line 487
            tmp___1 = streq(*(argv + i), (char *)"tcp");
            }
#line 487
            if (! tmp___1) {
#line 489
...
#line 457
  ...
  while_break: 
#line 507
  cmd___0->cflag = (int )flag['c'];
#line 508
  cmd___0->hflag = (int )flag['h'];
#line 509
  cmd___0->sflag = (int )flag['s'];
#line 510
  cmd___0->lflag = (int )flag['l'];
#line 511
  cmd___0->mflag = (int )flag['m'];
#line 512
  nflags = (((cmd___0->cflag + cmd___0->hflag) + cmd___0->sflag) + cmd___0->lflag) + cmd___0->mflag;
#line 513
  if (nflags == 0) {
#line 514
    if ((unsigned long )cmd___0->outfile != (unsigned long )((void *)0)) {
#line 515
      return (0);
    } else
#line 514
    if ((unsigned long )cmd___0->infile == (unsigned long )((void *)0)) {
#line 515
      return (0);
    }
  } else
...
{ 
  ...
  {
#line 100
  tmp = findval(defined, type, (int (*)())(& findtype));
#line 100
  def = (definition *)tmp;
  }
#line 101
...
#line 116
    ...
    {
#line 114
    tmp = isvectordef(def->def.ty.old_type, (relation )((unsigned int )def->def.ty.rel));
    }
#line 114
    if (! tmp) {
      {
...
#line 200
  ...
  {
#line 202
  tmp___0 = streq(type, (char *)"string");
  }
#line 202
  if (tmp___0) {
#line 203
...
#line 222
    ...
    {
#line 223
    tmp___1 = streq(type, (char *)"opaque");
    }
#line 223
    if (tmp___1) {
#line 224
  ...
  {
#line 226
  tmp___3 = streq(type, (char *)"string");
  }
#line 226
  if (tmp___3) {
    {
...
#line 248
  ...
  {
#line 250
  tmp___5 = streq(type, (char *)"string");
  }
#line 250
  if (tmp___5) {
#line 251
    ...
    {
#line 252
    tmp___4 = streq(type, (char *)"opaque");
    }
#line 252
    if (tmp___4) {
#line 253
  ...
  {
#line 255
  tmp___6 = streq(type, (char *)"string");
  }
#line 255
  if (tmp___6) {
    {
...
#line 311
    fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\tcase %s:\n",
            cl->case_name);
#line 312
    tmp___3 = streq(cs->type, (char *)"void");
    }
#line 312
    if (! tmp___3) {
      {
#line 313
      tmp___9 = strlen((char const   *)def->def_name);
#line 313
      tmp = (int )tmp___9;
#line 313
      tmp___10 = strlen((char const   *)format);
#line 313
      tmp___0 = (int )tmp___10;
#line 313
      tmp___11 = strlen((char const   *)cs->name);
#line 313
      tmp___1 = (int )tmp___11;
#line 313
      tmp___2 = malloc((size_t )((unsigned int )(((tmp + tmp___0) + tmp___1) + 1)));
#line 313
      object = (char *)tmp___2;
#line 315
      sprintf((char */* __restrict  */)object, (char const   */* __restrict  */)((char const   *)format),
...
#line 323
  if ((unsigned long )dflt != (unsigned long )((void *)0)) {
    {
#line 324
    tmp___8 = streq(dflt->type, (char *)"void");
    }
#line 324
    if (! tmp___8) {
      {
#line 325
      fprintf((FILE */* __restrict  */)fout, (char const   */* __restrict  */)"\tdefault:\n");
#line 326
      tmp___12 = strlen((char const   *)def->def_name);
#line 326
      tmp___4 = (int )tmp___12;
#line 326
      tmp___13 = strlen((char const   *)format);
#line 326
      tmp___5 = (int )tmp___13;
#line 326
      tmp___14 = strlen((char const   *)dflt->name);
#line 326
      tmp___6 = (int )tmp___14;
#line 326
...
#line 354
    if (dl->decl.storage == -1) {
      {
#line 355
      tmp = findval(defined, dl->decl.type, (int (*)())(& findtype));
#line 355
      d = (definition *)tmp;
      }
#line 356
...
#line 416
  rel = dec->rel;
#line 419
  tmp = isvectordef(type, (relation )((unsigned int )rel));
  }
#line 419
  if (tmp) {
    {
...
{ 
  ...
  {
#line 76
  memset((void *)(curline), 0, (size_t )1024);
#line 77
  where = curline;
#line 78
  linenum = 0;
...
{ 
  ...
  {
#line 315
  tmp = toktostr((tok_kind )((unsigned int )exp1));
#line 315
...
{ 
  ...
  {
#line 327
  tmp = toktostr((tok_kind )((unsigned int )exp2));
#line 327
  tmp___0 = toktostr((tok_kind )((unsigned int )exp1));
#line 327
...
{ 
  ...
  {
#line 340
  tmp = toktostr((tok_kind )((unsigned int )exp3));
#line 340
  tmp___0 = toktostr((tok_kind )((unsigned int )exp2));
#line 340
  tmp___1 = toktostr((tok_kind )((unsigned int )exp1));
#line 340
...
#line 19
  ...
  {
#line 20
  fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)s1),
          s2);
#line 21
...
extern int ( __attribute__((__nonnull__(1))) open)(char const   *__file , int __oflag 
                                                   , ...) ;
#line 31 "/home/june/collector/temp/acm-5.0/dis/sdbm/dba.c"
int sdump(int pagf ) ;
#line 55
...
#line 49
  while (1) {
    ...
    {
#line 49
    tmp___0 = read(pagf, (void *)(pag), (size_t )1024);
#line 49
    b = (int )tmp___0;
    }
#line 49
...
#line 64
    ...
    {
#line 66
    oops((char *)"read failed: block %d", (char *)n);
    }
  }
#line 67
  return (0);
...
#line 78
  off -= key.dsize;
#line 79
  memcpy((void */* __restrict  */)((void *)(pag + off)), (void const   */* __restrict  */)((void const   *)key.dptr),
         (size_t )key.dsize);
#line 80
  *(ino + (n + 1)) = (short )off;
#line 84
  off -= val.dsize;
#line 85
  memcpy((void */* __restrict  */)((void *)(pag + off)), (void const   */* __restrict  */)((void const   *)val.dptr),
         (size_t )val.dsize);
#line 86
  *(ino + (n + 2)) = (short )off;
#line 90
...
#line 250
  ino = (short *)(cur);
#line 252
  memcpy((void */* __restrict  */)((void *)(cur)), (void const   */* __restrict  */)((void const   *)pag),
         (size_t )1024);
#line 253
...
#line 117
  tmp___7 = malloc((size_t )((unsigned int )n));
#line 117
  tmp___4 = (int )tmp___7;
#line 117
...
#line 118
  ...
  {
#line 122
  tmp___5 = strcpy((char */* __restrict  */)dirname, (char const   */* __restrict  */)((char const   *)file));
#line 122
  dirname = strcat((char */* __restrict  */)tmp___5, (char const   */* __restrict  */)".dir");
#line 123
  tmp___6 = strlen((char const   *)dirname);
#line 123
  pagname = strcpy((char */* __restrict  */)((dirname + tmp___6) + 1), (char const   */* __restrict  */)((char const   *)file));
#line 124
...
#line 340
      db->pagbno = newp;
#line 341
      memcpy((void */* __restrict  */)((void *)pag), (void const   */* __restrict  */)((void const   *)new),
             (size_t )1024);
      }
    } else {
      {

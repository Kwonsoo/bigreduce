...
{ 
  ...
  {
#line 51
  fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)(ustring)),
          progname);
  }
#line 52
  return;
...
#line 81
  strncpy((char */* __restrict  */)(su.sun_path), (char const   */* __restrict  */)((char const   *)pathname),
          (size_t )108);
#line 82
  su.sun_path[107] = (char)0;
#line 84
  tmp = stat((char const   */* __restrict  */)((char const   *)(su.sun_path)), (struct stat */* __restrict  */)(& st));
  }
#line 84
  if (! tmp) {
#line 84
...
#line 226
    active_socket = accept(socket_handle, (struct sockaddr */* __restrict  */)((struct sockaddr *)(& peer)),
                           (socklen_t */* __restrict  */)((socklen_t *)(& alen)));
    }
#line 226
    if (active_socket == -1) {
      {
...
#line 118
    while (1) {
      ...
      {
#line 120
      selret = select(fdset_width, (fd_set */* __restrict  */)(& readfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),

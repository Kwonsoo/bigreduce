...
#line 171
  oldc = (char)0;
#line 174
  fp = fopen((char const   */* __restrict  */)((char const   *)opt.filename), (char const   */* __restrict  */)"rb");
  }
#line 175
  if (! fp) {
    {
...
#line 178
    ...
    {
#line 180
    tmp = fread((void */* __restrict  */)((void *)(fbuf)), (size_t )1, sizeof(fbuf),
                (FILE */* __restrict  */)fp);
#line 180
    i = (int )tmp;
#line 181
...
#line 182
    ...
    {
#line 183
    memcpy((void */* __restrict  */)((void *)((vbuf + read) - i)), (void const   */* __restrict  */)((void const   *)(fbuf)),
           (size_t )i);
    }
  }
  while_break___2: /* CIL Label */ ;

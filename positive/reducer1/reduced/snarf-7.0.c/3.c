...
#line 64
      if (! ((int )rsrc->options & (1 << 4))) {
        {
#line 64
        tmp___1 = fopen((char const   */* __restrict  */)((char const   *)rsrc->outfile),
...
#line 64
        ...
        {
#line 64
        tmp___2 = fopen((char const   */* __restrict  */)((char const   *)rsrc->outfile),
...
#line 412
  tmp___6 = __builtin_va_arg(args, char *);
#line 412
  tmp___0 = tmp___6;
#line 412
  s = tmp___0;
...
#line 426
    ...
    {
#line 427
    strcat((char */* __restrict  */)concat, (char const   */* __restrict  */)((char const   *)s));
#line 428
...
#line 527
  memcpy((void */* __restrict  */)((void *)(& sa.sin_addr)), (void const   */* __restrict  */)((void const   *)*(host->h_addr_list + 0)),
...
#line 99
  username = (char *)tmp;
#line 100
  memcpy((void */* __restrict  */)((void *)username), (void const   */* __restrict  */)((void const   *)string),
         (size_t )(i + 1));
#line 102
  *(username + i) = (char )'\000';
#line 104
...
#line 138
  password = (char *)tmp;
#line 141
  memcpy((void */* __restrict  */)((void *)password), (void const   */* __restrict  */)((void const   *)string),
         (size_t )i);
#line 142
  *(password + i) = (char )'\000';
#line 144
...
#line 161
  hostname = (char *)tmp;
#line 163
  memcpy((void */* __restrict  */)((void *)hostname), (void const   */* __restrict  */)((void const   *)url),
         (size_t )i);
#line 165
  *(hostname + i) = (char )'\000';
  }
...
#line 190
  memcpy((void */* __restrict  */)((void *)port_string), (void const   */* __restrict  */)((void const   *)url),
         (size_t )(i + 1));
#line 192
...
#line 214
  path = (char *)tmp___0;
#line 215
  memcpy((void */* __restrict  */)((void *)path), (void const   */* __restrict  */)((void const   *)url),
         (size_t )(i + 1));
#line 216
  *(path + i) = (char )'/';
#line 217
...
#line 236
  memcpy((void */* __restrict  */)((void *)file), (void const   */* __restrict  */)((void const   *)string),
         tmp___1 + 1UL);
#line 238
  u->file = file;
  }
...
#line 369
        ...
        {
#line 369
        tmp___3 = fopen((char const   */* __restrict  */)((char const   *)rsrc->outfile),
                        (char const   */* __restrict  */)"w");
#line 369
        tmp___4 = tmp___3;
        }
...
#line 405
            fwrite((void const   */* __restrict  */)((void const   *)raw_header),
                   (size_t )1, tmp___8, (FILE */* __restrict  */)stderr);
            }
          }
          {
#line 410
...
#line 94
      fwrite((void const   */* __restrict  */)((void const   *)(buf)), (size_t )1,
             (size_t )bytes_read, (FILE */* __restrict  */)stderr);
      }
    }
#line 96
    if ((int )buf[0] == 52) {
...
#line 422
  if (! passive) {
    {
#line 423
    data_sock = accept(data_sock, (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)0)),
                       (socklen_t */* __restrict  */)((socklen_t *)((void *)0)));
    }
  }
#line 427
  if (line) {
...
#line 429
      if (! ((int )rsrc->options & (1 << 4))) {
        {
#line 429
        tmp___12 = fopen((char const   */* __restrict  */)((char const   *)rsrc->outfile),
                         (char const   */* __restrict  */)"a");
#line 429
        tmp___14 = tmp___12;
        }
        ...
        {
#line 429
        tmp___13 = fopen((char const   */* __restrict  */)((char const   *)rsrc->outfile),
                         (char const   */* __restrict  */)"w");
#line 429
        tmp___14 = tmp___13;
        }

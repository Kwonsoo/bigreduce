...
#line 195
  ...
  {
#line 203
  memcpy((void */* __restrict  */)((void *)buffer), (void const   */* __restrict  */)((void const   *)((blockbuffer + extra) + cdromsectoroffset)),
         (size_t )xlength);
#line 204
...
#line 104
    ret = vfprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)format),
                   ap);
#line 105
    __builtin_va_end(ap);
    }
...
#line 422
    if (writeremain != 0L) {
      {
#line 423
      memcpy((void */* __restrict  */)((void *)(databuffer + writeoffset)), (void const   */* __restrict  */)((void const   *)marker),
             (size_t )writeremain);
      }
    } else {
      {
#line 425
      memcpy((void */* __restrict  */)((void *)(databuffer + writeoffset)), (void const   */* __restrict  */)((void const   *)(nullmarker)),
             (size_t )writeremain);
      }
    }
#line 427
...
#line 504
        fclose(*xblocksin);
#line 505
        *xblocksin = fopen((char const   */* __restrict  */)((char const   *)xblocksinfile),
...
#line 551
        tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)textbuffer),
                         (char const   */* __restrict  */)"%llu", & tmp_pos);
        }
#line 551
        if (tmp___0 != 1) {
#line 551
...
#line 606
      tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)textbuffer),
                       (char const   */* __restrict  */)"%llu", lastsourceblock);
      }
#line 606
      if (tmp___0 != 1) {
#line 606
...
#line 792
  tmp___20 = stat((char const   */* __restrict  */)((char const   *)sourcefile), (struct stat */* __restrict  */)(& filestatus));
  }
#line 792
  if (! tmp___20) {
#line 793
...
#line 799
  if (lowlevel > 0) {
    {
#line 800
    tmp___73 = lowlevel_filesize(sourcefile, filesize);
#line 800
    tmp___21 = (int )tmp___73;
#line 800
    filesize = (off_t )tmp___21;
#line 801
    tmp___74 = lowlevel_blocksize(sourcefile, fsblocksize);
#line 801
    tmp___22 = (int )tmp___74;
#line 801
...
#line 984
  if (incremental == 1) {
    {
#line 985
    bblocksin = fopen((char const   */* __restrict  */)((char const   *)bblocksinfile),
                      (char const   */* __restrict  */)"r");
    }
#line 986
...
#line 1046
  if ((unsigned long )timingfilestring != (unsigned long )((void *)0)) {
    {
#line 1047
    timingfile = fopen((char const   */* __restrict  */)((char const   *)timingfilestring),
...
#line 1154
              tmp = fgets((char */* __restrict  */)(textbuffer), 64, (FILE */* __restrict  */)bblocksin);
#line 1155
              tmp___51 = sscanf((char const   */* __restrict  */)((char const   *)(textbuffer)),
                                (char const   */* __restrict  */)"%llu", & lastsourceblock);
              }
#line 1155
              if (tmp___51 != 1) {
...
#line 1248
            tmp = fgets((char */* __restrict  */)(textbuffer), 64, (FILE */* __restrict  */)xblocksin);
#line 1249
            tmp___52 = sscanf((char const   */* __restrict  */)((char const   *)(textbuffer)),
                              (char const   */* __restrict  */)"%llu", & tmp_pos);
            }
#line 1249
            if (tmp___52 != 1) {
...
#line 1350
      select(source + 1, (fd_set */* __restrict  */)(& rfds), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 1376
        tmp___75 = read_desperately(sourcefile, & source, (unsigned char *)databuffer,
                                    sposition, maxremain, seekable, desperate, syncmode);
#line 1376
        tmp___55 = (int )tmp___75;
#line 1376
...
#line 1375
      debug(2, (char *)"debug: low level read\n");
#line 1376
      tmp___76 = read_desperately(sourcefile, & source, (unsigned char *)databuffer,
                                  sposition, maxremain, seekable, desperate, syncmode);
#line 1376
      tmp___55 = (int )tmp___76;
#line 1376
      block = (off_t )tmp___55;
      }
    }

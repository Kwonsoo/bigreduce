...
#line 111
void cli_print(struct cli_def *cli , char const   *format  , ...) ;
#line 115
...
#line 104
    ...
    {
#line 106
    sscanf((char const   */* __restrict  */)((char const   *)*(argv + 1)), (char const   */* __restrict  */)"%u",
           & sec);
    }
#line 107
    if (sec < 1U) {
...
#line 310
  while (1) {
    ...
    {
#line 310
    x = accept(s, (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)0)),
               (socklen_t */* __restrict  */)((socklen_t *)0));
    }
#line 310
    if (! x) {
#line 310
...
#line 112
void cli_bufprint(struct cli_def *cli , char const   *format  , ...) ;
#line 113
void cli_vabufprint(struct cli_def *cli , char const   *format , va_list ap ) ;
#line 114
void cli_error(struct cli_def *cli , char const   *format  , ...) ;
#line 116
...
#line 712
            memcpy((void */* __restrict  */)((void *)tmp___0), (void const   */* __restrict  */)((void const   *)word_start),
                   (size_t )len);
#line 713
            tmp___2 = nwords;
#line 713
...
#line 770
    ...
    {
#line 772
    strcat((char */* __restrict  */)p, (char const   */* __restrict  */)((char const   *)*(argv + i)));
#line 767
    i ++;
    }
  }
...
#line 1197
  ...
  {
#line 1200
  setbuf((FILE */* __restrict  */)cli->client, (char */* __restrict  */)((char *)((void *)0)));
  }
#line 1201
  if (cli->banner) {
    {
...
#line 1236
    ...
    {
#line 1239
    memcpy((void */* __restrict  */)((void *)(& tm)), (void const   */* __restrict  */)((void const   *)(& cli->timeout_tm)),
           sizeof(tm));
    }
    {
#line 1241
...
#line 1284
      sr = select(sockfd + 1, (fd_set */* __restrict  */)(& r), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                  (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& tm));
      }
#line 1284
      if (sr < 0) {
        {
...
#line 1598
          ...
          {
#line 1604
          strcpy((char */* __restrict  */)(cmd + l), (char const   */* __restrict  */)((char const   *)completions[0]));
#line 1605
...
#line 1688
            memset((void *)cmd, 0, (size_t )4096);
#line 1689
            strncpy((char */* __restrict  */)cmd, (char const   */* __restrict  */)((char const   *)cli->history[in_history]),
                    (size_t )4095);
#line 1690
...
#line 2144
  i = regcomp((regex_t */* __restrict  */)(& state->match.re), (char const   */* __restrict  */)((char const   *)p),
              rflags);
  }
#line 2144
  if (i) {
...
#line 2173
  if (state->flags & 1) {
    {
#line 2175
    tmp = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& state->match.re)),
                  (char const   */* __restrict  */)string, (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                  0);
    }
#line 2175
    if (! tmp) {

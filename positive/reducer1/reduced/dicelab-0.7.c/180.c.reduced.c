...
void *yynodealloc_result__, *yynodealloc_tmp___49, *count_create_tmp;
yynodealloc(p1) {
...
count_create() {
  struct count__ *node__;
  count_create_tmp = yynodealloc(sizeof(struct count__));
  node__ = count_create_tmp;

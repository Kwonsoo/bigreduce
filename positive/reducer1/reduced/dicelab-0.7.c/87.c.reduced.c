...
void *yynodealloc_result__, *yynodealloc_tmp___49, *whiledo_create_tmp;
yynodealloc(p1) {
...
ifdo_create() {
  struct whiledo__ *node__;
  whiledo_create_tmp = yynodealloc(sizeof(struct whiledo__));
  node__ = whiledo_create_tmp;

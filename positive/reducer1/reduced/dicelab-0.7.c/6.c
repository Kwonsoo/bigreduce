...
#line 10
struct roll_value *new_roll_multi(int count___0 ) ;
#line 11
...
#line 18
  ret->count = count___0;
#line 19
  tmp___0 = malloc(sizeof(int ) * (unsigned long )count___0);
#line 19
  ret->values = (int *)tmp___0;
#line 20
  memset((void *)ret->values, 0, sizeof(int ) * (unsigned long )count___0);
  }
#line 21
  return (ret);
}
...
#line 593
  {      (char const   */* const  */)"$end",      (char const   */* const  */)"error",      (char const   */* const  */)"$undefined",      (char const   */* const  */)"NUMBER", 
        ...
        (char const   */* const  */)"filter",      (char const   */* const  */)((char const   *)0)};
#line 618 "par.c"
...
#line 1196
        tmp = (int )((int const   )yytranslate[yychar___0]);
      } else {
#line 1196
        tmp = (int )((int const   )2);
      }
...
#line 51
    strcpy((char */* __restrict  */)yylval.tval, (char const   */* __restrict  */)((char const   *)yytext));
    }
#line 52
    return (259);
#line 54
...
#line 1324
      if (yy_current_state >= 102) {
#line 1325
        airac_observe(yy_meta, (unsigned int )yy_c);
#line 1325
        yy_c = (YY_CHAR )yy_meta[(unsigned int )yy_c];
      }
    }
...
#line 16
void permute(int *data , int count___0 ) ;
#line 18
void all_permutations(int *data , int count___0 , void (*callback)(int *data , int count ,
                                                                   void *arg , float farg ) ,
                      void *arg , float farg ) ;
#line 22
...
#line 43
  cur = *list;
#line 43
  last___0 = (struct result_node *)((void *)0);
  {
#line 44
  while (1) {
    while_continue: /* CIL Label */ ;
...
#line 62
    last___0->next = (struct result_node *)tmp___1;
#line 63
    (last___0->next)->value = value;
#line 64
    (last___0->next)->prob = 1;
#line 65
    (last___0->next)->next = cur;
    }
  } else {
    {
#line 68
...
void _rec_all_permutations(int *data , int count___0 , void (*callback)(int *data ,
                                                                        int count ,
                                                                        void *arg ,
                                                                        float farg ) ,
...
#line 86
  if (1 == n) {
    {
#line 87
    (*callback)(data, count___0, arg, farg);
    }
  } else {
#line 91
    c = 0;
...
#line 91
      ...
      {
#line 92
      _rec_all_permutations(data, count___0, callback, arg, farg, n - 1);
      }
#line 93
      if (n % 2 == 1) {
#line 93
...
{ 
  ...
  {
#line 101
  _rec_all_permutations(data, count___0, callback, arg, farg, count___0);
  }
#line 102
  return;
}
...
#line 778
    cdata = (int *)tmp;
#line 779
    memcpy((void */* __restrict  */)((void *)cdata), (void const   */* __restrict  */)((void const   *)data),
           (unsigned long )count___0 * sizeof(int ));
#line 780
    memcpy((void */* __restrict  */)((void *)(cdata + count___0)), (void const   */* __restrict  */)((void const   *)cv->values),
...
#line 789
        memcpy((void */* __restrict  */)((void *)(nst->__annonCompField1.rvalue)->values),
               (void const   */* __restrict  */)((void const   *)cv->values), sizeof(int ) * (unsigned long )cv->count);
#line 790
        nst->next = symtab;
#line 791
...
#line 940
  current = tmp;
#line 941
  memcpy((void */* __restrict  */)((void *)current->values), (void const   */* __restrict  */)((void const   *)data),
...
#line 521
      ret->values = (int *)tmp___0;
#line 522
      memcpy((void */* __restrict  */)((void *)ret->values), (void const   */* __restrict  */)((void const   *)(nst->__annonCompField1.rvalue)->values),
...
#line 147
    memcpy((void */* __restrict  */)((void *)(rv->values + rv->count)), (void const   */* __restrict  */)((void const   *)roll->values),
...
#line 234
          ...
          {
#line 235
          memcpy((void */* __restrict  */)((void *)(cret->values + cp)), (void const   */* __restrict  */)((void const   *)(*(index___0 + *(pos + i)))->values),
...
#line 163
  memcpy((void */* __restrict  */)((void *)(rv1->values + rv1->count)), (void const   */* __restrict  */)((void const   *)rv2->values),
...
#line 323
      cret = tmp___1;
#line 325
      memcpy((void */* __restrict  */)((void *)cret->values), (void const   */* __restrict  */)((void const   *)ce1->values),
             (unsigned long )ce1->count * sizeof(int ));
#line 326
      memcpy((void */* __restrict  */)((void *)(cret->values + ce1->count)), (void const   */* __restrict  */)((void const   *)ce2->values),
...
#line 683
    memcpy((void */* __restrict  */)((void *)(nst->__annonCompField1.rvalue)->values),
           (void const   */* __restrict  */)((void const   *)ccnt->values), sizeof(int ) * (unsigned long )ccnt->count);
#line 684
    nst->next = this->symtab;
#line 685
    (*(((struct expression_vtable__ *)(this->expr2)->vtable__)->set_symtab_v__))(this->expr2,
...
#line 561
    ret->values = (int *)tmp___5;
#line 563
    memcpy((void */* __restrict  */)((void *)(ret->values + ret->count)), (void const   */* __restrict  */)((void const   *)cur->values),
...
#line 735
          item = tmp___5;
#line 738
          memcpy((void */* __restrict  */)((void *)item->values), (void const   */* __restrict  */)((void const   *)cret->values),
                 sizeof(int ) * (unsigned long )cret->count);
#line 740
          memcpy((void */* __restrict  */)((void *)(item->values + cret->count)),
                 (void const   */* __restrict  */)((void const   *)ccur->values),
...
#line 280
      ...
      {
#line 283
      memcpy((void */* __restrict  */)((void *)(exp___0->values + 0)), (void const   */* __restrict  */)((void const   *)(exp___0->values + (exp___0->count - i))),
...
#line 364
        cret->values = (int *)tmp___3;
#line 365
        memcpy((void */* __restrict  */)((void *)cret->values), (void const   */* __restrict  */)((void const   *)(cexp->values + (cexp->count - cret->count))),
...
#line 371
        memcpy((void */* __restrict  */)((void *)cret->values), (void const   */* __restrict  */)((void const   *)cexp->values),
               (unsigned long )cret->count * sizeof(int ));
        }
      }
      {
...
#line 312
  if (*(num->values + 0) < exp___0->count) {
    {
#line 313
    memcpy((void */* __restrict  */)((void *)(exp___0->values + 0)), (void const   */* __restrict  */)((void const   *)(exp___0->values + (exp___0->count - *(num->values + 0)))),
...
#line 392
  mask = (int *)tmp___2;
#line 393
  memcpy((void */* __restrict  */)((void *)slist), (void const   */* __restrict  */)((void const   *)exp___0->values),
...
#line 460
      mask = (int *)tmp___4;
#line 461
      memcpy((void */* __restrict  */)((void *)slist), (void const   */* __restrict  */)((void const   *)cexp->values),
...
#line 149
    filename = fname;
#line 150
    strcpy((char */* __restrict  */)fname, (char const   */* __restrict  */)((char const   *)optarg));
    }
#line 151
    goto switch_break;
    switch_default: 
...
#line 173
  if (fname) {
    {
#line 174
    yyin = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
    }
#line 175

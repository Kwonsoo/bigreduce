...
void *yynodealloc_result__, *yynodealloc_tmp___49, *range_create_tmp;
yynodealloc(p1) {
...
range_create() {
  struct range__ *node__;
  range_create_tmp = yynodealloc(sizeof(struct range__));
  node__ = range_create_tmp;

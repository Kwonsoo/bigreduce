...
void *yynodealloc_result__, *yynodealloc_tmp___49, *sort_create_tmp;
yynodealloc(p1) {
...
sort_create() {
  struct sort__ *node__;
  sort_create_tmp = yynodealloc(sizeof(struct sort__));
  node__ = sort_create_tmp;

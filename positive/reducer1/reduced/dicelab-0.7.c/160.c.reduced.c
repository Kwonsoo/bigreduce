...
void *yynodealloc_result__, *yynodealloc_tmp___49, *negate_create_tmp;
yynodealloc(p1) {
...
negate_create() {
  struct negate__ *node__;
  negate_create_tmp = yynodealloc(sizeof(struct negate__));
  node__ = negate_create_tmp;

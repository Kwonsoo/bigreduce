...
void *yynodealloc_result__, *yynodealloc_tmp___49, *divi_create_tmp;
yynodealloc(p1) {
...
divi_create() {
  struct divi__ *node__;
  divi_create_tmp = yynodealloc(sizeof(struct divi__));
  node__ = divi_create_tmp;

...
void *yynodealloc_result__, *yynodealloc_tmp___49, *first_create_tmp;
yynodealloc(p1) {
...
first_create() {
  struct first__ *node__;
  first_create_tmp = yynodealloc(sizeof(struct first__));
  node__ = first_create_tmp;

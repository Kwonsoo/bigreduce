...
void *yynodealloc_result__, *yynodealloc_tmp___49, *dice_create_tmp;
yynodealloc(p1) {
...
dice_create() {
  struct dice__ *node__;
  dice_create_tmp = yynodealloc(sizeof(struct dice__));
  node__ = dice_create_tmp;

...
void *yynodealloc_result__, *yynodealloc_tmp___49, *variable_create_tmp;
yynodealloc(p1) {
...
variable_create() {
  struct variable__ *node__;
  variable_create_tmp = yynodealloc(sizeof(struct variable__));
  node__ = variable_create_tmp;

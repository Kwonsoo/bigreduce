...
void *yynodealloc_result__, *yynodealloc_tmp___49, *perm_create_tmp;
yynodealloc(p1) {
...
perm_create() {
  struct perm__ *node__;
  perm_create_tmp = yynodealloc(sizeof(struct perm__));
  node__ = perm_create_tmp;

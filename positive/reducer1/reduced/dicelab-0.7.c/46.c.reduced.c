...
void *yynodealloc_result__, *yynodealloc_tmp___49, *scat_create_tmp;
yynodealloc(p1) {
...
scat_create() {
  struct scat__ *node__;
  scat_create_tmp = yynodealloc(sizeof(struct scat__));
  node__ = scat_create_tmp;

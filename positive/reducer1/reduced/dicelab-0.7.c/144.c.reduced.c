...
void *yynodealloc_result__, *yynodealloc_tmp___49, *high_create_tmp;
yynodealloc(p1) {
...
high_create() {
  struct high__ *node__;
  high_create_tmp = yynodealloc(sizeof(struct high__));
  node__ = high_create_tmp;

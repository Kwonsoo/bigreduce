...
void *yynodealloc_result__, *yynodealloc_tmp___49, *plus_create_tmp;
yynodealloc(p1) {
...
plus_create() {
  struct plus__ *node__;
  plus_create_tmp = yynodealloc(sizeof(struct plus__));
  node__ = plus_create_tmp;

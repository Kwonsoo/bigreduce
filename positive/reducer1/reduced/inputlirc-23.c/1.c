...
#line 106
    ...
    {
#line 107
    tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)line), (char const   */* __restrict  */)" %99s = %99s ",
...
#line 113
    ...
    {
#line 115
    tmp___5 = strtoul((char const   */* __restrict  */)((char const   *)(event_name)),
...
#line 252
  strncpy((char */* __restrict  */)(sa.sun_path), (char const   */* __restrict  */)((char const   *)device),
          sizeof(sa.sun_path) - 1UL);
#line 254
  unlink((char const   *)device);
#line 256
  tmp___3 = bind(sockfd, (struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& sa))),
                 (socklen_t )sizeof(sa));
  }
#line 256
  if (tmp___3 < 0) {
...
#line 272
  newclient->fd = accept(sockfd, (struct sockaddr */* __restrict  */)((struct sockaddr *)((void *)0)),
...
#line 401
    retselect = select(maxfd, (fd_set */* __restrict  */)(& fdset), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                       (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)(& evdev_timeout));
    }
#line 402
    if (retselect > 0) {
#line 403

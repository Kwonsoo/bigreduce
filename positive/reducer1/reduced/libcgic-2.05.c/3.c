...
#line 146
    if (tmp < sizeof(cgiContentTypeData)) {
      {
#line 147
      strcpy((char */* __restrict  */)cgiContentType, (char const   */* __restrict  */)((char const   *)e));
      }
    } else {
      {
#line 151
      strncpy((char */* __restrict  */)cgiContentType, (char const   */* __restrict  */)((char const   *)e),
...
#line 307
  ...
  {
#line 309
  tmp___0 = fread((void */* __restrict  */)((void *)input), (size_t )1, (size_t )cgiContentLength,
...
#line 360
  if (len) {
    {
#line 361
    tmp___1 = fread((void */* __restrict  */)((void *)buffer), (size_t )1, (size_t )len,
                    (FILE */* __restrict  */)cgiIn);
#line 361
    fgot = (int )tmp___1;
    }
...
#line 521
      ...
      {
#line 523
      outf = fopen((char const   */* __restrict  */)((char const   *)(tfileName)),
...
#line 550
    ...
    {
#line 552
    strcpy((char */* __restrict  */)n->attr, (char const   */* __restrict  */)((char const   *)(fname)));
    }
#line 553
    if (out) {
#line 554
...
#line 573
    ...
    {
#line 575
    strcpy((char */* __restrict  */)n->fileName, (char const   */* __restrict  */)((char const   *)(ffileName)));
#line 576
...
#line 578
    ...
    {
#line 580
    strcpy((char */* __restrict  */)n->contentType, (char const   */* __restrict  */)((char const   *)(fcontentType)));
#line 581
...
#line 583
    ...
    {
#line 585
    strcpy((char */* __restrict  */)n->tfileName, (char const   */* __restrict  */)((char const   *)(tfileName)));
#line 587
    l = n;
    }
  }
...
#line 1313
  ...
  {
#line 1315
  cfp->in = fopen((char const   */* __restrict  */)((char const   *)e->tfileName),
...
#line 1330
  ...
  {
#line 1332
  tmp = fread((void */* __restrict  */)((void *)buffer), (size_t )1, (size_t )bufferSize,
              (FILE */* __restrict  */)cfp->in);
#line 1332
  got = (int )tmp;
  }
#line 1333
...
#line 1401
      ...
      {
#line 1403
      strcpy((char */* __restrict  */)*(stringArray + i), (char const   */* __restrict  */)((char const   *)e->value));
#line 1404
...
{ 
  ...
  {
#line 1880
  out = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"wb");
  }
#line 1881
  if (! out) {
#line 1883
...
#line 1977
        ...
        {
#line 1980
        tmp___27 = fwrite((void const   */* __restrict  */)((void const   *)(buffer)),
                          (size_t )1, (size_t )got, (FILE */* __restrict  */)out);
        }
#line 1980
        if ((int )tmp___27 != got) {
          {
...
#line 2009
  tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)s), (size_t )1,
                   (size_t )len, (FILE */* __restrict  */)out);
  }
#line 2009
  if ((int )tmp___0 != len) {
#line 2010
...
{ 
  ...
  {
#line 2016
  tmp = fwrite((void const   */* __restrict  */)((void const   *)(& i)), sizeof(int ),
...
#line 2033
  cgiFreeResources();
#line 2035
  in = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rb");
  }
#line 2036
  if (! in) {
#line 2038
...
#line 2155
      ...
      {
#line 2157
      out = fopen((char const   */* __restrict  */)((char const   *)(tfileName)),
                  (char const   */* __restrict  */)"w+b");
      }
#line 2158
      if (! out) {
...
#line 2168
        ...
        {
#line 2170
        tmp___30 = fread((void */* __restrict  */)((void *)(buffer)), (size_t )1,
                         (size_t )tryr, (FILE */* __restrict  */)in);
#line 2170
        got = (int )tmp___30;
        }
#line 2171
...
#line 2175
        ...
        {
#line 2177
        tmp___31 = fwrite((void const   */* __restrict  */)((void const   *)(buffer)),
                          (size_t )1, (size_t )got, (FILE */* __restrict  */)out);
        }
#line 2177
        if ((int )tmp___31 != got) {
...
#line 2191
      ...
      {
#line 2193
      strcpy((char */* __restrict  */)e->tfileName, (char const   */* __restrict  */)((char const   *)(tfileName)));
      }
    } else {
      {
#line 2195
...
#line 2246
  ...
  {
#line 2248
  tmp___1 = fread((void */* __restrict  */)((void *)*s), (size_t )1, (size_t )len,
                  (FILE */* __restrict  */)in);
  }
#line 2248
  if ((int )tmp___1 != len) {
...
{ 
  ...
  {
#line 2256
  tmp = fread((void */* __restrict  */)((void *)i), sizeof(int ), (size_t )1, (FILE */* __restrict  */)out);
  }
#line 2256
  if (! tmp) {
#line 2257
...
#line 2379
      ...
      {
#line 2381
      memcpy((void */* __restrict  */)((void *)*(stringArray + i)), (void const   */* __restrict  */)((void const   *)n),
             (size_t )(p - n));
#line 2382
...
#line 2448
    ...
    {
#line 2450
    strcpy((char */* __restrict  */)*(stringArray + i), (char const   */* __restrict  */)((char const   *)e->attr));
#line 2451
    i ++;
    }
    skipSecondValue2: 

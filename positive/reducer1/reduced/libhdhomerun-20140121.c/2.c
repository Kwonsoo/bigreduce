...
{ 
  ...
  {
#line 127
  tmp = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
#line 127
  fp = tmp;
  }
#line 128
...
#line 246
  ...
  {
#line 251
  tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)target), (char const   */* __restrict  */)"%u.%u.%u.%u:%u",
...
#line 27
  ...
  {
#line 31
  tmp___2 = fread((void */* __restrict  */)((void *)(& Result)), (size_t )4, (size_t )1,
                  (FILE */* __restrict  */)fp);
  }
#line 31
  if (tmp___2 != 1UL) {
...
#line 237
  tmp = getaddrinfo((char const   */* __restrict  */)name, (char const   */* __restrict  */)"",
                    ...
                    (struct addrinfo **/* __restrict  */)(& sock_info));
  }
#line 237
  if (tmp != 0) {
#line 238
...
#line 151
    *tmp___0 = (char)0;
#line 154
    tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)line), (char const   */* __restrict  */)"tsid=0x%x",
                     & transport_stream_id);
    }
#line 154
    if (tmp___1 == 1) {
...
#line 167
    hdhomerun_sprintf(program.program_str, program.program_str + sizeof(program.program_str),
                      "%s", line);
#line 171
    tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)line), (char const   */* __restrict  */)"%u: %u.%u",
...
#line 171
    if (tmp___3 != 3) {
      {
#line 172
      tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)line), (char const   */* __restrict  */)"%u: %u",
...
#line 198
    if (tmp___7 != 0) {
      {
#line 199
      memcpy((void */* __restrict  */)((void *)(& result___1->programs[program_count])),
             (void const   */* __restrict  */)((void const   *)(& program)), sizeof(program));
#line 200
      *pchanged = 1;
      }
    }
...
#line 370
  while (1) {
    ...
    {
#line 372
    tmp___1 = fread((void */* __restrict  */)((void *)(data)), (size_t )1, (size_t )1024,
                    (FILE */* __restrict  */)upgrade_file);
#line 372
    length = tmp___1;
    }
#line 373
...
#line 224
  if (tmp___0 == 5) {
    {
#line 225
    tmp = hdhomerun_device_create_from_str_ip_result(a, port, tuner, dbg);
    }
#line 225
    return (tmp);
  }
...
#line 227
  if (tmp___2 == 5) {
    {
#line 228
    tmp___1 = hdhomerun_device_create_from_str_ip_result(a, port, tuner, dbg);
    }
#line 228
    return (tmp___1);
  }
...
#line 230
  if (tmp___4 == 4) {
    {
#line 231
    tmp___3 = hdhomerun_device_create_from_str_ip_result(a, port, tuner, dbg);
    }
#line 231
    return (tmp___3);
  }
...
#line 485
    if (channel) {
      {
#line 486
      sscanf((char const   */* __restrict  */)((char const   *)(channel + 3)), (char const   */* __restrict  */)"%31s",
             status->channel);
      }
    }
    {
...
#line 490
    if (lock___1) {
      {
#line 491
      sscanf((char const   */* __restrict  */)((char const   *)(lock___1 + 5)), (char const   */* __restrict  */)"%31s",
             status->lock_str);
      }
    }
    {
...
#line 577
    if (vch) {
      {
#line 578
      sscanf((char const   */* __restrict  */)((char const   *)(vch + 4)), (char const   */* __restrict  */)"%31s",
             vstatus->vchannel);
      }
    }
    {
...
#line 582
    if (name) {
      {
#line 583
      sscanf((char const   */* __restrict  */)((char const   *)(name + 5)), (char const   */* __restrict  */)"%31s",
             vstatus->name);
      }
    }
    {
...
#line 587
    if (auth) {
      {
#line 588
      sscanf((char const   */* __restrict  */)((char const   *)(auth + 5)), (char const   */* __restrict  */)"%31s",
             vstatus->auth);
      }
    }
    {
...
#line 592
    if (cci) {
      {
#line 593
      sscanf((char const   */* __restrict  */)((char const   *)(cci + 4)), (char const   */* __restrict  */)"%31s",
             vstatus->cci);
      }
    }
    {
...
#line 597
    if (cgms) {
      {
#line 598
      sscanf((char const   */* __restrict  */)((char const   *)(cgms + 5)), (char const   */* __restrict  */)"%31s",
             vstatus->cgms);
      }
    }
    {
...
#line 724
    *tmp___1 = (char)0;
#line 727
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)result___1),
                     (char const   */* __restrict  */)"%x", & raw);
    }
#line 727
    if (tmp___2 != 1) {
#line 728
...
#line 824
  if (pversion_num) {
    {
#line 826
    tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)version_str),
                     (char const   */* __restrict  */)"%u", & version_num);
    }
#line 826
    if (tmp___0 != 1) {
#line 827
...
{ 
  ...
  {
#line 175
  memcpy((void */* __restrict  */)((void *)pkt->pos), (void const   */* __restrict  */)mem,
         length);
#line 176
  pkt->pos += length;
  }
...
#line 94
  ...
  {
#line 98
  tmp___2 = pthread_create((pthread_t */* __restrict  */)(& vs->thread), (pthread_attr_t const   */* __restrict  */)((pthread_attr_t const   *)((void *)0)),
                           & hdhomerun_video_thread_execute, (void */* __restrict  */)((void *)vs));
  }
#line 98
  if (tmp___2 != 0) {
    {
...
#line 253
    ptr = vs->buffer + head;
#line 254
    memcpy((void */* __restrict  */)((void *)ptr), (void const   */* __restrict  */)((void const   *)pkt->pos),
           length);
#line 257
...
#line 86
  tmp___0 = pthread_create((pthread_t */* __restrict  */)(& dbg->thread), (pthread_attr_t const   */* __restrict  */)((pthread_attr_t const   *)((void *)0)),
                           & hdhomerun_debug_thread_execute, (void */* __restrict  */)((void *)dbg));
  }
#line 86
  if (tmp___0 != 0) {
    {
...
#line 280
  tmp___2 = strftime((char */* __restrict  */)ptr, (size_t )(end - ptr), (char const   */* __restrict  */)"%Y%m%d-%H:%M:%S ",
                     (struct tm  const  */* __restrict  */)((struct tm  const  *)tmp___1));
#line 280
  ptr += tmp___2;
  }
#line 281
...
#line 338
    dbg->file_fp = fopen((char const   */* __restrict  */)((char const   *)dbg->file_name),
...
#line 171
      ...
      {
#line 174
      tmp___0 = fread((void */* __restrict  */)((void *)(buffer + pos)), (size_t )1,
                      (size_t )1024, (FILE */* __restrict  */)stdin);
#line 174
      size = tmp___0;
#line 175
      pos += size;
...
#line 399
    if (fp) {
      {
#line 400
      tmp___6 = fwrite((void const   */* __restrict  */)((void const   *)ptr), (size_t )1,
                       actual_size, (FILE */* __restrict  */)fp);
      }
#line 400
...
#line 568
    ...
    {
#line 570
    tmp___2 = strtoul((char const   */* __restrict  */)((char const   *)*(argv + 0)),

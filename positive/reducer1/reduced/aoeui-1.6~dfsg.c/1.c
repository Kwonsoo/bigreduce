...
#line 92
      fprintf((FILE */* __restrict  */)debug_file, (char const   */* __restrict  */)"emit %d:",
              (int )bytes);
#line 93
      fwrite((void const   */* __restrict  */)((void const   *)str), bytes, (size_t )1,
             (FILE */* __restrict  */)debug_file);
#line 94
      fputc('\n', debug_file);
      }
    }
...
#line 119
    ...
    {
#line 121
    memcpy((void */* __restrict  */)((void *)(display___0->outbuf + display___0->outbuf_bytes)),
           (void const   */* __restrict  */)((void const   *)str), bytes);
#line 122
...
#line 664
    sigact.sa_flags = 4;
#line 665
    sigaction(28, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& sigact)),
              (struct sigaction */* __restrict  */)(& old_sigact));
    }
#line 666
...
#line 808
        if (n > 0) {
          {
#line 809
          fwrite((void const   */* __restrict  */)((void const   *)(display___0->inbuf + display___0->inbuf_bytes)),
...
#line 242
  single = (char *)tmp___0;
#line 244
  memcpy((void */* __restrict  */)((void *)single), (void const   */* __restrict  */)((void const   *)(buf)),
         len);
#line 245
...
size_t clip(unsigned int reg , struct view *view , position_t offset , size_t bytes ,
            Boolean_t append ) ;
#line 15 "/home/june/collector/temp/aoeui-1.6~dfsg/mode.h"
...
#line 159
      len = (size_t )2;
#line 159
      memcpy((void */* __restrict  */)((void *)p), (void const   */* __restrict  */)((void const   *)"\r\n"),
             len);
      }
    } else {
#line 158
...
extern  __attribute__((__nothrow__)) int ( __attribute__((__nonnull__(1), __leaf__)) mkdir)(char const   *__path ,
                                                                                            __mode_t __mode ) ;
#line 72 "/home/june/collector/temp/aoeui-1.6~dfsg/text.h"
...
#line 76
    apath = (char *)tmp___1;
#line 77
    memcpy((void */* __restrict  */)((void *)apath), (void const   */* __restrict  */)((void const   *)path),
           pathlen);
#line 78
...
#line 201
  *tmp___1 = 0;
#line 202
  tmp___12 = stat((char const   */* __restrict  */)((char const   *)path), (struct stat */* __restrict  */)(& statbuf));
  }
#line 202
  if (tmp___12) {
    {
...
#line 482
  if (text->clean) {
    {
#line 483
    memcpy((void */* __restrict  */)((void *)text->clean), (void const   */* __restrict  */)((void const   *)raw),
           bytes);
#line 484
...
#line 71 "/home/june/collector/temp/aoeui-1.6~dfsg/text.h"
...
#line 39
  if ((view->text)->flags & (unsigned int )(1 << 2)) {
    {
#line 40
    memcpy((void */* __restrict  */)((void *)new), (void const   */* __restrict  */)((void const   *)name),
           (size_t )(len + 1));
#line 41
    p = new + len;
    }
...
#line 227
  ...
  {
#line 228
  memcpy((void */* __restrict  */)out___1, (void const   */* __restrict  */)((void const   *)(text->clean + offset)),
         bytes);
  }
#line 229
  return (bytes);
...
#line 53
  ...
  {
#line 54
  err = regexec((regex_t const   */* __restrict  */)((regex_t const   *)mode->regex),
                (char const   */* __restrict  */)((char const   *)raw), (size_t )10,
                (regmatch_t */* __restrict  */)(match), (int )flags);
  }
#line 55
  if (err) {
#line 55
...
#line 143
      err = regcomp((regex_t */* __restrict  */)mode->regex, (char const   */* __restrict  */)((char const   *)((char *)mode->pattern)),
                    (1 | (1 << 1)) | ((1 << 1) << 1));
      }
#line 145
      if (err) {
...
#line 246
        memcpy((void */* __restrict  */)((void *)mode->pattern), (void const   */* __restrict  */)((void const   *)last_search),
               mode->bytes + 1UL);
        }
#line 247
        if (ch == (Unicode_t )cmdchar[0][is_asdfg]) {
...
#line 258
    memcpy((void */* __restrict  */)((void *)last_search), (void const   */* __restrict  */)((void const   *)mode->pattern),
           mode->bytes);
#line 259
...
#line 22
  new = (char *)tmp___5;
#line 23
  memcpy((void */* __restrict  */)((void *)new), (void const   */* __restrict  */)((void const   *)string),
         length + 1UL);
#line 24
...
#line 43
      if (! best_len) {
        {
#line 44
        strcpy((char */* __restrict  */)(new + length), (char const   */* __restrict  */)((char const   *)(dent->d_name + prefix_len)));
#line 45
...
#line 158
  if (old) {
    {
#line 159
    memcpy((void */* __restrict  */)p, (void const   */* __restrict  */)((void const   *)old),
           buffer->payload);
#line 160
    munmap((void *)old, buffer->mapped);
    }
...
#line 211
    ...
    {
#line 212
    memcpy((void */* __restrict  */)out___1, (void const   */* __restrict  */)((void const   *)(buffer->data + offset)),
           (size_t )before);
#line 213
...
#line 250
  if (in) {
    {
#line 251
    memcpy((void */* __restrict  */)((void *)(buffer->data + offset)), (void const   */* __restrict  */)in,
           bytes);
    }
  } else {
    {
...
#line 131
    path = (char *)tmp___6;
#line 132
    strcpy((char */* __restrict  */)path, (char const   */* __restrict  */)((char const   *)(tags->text)->path));
#line 133
    slash = strrchr((char const   *)path, '/');
    }
#line 133
...
#line 134
    ...
    {
#line 135
    strcpy((char */* __restrict  */)(slash + 1), (char const   */* __restrict  */)((char const   *)this));
#line 136
    reallocate((void const   *)this, (size_t )0);
#line 136
    this = (char *)((void *)0);

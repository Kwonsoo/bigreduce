...
#line 54
  if (m_headers) {
    {
#line 58
    hdr_fp = fopen((char const   */* __restrict  */)((char const   *)m_headers), (char const   */* __restrict  */)"r");
    }
#line 58
    if (hdr_fp) {
      {
...
#line 59
        ...
        {
#line 60
        fputs((char const   */* __restrict  */)((char const   *)(lbuf)), (FILE */* __restrict  */)fp);
        }
      }
...
#line 211
    if (optarg) {
      {
#line 212
      log_fp = fopen((char const   */* __restrict  */)((char const   *)optarg), (char const   */* __restrict  */)"a");
      }
#line 212
      if (! log_fp) {
        {

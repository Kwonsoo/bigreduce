...
#line 85
        temp->number = k;
#line 86
        temp->prec = *(symbol_prec + (int )symbol);
#line 87
        temp->action_code = (char)1;
#line 88
        temp->assoc = *(symbol_assoc + (int )symbol);
#line 89
        actions = temp;
        }
      }
...
#line 172
    if ((int )*(accessing_symbol + (int )final_state) == goal___0) {
#line 173
      goto while_break;
    }
#line 169
...
#line 194
          *(rules_used + (int )p->number) = (Value_t )1;
        }
      }
#line 191
      p = p->next;
...
#line 393
  if (! lflag) {
    {
#line 394
    fprintf((FILE */* __restrict  */)f, (char const   */* __restrict  */)((char const   *)(line_format)),
...
#line 540
  if (! lflag) {
    {
#line 541
    fprintf((FILE */* __restrict  */)text_file, (char const   */* __restrict  */)((char const   *)(line_format)),
            lineno, input_file_name);
    }
  }
  {
...
#line 1070
  ...
  {
#line 1072
  strcpy((char */* __restrict  */)s, (char const   */* __restrict  */)((char const   *)cache));
#line 1073
  *(tag_table + ntags) = s;
#line 1074
  ntags ++;
...
#line 2014
    if ((unsigned long )*(v + (int )i) != (unsigned long )goal) {
#line 2016
      (*(v + (int )i))->index = k;
#line 2017
      k = (Value_t )((int )k + 1);
...
#line 2038
        *(symbol_value + (int )j) = *(symbol_value + ((int )j - 1));
#line 2037
        j = (Value_t )((int )j - 1);
      }
...
#line 2054
        if ((int )j < (int )k) {
#line 2054
          if (! ((int )n == (int )*(symbol_value + (int )j))) {
#line 2054
...
#line 2071
    *(symbol_name + (int )i) = (*(v + (int )i))->name;
#line 2072
    *(symbol_value + (int )i) = (*(v + (int )i))->value;
#line 2073
    *(symbol_prec + (int )i) = (*(v + (int )i))->prec;
#line 2074
    *(symbol_assoc + (int )i) = (*(v + (int )i))->assoc;
#line 2069
    i = (Value_t )((int )i + 1);
  }
  ...
  while_break___9: 
#line 2076
  *(symbol_name + (int )start_symbol) = name_pool;
#line 2077
  *(symbol_value + (int )start_symbol) = (Value_t )-1;
#line 2078
  *(symbol_prec + (int )start_symbol) = (Value_t )0;
#line 2079
  *(symbol_assoc + (int )start_symbol) = (char)0;
#line 2080
  i = (Value_t )((int )i + 1);
  {
#line 2080
...
#line 2082
    k = (*(v + (int )i))->index;
#line 2083
    *(symbol_name + (int )k) = (*(v + (int )i))->name;
#line 2084
    *(symbol_value + (int )k) = (*(v + (int )i))->value;
#line 2085
    *(symbol_prec + (int )k) = (*(v + (int )i))->prec;
#line 2086
    *(symbol_assoc + (int )k) = (*(v + (int )i))->assoc;
#line 2080
    i = (Value_t )((int )i + 1);
  }
...
#line 2094
      ...
      {
#line 2095
      protect_string(*(symbol_name + (int )i), symbol_pname + (int )i);
#line 2094
      i = (Value_t )((int )i + 1);
      }
    }
...
#line 2144
      *(ritem + (int )j) = (*(pitem + (int )j))->index;
#line 2145
      if ((int )(*(pitem + (int )j))->class == 1) {
#line 2147
        prec2 = (*(pitem + (int )j))->prec;
#line 2148
        assoc = (*(pitem + (int )j))->assoc;
      }
#line 2150
      j = (Value_t )((int )j + 1);
    }
...
#line 2183
      fprintf((FILE */* __restrict  */)f, (char const   */* __restrict  */)"%4d  %s :",
              i - 2, *(symbol_name + (int )*(rlhs + i)));
#line 2184
      tmp = strlen((char const   *)*(symbol_name + (int )*(rlhs + i)));
#line 2184
      spacing = tmp + 1UL;
      }
    } else {
...
#line 199
        i = p->number;
#line 200
        if ((int )*(rrhs + (int )i) + 1 == (int )*(rrhs + ((int )i + 1))) {
#line 202
          j = (Value_t )0;
          {
#line 202
...
#line 214
              *(null_rules + (int )k) = *(null_rules + ((int )k - 1));
#line 213
              k = (Value_t )((int )k - 1);
            }
            while_break___5: /* CIL Label */ ;
...
#line 224
    fprintf((FILE */* __restrict  */)verbose_file, (char const   */* __restrict  */)"\t%s : .  (%d)\n",
            *(symbol_name + (int )*(rlhs + (int )j)), (int )j - 2);
#line 221
    i = (Value_t )((int )i + 1);
    }
  }
...
#line 248
    if ((int )sp->nshifts > 0) {
#line 250
      as = (int )*(accessing_symbol + (int )sp->shift[(int )sp->nshifts - 1]);
#line 251
...
#line 274
          fprintf((FILE */* __restrict  */)verbose_file, (char const   */* __restrict  */)"\t%s  shift %d\n",
                  *(symbol_name + (int )p->symbol), (int )p->number);
          }
        }
      }
#line 271
...
#line 399
    ...
    {
#line 400
    tmp___0 = strncpy((char */* __restrict  */)file_prefix, (char const   */* __restrict  */)((char const   *)output_file_name),
                      len);
#line 400
    *(tmp___0 + len) = (char)0;
    }
...
#line 409
    ...
    {
#line 409
    strcpy((char */* __restrict  */)output_file_name, (char const   */* __restrict  */)((char const   *)file_prefix));
#line 409
...
#line 414
    ...
    {
#line 414
    strcpy((char */* __restrict  */)code_file_name, (char const   */* __restrict  */)((char const   *)file_prefix));
#line 414
...
#line 421
    ...
    {
#line 421
    strcpy((char */* __restrict  */)defines_file_name, (char const   */* __restrict  */)((char const   *)file_prefix));
#line 421
...
#line 426
    ...
    {
#line 426
    strcpy((char */* __restrict  */)externs_file_name, (char const   */* __restrict  */)((char const   *)file_prefix));
#line 426
...
#line 431
    ...
    {
#line 431
    strcpy((char */* __restrict  */)verbose_file_name, (char const   */* __restrict  */)((char const   *)file_prefix));
#line 431
...
#line 436
    ...
    {
#line 436
    strcpy((char */* __restrict  */)graph_file_name, (char const   */* __restrict  */)((char const   *)file_prefix));
#line 436
...
#line 578
  if ((unsigned long )input_file == (unsigned long )((FILE *)0)) {
    {
#line 580
    input_file = fopen((char const   */* __restrict  */)((char const   *)input_file_name),
...
#line 588
  if (vflag) {
    {
#line 590
    verbose_file = fopen((char const   */* __restrict  */)((char const   *)verbose_file_name),
...
#line 595
  if (gflag) {
    {
#line 597
    graph_file = fopen((char const   */* __restrict  */)((char const   *)graph_file_name),
                       (char const   */* __restrict  */)"w");
    }
#line 598
    if ((unsigned long )graph_file == (unsigned long )((FILE *)0)) {
...
#line 612
  if (dflag) {
    {
#line 614
    defines_file = fopen((char const   */* __restrict  */)((char const   *)defines_file_name),
                         (char const   */* __restrict  */)"w");
    }
#line 615
    if ((unsigned long )defines_file == (unsigned long )((FILE *)0)) {
...
#line 620
  if (iflag) {
    {
#line 622
    externs_file = fopen((char const   */* __restrict  */)((char const   *)externs_file_name),
                         (char const   */* __restrict  */)"w");
    }
#line 623
...
#line 624
  ...
  {
#line 627
  output_file = fopen((char const   */* __restrict  */)((char const   *)output_file_name),
                      (char const   */* __restrict  */)"w");
  }
#line 628
  if ((unsigned long )output_file == (unsigned long )((FILE *)0)) {
...
#line 631
  if (rflag) {
    {
#line 633
    code_file = fopen((char const   */* __restrict  */)((char const   *)code_file_name),
                      (char const   */* __restrict  */)"w");
    }
#line 634
    if ((unsigned long )code_file == (unsigned long )((FILE *)0)) {
...
#line 17 "/home/june/collector/temp/byacc-20140101/skeleton.c"
  {      (char const   */* const  */)"#ifndef lint",      (char const   */* const  */)"static const char yysccsid[] = \"@(#)yaccpar\t1.9 (Berkeley) 02/21/93\";",      (char const   */* const  */)"#endif",      (char const   */* const  */)"", 
        ...
        (char const   */* const  */)"#define YYRECOVERING() (yyerrflag != 0)",      (char const   */* const  */)"",      (char const   */* const  */)((char const   *)0)};
#line 38 "/home/june/collector/temp/byacc-20140101/skeleton.c"
char const   * const  xdecls[3]  = {      (char const   */* const  */)"",      (char const   */* const  */)"extern int YYPARSE_DECL();",      (char const   */* const  */)((char const   *)0)};
...
#line 45
  {      (char const   */* const  */)"extern short yylhs[];",      (char const   */* const  */)"extern short yylen[];",      (char const   */* const  */)"extern short yydefred[];",      (char const   */* const  */)"extern short yydgoto[];", 
        ...
        (char const   */* const  */)"extern char *yyrule[];",      (char const   */* const  */)"#endif",      (char const   */* const  */)((char const   *)0)};
#line 64 "/home/june/collector/temp/byacc-20140101/skeleton.c"
char const   * const  global_vars[4]  = {      (char const   */* const  */)"",      (char const   */* const  */)"int      yydebug;",      (char const   */* const  */)"int      yynerrs;",      (char const   */* const  */)((char const   *)0)};
...
char const   * const  impure_vars[6]  = {      (char const   */* const  */)"",      (char const   */* const  */)"int      yyerrflag;",      (char const   */* const  */)"int      yychar;",      (char const   */* const  */)"YYSTYPE  yyval;", 
        (char const   */* const  */)"YYSTYPE  yylval;",      (char const   */* const  */)((char const   *)0)};
...
char const   * const  hdr_vars[3]  = {      (char const   */* const  */)"/* variables for the parser stack */",      (char const   */* const  */)"static YYSTACKDATA yystack;",      (char const   */* const  */)((char const   *)0)};
...
#line 118
  {      (char const   */* const  */)"    int      yyerrflag;",      (char const   */* const  */)"    int      yychar;",      (char const   */* const  */)"    YYSTYPE  yyval;",      (char const   */* const  */)"    YYSTYPE  yylval;", 
        (char const   */* const  */)"",      (char const   */* const  */)"    /* variables for the parser stack */",      (char const   */* const  */)"    YYSTACKDATA yystack;",      (char const   */* const  */)((char const   *)0)};
...
#line 130
  {      (char const   */* const  */)"",      (char const   */* const  */)"#if YYDEBUG",      (char const   */* const  */)"#include <stdio.h>\t\t/* needed for printf */",      (char const   */* const  */)"#endif", 
        ...
        (char const   */* const  */)"YYPARSE_DECL()",      (char const   */* const  */)"{",      (char const   */* const  */)((char const   *)0)};
...
#line 270
  {      (char const   */* const  */)"",      (char const   */* const  */)"    goto yyerrlab;",      (char const   */* const  */)"",      (char const   */* const  */)"yyerrlab:", 
        ...
        (char const   */* const  */)"    switch (yyn)",      (char const   */* const  */)"    {",      (char const   */* const  */)((char const   *)0)};
...
#line 347
  {      (char const   */* const  */)"    }",      (char const   */* const  */)"    yystack.s_mark -= yym;",      (char const   */* const  */)"    yystate = *yystack.s_mark;",      (char const   */* const  */)"    yystack.l_mark -= yym;", 
        ...
        (char const   */* const  */)"yyoverflow:",      (char const   */* const  */)((char const   *)0)};
...
#line 401
  {      (char const   */* const  */)"",      (char const   */* const  */)"yyabort:",      (char const   */* const  */)"    yyfreestack(&yystack);",      (char const   */* const  */)"    return (1);", 
        ...
        (char const   */* const  */)"}",      (char const   */* const  */)((char const   *)0)};
...
#line 31
      symbol = (int )*(ritem + (int )*(rrhs + rule));
#line 32
...
{ 
  ...
  {
#line 226
  start_derives = *(derives + (int )start_symbol);
#line 227
  i = 0U;
  {
#line 227
...
#line 240
    p->items[i] = *(rrhs + (int )*(start_derives + i));
#line 239
    i ++;
  }
  while_break___2: /* CIL Label */ ;
...
#line 332
    printf((char const   */* __restrict  */)"state %d, number = %d, accessing symbol = %s\n",
           k, (int )p->number, *(symbol_name + (int )p->accessing_symbol));
#line 334
    n = (int )p->nitems;
#line 335
    i = 0;
...
#line 341
      ...
      {
#line 342
      printf((char const   */* __restrict  */)"%s :", *(symbol_name + (int )*(rlhs + - ((int )*(ritem + j)))));
#line 343
...
#line 345
        j ++;
#line 345
        printf((char const   */* __restrict  */)" %s", *(symbol_name + (int )*(ritem + tmp)));
        }
      }
      while_break___7: /* CIL Label */ ;
      }
...
#line 348
        j ++;
#line 348
        printf((char const   */* __restrict  */)" %s", *(symbol_name + (int )*(ritem + tmp___0)));
        }
      }
      while_break___8: /* CIL Label */ ;
      }
...
#line 87
    *(accessing_symbol + (int )sp->number) = sp->accessing_symbol;
#line 86
    sp = sp->next;
  }
  while_break___0: /* CIL Label */ ;
...
#line 107
    *(reduction_table + (int )rp->number) = rp;
#line 106
    rp = rp->next;
  }
  while_break___0: /* CIL Label */ ;
...
#line 194
      symbol = (int )*(accessing_symbol + (int )sp->shift[i]);
#line 196
      if (symbol < (int )start_symbol) {
#line 197
        goto while_break___0;
...
#line 228
      state2 = sp->shift[i];
#line 229
      symbol = (int )*(accessing_symbol + (int )state2);
#line 231
      if (symbol < (int )start_symbol) {
#line 232
        goto while_break___4;
...
#line 305
        symbol = (int )*(accessing_symbol + (int )sp->shift[j]);
#line 306
        if (symbol >= (int )start_symbol) {
#line 307
          goto while_break___0;
...
#line 374
    state1 = *(from_state + i);
#line 375
    symbol1 = (int )*(accessing_symbol + (int )*(to_state + i));
#line 377
...
#line 391
          stateno = sp->shift[j];
#line 392
          if ((int )*(accessing_symbol + (int )stateno) == symbol2) {
#line 393
            goto while_break___2;
          }
#line 389
...
#line 483
        sp ++;
#line 483
        *(nedges + (int )*tmp___0) = (Value_t )((int )*(nedges + (int )*tmp___0) + 1);
      }
      while_break___5: /* CIL Label */ ;
      }
      while_break___0: ;
...
#line 51
      outline ++;
#line 52
      fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)((char const   *)(line_format)),
...
#line 61
    outline ++;
#line 62
    fprintf((FILE */* __restrict  */)code_file, (char const   */* __restrict  */)((char const   *)(line_format)),
            lineno, input_file_name);
    }
  }
#line 64
...
{ 
  ...
  {
#line 177
  start_int_table("lhs", (int )*(symbol_value + (int )start_symbol));
#line 179
  j = 10;
#line 180
  i = 3;
...
#line 188
    ...
    {
#line 190
    output_int((int )*(symbol_value + (int )*(rlhs + i)));
#line 180
    i ++;
    }
  }
...
#line 262
            *(actionrow + (int )p->symbol) = p->number;
          } else
#line 264
          if ((int )p->action_code == 2) {
#line 264
...
#line 340
    *(state_count + (int )*(to_state + i)) = (Value_t )((int )*(state_count + (int )*(to_state + i)) + 1);
#line 339
    i ++;
  }
  while_break___3: /* CIL Label */ ;
...
#line 935
    *(symnam + (int )*(symbol_value + i)) = (char const   *)*(symbol_name + i);
#line 934
    i --;
  }
  while_break___14: /* CIL Label */ ;
...
#line 1088
      s = (char const   *)*(symbol_name + (int )*(ritem + j));
#line 1089
      if ((int const   )*(s + 0) == 34) {
        {
#line 1091

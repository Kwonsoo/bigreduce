...
#line 64
    ...
    {
#line 68
    memcpy((void */* __restrict  */)((void *)(H)), (void const   */* __restrict  */)((void const   *)IV),
           (size_t )20);
#line 69
    SHA1_Transform(H, (unsigned char const   *)X);
    }
#line 70
    if (blocks == 2) {
      {
#line 71
      SHA1_Transform(H, (unsigned char const   *)(X + 64));
      }
    }
#line 74
    A = H[0];
...
#line 256
    if (i) {
      {
#line 256
      strncat((char */* __restrict  */)resp, (char const   */* __restrict  */)((char const   *)(conts)),
              (size_t )1);
#line 256
      resp ++;
      }
...
#line 505
    ...
    {
#line 508
    re_code = regcomp((regex_t */* __restrict  */)*comp, (char const   */* __restrict  */)((char const   *)bound_regexp),
                      1 | (((1 << 1) << 1) << 1));
    }
#line 508
    if (re_code != 0) {
      {
#line 510
      regerror(re_code, (regex_t const   */* __restrict  */)((regex_t const   *)*comp),
               (char */* __restrict  */)(re_err), (size_t )256);
#line 511
      *err = re_err;
      }
#line 512
...
#line 515
  ...
  {
#line 517
  tmp___2 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)*comp),
                    (char const   */* __restrict  */)str, (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                    0);
  }
#line 517
  return (tmp___2 == 0);
...
#line 623
        strncpy((char */* __restrict  */)(token), (char const   */* __restrict  */)((char const   *)(tokens.elt + t)->str),
                (size_t )10771);
#line 624
        t ++;
#line 625
...
#line 654
            token[10771] = (char )'\000';
#line 654
            strncpy((char */* __restrict  */)(token), (char const   */* __restrict  */)((char const   *)(line + hdr_len)),
                    (size_t )10771);
#line 655
            hdrs_found = 1;
            }
...
#line 657
            token[10771] = (char )'\000';
#line 657
            strncpy((char */* __restrict  */)(token), (char const   */* __restrict  */)((char const   *)(line + hdr2_len)),
                    (size_t )10771);
#line 658
            hdrs_found = 1;
#line 659
...
#line 663
          token[10771] = (char )'\000';
#line 663
          strncpy((char */* __restrict  */)(token), (char const   */* __restrict  */)((char const   *)line),
                  (size_t )10771);
          }
        }
        {
...
#line 1096
    *(val + 13) = (char )'\000';
#line 1096
    strncpy((char */* __restrict  */)val, (char const   */* __restrict  */)((char const   *)(arg->now_utime)),
            (size_t )13);
    }
#line 1097
    return (1);
...
#line 1117
        if (! lowered) {
          {
#line 1118
          strncpy((char */* __restrict  */)(lower_token_res), (char const   */* __restrict  */)((char const   *)(token_res)),
                  (size_t )256);
#line 1119
...
#line 1190
  ...
  {
#line 1193
  tmp___1 = hashcash_to_utctimestr(arg.now_utime, 13, now_time);
  }
#line 1193
  if (! tmp___1) {
#line 1194
...
#line 1405
  strncpy((char */* __restrict  */)(*s + slen), (char const   */* __restrict  */)((char const   *)append),
          (size_t )alen);
  }
#line 1406
  return (1);
...
#line 1416
    *(*s + *smax) = (char )'\000';
#line 1416
    strncpy((char */* __restrict  */)*s, (char const   */* __restrict  */)((char const   *)a),
            (size_t )*smax);
    }
  } else {
    {
...
#line 82
    airac_observe(wordUpdate, tmp___3);
#line 82
...
#line 165
  {      (unsigned long (*/* const  */)(int bits , int *best , unsigned char *block ,
                                    uInt32 const   *IV , int tailIndex , unsigned long maxIter ,
                                    int (*cb)(int percent , int largest , int target ,
                                              double count , double expected , void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_library),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      double count ,
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_ansi_compact_1),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_ansi_standard_1),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_ansi_ultracompact_1), 
        (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_ansi_compact_2),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_ansi_standard_2),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_altivec_standard_1),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_altivec_compact_2), 
        (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_altivec_standard_2),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_mmx_compact_1),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))(& minter_mmx_standard_1),      (unsigned long (*/* const  */)(int bits ,
                                    int *best , unsigned char *block , uInt32 const   *IV ,
                                    int tailIndex , unsigned long maxIter , int (*cb)(int percent ,
                                                                                      int largest ,
                                                                                      int target ,
                                                                                      ...
                                                                                      double expected ,
                                                                                      void *user ) ,
                                    void *user_args , double counter , double expected ))((void *)0)};
...
#line 178
  {      (int (*/* const  */)(void))(& minter_library_test),      (int (*/* const  */)(void))(& minter_ansi_compact_1_test),      (int (*/* const  */)(void))(& minter_ansi_standard_1_test),      (int (*/* const  */)(void))(& minter_ansi_ultracompact_1_test), 
        (int (*/* const  */)(void))(& minter_ansi_compact_2_test),      (int (*/* const  */)(void))(& minter_ansi_standard_2_test),      (int (*/* const  */)(void))(& minter_altivec_standard_1_test),      (int (*/* const  */)(void))(& minter_altivec_compact_2_test), 
        (int (*/* const  */)(void))(& minter_altivec_standard_2_test),      (int (*/* const  */)(void))(& minter_mmx_compact_1_test),      (int (*/* const  */)(void))(& minter_mmx_standard_1_test),      (int (*/* const  */)(void))((void *)0)};
...
#line 290
      (*best_minter_fp)((int )test_bits, & gotbits, block, SHA1_IV___0, (int )test_tail,
                        iter_count, (int (*)(int percent , int largest , int target ,
                                             double count , double expected , void *user ))((void *)0),
...
#line 420
    ...
    {
#line 421
    (*(minters[i].func))((int )test_bits___0, & got_bits, block, SHA1_IV___0, (int )test_tail___0,
                         (unsigned long )(1 << 30), (int (*)(int percent , int largest ,
                                                             int target , double count ,
...
#line 140
  ctx->bits = 0UL;
#line 141
  memcpy((void */* __restrict  */)((void *)(ctx->H)), (void const   */* __restrict  */)((void const   *)(SHA1_IV)),
         (size_t )20);
  }
#line 142
  return;
...
#line 150
  ctx->bits = 0UL;
#line 151
  memcpy((void */* __restrict  */)((void *)(ctx->H)), (void const   */* __restrict  */)((void const   *)user_IV),
         (size_t )20);
  }
#line 152
...
#line 167
  ...
  {
#line 172
  memcpy((void */* __restrict  */)((void *)(W)), (void const   */* __restrict  */)((void const   *)M),
         (size_t )64);
#line 259
  E += ((((A << 5) | (A >> 27)) + (D ^ (B & (C ^ D)))) + W[0]) + 1518500249U;
#line 259
...
#line 305
  memcpy((void */* __restrict  */)((void *)(ctx->M + mlen)), (void const   */* __restrict  */)((void const   *)data),
         (size_t )use);
#line 306
  mlen += use;
#line 307
...
#line 311
    ...
    {
#line 312
    SHA1_Transform(ctx->H, (unsigned char const   *)(ctx->M));
    }
#line 313
    if (64UL < data_len) {
#line 313
...
#line 314
    memcpy((void */* __restrict  */)((void *)(ctx->M)), (void const   */* __restrict  */)((void const   *)data),
           (size_t )use);
#line 315
    mlen = use;
#line 316
...
#line 355
  ...
  {
#line 357
  memcpy((void */* __restrict  */)((void *)((ctx->M + 64) - 2UL * sizeof(unsigned int ))),
         (void const   */* __restrict  */)((void const   *)(& temp)), 2UL * sizeof(unsigned int ));
#line 363
  SHA1_Transform(ctx->H, (unsigned char const   *)(ctx->M));
#line 365
  memcpy((void */* __restrict  */)((void *)digest), (void const   */* __restrict  */)((void const   *)(ctx->H)),
         (size_t )20);
  }
#line 366
  if ((int )*((char *)(& endian_test)) == 1) {
...
#line 18
    ...
    {
#line 20
    file = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"rb");
    }
#line 21
...
#line 26
    ...
    {
#line 27
    bytes_read = fread((void */* __restrict  */)((void *)(buffer)), (size_t )1, (size_t )1024,

...
#line 93
  count = 1;
#line 95
  strcpy((char */* __restrict  */)cname, (char const   */* __restrict  */)((char const   *)cpfix));
#line 96
...
{ 
  ...
  {
#line 1387
  __gmpq_set(value, (mpq_srcptr )(nzo->value));
  }
#line 1388
  return;
}
...
{ 
  ...
  {
#line 1471
  __gmpq_set(cost, (mpq_srcptr )(var->cost));
  }
#line 1472
  return;
}
...
{ 
  ...
  {
#line 1497
  __gmpq_set(lower, (mpq_srcptr )(var->lower));
  }
#line 1498
  return;
}
...
{ 
  ...
  {
#line 1538
  __gmpq_set(upper, (mpq_srcptr )(var->upper));
  }
#line 1539
  return;
}
...
{ 
  ...
  {
#line 1663
  __gmpq_set(lhs, (mpq_srcptr )(con->lhs));
  }
#line 1664
  return;
}
...
{ 
  ...
  {
#line 1673
  __gmpq_set(rhs, (mpq_srcptr )(con->rhs));
  }
#line 1674
  return;
}
...
#line 1975
      *(target + len) = (char )'\000';
#line 1976
      strcat((char */* __restrict  */)target, (char const   */* __restrict  */)((char const   *)(temp)));
      }
    }
  } else {
    {
...
#line 2101
    __gmpq_add(sum, (mpq_srcptr )sum, (mpq_srcptr )(val));
#line 2093
    nzo = nzo->con_next;
    }
  }
...
#line 152
  __gmpq_init(rhs);
#line 157
  tmp___19 = lps_con_sumup(con, sum);
  }
#line 157
  if (tmp___19) {
    {
...
#line 583
  __gmpq_init(val2);
#line 585
  lps_getcost((Var const   *)var, val1);
#line 586
...
#line 229
    printf((char const   */* __restrict  */)((char const   *)usage), *(argv + 0));
#line 230
...
#line 249
    if ((int )*optarg != 99) {
      {
#line 251
      fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)usage),
              *(argv + 0));
#line 252
      exit(0);
      }
...
#line 421
  if (write_order) {
    {
#line 423
    sprintf((char */* __restrict  */)outpipe, (char const   */* __restrict  */)((char const   *)filter),
            ordfile, "ord");
    }
#line 425
    if (verbose >= 1) {
...
#line 170
  tmp[k] = (char )'\000';
#line 174
  __gmpq_set_str(value, (char const   *)(tmp), 10);
#line 175
  __gmpq_canonicalize(value);
  }
#line 176
  return;
}
...
#line 213
    p = mem_malloc(new_size, "/home/june/repo/benchmarks/collector/temp/zimpl-3.3.1+dfsg/src/gmpmisc.c",
                   (int const   )213);
#line 215
    memcpy((void */* __restrict  */)p, (void const   */* __restrict  */)((void const   *)ptr),
           old_size);
#line 217
    pool_free(ptr);
    }
...
#line 130
    ...
    {
#line 132
    tmp___1 = __builtin_va_arg(ap, CodeNode *);
#line 132
    tmp___0 = tmp___1;
#line 132
    child = tmp___0;
...
{ 
  ...
  {
#line 452
  return ((CodeNode *(*)(CodeNode *self ))node->eval);
}
}
...
#line 526
  {      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_abs),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_sgn),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_add),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_card), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_ceil),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_div),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_exp),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_sqrt), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_fac),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_floor),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_if_else),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_intdiv), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_length),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_ln),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_log),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_ord), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_prod),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_round),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_sum),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_max), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_max2),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_sglmax),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_min),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_min2), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_sglmin),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_mul),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_mod),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_neg), 
        (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_pow),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_sub),      (CodeNode *(*/* const  */)(CodeNode *self ))(& i_expr_substr),      (CodeNode *(*/* const  */)(CodeNode *self ))((void *)0)};
...
#line 104
  ...
  {
#line 106
  write_val(fp, format, 0, (__mpq_struct */* const  */)((__mpq_struct *)(con->lhs)));
#line 107
  fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)" <= ");
  }
#line 108
...
#line 123
  fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)" <= ");
#line 124
  write_val(fp, format, 0, (__mpq_struct */* const  */)((__mpq_struct *)(con->rhs)));
  }
#line 125
  goto switch_break;
  case_1: 
...
#line 439
        fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)" ");
#line 440
        write_val(fp, format, 1, (__mpq_struct */* const  */)((__mpq_struct *)(var->cost)));
#line 441
        fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)" %s",
                name);
        }
...
#line 560
      fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)" %s = ",
              name);
#line 561
      write_val(fp, format, 0, (__mpq_struct */* const  */)((__mpq_struct *)(var->lower)));
#line 562
      fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)"\n");
      }
    } else {
...
#line 580
      if ((unsigned int const   )var->type == 2U) {
        {
#line 582
        write_val(fp, format, 0, (__mpq_struct */* const  */)((__mpq_struct *)(var->upper)));
#line 583
        fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)"\n");
        }
      } else
...
#line 631
        fprintf((FILE */* __restrict  */)fp, (char const   */* __restrict  */)" %s:",
                name);
#line 632
        write_val(fp, format, 0, (__mpq_struct */* const  */)((__mpq_struct *)(sse->weight)));
#line 634
        cnt ++;
        }
#line 634
...
#line 137
      write_data(fp, 1, (int const   )' ', (int const   )' ', (char const   *)vtmp,
                 (char const   *)ctmp, (__mpq_struct */* const  */)((__mpq_struct *)(nzo->value)));
#line 129
...
#line 234
      write_data(fp, 1, (int const   )' ', (int const   )' ', "RHS", (char const   *)ctmp,
                 (__mpq_struct */* const  */)((__mpq_struct *)(con->rhs)));
      }
    }
#line 235
    goto switch_break___0;
...
#line 238
      write_data(fp, 1, (int const   )' ', (int const   )' ', "RHS", (char const   *)ctmp,
                 (__mpq_struct */* const  */)((__mpq_struct *)(con->lhs)));
      }
    }
#line 239
    goto switch_break___0;
...
#line 299
      write_data(fp, 1, (int const   )'F', (int const   )'X', "BOUND", (char const   *)vtmp,
                 (__mpq_struct */* const  */)((__mpq_struct *)(var->lower)));
      }
    } else {
#line 302
      if ((unsigned int const   )var->type == 1U) {
...
#line 308
        write_data(fp, 1, (int const   )'U', (int const   )'P', "BOUND", (char const   *)vtmp,
                   (__mpq_struct */* const  */)((__mpq_struct *)(var->upper)));
        }
      } else
#line 307
      if ((unsigned int const   )var->type == 3U) {
...
#line 328
        write_data(fp, 1, (int const   )' ', (int const   )' ', "", (char const   *)vtmp,
                   (__mpq_struct */* const  */)((__mpq_struct *)(sse->weight)));
#line 324
        sse = (Sse const   *)sse->next;
        }
      }

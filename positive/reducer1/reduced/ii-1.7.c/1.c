...
#line 165
  memcpy((void */* __restrict  */)((void *)(& sin.sin_addr)), (void const   */* __restrict  */)((void const   *)*(hp->h_addr_list + 0)),
         (size_t )hp->h_length);
#line 166
...
#line 189
    if (i > 1UL) {
      {
#line 189
      tmp = strtol((char const   */* __restrict  */)((char const   *)*(result + 0)),
...
#line 210
  out = fopen((char const   */* __restrict  */)((char const   *)(outfile)), (char const   */* __restrict  */)"a");
  }
#line 210
  if (! out) {
#line 210
...
#line 432
    r = select(maxfd + 1, (fd_set */* __restrict  */)(& rd), (fd_set */* __restrict  */)((fd_set *)0),
...
#line 475
    i ++;
#line 475
    tmp___1 = strtol((char const   */* __restrict  */)((char const   *)*(argv + i)),
                     (char **/* __restrict  */)((char **)((void *)0)), 10);
#line 475

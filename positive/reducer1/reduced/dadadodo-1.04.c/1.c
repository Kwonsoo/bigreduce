...
#line 43
  ...
  {
#line 44
  tmp = fwrite((void const   */* __restrict  */)((void const   *)(write_buf)), (size_t )1,
               (size_t )write_fp, (FILE */* __restrict  */)out);
#line 44
  status = (int )tmp;
#line 45
  write_fp = 0;
...
#line 154
    if (i == npools - 1) {
      {
#line 155
      tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)(p->chars)),
                       (size_t )1, (size_t )p->fp, (FILE */* __restrict  */)out);
#line 155
      status = (int )tmp___0;
      }
    } else {
...
#line 159
      ...
      {
#line 160
      tmp___1 = fwrite((void const   */* __restrict  */)((void const   *)(p->chars)),
                       (size_t )1, 512000UL - sizeof(void *) * 4UL, (FILE */* __restrict  */)out);
#line 160
      status = (int )tmp___1;
      }
    }
...
#line 300
  tmp = fgets((char */* __restrict  */)((char *)(write_buf)), 100, (FILE */* __restrict  */)in);
#line 300
...
#line 368
    tmp___17 = fread((void */* __restrict  */)((void *)*(spools + i)), (size_t )1,
                     (size_t )bytes_to_read, (FILE */* __restrict  */)in);
#line 368
...
#line 575
  while (1) {
    ...
    {
#line 576
    tmp___59 = fread((void */* __restrict  */)((void *)b2___0), (size_t )1, (size_t )bytes_to_read___0,
                     (FILE */* __restrict  */)in);
#line 576
...
#line 224
      fputs((char const   */* __restrict  */)((char const   *)(indent_str)), (FILE */* __restrict  */)stream);
#line 225
...
#line 248
    if (always_cap_p) {
      {
#line 249
      strcpy((char */* __restrict  */)((char *)c2), (char const   */* __restrict  */)((char const   *)c1));
      }
    } else {
      {
#line 252
...
#line 254
    ...
    {
#line 257
    fputs((char const   */* __restrict  */)((char const   *)(buf)), (FILE */* __restrict  */)stream);
    }
#line 259
    if (punc) {
#line 259
...
#line 286
    if (punc) {
      {
#line 287
      fputs((char const   */* __restrict  */)((char const   *)punc), (FILE */* __restrict  */)stream);
      }
    }
#line 289
...
#line 42
  ...
  {
#line 44
  memcpy((void */* __restrict  */)((void *)(spool->chars + spool->fp)), (void const   */* __restrict  */)((void const   *)s___0),
         (size_t )(L + 1));
#line 45
...
#line 201
    ...
    {
#line 204
    tmp = fgets((char */* __restrict  */)((char *)(buf)), (int )(sizeof(buf) - 1UL),
...
#line 221
      ...
      {
#line 222
      strcpy((char */* __restrict  */)((char *)qp_free_wrap_hack), (char const   */* __restrict  */)((char const   *)qp_wrap_hack));
#line 223
      strcat((char */* __restrict  */)((char *)qp_free_wrap_hack), (char const   */* __restrict  */)((char const   *)s___0));
#line 224
...
#line 750
    ...
    {
#line 210
    tmp___61 = fgets((char */* __restrict  */)((char *)(buf)), (int )(sizeof(buf) - 1UL),
                     (FILE */* __restrict  */)file);
#line 210
...
#line 941
        if (! f) {
          {
#line 943
          sprintf((char */* __restrict  */)((char *)(buf)), (char const   */* __restrict  */)"%s: opening input file %s",
                  *(argv + 0), *(input + i));
#line 944
...
#line 949
      fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"%s: reading %s...\n",
              *(argv + 0), tmp___17);
#line 952
      tmp___18 = fgets((char */* __restrict  */)((char *)(buf)), (int )(sizeof(buf) - 1UL),
                       (FILE */* __restrict  */)f);
#line 952
...
#line 998
      b = (char *)tmp___23;
#line 999
      strcpy((char */* __restrict  */)b, (char const   */* __restrict  */)((char const   *)tmp___20));
#line 1000
...
#line 1002
      sprintf((char */* __restrict  */)(b + tmp___26), (char const   */* __restrict  */)"dadadodo.%d",
              tmp___25);
#line 1004
      tmp_file = fopen((char const   */* __restrict  */)((char const   *)b), (char const   */* __restrict  */)"wb+");
      }
#line 1005
      if (! tmp_file) {
        {
...
#line 1016
      if (tmp___27) {
        {
#line 1020
        out = fopen((char const   */* __restrict  */)((char const   *)output), (char const   */* __restrict  */)"wb");
        }
#line 1021
        if (! out) {
          {
...
#line 1051
    if (load) {
      {
#line 1053
      f___0 = fopen((char const   */* __restrict  */)((char const   *)load), (char const   */* __restrict  */)"rb");
      }
#line 1054
      if (! f___0) {
        {
...
#line 1061
    if (output) {
      {
#line 1063
      f___0 = fopen((char const   */* __restrict  */)((char const   *)output), (char const   */* __restrict  */)"rb");
      }
#line 1064
      if (! f___0) {
        {
...
#line 1112
          done_once___0 = 1;
#line 1109
          tmp___29 = strtok((char */* __restrict  */)((char *)0), (char const   */* __restrict  */)",; ");
#line 1109

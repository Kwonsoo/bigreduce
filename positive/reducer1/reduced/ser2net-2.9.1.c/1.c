...
#line 173
      ...
      {
#line 177
      memcpy((void */* __restrict  */)((void *)(cntlr->outbuf + cntlr->outbuf_count)),
             (void const   */* __restrict  */)((void const   *)data), (size_t )count);
      }
    } else {
      {
#line 183
...
#line 194
      memcpy((void */* __restrict  */)((void *)newbuf), (void const   */* __restrict  */)((void const   *)(cntlr->outbuf + cntlr->outbuf_pos)),
             (size_t )cntlr->outbuf_count);
#line 197
      memcpy((void */* __restrict  */)((void *)(newbuf + cntlr->outbuf_count)), (void const   */* __restrict  */)((void const   *)data),
             (size_t )count);
#line 198
      free((void *)cntlr->outbuf);
#line 199
...
#line 216
    memcpy((void */* __restrict  */)((void *)newbuf___0), (void const   */* __restrict  */)((void const   *)data),
           (size_t )count);
#line 217
...
#line 340
                    ...
                    {
#line 343
                    str = strtok_r((char */* __restrict  */)((char *)((void *)0)),
                                   (char const   */* __restrict  */)" \t", (char **/* __restrict  */)(& strtok_data));
                    }
#line 344
...
#line 351
                  if (tmp___21 == 0) {
                    {
#line 352
                    tok = strtok_r((char */* __restrict  */)((char *)((void *)0)),
                                   (char const   */* __restrict  */)" \t", (char **/* __restrict  */)(& strtok_data));
                    }
#line 353
                    if ((unsigned long )tok == (unsigned long )((void *)0)) {
...
#line 766
  ...
  {
#line 768
  memcpy((void */* __restrict  */)((void *)(& tmp_read_set)), (void const   */* __restrict  */)((void const   *)(& sel->read_set)),
         sizeof(tmp_read_set));
#line 769
  memcpy((void */* __restrict  */)((void *)(& tmp_write_set)), (void const   */* __restrict  */)((void const   *)(& sel->write_set)),
         sizeof(tmp_write_set));
#line 770
  memcpy((void */* __restrict  */)((void *)(& tmp_except_set)), (void const   */* __restrict  */)((void const   *)(& sel->except_set)),
...
#line 927
  err = sigaction(1, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& act)),
...
#line 935
  err = sigaction(2, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& act)),
                  (struct sigaction */* __restrict  */)((struct sigaction *)((void *)0)));
  }
#line 936
  if (err) {
...
#line 92
    memcpy((void */* __restrict  */)((void *)(buf___1->buf + end)), (void const   */* __restrict  */)((void const   *)data),
           (size_t )availend);
#line 93
...
#line 114
  ...
  {
#line 117
  memcpy((void */* __restrict  */)((void *)working_longstr->str), (void const   */* __restrict  */)((void const   *)line),
         (size_t )line_len);
#line 118
...
#line 151
  memcpy((void */* __restrict  */)((void *)(working_longstr->str + working_longstr_len)),
         (void const   */* __restrict  */)((void const   *)line), (size_t )line_len);
#line 152
  working_longstr_len += line_len;
  }
  out: 
...
#line 302
    ...
    {
#line 303
    tmp___0 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\n",
                       (char **/* __restrict  */)(& strtok_data));
#line 303
...
#line 311
  if (tmp___4 == 0) {
    {
#line 312
    tmp___2 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                       (char **/* __restrict  */)(& strtok_data));
#line 312
    name = tmp___2;
#line 313
    tmp___3 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\n",
                       (char **/* __restrict  */)(& strtok_data));
#line 313
    str___0 = tmp___3;
    }
...
#line 322
  if (tmp___7 == 0) {
    {
#line 323
    tmp___5 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                       (char **/* __restrict  */)(& strtok_data));
#line 323
    name___0 = tmp___5;
#line 324
    tmp___6 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\n",
                       (char **/* __restrict  */)(& strtok_data));
#line 324
    str___1 = tmp___6;
    }
...
#line 333
  if (tmp___10 == 0) {
    {
#line 334
    tmp___8 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                       (char **/* __restrict  */)(& strtok_data));
#line 334
    name___1 = tmp___8;
#line 335
    tmp___9 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\n",
                       (char **/* __restrict  */)(& strtok_data));
#line 335
    str___2 = tmp___9;
    }
...
#line 344
  if (tmp___13 == 0) {
    {
#line 345
    tmp___11 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                        (char **/* __restrict  */)(& strtok_data));
#line 345
    name___2 = tmp___11;
#line 346
    tmp___12 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\n",
                        (char **/* __restrict  */)(& strtok_data));
#line 346
    str___3 = tmp___12;
    }
...
#line 355
  if (tmp___17 == 0) {
    {
#line 356
    tmp___14 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                        (char **/* __restrict  */)(& strtok_data));
#line 356
    name___3 = tmp___14;
#line 357
    tmp___15 = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"\n",
                        (char **/* __restrict  */)(& strtok_data));
#line 357
    str___4 = tmp___15;
    }
...
#line 367
  ...
  {
#line 370
  state = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                   (char **/* __restrict  */)(& strtok_data));
  }
#line 371
...
#line 373
  ...
  {
#line 376
  timeout = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                     (char **/* __restrict  */)(& strtok_data));
  }
#line 377
...
#line 379
  ...
  {
#line 382
  devname = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                     (char **/* __restrict  */)(& strtok_data));
  }
#line 383
...
#line 385
  ...
  {
#line 388
  devcfg = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)":",
                    (char **/* __restrict  */)(& strtok_data));
  }
#line 389
...
#line 410
  lineno = 0;
#line 412
  instream = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
  }
#line 413
...
{ 
  ...
  {
#line 120
  fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)help_string),
          name);
#line 121
  exit(1);
  }
...
#line 129
  ...
  {
#line 130
  fpidfile = fopen((char const   */* __restrict  */)((char const   *)pidfile), (char const   */* __restrict  */)"w");
  }
#line 131
  if (! fpidfile) {
    {
...
#line 283
    ...
    {
#line 286
    pos = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)", \t",
                   (char **/* __restrict  */)(& strtok_data));
    }
  }
  while_break___0: /* CIL Label */ ;
...
#line 466
  ...
  {
#line 469
  strcpy((char */* __restrict  */)str, (char const   */* __restrict  */)((char const   *)instr));
#line 471
  pos = strtok_r((char */* __restrict  */)str, (char const   */* __restrict  */)" \t",
                 (char **/* __restrict  */)(& strtok_data));
  }
...
#line 77
  ip = strtok_r((char */* __restrict  */)str, (char const   */* __restrict  */)",",
                (char **/* __restrict  */)(& strtok_data));
#line 78
  port = strtok_r((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)"",
                  (char **/* __restrict  */)(& strtok_data));
  }
#line 79
...
#line 87
  tmp = getaddrinfo((char const   */* __restrict  */)((char const   *)ip), (char const   */* __restrict  */)((char const   *)port),
...
#line 88
  ...
  {
#line 90
  memcpy((void */* __restrict  */)((void *)addr), (void const   */* __restrict  */)((void const   *)ai->ai_addr),
...
#line 310
  ...
  {
#line 312
  tmp___8 = stat((char const   */* __restrict  */)((char const   *)uucp_lck_dir),
                 (struct stat */* __restrict  */)(& stt));
  }
#line 312
  if (tmp___8 == 0) {
    {
...
#line 336
        sscanf((char const   */* __restrict  */)((char const   *)(buf___1.str)), (char const   */* __restrict  */)"%d",
               & pid);
        }
      }
#line 339
...
#line 547
  len += tmp___0;
#line 548
  getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& port->remote))),
...
#line 554
  ...
  {
#line 556
  strncpy((char */* __restrict  */)(buf + len), (char const   */* __restrict  */)((char const   *)(portstr)),
...
#line 1298
      ...
      {
#line 1305
      tmp___5 = getnameinfo((struct sockaddr  const  */* __restrict  */)((struct sockaddr  const  *)((struct sockaddr *)(& port->remote))),
                            (socklen_t )sizeof(port->remote), (char */* __restrict  */)(ip),
                            (socklen_t )sizeof(ip), (char */* __restrict  */)((char *)((void *)0)),
                            (socklen_t )0, 1);
      }
#line 1305
      if (! tmp___5) {
...
#line 1348
  len = 0U;
#line 1352
  localtime_r((time_t const   */* __restrict  */)((time_t const   *)(& tv->tv_sec)),
              (struct tm */* __restrict  */)(& now));
#line 1353
...
#line 2093
  ...
  {
#line 2095
  strcpy((char */* __restrict  */)new_port->portname, (char const   */* __restrict  */)((char const   *)portnum));
#line 2097
...
#line 2138
  ...
  {
#line 2140
  strcpy((char */* __restrict  */)new_port->devname, (char const   */* __restrict  */)((char const   *)devname));
#line 2142
...
#line 2839
  strncpy((char */* __restrict  */)((char *)(outopt) + 2), (char const   */* __restrict  */)((char const   *)port->dinfo.signature),
          (size_t )sign_len);
#line 2840

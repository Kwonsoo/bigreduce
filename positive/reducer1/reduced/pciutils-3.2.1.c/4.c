...
#line 66
  ...
  {
#line 67
  f = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"r");
  }
#line 67
  if (! f) {
    {
...
#line 82
    if (tmp___13) {
      {
#line 82
      tmp___14 = sscanf((char const   */* __restrict  */)((char const   *)(buf)),
                        (char const   */* __restrict  */)"%x:%x.%d", & bn, & dn, & fn);
      }
#line 82
      if (tmp___14 == 3) {
        {
...
#line 82
      if (tmp___15) {
        {
#line 82
        tmp___16 = sscanf((char const   */* __restrict  */)((char const   *)(buf)),
                          (char const   */* __restrict  */)"%x:%x:%x.%d", & mn, & bn,
                          & dn, & fn);
        }
#line 82
        if (tmp___16 == 4) {
...
#line 91
          if (tmp___11) {
            ...
            {
#line 91
            tmp___12 = sscanf((char const   */* __restrict  */)((char const   *)(buf)),
                              (char const   */* __restrict  */)"%x: ", & i);
            }
#line 91
            if (tmp___12 == 1) {
              {
...
#line 97
                    if ((int )*(z + 2) == 32) {
                      ...
                      {
#line 97
                      tmp___9 = sscanf((char const   */* __restrict  */)((char const   *)z),
                                       (char const   */* __restrict  */)"%x", & j);
                      }
#line 97
                      if (tmp___9 == 1) {
#line 97
...
#line 108
                  memcpy((void */* __restrict  */)((void *)(((struct dump_data *)dev->aux)->data)),
                         (void const   */* __restrict  */)((void const   *)(dd->data)),
                         (size_t )256);
#line 109
                  pci_mfree((void *)dd);
#line 110
...
#line 153
  ...
  {
#line 154
  memcpy((void */* __restrict  */)((void *)buf), (void const   */* __restrict  */)((void const   *)(dd->data + pos)),
         (size_t )len);
  }
#line 155
  return (1);
...
#line 62
  ...
  {
#line 65
  f = fopen((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"rb");
  }
#line 66
  if (! f) {
    {
...
#line 88
        ...
        {
#line 93
        tmp___1 = sscanf((char const   */* __restrict  */)((char const   *)(line)),
                         (char const   */* __restrict  */)"%d%x%x%x%x%n", & cat, & id1,
                         & id2, & id3, & id4, & cnt);
        }
#line 93
        if (tmp___1 >= 5) {
...
#line 138
  f = fopen((char const   */* __restrict  */)((char const   *)tmpname), (char const   */* __restrict  */)"wb");
  }
#line 139
  if (! f) {
    {
...
#line 83
  t = (char *)tmp___0;
#line 84
  memcpy((void */* __restrict  */)((void *)t), (void const   */* __restrict  */)((void const   *)s),
         (size_t )len);
  }
#line 85
  return (t);
...
#line 116
  __builtin_va_start(args, msg);
#line 117
  vfprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)((char const   *)msg),
           args);
#line 118
...
#line 121
  tmp = strtol((char const   */* __restrict  */)((char const   *)(buf)), (char **/* __restrict  */)((char **)((void *)0)),
               0);
  }
#line 121
  return ((int )tmp);
...
#line 133
  file = fopen((char const   */* __restrict  */)((char const   *)(namebuf)), (char const   */* __restrict  */)"r");
  }
#line 134
  if (! file) {
    {
...
#line 140
    ...
    {
#line 141
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%llx %llx %llx",
                     & start, & end, & flags);
    }
#line 141
    if (tmp___2 != 3) {
...
#line 184
    d = pci_alloc_dev(a);
#line 185
    tmp___0 = sscanf((char const   */* __restrict  */)((char const   *)(entry->d_name)),
                     (char const   */* __restrict  */)"%x:%x:%x.%d", & dom, & bus,
                     & dev, & func);
    }
#line 185
    if (tmp___0 < 4) {
...
#line 248
    if (tmp___0) {
      {
#line 248
      res = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%x:%x:%x",
                   & dom, & bus, & dev);
      }
#line 248
      if (res < 3) {
...
#line 64
  ...
  {
#line 65
  f = fopen((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"r");
  }
#line 66
  if (! f) {
    {
...
#line 70
    d = tmp___1;
#line 74
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%x %x %x %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx %08lx",
...
#line 40
        if (tmp___5) {
          {
#line 42
          tmp___4 = strtol((char const   */* __restrict  */)((char const   *)str),
                           (char **/* __restrict  */)(& e), 16);
#line 42
          x = tmp___4;
          }
#line 43
...
#line 50
      if (tmp___7) {
        {
#line 52
        tmp___6 = strtol((char const   */* __restrict  */)((char const   *)bus), (char **/* __restrict  */)(& e),
                         16);
#line 52
        x___0 = tmp___6;
        }
...
#line 60
    if (tmp___10) {
      {
#line 62
      tmp___9 = strtol((char const   */* __restrict  */)((char const   *)mid), (char **/* __restrict  */)(& e),
                       16);
#line 62
      x___1 = tmp___9;
      }
...
#line 67
      if (tmp___12) {
        {
#line 69
        tmp___11 = strtol((char const   */* __restrict  */)((char const   *)dot),
                          (char **/* __restrict  */)(& e), 16);
#line 69
        x___2 = tmp___11;
        }
...
#line 90
    if (tmp___1) {
      {
#line 92
      tmp___0 = strtol((char const   */* __restrict  */)((char const   *)str), (char **/* __restrict  */)(& e),
                       16);
#line 92
      x = tmp___0;
      }
...
#line 97
    if (tmp___3) {
      {
#line 99
      tmp___2 = strtol((char const   */* __restrict  */)((char const   *)s), (char **/* __restrict  */)(& e),
                       16);
#line 99
      x___0 = tmp___2;
      }
...
#line 224
  a->id_load_failed = 1;
#line 225
  f = fopen((char const   */* __restrict  */)((char const   *)a->id_file_name), (char const   */* __restrict  */)"r");
  }
#line 225
  if (! f) {
#line 226
...
#line 78
  n->src = (byte )src;
#line 79
  memcpy((void */* __restrict  */)((void *)(n->name)), (void const   */* __restrict  */)((void const   *)text),
         (size_t )(len + 1));
#line 80
  n->next = *(a->id_hash + h);
#line 81
...
#line 72
  if (pos + len <= d->cache_len) {
    {
#line 73
    memcpy((void */* __restrict  */)buf, (void const   */* __restrict  */)((void const   *)(d->cache + pos)),
           (size_t )len);
    }
  } else {
    {
...
#line 119
  if (pos + len <= d->cache_len) {
    {
#line 120
    memcpy((void */* __restrict  */)((void *)(d->cache + pos)), (void const   */* __restrict  */)((void const   *)buf),
           (size_t )len);
    }
  }
  {
...
#line 141
  ...
  {
#line 143
  tmp___33 = __builtin_va_arg(args, int );
#line 143
  tmp___2 = tmp___33;
#line 143
  iv = tmp___2;
#line 144
  tmp___34 = __builtin_va_arg(args, int );
#line 144
  tmp___3 = tmp___34;
#line 144
  id = tmp___3;
...
#line 146
  ...
  {
#line 148
  tmp___35 = __builtin_va_arg(args, int );
#line 148
  tmp___6 = tmp___35;
#line 148
  iv = tmp___6;
...
#line 158
  ...
  {
#line 160
  tmp___38 = __builtin_va_arg(args, int );
#line 160
  tmp___11 = tmp___38;
#line 160
  iv = tmp___11;
#line 161
  tmp___39 = __builtin_va_arg(args, int );
#line 161
  tmp___12 = tmp___39;
#line 161
  id = tmp___12;
#line 162
  tmp___40 = __builtin_va_arg(args, int );
#line 162
  tmp___13 = tmp___40;
#line 162
  isv = tmp___13;
...
#line 165
  ...
  {
#line 167
  tmp___42 = __builtin_va_arg(args, int );
#line 167
  tmp___17 = tmp___42;
#line 167
  iv = tmp___17;
...
#line 174
  ...
  {
#line 176
  tmp___46 = __builtin_va_arg(args, int );
#line 176
  tmp___22 = tmp___46;
#line 176
  icls = tmp___22;
...
#line 184
  ...
  {
#line 186
  tmp___47 = __builtin_va_arg(args, int );
#line 186
  tmp___24 = tmp___47;
#line 186
  icls = tmp___24;
#line 187
  tmp___48 = __builtin_va_arg(args, int );
#line 187
  tmp___25 = tmp___48;
#line 187
  ipif = tmp___25;
...
#line 220
      ...
      {
#line 222
      memcpy((void */* __restrict  */)((void *)(txt)), (void const   */* __restrict  */)((void const   *)(data + (j + 1))),
             (size_t )*(data + j));
#line 223
      txt[*(data + j)] = (char)0;
#line 224

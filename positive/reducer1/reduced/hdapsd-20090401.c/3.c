...
#line 137
  ...
  {
#line 138
  tmp = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"(%d,%d)\n",
               x, y);
  }
#line 138
  return (tmp != 2);
...
#line 149
  ...
  {
#line 150
  tmp = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%d %d %d\n",
               x, y, z);
  }
#line 150
  return (tmp != 3);
...
#line 175
  ...
  {
#line 176
  tmp = sscanf((char const   */* __restrict  */)((char const   *)(buf)), (char const   */* __restrict  */)"%d\n",
               & ret);
  }
#line 176
  if (tmp != 1) {
...
#line 530
      ...
      {
#line 533
      strncpy((char */* __restrict  */)(disklist->name), (char const   */* __restrict  */)((char const   *)disk),
              sizeof(disklist->name));
#line 534
      strncpy((char */* __restrict  */)(disklist->protect_file), (char const   */* __restrict  */)((char const   *)(protect_file)),
...
#line 545
      ...
      {
#line 548
      strncpy((char */* __restrict  */)((p->next)->name), (char const   */* __restrict  */)((char const   *)disk),
              sizeof((p->next)->name));
#line 549
      strncpy((char */* __restrict  */)((p->next)->protect_file), (char const   */* __restrict  */)((char const   *)(protect_file)),
...
#line 727
        airac_observe(protect_method, tmp___1);
#line 727

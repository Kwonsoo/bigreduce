...
#line 291
      ...
      {
#line 341
      memcpy((void */* __restrict  */)((void *)pfile->pbuf), (void const   */* __restrict  */)((void const   *)pfile->pwritebuf),
...
#line 512
      if ((unsigned long )pfile->pwritebuf != (unsigned long )((unsigned char *)0)) {
        {
#line 513
        memcpy((void */* __restrict  */)((void *)(pfile->pwritebuf + ioffset)), (void const   */* __restrict  */)((void const   *)(pfile->pbuf + ioffset)),
               (size_t )cb);
        }
      }
#line 514
...
#line 576
    ...
    {
#line 576
    memcpy((void */* __restrict  */)((void *)pbuf), (void const   */* __restrict  */)((void const   *)(tmp___0 + (pfile->useroffset - pfile->bufferoffset))),
           (size_t )cbavail);
#line 578
...
#line 603
    ...
    {
#line 604
    memcpy((void */* __restrict  */)((void *)(pfile->pwritebuf + (pfile->useroffset - pfile->bufferoffset))),
           (void const   */* __restrict  */)((void const   *)pbuf), (size_t )cbavail);
#line 605
    pfile->fwritten = 1;
#line 606
    pfile->useroffset += (off_t )cbavail;
...
#line 749
  if ((unsigned long )pp->pto == (unsigned long )((mtd_file *)0)) {
    {
#line 750
    tmp = fwrite((void const   */* __restrict  */)((void const   *)pbuf), cb, (size_t )1,
...
#line 779
    if ((unsigned long )pp->pfrom == (unsigned long )((mtd_file *)0)) {
      {
#line 780
      tmp = fread((void */* __restrict  */)((void *)(buf)), cbavail, (size_t )1, (FILE */* __restrict  */)stdin);
      }
#line 780
      if (tmp != 1UL) {
        {
...
#line 989
        *tmp___3 = 0;
#line 990
        num = strtoul((char const   */* __restrict  */)((char const   *)lp), (char **/* __restrict  */)(& end),
                      0);
        }
#line 991
...
#line 1181
  ...
  {
#line 1184
  memcpy((void */* __restrict  */)((void *)buffer), (void const   */* __restrict  */)((void const   *)(line + start)),
         (size_t )end);
#line 1185
...
#line 1515
        pp->cstack = 8;
#line 1516
        printf((char const   */* __restrict  */)((char const   *)(buffer)), *(stack___0 + 0),
               *(stack___0 + -1), *(stack___0 + -2), *(stack___0 + -3), *(stack___0 + -4),
               *(stack___0 + -5), *(stack___0 + -6), *(stack___0 + -7));
        }
#line 1519
        goto stdout_check;
        case_exp___19: 

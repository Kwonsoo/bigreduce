...
#line 58
  if (tmp___0 < 33UL) {
    {
#line 60
    strncpy((char */* __restrict  */)dest, (char const   */* __restrict  */)((char const   *)basen),
            (size_t )33);
    }
#line 61
    return;
...
{ 
  ...
  {
#line 338
  tmp___1 = lstat((char const   */* __restrict  */)((char const   *)fn), (struct stat */* __restrict  */)(& sb));
  }
#line 338
  if (tmp___1) {
    {
...
{ 
  ...
  {
#line 420
  tmp___1 = stat((char const   */* __restrict  */)((char const   *)fn), (struct stat */* __restrict  */)(& sb));
  }
#line 420
  if (tmp___1) {
    {
...
#line 147
  if (s->mode & (unsigned long )(1 << 3)) {
    {
#line 148
    strncpy((char */* __restrict  */)fn, (char const   */* __restrict  */)((char const   *)input),
            (size_t )4096);
    }
  } else {
    {
...
#line 157
    if ((unsigned long )((void *)0) == (unsigned long )cwd) {
      {
#line 161
      realpath((char const   */* __restrict  */)((char const   *)input), (char */* __restrict  */)fn);
      }
    } else {
      {
#line 163
...
#line 46
  d_name = (char *)tmp;
#line 51
  realpath((char const   */* __restrict  */)((char const   *)fn), (char */* __restrict  */)d_name);
  }
#line 54
...
#line 53
    __builtin_va_start(ap, fmt);
#line 53
    tmp___1 = vfprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)fmt),
                       ap);
    }
#line 53
    if (tmp___1 < 0) {
...
#line 91
      if ((int const   )*(*tmp + (int )*(s->buf + (int )inpos)) & 16384) {
#line 93
        *(s->strings + (int )outpos) = *(s->buf + (int )inpos);
#line 94
...
#line 98
        recording = 0;
#line 99
        *(s->strings + (int )outpos) = (unsigned char )',';
#line 100
        outpos = (uint16_t )((int )outpos + 1);
      }
    } else {
...
#line 181
  ...
  {
#line 186
  s->handle = fopen((char const   */* __restrict  */)((char const   *)fn), (char const   */* __restrict  */)"rb");
  }
#line 187
...
#line 200
  s->bytes_read = fread((void */* __restrict  */)((void *)s->buf), (size_t )1, (size_t )8192,

...
{ 
  ...
  {
#line 82
  memcpy((void */* __restrict  */)((void *)(& val)), (void const   */* __restrict  */)((void const   *)buf),
         sizeof(val));
  }
#line 84
  if (val) {
...
#line 97
  *tmp = 0;
#line 98
  tmp___0 = strtoul((char const   */* __restrict  */)((char const   *)text), (char **/* __restrict  */)((char **)((void *)0)),
                    0);
#line 98
...
#line 121
  strncpy((char */* __restrict  */)((char *)dest), (char const   */* __restrict  */)((char const   *)text),
          (size_t )128);
  }
#line 122
  if ((int )*(dest + 127) != 0) {
...
{ 
  ...
  {
#line 187
  memcpy((void */* __restrict  */)((void *)(& addr)), (void const   */* __restrict  */)((void const   *)buf),
         sizeof(addr));
#line 188
  tmp = inet_ntoa(addr);
#line 188
...
#line 200
  ...
  {
#line 202
  memcpy((void */* __restrict  */)buf, (void const   */* __restrict  */)((void const   *)addr),
...
#line 26
    ...
    {
#line 27
    printf((char const   */* __restrict  */)"%02x", (int )*((uint8_t *)buf + (int )i));
    }
#line 28
    if ((int )i % 2) {
      {
...
#line 141
  if ((int )verb <= (int )verbosity) {
    {
#line 142
    memcpy((void */* __restrict  */)((void *)(buf)), (void const   */* __restrict  */)((void const   *)key->dataval),
...
#line 243
    ...
    {
#line 244
    memcpy((void */* __restrict  */)((void *)(& key)), (void const   */* __restrict  */)((void const   *)(buf + 4)),
           sizeof(key));
#line 245
...
#line 256
  ...
  {
#line 259
  memcpy((void */* __restrict  */)((void *)(& len)), (void const   */* __restrict  */)((void const   *)buf),
         sizeof(len));
#line 260
...
#line 266
  ...
  {
#line 269
  memcpy((void */* __restrict  */)((void *)(& key)), (void const   */* __restrict  */)((void const   *)((buf + len) - 8)),
         sizeof(key));
#line 270
  fix_endian32((void *)(& key), swab);
  }
...
#line 273
  ...
  {
#line 277
  memcpy((void */* __restrict  */)((void *)(& crc)), (void const   */* __restrict  */)((void const   *)((buf + len) - 4)),
         sizeof(crc));
#line 278
...
#line 417
  ...
  {
#line 420
  memcpy((void */* __restrict  */)((void *)key.dataval), (void const   */* __restrict  */)((void const   *)(buf)),
         (size_t )types[key.type].type_size);
  }
  {
#line 422
...
#line 461
  ...
  {
#line 464
  memcpy((void */* __restrict  */)((void *)((buf + len) - 4)), (void const   */* __restrict  */)((void const   *)(& crc)),
         sizeof(crc));
#line 467
  memcpy((void */* __restrict  */)((void *)(& crc)), (void const   */* __restrict  */)((void const   *)((buf + len) - 4)),
         sizeof(crc));
...
#line 258
    ...
    {
#line 260
    sscanf((char const   */* __restrict  */)((char const   *)optarg), (char const   */* __restrict  */)"%i",
           & offset);
    }
#line 261
    goto switch_break;

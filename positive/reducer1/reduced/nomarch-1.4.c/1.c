...
#line 99
  ...
  {
#line 101
  tmp___0 = fread((void */* __restrict  */)((void *)(hdrp->name)), (size_t )1, sizeof(hdrp->name),
                  (FILE */* __restrict  */)in);
  }
#line 101
...
#line 103
    ...
    {
#line 101
    tmp___1 = fread((void */* __restrict  */)((void *)(buf___1)), (size_t )1, (size_t )bufsiz,
                    (FILE */* __restrict  */)in);
    }
#line 101
...
#line 124
  if (method_high) {
    {
#line 126
    tmp___4 = fread((void */* __restrict  */)((void *)(buf___1)), (size_t )1, (size_t )12,
                    (FILE */* __restrict  */)in);
    }
#line 126
    if (tmp___4 != 12UL) {
...
#line 189
  ...
  {
#line 191
  tmp___0 = fread((void */* __restrict  */)((void *)data), (size_t )1, (size_t )siz,
                  (FILE */* __restrict  */)in);
  }
#line 191
...
#line 390
  in = fopen((char const   */* __restrict  */)((char const   *)archive_filename),
...
#line 571
          if (! test_only) {
            {
#line 571
            out = fopen((char const   */* __restrict  */)((char const   *)(hdr.name)),
...
#line 578
          if (! test_only) {
            {
#line 578
            tmp___16 = fwrite((void const   */* __restrict  */)((void const   *)orig_data),
                              (size_t )1, hdr.orig_size, (FILE */* __restrict  */)out);
            }
#line 578

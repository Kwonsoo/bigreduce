...
#line 47
    ...
    {
#line 49
    strncpy((char */* __restrict  */)(p___2->name), (char const   */* __restrict  */)((char const   *)u___0->pw_name),
            (size_t )8);
#line 50
    p___2->name[8] = (char)0;
    }
...
#line 122
  memcpy((void */* __restrict  */)((void *)t), (void const   */* __restrict  */)((void const   *)src),
         sizeof(*t));
#line 124
  t->inode = inode;
#line 125
...
#line 135
  i___0 = sscanf((char const   */* __restrict  */)((char const   *)s), (char const   */* __restrict  */)"%x:%x %x:%x %x",
...
#line 146
  ...
  {
#line 150
  memcpy((void */* __restrict  */)((void *)((char *)(& t) + offset)), (void const   */* __restrict  */)((void const   *)((char *)tmp + offset)),
         sizeof(t) - (unsigned long )offset);
  }
#line 159
  return (tmp);
...
#line 184
    tmp ++;
#line 184
    tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)tmp), (char const   */* __restrict  */)"%d",
                     & inode);
    }
#line 184
    if (tmp___2 != 1) {
...
#line 214
  ...
  {
#line 215
  tmp = sscanf((char const   */* __restrict  */)((char const   *)s), (char const   */* __restrict  */)"%d",
               & inode);
  }
#line 215
  if (tmp != 1) {
...
#line 286
  c___0 = 1;
#line 287
  f = fopen((char const   */* __restrict  */)((char const   *)name___0), (char const   */* __restrict  */)"r");
  }
#line 288
  if (! f) {
#line 288
...
#line 352
  snprintf((char */* __restrict  */)(buf___6), sizeof(buf___6), (char const   */* __restrict  */)"/proc/%d/stat",
           pid___0);
#line 353
  f = fopen((char const   */* __restrict  */)((char const   *)(buf___6)), (char const   */* __restrict  */)"r");
  }
#line 354
  if (! f) {
#line 354
...
#line 381
  fclose(f);
#line 382
  sscanf((char const   */* __restrict  */)((char const   *)(buf___6 + 5)), (char const   */* __restrict  */)"%ld",
         & boot_time);
  }
#line 383
  return (boot_time);
...
#line 472
  cur_cpu_info = tmp;
#line 473
  i___0 = sscanf((char const   */* __restrict  */)((char const   *)(buf___6 + 5)),
                 (char const   */* __restrict  */)"%lld %lld %lld %lld", & tmp->u_mode,
                 & tmp->nice, & tmp->s_mode, & tmp->idle);
#line 475
  fclose(f);
  }
#line 476
...
{ 
  ...
  {
#line 13
  tmp = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& cur_reg)),
                (char const   */* __restrict  */)s, (size_t )0, (regmatch_t */* __restrict  */)((regmatch_t *)0),
                1 << 1);
  }
#line 13
  if (tmp) {
...
{ 
  ...
  {
#line 22
  err___0 = regcomp((regex_t */* __restrict  */)(& cur_reg), (char const   */* __restrict  */)((char const   *)s),
                    (1 | (1 << 1)) | (((1 << 1) << 1) << 1));
  }
#line 23
  if (err___0) {
    {
#line 24
    regerror(err___0, (regex_t const   */* __restrict  */)((regex_t const   *)(& cur_reg)),
             (char */* __restrict  */)(errbuf), sizeof(errbuf));
    }
#line 26
    return (0);
  }
...
#line 45
  snprintf((char */* __restrict  */)(buf___6), sizeof(buf___6), (char const   */* __restrict  */)"/proc/%d/stat",
           pid___0);
#line 46
  f = fopen((char const   */* __restrict  */)((char const   *)(buf___6)), (char const   */* __restrict  */)"rt");
  }
#line 46
  if (! f) {
#line 47
...
#line 93
  ...
  {
#line 94
  memcpy((void */* __restrict  */)((void *)(buf___3)), (void const   */* __restrict  */)((void const   *)s),
         (size_t )n);
  }
#line 95
  return (buf___3);
...
#line 126
  snprintf((char */* __restrict  */)(buf___6), sizeof(buf___6), (char const   */* __restrict  */)"/proc/%d",
           pid___0);
#line 127
  tmp = stat((char const   */* __restrict  */)((char const   *)(buf___6)), (struct stat */* __restrict  */)(& s));
  }
#line 127
  if (tmp == -1) {
#line 127
...
#line 156
  sprintf((char */* __restrict  */)(buf___4), (char const   */* __restrict  */)"/dev/%s",
          tty);
#line 158
  tmp = stat((char const   */* __restrict  */)((char const   *)(buf___4)), (struct stat */* __restrict  */)(& st));
  }
#line 158
  if (tmp == -1) {
#line 158
...
#line 149
  if (show_linenr) {
    {
#line 150
    offset = snprintf((char */* __restrict  */)((char *)((w->mwin)->gbuf)), (size_t )(w->mwin)->gbsize,
...
#line 153
    snprintf((char */* __restrict  */)((char *)((w->mwin)->gbuf + offset)), (size_t )((w->mwin)->gbsize - (u32 )offset),
...
#line 69 "/home/june/repo/benchmarks/collector2/temp/whowatch-1.8.5/src/whowatch.h"
int full_cmd ;
#line 116
...
#line 277
  wdgt_init(w);
#line 278
  memcpy((void */* __restrict  */)((void *)(w->name)), (void const   */* __restrict  */)((void const   *)name___0),
         sizeof(w->name) - 1UL);
#line 279
  w->x = x;
#line 280
...
#line 419
    retval = select(1, (fd_set */* __restrict  */)(& rfds), (fd_set */* __restrict  */)((fd_set *)0),
...
#line 57
  ...
  {
#line 58
  strncpy((char */* __restrict  */)(u___0->name), (char const   */* __restrict  */)((char const   *)(entry___0->ut_user)),
          (size_t )32);
#line 59
  strncpy((char */* __restrict  */)(u___0->tty), (char const   */* __restrict  */)((char const   *)(entry___0->ut_line)),
          (size_t )32);
#line 60
  strncpy((char */* __restrict  */)(u___0->host), (char const   */* __restrict  */)((char const   *)(entry___0->ut_host)),
          (size_t )256);
#line 62
...
#line 68
    strncpy((char */* __restrict  */)(u___0->parent), (char const   */* __restrict  */)((char const   *)tmp___0),
...
#line 86
  ...
  {
#line 86
  n = snprintf((char */* __restrict  */)((char *)((w->mwin)->gbuf)), (size_t )(w->mwin)->gbsize,

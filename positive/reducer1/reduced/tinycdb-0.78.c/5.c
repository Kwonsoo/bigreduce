...
#line 77
static  __attribute__((__noreturn__)) void error(int errnum , char const   *fmt  , ...) ;
#line 77
static  __attribute__((__noreturn__)) void error(int errnum , char const   *fmt  , ...) ;
#line 77 "/home/june/repo/benchmarks/collector/temp/tinycdb-0.78/cdb.c"
static void error(int errnum , char const   *fmt  , ...) 
{ 
  va_list ap ;
  char *tmp ;
  int tmp___0 ;
...
#line 132
    ...
    {
#line 133
    fwrite((void const   */* __restrict  */)((void const   *)buf), (size_t )1, (size_t )c.cdb_vlen,
...
#line 147
  ...
  {
#line 148
  tmp___1 = fread((void */* __restrict  */)((void *)b), (size_t )1, (size_t )len,
                  (FILE */* __restrict  */)f);
  }
#line 148
...
#line 161
      tmp = fwrite((void const   */* __restrict  */)((void const   *)buf), (size_t )1,
                   (size_t )blen, (FILE */* __restrict  */)fo);
      }
#line 161
      if (tmp != (size_t )blen) {
#line 161
...
#line 166
    if (fo) {
      {
#line 166
      tmp___0 = fwrite((void const   */* __restrict  */)((void const   *)buf), (size_t )1,
                       (size_t )len, (FILE */* __restrict  */)fo);
      }
#line 166
...
#line 178
    ...
    {
#line 179
    f = fopen((char const   */* __restrict  */)((char const   *)dbname), (char const   */* __restrict  */)"r");
    }
#line 179
...
#line 319
      fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"%s: key `",
              program_invocation_short_name);
#line 320
      fwrite((void const   */* __restrict  */)((void const   *)key), (size_t )1, (size_t )klen,
...
#line 396
    ...
    {
#line 404
    tmp___1 = strcpy((char */* __restrict  */)tmpname, (char const   */* __restrict  */)((char const   *)dbname));
#line 404
...
#line 421
        ...
        {
#line 423
        tmp___6 = fopen((char const   */* __restrict  */)((char const   *)*(argv + i)),
...
#line 481
    ep = (char *)((void *)0);
#line 482
    tmp = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& ep),
                 0);
#line 482
    perms = (int )tmp;
    }
...
#line 488
    ep___0 = (char *)((void *)0);
#line 489
    tmp___0 = strtol((char const   */* __restrict  */)((char const   *)optarg), (char **/* __restrict  */)(& ep___0),
                     0);
#line 489
    num = (int )tmp___0;
    }
...
#line 37
  tmp___6 = _cdb_make_write(cdbmp, (unsigned char const   *)(rlen), 8U);
#line 37
  tmp___3 = (int )tmp___6;
  }
#line 37
...
#line 40
    ...
    {
#line 37
    tmp___7 = _cdb_make_write(cdbmp, (unsigned char const   *)key, klen);
#line 37
    tmp___4 = (int )tmp___7;
    }
#line 37
...
#line 40
      ...
      {
#line 37
      tmp___8 = _cdb_make_write(cdbmp, (unsigned char const   *)val, vlen);
#line 37
      tmp___5 = (int )tmp___8;
      }
#line 37
...
#line 57
      ...
      {
#line 58
      tmp___5 = cdb_unpack(cdbp->cdb_mem + pos);
      }
#line 58
      if (tmp___5 == klen) {
#line 59
...
#line 51
      ...
      {
#line 52
      tmp___4 = cdb_unpack(cdbp->cdb_mem + pos);
      }
#line 52
      if (tmp___4 == klen) {
#line 53
...
#line 62
  if (len > l) {
    {
#line 63
    memcpy((void */* __restrict  */)((void *)cdbmp->cdb_bpos), (void const   */* __restrict  */)((void const   *)ptr),
           (size_t )l);
#line 64
    cdbmp->cdb_bpos += l;
#line 65
...
#line 44
      ...
      {
#line 42
      tmp___3 = _cdb_make_fullwrite(fd, (unsigned char const   *)(cdbmp->cdb_buf),
                                    (unsigned int )r);
#line 42
      tmp___2 = (int )tmp___3;
      }
...
#line 62
  cdb_pack(rlen - 8U, cdbmp->cdb_buf + 4);
  }
  {
#line 63
  while (1) {
...
#line 64
    ...
    {
#line 65
    tmp___1 = _cdb_make_fullwrite(cdbmp->cdb_fd, (unsigned char const   *)(cdbmp->cdb_buf),
                                  rpos);
#line 65
    tmp___0 = (int )tmp___1;
    }
...
#line 195
  ...
  {
#line 198
  tmp___3 = _cdb_make_add(cdbmp, hval, key, klen, val, vlen);
#line 198
  tmp___2 = (int )tmp___3;
  }
#line 198

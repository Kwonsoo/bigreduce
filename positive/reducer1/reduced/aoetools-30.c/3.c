...
#line 144
  ...
  {
#line 146
  memcpy((void */* __restrict  */)((void *)c), (void const   */* __restrict  */)((void const   *)(buf)),
         sizeof(*c));
  }
#line 147
  return;
...
#line 183
  memcpy((void */* __restrict  */)((void *)(a->h.dst)), (void const   */* __restrict  */)((void const   *)(c->h.src)),
         sizeof(a->h.dst));
#line 184
  memcpy((void */* __restrict  */)((void *)(a->h.src)), (void const   */* __restrict  */)((void const   *)(mac___0)),
         sizeof(a->h.src));
#line 185
...
{ 
  ...
  {
#line 202
  fputs((char const   */* __restrict  */)((char const   *)prefix), (FILE */* __restrict  */)stdout);
#line 203
  i = 0;
  }
  {
...
#line 296
  if (tmp___0) {
    {
#line 297
    tmp = strtol((char const   */* __restrict  */)((char const   *)opts___0), (char **/* __restrict  */)((char **)((void *)0)),
                 0);
#line 297
    a->lba[0] = (uchar )tmp;
    }
...
{ 
  ...
  {
#line 37
  strcpy((char */* __restrict  */)(xx.ifr_ifrn.ifrn_name), (char const   */* __restrict  */)((char const   *)name));
#line 38
...
#line 76
  tmp___1 = select(fd + 1, (fd_set */* __restrict  */)(& rfd), (fd_set */* __restrict  */)((fd_set *)0),

...
#line 218
      ...
      {
#line 223
      strncpy((char */* __restrict  */)(hostresult.hostname), (char const   */* __restrict  */)((char const   *)hp->h_name),
              (size_t )13);
#line 224
...
#line 224
      if (alp) {
        {
#line 225
        strncpy((char */* __restrict  */)(hostresult.alias), (char const   */* __restrict  */)((char const   *)alp),
                (size_t )13);
        }
      } else {
#line 227
...
#line 343
                    strncpy((char */* __restrict  */)(hostresult.dosuser), (char const   */* __restrict  */)((char const   *)bp),
                            (size_t )14);
                    }
                  } else {
                    {
#line 346
                    strcpy((char */* __restrict  */)(hostresult.dosuser), (char const   */* __restrict  */)((char const   *)bp));
                    }
                  }
                } else {
#line 337
...
#line 349
              if (tmp___14 == 0) {
                {
#line 350
                strcpy((char */* __restrict  */)(defcluser), (char const   */* __restrict  */)((char const   *)bits[1]));
                }
#line 351
                goto next_host;
              }
...
#line 372
                      strncpy((char */* __restrict  */)(hostresult.dosuser), (char const   */* __restrict  */)((char const   *)bp___0),
                              (size_t )11);
                      }
                    } else {
                      {
#line 375
                      strcpy((char */* __restrict  */)(hostresult.dosuser), (char const   */* __restrict  */)((char const   *)bp___0));
                      }
                    }
                  } else {
                    {
...
#line 388
      if (flags & (unsigned int )(1 << 5)) {
        {
#line 393
        strncpy((char */* __restrict  */)(hostresult.hostname), (char const   */* __restrict  */)((char const   *)bits[0]),
                (size_t )13);
        }
#line 395
        if (bits[1]) {
          {
#line 396
          strncpy((char */* __restrict  */)(hostresult.alias), (char const   */* __restrict  */)((char const   *)bits[1]),
                  (size_t )13);
          }
        } else {
#line 398
...
#line 426
          flags |= 1U;
#line 427
          strncpy((char */* __restrict  */)(hostresult.hostname), (char const   */* __restrict  */)((char const   *)bits[1]),
                  (size_t )13);
#line 428
          hostresult.alias[0] = (char )'\000';
#line 429
...
#line 703
      askuser(wuser, (int const   )(nxtline + 1), "Default user", (int const   )1,
              (int const   )1);
#line 704
      strcpy((char */* __restrict  */)(defcluser), (char const   */* __restrict  */)((char const   *)(wuser)));
      }
    }
  }
#line 706
...
#line 73
    ...
    {
#line 75
    tmp = freopen((char const   */* __restrict  */)((char const   *)outf), (char const   */* __restrict  */)"w",
...
#line 88
  if (inplace) {
    {
#line 88
    tmp___0 = freopen((char const   */* __restrict  */)((char const   *)inf), (char const   */* __restrict  */)"w",
                      (FILE */* __restrict  */)stdout);
    }
#line 88
    if (! tmp___0) {
...
#line 29 "/home/june/repo/benchmarks/collector/temp/gnuspool-1.7ubuntu1/util/helpparse.c"
  {      (char )'E',      (char )'H',      (char )'P',      (char )'Q', 
        ...
        (char )'X',      (char )'\000'};
#line 30 "/home/june/repo/benchmarks/collector/temp/gnuspool-1.7ubuntu1/util/helpparse.c"
...
#line 105
    modin = fopen((char const   */* __restrict  */)((char const   *)(mod_path)), (char const   */* __restrict  */)"r");
    }
#line 106
    if (! modin) {
      {
...
#line 111
    modout = fopen((char const   */* __restrict  */)((char const   *)(mod_path)),
...
#line 128
    sprintf((char */* __restrict  */)(mod_path___0), (char const   */* __restrict  */)"%s/%s",
            srcdir, mp->mod_name);
#line 129
    modin = fopen((char const   */* __restrict  */)((char const   *)(mod_path___0)),
...
#line 134
    sprintf((char */* __restrict  */)(mod_path___0), (char const   */* __restrict  */)"%s/%s",
            destdir, mp->mod_name);
#line 135
    modout = fopen((char const   */* __restrict  */)((char const   *)(mod_path___0)),
                   (char const   */* __restrict  */)"w");
    }
#line 136
    if (! modout) {
...
#line 525
      hlpin = fopen((char const   */* __restrict  */)((char const   *)(hlp_path)),
                    (char const   */* __restrict  */)"r");
      }
#line 526
      if (! hlpin) {
...
#line 531
      hf->hf_filep = fopen((char const   */* __restrict  */)((char const   *)(hlp_path)),
                           (char const   */* __restrict  */)"w");
      }
#line 532
      if (! hf->hf_filep) {
...
#line 548
      sprintf((char */* __restrict  */)(hlp_path___0), (char const   */* __restrict  */)"%s/%s",
              srcdir, hf->hf_name);
#line 549
      hlpin = fopen((char const   */* __restrict  */)((char const   *)(hlp_path___0)),
                    (char const   */* __restrict  */)"r");
      }
#line 550
      if (! hlpin) {
...
#line 554
      sprintf((char */* __restrict  */)(hlp_path___0), (char const   */* __restrict  */)"%s/%s",
              destdir, hf->hf_name);
#line 555
      hf->hf_filep = fopen((char const   */* __restrict  */)((char const   *)(hlp_path___0)),
                           (char const   */* __restrict  */)"w");
      }
#line 556
      if (! hf->hf_filep) {
...
#line 41
    if ((unsigned long )yyleng >= sizeof(filenbuf) - 1UL) {
      {
#line 42
      strncpy((char */* __restrict  */)(filenbuf), (char const   */* __restrict  */)((char const   *)yytext),
              sizeof(filenbuf) - 1UL);
      }
    } else {
      {
#line 44
      strcpy((char */* __restrict  */)(filenbuf), (char const   */* __restrict  */)((char const   *)yytext));
      }
    }
    {
#line 45
...
#line 47
  hadsame = 0U;
#line 48
  memcpy((void */* __restrict  */)((void *)(lastbuf)), (void const   */* __restrict  */)((void const   *)b),
         (size_t )blksize);
#line 49
...
#line 209
  sprintf((char */* __restrict  */)fname, (char const   */* __restrict  */)"%s/Menuhelp",
          *(names + crow));
#line 210
  hf = fopen((char const   */* __restrict  */)((char const   *)fname), (char const   */* __restrict  */)"r");
  }
#line 210
  if (hf) {
#line 211

...
#line 64
    fn = *tmp;
#line 65
    tmp___0 = stat((char const   */* __restrict  */)((char const   *)fn), (struct stat */* __restrict  */)(& sb));
    }
#line 65
    if (! tmp___0) {
#line 66
...
#line 57
    ...
    {
#line 59
    strncpy((char */* __restrict  */)(dir), (char const   */* __restrict  */)((char const   *)optarg),
            sizeof(dir));
#line 60
...
#line 62
    ...
    {
#line 64
    strncpy((char */* __restrict  */)(sfvfile), (char const   */* __restrict  */)((char const   *)optarg),
            sizeof(sfvfile));
#line 65
...
#line 117
    if (rsfvflag == 2) {
      {
#line 122
      strcpy((char */* __restrict  */)(dir), (char const   */* __restrict  */)((char const   *)(sfvfile)));
#line 123
...
#line 79
  ...
  {
#line 81
  fd = fopen((char const   */* __restrict  */)((char const   *)fn), (char const   */* __restrict  */)"r");
  }
#line 82
...
#line 147
    tmp___12 = strtoul((char const   */* __restrict  */)((char const   *)(& buf[checksumstart])),
...
#line 327
      if ((int )*bar == 0) {
        {
#line 328
        strcpy((char */* __restrict  */)filename, (char const   */* __restrict  */)((char const   *)(dirinfo->d_name)));
        }
      }
    }
  }
...
#line 385
    if (! follow) {
      {
#line 386
      ret = lstat((char const   */* __restrict  */)((char const   *)(dirinfo->d_name)),
                  (struct stat */* __restrict  */)(& dirstat));
      }
    } else {
      {
#line 389
      ret = stat((char const   */* __restrict  */)((char const   *)(dirinfo->d_name)),
                 (struct stat */* __restrict  */)(& dirstat));
      }
    }
#line 391

...
#line 153
  tmp___26 = strftime((char */* __restrict  */)(tmp), (size_t )50, (char const   */* __restrict  */)"%Y-%m-%d %T %Z",
                      (struct tm  const  */* __restrict  */)((struct tm  const  *)loctime));
#line 153
  ret = (int )tmp___26;
  }
#line 155
...
#line 347
  ...
  {
#line 350
  strcpy((char */* __restrict  */)newname, (char const   */* __restrict  */)((char const   *)oldname));
#line 351
  strcat((char */* __restrict  */)newname, (char const   */* __restrict  */)((char const   *)logfile___0->oldext));
#line 353
...
#line 383
  ...
  {
#line 386
  strcpy((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)logfile___0->name));
#line 387
  strcat((char */* __restrict  */)name, (char const   */* __restrict  */)((char const   *)(number)));
  }
#line 389
  return (name);
}
...
#line 505
        if (writetimestamp) {
          {
#line 506
          memcpy((void */* __restrict  */)((void *)(& app.toffset)), (void const   */* __restrict  */)((void const   *)(& tvtime)),
...
#line 106
    if (pipe___0->regexp) {
      {
#line 107
      tmp = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& pipe___0->preg)),
                    (char const   */* __restrict  */)((char const   *)pipe___0->buf),
...
#line 171
        strcpy((char */* __restrict  */)(pipe___0->buf + (ccount - 1U)), (char const   */* __restrict  */)((char const   *)pipe___0->escreset));
#line 172
...
#line 384
    ...
    {
#line 391
    strcpy((char */* __restrict  */)pipe___0->dbuf, (char const   */* __restrict  */)((char const   *)pipe___0->esccolor));
#line 392
...
#line 547
    if (pipe___0->execregexp) {
      {
#line 548
      tmp___2 = regexec((regex_t const   */* __restrict  */)((regex_t const   *)(& pipe___0->pexecreg)),
                        (char const   */* __restrict  */)((char const   *)pipe___0->buf),
                        (size_t )pipe___0->bfill, (regmatch_t */* __restrict  */)((regmatch_t *)((void *)0)),
                        0);
      }
#line 548
      if (! tmp___2) {
...
#line 592
  while (1) {
    ...
    {
#line 593
    tmp___0 = select(pipe___0->fh + 1, (fd_set */* __restrict  */)(& fd_pipe), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
...
#line 642
    tmp___1 = select(1024, (fd_set */* __restrict  */)(& rdfs), (fd_set */* __restrict  */)((fd_set *)((void *)0)),
                     (fd_set */* __restrict  */)((fd_set *)((void *)0)), (struct timeval */* __restrict  */)((struct timeval *)((void *)0)));
    }
#line 642
    if (tmp___1 > 0) {
...
#line 686
  ...
  {
#line 690
  pthread_create((pthread_t */* __restrict  */)(& (app.pstderr)->ct), (pthread_attr_t const   */* __restrict  */)((pthread_attr_t const   *)((void *)0)),
                 & capture_thread, (void */* __restrict  */)((void *)app.pstderr));
#line 692
  pthread_create((pthread_t */* __restrict  */)(& (app.pstdout)->ct), (pthread_attr_t const   */* __restrict  */)((pthread_attr_t const   *)((void *)0)),
                 & capture_thread, (void */* __restrict  */)((void *)app.pstdout));
  }
#line 698
  return (0);
}
...
#line 87
  if ((unsigned int )type != 0U) {
    {
#line 88
    memcpy((void */* __restrict  */)((void *)fmtstring), (void const   */* __restrict  */)((void const   *)"logapp"),
           (size_t )exec_len);
#line 89
    fmt_len = exec_len;
    }
...
#line 104
  ...
  {
#line 97
  memcpy((void */* __restrict  */)((void *)(fmtstring + exec_len)), (void const   */* __restrict  */)((void const   *)" warning: "),
         (size_t )warn_len);
#line 98
  fmt_len += warn_len;
  }
#line 99
  ...
  {
#line 101
  memcpy((void */* __restrict  */)((void *)(fmtstring + exec_len)), (void const   */* __restrict  */)((void const   *)" error: "),
         (size_t )err_len);
#line 102
  fmt_len += err_len;
  }
...
#line 104
  ...
  {
#line 107
  memcpy((void */* __restrict  */)((void *)(fmtstring + fmt_len)), (void const   */* __restrict  */)((void const   *)format),
         (size_t )format_len);
#line 108
  *((fmtstring + fmt_len) + format_len) = (char )'\000';
#line 110
  tmp___5 = vfprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)((char const   *)fmtstring),
                     argptr);
  }
#line 110
  if (tmp___5 < 0) {
...
#line 197
        ...
        {
#line 199
        memcpy((void */* __restrict  */)((void *)(& linebuf[offset___0])), (void const   */* __restrict  */)((void const   *)(arglist[i].desc + descoffset)),
               (size_t )(j - descoffset));
#line 202
...
#line 253
    if ((unsigned long )app.ptytermios != (unsigned long )((void *)0)) {
      {
#line 254
      memcpy((void */* __restrict  */)((void *)app.ptytermios_bak), (void const   */* __restrict  */)((void const   *)app.ptytermios),
...
#line 491
    if ((unsigned long )longpath != (unsigned long )((void *)0)) {
      {
#line 492
      strcpy((char */* __restrict  */)longpath, (char const   */* __restrict  */)((char const   *)home));
#line 493
...
#line 574
  ...
  {
#line 577
  memcpy((void */* __restrict  */)((void *)pipe___0->esccolor), (void const   */* __restrict  */)((void const   *)pipe___0->escreset),
...
#line 605
    if (tmp___3) {
      {
#line 606
      tmp___2 = regcomp((regex_t */* __restrict  */)(& pipe___0->preg), (char const   */* __restrict  */)((char const   *)pipe___0->regexp),
                        regexp_cflags);
      }
#line 606
      if (tmp___2) {
...
#line 618
    if (tmp___5) {
      {
#line 619
      tmp___4 = regcomp((regex_t */* __restrict  */)(& pipe___0->pexecreg), (char const   */* __restrict  */)((char const   *)pipe___0->execregexp),
                        regexp_cflags);
      }
#line 619
      if (tmp___4) {
...
#line 802
  *tmp___0 = 0;
#line 803
  tmp___1 = strtol((char const   */* __restrict  */)((char const   *)string), (char **/* __restrict  */)(& p),
                   0);
#line 803
...
#line 1154
      ...
      {
#line 1156
      conffile = fopen((char const   */* __restrict  */)((char const   *)filename),
...
#line 1212
    key ++;
#line 1212
    tok[key] = strtok((char */* __restrict  */)((char *)((void *)0)), (char const   */* __restrict  */)", ");
    }
  }
  while_break___2: /* CIL Label */ ;
  }

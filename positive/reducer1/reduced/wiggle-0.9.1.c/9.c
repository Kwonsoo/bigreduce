...
#line 117
    ...
    {
#line 120
    sscanf((char const   */* __restrict  */)((char const   *)(e.start + 1)), (char const   */* __restrict  */)"%d %d %d",
           & a, & b, & c);
#line 121
...
{ 
  ...
  {
#line 128
  sscanf((char const   */* __restrict  */)((char const   *)(e1.start + 1)), (char const   */* __restrict  */)"%d %d %d",
         & a, & b, & c);
#line 129
  sscanf((char const   */* __restrict  */)((char const   *)(e2.start + 1)), (char const   */* __restrict  */)"%d %d %d",
         & d, & e, & f);
#line 130
...
#line 519
    strcpy((char */* __restrict  */)replacename, (char const   */* __restrict  */)((char const   *)*(argv + 0)));
#line 520
    strcpy((char */* __restrict  */)orignew, (char const   */* __restrict  */)((char const   *)*(argv + 0)));
#line 521
...
#line 609
  filename = *(argv + 0);
#line 610
  f = fopen((char const   */* __restrict  */)((char const   *)filename), (char const   */* __restrict  */)"r");
  }
#line 611
  if (! f) {
    {
...
#line 675
    ...
    {
#line 677
    fputs((char const   */* __restrict  */)((char const   *)helpmsg), (FILE */* __restrict  */)stderr);
#line 678
    exit(0);
    }
    case_86: 
    {
#line 681
    fputs((char const   */* __restrict  */)((char const   *)(Version)), (FILE */* __restrict  */)stderr);
#line 682
    exit(0);
    }
    switch_default: 
    {
#line 686
    fputs((char const   */* __restrict  */)((char const   *)(Usage)), (FILE */* __restrict  */)stderr);
#line 687
    exit(2);
    }
    case_109___0: 
...
#line 912
                  sscanf((char const   */* __restrict  */)((char const   *)(e1.start + 1)),
                         (char const   */* __restrict  */)"%d %d %d", & A, & B, & C);
#line 913
                  sscanf((char const   */* __restrict  */)((char const   *)(e.start + 1)),
                         (char const   */* __restrict  */)"%d %d %d", & D, & E, & F);
#line 914
...
#line 1554
    searchlen = 0U;
#line 1555
    airac_observe(search, searchlen);
#line 1555
    search[searchlen] = (char)0;
#line 1556
    searchdir = -1;
...
#line 2368
  ...
  {
#line 2371
  f = fopen((char const   */* __restrict  */)((char const   *)*(argv + 0)), (char const   */* __restrict  */)"r");
  }
#line 2372
  if (! f) {
    {
...
#line 2391
  ...
  {
#line 2393
  f = fopen((char const   */* __restrict  */)((char const   *)*(argv + 1)), (char const   */* __restrict  */)"r");
  }
#line 2394
  if (! f) {
    {
...
#line 87
    ...
    {
#line 89
    tmp___8 = sscanf((char const   */* __restrict  */)((char const   *)cp), (char const   */* __restrict  */)"@@ -%s +%s @@",
                     before, after);
    }
#line 89
    if (tmp___8 == 2) {
...
#line 90
      ok = 1;
#line 91
      tmp___3 = sscanf((char const   */* __restrict  */)((char const   *)(before)),
                       (char const   */* __restrict  */)"%d,%d", & a, & b);
      }
#line 91
      if (tmp___3 == 2) {
#line 92
        ...
        {
#line 93
        tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)(before)),
                         (char const   */* __restrict  */)"%d", & a);
        }
#line 93
        if (tmp___2 == 1) {
#line 94
...
#line 96
      ...
      {
#line 98
      tmp___5 = sscanf((char const   */* __restrict  */)((char const   *)(after)),
                       (char const   */* __restrict  */)"%d,%d", & c, & d);
      }
#line 98
      if (tmp___5 == 2) {
#line 99
        ...
        {
#line 100
        tmp___4 = sscanf((char const   */* __restrict  */)((char const   *)(after)),
                         (char const   */* __restrict  */)"%d", & c);
        }
#line 100
        if (tmp___4 == 1) {
#line 101
...
#line 107
      ...
      {
#line 108
      tmp___7 = sscanf((char const   */* __restrict  */)((char const   *)cp), (char const   */* __restrict  */)"*** %d,%d ****",
                       & a, & b);
      }
#line 108
      if (tmp___7 == 2) {
...
#line 110
        ...
        {
#line 111
        tmp___6 = sscanf((char const   */* __restrict  */)((char const   *)cp), (char const   */* __restrict  */)"--- %d,%d ----",
                         & c, & d);
        }
#line 111
        if (tmp___6 == 2) {
...
#line 120
      sprintf((char */* __restrict  */)(buf + 1), (char const   */* __restrict  */)"%5d %5d %5d\n",
              chunks, a, acnt);
#line 121
      memcpy((void */* __restrict  */)((void *)(r1.body + r1.len)), (void const   */* __restrict  */)((void const   *)(buf)),
             (size_t )20);
#line 122
      r1.len += 20;
      }
...
#line 127
      sprintf((char */* __restrict  */)(buf___0 + 1), (char const   */* __restrict  */)"%5d %5d %5d\n",
              chunks, c, bcnt);
#line 128
      memcpy((void */* __restrict  */)((void *)(r2.body + r2.len)), (void const   */* __restrict  */)((void const   *)(buf___0)),
             (size_t )20);
#line 129
      r2.len += 20;
      }
...
#line 62
    ...
    {
#line 63
    memcpy((void */* __restrict  */)((void *)c), (void const   */* __restrict  */)((void const   *)(list + i)->body),
           (size_t )(list + i)->len);
#line 64
    c += (list + i)->len;
#line 65
...
#line 116
  tmp___0 = fread((void */* __restrict  */)((void *)s.body), (size_t )1, (size_t )s.len,
                  (FILE */* __restrict  */)f);
  }
#line 116
...
#line 130
  s.len = 0;
#line 131
  tmp___2 = sscanf((char const   */* __restrict  */)((char const   *)name), (char const   */* __restrict  */)"_wiggle_:%d:%d:%n",
...
#line 131
    if (prefix_len > 0) {
      {
#line 133
      tmp = fopen((char const   */* __restrict  */)((char const   *)(name + prefix_len)),

...
#line 260
  ...
  {
#line 263
  memcpy((void */* __restrict  */)((void *)buf->ptr), (void const   */* __restrict  */)data,
         size);
#line 264
  buf->ptr += size;
  }
...
#line 47 "/home/june/repo/benchmarks/collector/temp/haserl-0.9.32/src/haserl.h"
char x2c(char *what ) ;
#line 48
...
#line 249
    strncat((char */* __restrict  */)entry, (char const   */* __restrict  */)((char const   *)prefix),
            tmp___5);
    }
  }
#line 252
  if (array == 1) {
    {
#line 254
    strncat((char */* __restrict  */)entry, (char const   */* __restrict  */)((char const   *)str),
            keylen);
#line 255
    strcat((char */* __restrict  */)entry, (char const   */* __restrict  */)((char const   *)((str + keylen) + 2)));
    }
  } else {
    {
#line 259
    strcat((char */* __restrict  */)entry, (char const   */* __restrict  */)((char const   *)str));
    }
  }
  {
#line 263
...
#line 276
        strcat((char */* __restrict  */)temp, (char const   */* __restrict  */)((char const   *)((str + keylen) + 3)));
#line 277
        free((void *)entry);
#line 278
        entry = temp;
...
#line 474
    tmp___1 = strtoul((char const   */* __restrict  */)((char const   *)tmp___0),
...
#line 493
    sbuf.maxread = strtoul((char const   */* __restrict  */)((char const   *)tmp___6),
                           (char **/* __restrict  */)((char **)((void *)0)), 10);
    }
  }
  {
...
#line 103
  memcpy((void */* __restrict  */)((void *)scriptbuf->name), (void const   */* __restrict  */)((void const   *)filename),
         tmp___4);
#line 104
...
#line 107
      sigaction(13, (struct sigaction  const  */* __restrict  */)((struct sigaction  const  *)(& new_action)),
...
#line 122
  ptr = (char *)tmp;
#line 123
  memcpy((void */* __restrict  */)((void *)ptr), (void const   */* __restrict  */)((void const   *)start),
         (size_t )len);
  }
#line 124
  return (ptr);
...
#line 296
  strcpy((char */* __restrict  */)tmpname, (char const   */* __restrict  */)((char const   *)global.uploaddir));
#line 297
...
#line 420
  memcpy((void */* __restrict  */)((void *)boundary), (void const   */* __restrict  */)((void const   *)crlf),
         (size_t )2);
#line 421
  memcpy((void */* __restrict  */)((void *)(boundary + 2)), (void const   */* __restrict  */)((void const   *)"--"),
         (size_t )2);
#line 422
  tmp___3 = strlen((char const   *)(str + i));
#line 422
  memcpy((void */* __restrict  */)((void *)(boundary + 4)), (void const   */* __restrict  */)((void const   *)(str + i)),
         tmp___3 + 1UL);
  }
#line 423
  if (i > 0) {
...
#line 439
    sbuf.maxread = strtoul((char const   */* __restrict  */)((char const   *)tmp___5),
                           (char **/* __restrict  */)((char **)((void *)0)), 10);
    }
  }
  {
